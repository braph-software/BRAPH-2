...
el_class_list = {'NNDataPoint_Shuffled' 'NNxMLP_FeatureImportance' 'NNxMLP_FeatureImportance_CrossValidation' 'NNxMLP_FeatureImportanceAcrossMeasures' 'NNxMLP_FeatureImportanceAcrossMeasures_CrossValidation'}; 
