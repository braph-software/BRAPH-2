classdef PlotBrainGraphComparison < PlotBrainAtlas
	% PlotBrainGraphComparison is a plot of a brain graph comparison.
	...
	%
	% The list of PlotBrainGraphComparison properties is:
	...
	%
	% PlotBrainGraphComparison methods (constructor):
	% PlotBrainGraphComparison - constructor
	%
	% PlotBrainGraphComparison methods (Static):
	...
	%
	% PlotBrainGraphComparison methods:
	...
	%  set_settings - hComparison/set_settings is a function.
	%  cb_close - closes the figure containing the panel and the settings figure.
	%  cb_close_fs - phComparison/cb_close_fs is a function.
	...
	%
	% PlotBrainGraphComparison methods (operators):
	%  isequal - determines whether two PlotBrainGraphComparison are equal (values, locked)
	%
	% PlotBrainGraphComparison methods (display):
	%  tostring - string with information about the PlotBrainGraphComparison
	%  disp - displays information about the PlotBrainGraphComparison
	%  tree - displays the element of PlotBrainGraphComparison
	%
	% PlotBrainGraphComparison method (element list):
	%  getElementList - returns a list with all subelements of PlotBrainGraphComparison
	%
	% PlotBrainGraphComparison method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the PlotBrainGraphComparison
	%
	% PlotBrainGraphComparison method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the PlotBrainGraphComparison
	%
	% PlotBrainGraphComparison methods (copy):
	%  copy - copies the PlotBrainGraphComparison
	%  deepclone - deep-clones the PlotBrainGraphComparison
	%  clone - clones the PlotBrainGraphComparison
	%
	% PlotBrainGraphComparison methods (inspection, Static):
	%  getClass - returns PlotBrainGraphComparison
	%  getName - returns the name of PlotBrainGraphComparison
	%  getDescription - returns the description of PlotBrainGraphComparison
	%  getProps - returns the property list of PlotBrainGraphComparison
	%  getPropNumber - returns the property number of PlotBrainGraphComparison
	...
	%  checkProp - checks whether a value has the correct format/error
	%
	% PlotBrainGraphComparison methods (category, Static):
	...
	%
	% PlotBrainGraphComparison methods (format, Static):
	...
	%
	% PlotBrainGraphComparison methods (GUI):
	%  getGUI - returns the element GUI
	%  getPlotElement - returns the element plot
	%  getPlotProp - returns a prop plot
	%
	% PlotBrainGraphComparison methods (GUI, Static):
	%  getGUIMenuImport - returns an importer menu
	%  getGUIMenuExport - returns an exporter menu
	%
	% PlotBrainGraphComparison properties (Constant).
	...
	methods (Static) % inspection methods
		function pl_class = getClass()
			%GETCLASS returns the class of the plot brain graph.
			%
			% CLASS = PlotBrainGraphComparison.GETCLASS() returns the class 'PlotBrainGraphComparison'.
			%
			% Alternative forms to call this method are:
			%  CLASS = PL.GETCLASS() returns the class of the plot brain graph PL.
			%  CLASS = Element.GETCLASS(PL) returns the class of 'PL'.
			%  CLASS = Element.GETCLASS('PlotBrainGraphComparison') returns 'PlotBrainGraphComparison'.
			%
			% See also getName, getDescription.
			
			pl_class = 'PlotBrainGraphComparison';
		end
		function pl_name = getName()
			%GETNAME returns the name of the plot brain graph.
			%
			% NAME = PlotBrainGraphComparison.GETNAME() returns the name of the 'plot brain graph'.
			%  Plot Brain Graph.
			%
			% Alternative forms to call this method are:
			%  NAME = PL.GETNAME() returns the name of the plot brain graph PL.
			%  NAME = Element.GETNAME(PL) returns the name of 'PL'.
			%  NAME = Element.GETNAME('PlotBrainGraphComparison') returns the name of 'PlotBrainGraphComparison'.
			%
		...
		function pl_description = getDescription()
			%GETDESCRIPTION returns the description of the plot brain graph.
			%
			% STR = PlotBrainGraphComparison.GETDESCRIPTION() returns the description of the 'plot brain graph'.
			%  which is:
			%
			%  PlotBrainGraphComparison manages the plot of the graph edges, arrows and cylinders.
			%  PlotBrainGraphComparison utilizes the surface created from PlotBrainAtlas to
			...
			%  STR = Element.GETDESCRIPTION('PlotBrainGraphComparison') returns the description of 'PlotBrainGraphComparison'.
			%
		...
		function prop_list = getProps(category)
			%GETPROPS returns the property list of plot brain graph.
			%
			% PROPS = PlotBrainGraphComparison.GETPROPS() returns the property list of plot brain graph.
			%
			% PROPS = PlotBrainGraphComparison.GETPROPS(CATEGORY) returns the property list 
			...
			%  PROPS = Element.GETPROPS('PlotBrainGraphComparison'[, CATEGORY]) returns the property list of 'PlotBrainGraphComparison'.
			%
			...
			switch category
				case Category.METADATA
					prop_list = [
						...
						PlotBrainGraphComparison.COMP
						PlotBrainGraphComparison.PROPTAG
						PlotBrainGraphComparison.TYPE
						];
		...
		function prop_number = getPropNumber()
			%GETPROPNUMBER returns the property number of plot brain graph.
			%
			% N = PlotBrainGraphComparison.GETPROPNUMBER() returns the property number of plot brain graph.
			%
			% Alternative forms to call this method are:
			...
			%  N = Element.GETPROPNUMBER('PlotBrainGraphComparison') returns the property number of 'PlotBrainGraphComparison'.
			%
			% See also getProps.
		...
		function check = existsProp(prop)
			%EXISTSPROP checks whether property exists in plot brain graph/error.
			%
			% CHECK = PlotBrainGraphComparison.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			...
			%  CHECK = Element.EXISTSPROP(PlotBrainGraphComparison, PROP) checks whether PROP exists for PlotBrainGraphComparison.
			%
			% Element.EXISTSPROP(PROP) throws an error if the PROP does NOT exist.
			%  Error id: [BRAPH2:PlotBrainGraphComparison:WrongInput]
			%
			% Alternative forms to call this method are:
			...
			%   Error id: [BRAPH2:PlotBrainGraphComparison:WrongInput]
			%  Element.EXISTSPROP(PlotBrainGraphComparison, PROP) throws error if PROP does NOT exist for PlotBrainGraphComparison.
			%   Error id: [BRAPH2:PlotBrainGraphComparison:WrongInput]
			%
			...
			if nargout == 1
				...
				assert( ...
					PlotBrainGraphComparison.existsProp(prop), ...
					[BRAPH2.STR ':PlotBrainGraphComparison:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PlotBrainGraphComparison:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(prop, 100, ' ...') ' is not a valid prop for PlotBrainGraphComparison.'] ...
					)
			end
		end
		function check = existsTag(tag)
			%EXISTSTAG checks whether tag exists in plot brain graph/error.
			%
			% CHECK = PlotBrainGraphComparison.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PL.EXISTSTAG(TAG) checks whether TAG exists for PL.
			%  CHECK = Element.EXISTSTAG(PL, TAG) checks whether TAG exists for PL.
			%  CHECK = Element.EXISTSTAG(PlotBrainGraphComparison, TAG) checks whether TAG exists for PlotBrainGraphComparison.
			%
			...
			%   Error id: [BRAPH2:PlotBrainGraphComparison:WrongInput]
			%  Element.EXISTSTAG(PlotBrainGraphComparison, TAG) throws error if TAG does NOT exist for PlotBrainGraphComparison.
			%   Error id: [BRAPH2:PlotBrainGraphComparison:WrongInput]
			%
			% See also getProps, existsTag.
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				plotbraingraphcomparison_tag_list = { 'id'  'bkgcolor'  'surf'  'axescolor'  'view'  'hold'  'grid'  'axis'  'equal'  'tight'  'brain'  'edgecolor'  'edgealpha'  'facecolor'  'facealpha'  'lighting'  'material'  'camlight'  'shading'  'colormap'  'colormapstring'  'atlas'  'parent'  'syms'  'syms_size'  'syms_marker'  'syms_face_color'  'syms_edge_color'  'sphs'  'sphs_size'  'sphs_edge_color'  'sphs_face_color'  'sphs_edge_alpha'  'sphs_face_alpha'  'ids'  'ids_size'  'ids_font_color'  'ids_font_name'  'ids_font_interpreter'  'labs'  'labs_size'  'labs_font_color'  'labs_font_name'  'labs_font_interpreter'  'comp'  'proptag'  'type' };
				
				check = any(strcmpi(tag, plotbraingraphcomparison_tag_list));
			else
				assert( ...
					PlotBrainGraphComparison.existsTag(tag), ...
					[BRAPH2.STR ':PlotBrainGraphComparison:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PlotBrainGraphComparison:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tag ' is not a valid tag for PlotBrainGraphComparison'] ...
					)
			end
		end
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(PlotBrainGraphComparison, POINTER) returns property number of POINTER of PlotBrainGraphComparison.
			%  PROPERTY = PL.GETPROPPROP(PlotBrainGraphComparison, POINTER) returns property number of POINTER of PlotBrainGraphComparison.
			%
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, plotbraingraphcomparison_tag_list));
			else % numeric
				prop = pointer;
				PlotBrainGraphComparison.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(PlotBrainGraphComparison, POINTER) returns tag of POINTER of PlotBrainGraphComparison.
			%  TAG = PL.GETPROPTAG(PlotBrainGraphComparison, POINTER) returns tag of POINTER of PlotBrainGraphComparison.
			%
			...
			if ischar(pointer)
				...
				switch prop
					case PlotBrainGraphComparison.COMP
						tag = PlotBrainGraphComparison.COMP_TAG;
					case PlotBrainGraphComparison.PROPTAG
						tag = PlotBrainGraphComparison.PROPTAG_TAG;
					case PlotBrainGraphComparison.TYPE
						tag = PlotBrainGraphComparison.TYPE_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(PlotBrainGraphComparison, POINTER) returns category of POINTER of PlotBrainGraphComparison.
			%  CATEGORY = PL.GETPROPCATEGORY(PlotBrainGraphComparison, POINTER) returns category of POINTER of PlotBrainGraphComparison.
			%
			% See also Category, getPropProp, getPropTag, getPropSettings,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
			
			prop = PlotBrainGraphComparison.getPropProp(pointer);
			
			switch prop
				case PlotBrainGraphComparison.COMP
					prop_category = PlotBrainGraphComparison.COMP_CATEGORY;
				case PlotBrainGraphComparison.PROPTAG
					prop_category = PlotBrainGraphComparison.PROPTAG_CATEGORY;
				case PlotBrainGraphComparison.TYPE
					prop_category = PlotBrainGraphComparison.TYPE_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(PlotBrainGraphComparison, POINTER) returns format of POINTER of PlotBrainGraphComparison.
			%  FORMAT = PL.GETPROPFORMAT(PlotBrainGraphComparison, POINTER) returns format of POINTER of PlotBrainGraphComparison.
			%
			...
			switch prop
				case PlotBrainGraphComparison.COMP
					prop_format = PlotBrainGraphComparison.COMP_FORMAT;
				case PlotBrainGraphComparison.PROPTAG
					prop_format = PlotBrainGraphComparison.PROPTAG_FORMAT;
				case PlotBrainGraphComparison.TYPE
					prop_format = PlotBrainGraphComparison.TYPE_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(PlotBrainGraphComparison, POINTER) returns description of POINTER of PlotBrainGraphComparison.
			%  DESCRIPTION = PL.GETPROPDESCRIPTION(PlotBrainGraphComparison, POINTER) returns description of POINTER of PlotBrainGraphComparison.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(PlotBrainGraphComparison, POINTER) returns settings of POINTER of PlotBrainGraphComparison.
			%  SETTINGS = PL.GETPROPSETTINGS(PlotBrainGraphComparison, POINTER) returns settings of POINTER of PlotBrainGraphComparison.
			%
			% See also getPropProp, getPropTag, getPropCategory,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = PlotBrainGraphComparison.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = PlotBrainGraphComparison.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PL.GETPROPDEFAULT(POINTER) returns the default value of POINTER of PL.
			%  DEFAULT = Element.GETPROPDEFAULT(PlotBrainGraphComparison, POINTER) returns the default value of POINTER of PlotBrainGraphComparison.
			%  DEFAULT = PL.GETPROPDEFAULT(PlotBrainGraphComparison, POINTER) returns the default value of POINTER of PlotBrainGraphComparison.
			%
			...
			switch prop
				case PlotBrainGraphComparison.COMP
					prop_default = Format.getFormatDefault(Format.ITEM, PlotBrainGraphComparison.getPropSettings(prop));
				case PlotBrainGraphComparison.PROPTAG
					prop_default = Format.getFormatDefault(Format.STRING, PlotBrainGraphComparison.getPropSettings(prop));
				case PlotBrainGraphComparison.TYPE
					prop_default = Format.getFormatDefault(Format.STRING, PlotBrainGraphComparison.getPropSettings(prop));
				otherwise
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = PlotBrainGraphComparison.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = PlotBrainGraphComparison.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PL.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of PL.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(PlotBrainGraphComparison, POINTER) returns the conditioned default value of POINTER of PlotBrainGraphComparison.
			%  DEFAULT = PL.GETPROPDEFAULTCONDITIONED(PlotBrainGraphComparison, POINTER) returns the conditioned default value of POINTER of PlotBrainGraphComparison.
			%
			...
			prop_default = PlotBrainGraphComparison.conditioning(prop, PlotBrainGraphComparison.getPropDefault(prop));
		end
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(PlotBrainGraphComparison, PROP, VALUE) checks VALUE format for PROP of PlotBrainGraphComparison.
			%  CHECK = PL.CHECKPROP(PlotBrainGraphComparison, PROP, VALUE) checks VALUE format for PROP of PlotBrainGraphComparison.
			% 
			...
			%   Error id: [BRAPH2:PlotBrainGraphComparison:WrongInput]
			%  Element.CHECKPROP(PlotBrainGraphComparison, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PlotBrainGraphComparison.
			%   Error id: [BRAPH2:PlotBrainGraphComparison:WrongInput]
			%  PL.CHECKPROP(PlotBrainGraphComparison, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PlotBrainGraphComparison.
			%   Error id: [BRAPH2:PlotBrainGraphComparison:WrongInput]
			% 
			...
			switch prop
				case PlotBrainGraphComparison.COMP
					check = Format.checkFormat(Format.ITEM, value, PlotBrainGraphComparison.getPropSettings(prop));
				case PlotBrainGraphComparison.PROPTAG
					check = Format.checkFormat(Format.STRING, value, PlotBrainGraphComparison.getPropSettings(prop));
				case PlotBrainGraphComparison.TYPE
					check = Format.checkFormat(Format.STRING, value, PlotBrainGraphComparison.getPropSettings(prop));
				otherwise
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':PlotBrainGraphComparison:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PlotBrainGraphComparison:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' PlotBrainGraphComparison.getPropTag(prop) ' (' PlotBrainGraphComparison.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function pl = PlotBrainGraphComparison(varargin)
			% PlotBrainGraphComparison() creates a plot brain graph.
			%
			% PlotBrainGraphComparison(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% PlotBrainGraphComparison(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
