...
for prop = 1:1:prop_number
	...
	assert( ...
		...
		[BRAPH2.STR ':BrainSurface:' BRAPH2.BUG_FUNC], ...
		['BrainSurface.getr(' int2str(prop) ') must be inizialized to NoValue(). ' ...
		'Or there could be an error in BrainSurface.getr(' int2str(prop) ').'] ...
		)
	assert( ...
		isa(bs.getr(TAG), 'NoValue'), ...
		[BRAPH2.STR ':BrainSurface:' BRAPH2.BUG_FUNC], ...
		['BrainSurface.getr(''' TAG ''') must be inizialized to NoValue(). ' ...
...
warning('off', 'BRAPH2:BrainSurface')
bs = BrainSurface( ...
...
warning('on', 'BRAPH2:BrainSurface')
	...
	switch BrainSurface.getPropCategory(prop)
		...
		case Category.RESULT
			assert( ...
				isa(bs.getr(prop), 'NoValue'), ...
				[BRAPH2.STR ':BrainSurface:' BRAPH2.BUG_FUNC], ...
				['Being a result, BrainSurface.getr(' int2str(prop) ') must be inizialized to NoValue(). ' ...
				'Or there could be an error in BrainSurface.getr(' int2str(prop) ').'] ...
				)
			assert( ...
				isa(bs.getr(TAG), 'NoValue'), ...
				[BRAPH2.STR ':BrainSurface:' BRAPH2.BUG_FUNC], ...
				['Being a result, BrainSurface.getr(''' TAG ''') must be inizialized to NoValue(). ' ...
				'Or there could be an error in BrainSurface.getr(''' TAG ''').'] ...
				)
	end
end
...
bs_1 = BrainSurface( ...
	BrainSurface.ID, Callback('EL', bs_0, 'PROP', 1), ...
	BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
	BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
	BrainSurface.VERTEX_NUMBER, Callback('EL', bs_0, 'PROP', 4), ...
	BrainSurface.COORDINATES, Callback('EL', bs_0, 'PROP', 5), ...
	BrainSurface.TRIANGLES_NUMBER, Callback('EL', bs_0, 'PROP', 6), ...
	BrainSurface.TRIANGLES, Callback('EL', bs_0, 'PROP', 7) ...
	);
...
bs_2 = BrainSurface( ...
	BrainSurface.ID, Callback('EL', bs_1, 'PROP', 1), ...
	BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
	BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
	BrainSurface.VERTEX_NUMBER, Callback('EL', bs_1, 'PROP', 4), ...
	BrainSurface.COORDINATES, Callback('EL', bs_1, 'PROP', 5), ...
	BrainSurface.TRIANGLES_NUMBER, Callback('EL', bs_1, 'PROP', 6), ...
	BrainSurface.TRIANGLES, Callback('EL', bs_1, 'PROP', 7) ...
	);
...
bs_3 = BrainSurface( ...
	BrainSurface.ID, Callback('EL', bs_2, 'PROP', 1), ...
	BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
	BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
	BrainSurface.VERTEX_NUMBER, Callback('EL', bs_2, 'PROP', 4), ...
	BrainSurface.COORDINATES, Callback('EL', bs_2, 'PROP', 5), ...
	BrainSurface.TRIANGLES_NUMBER, Callback('EL', bs_2, 'PROP', 6), ...
	BrainSurface.TRIANGLES, Callback('EL', bs_2, 'PROP', 7) ...
	);
	...
	switch BrainSurface.getPropCategory(prop)
		...
		case Category.RESULT
			...
			assert( ...
				isa(bs.getr(prop),  'NoValue'), ...
				[BRAPH2.STR ':BrainSurface:' BRAPH2.BUG_FUNC], ...
				['BrainSurface.getr(' int2str(prop) ') must be a NoValue, because it has not been memorized.'] ...
				)
