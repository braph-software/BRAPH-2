classdef PPCompareEnsemble_CPDict_WU < PlotProp
	% PPCompareEnsemble_CPDict_WU is a plot of a comparison ensemble dictionary.
	...
	%
	% The list of PPCompareEnsemble_CPDict_WU properties is:
	...
	%
	% PPCompareEnsemble_CPDict_WU methods (constructor):
	% PPCompareEnsemble_CPDict_WU - constructor
	%
	% PPCompareEnsemble_CPDict_WU methods (Static):
	...
	%
	% PPCompareEnsemble_CPDict_WU methods:
	...
	%  cb_measure_calc - e_CPDict_WU/cb_measure_calc is a function.
	...
	%  cb_button_del - ble_CPDict_WU/cb_button_del is a function.
	%  cb_button_calc - le_CPDict_WU/cb_button_calc is a function.
	%  cb_button_cb - mble_CPDict_WU/cb_button_cb is a function.
	%  set_settings - mble_CPDict_WU/set_settings is a function.
	%  cb_close_fs - emble_CPDict_WU/cb_close_fs is a function.
	...
	%
	% PPCompareEnsemble_CPDict_WU methods (operators):
	%  isequal - determines whether two PPCompareEnsemble_CPDict_WU are equal (values, locked)
	%
	% PPCompareEnsemble_CPDict_WU methods (display):
	%  tostring - string with information about the PPCompareEnsemble_CPDict_WU
	%  disp - displays information about the PPCompareEnsemble_CPDict_WU
	%  tree - displays the element of PPCompareEnsemble_CPDict_WU
	%
	% PPCompareEnsemble_CPDict_WU method (element list):
	%  getElementList - returns a list with all subelements of PPCompareEnsemble_CPDict_WU
	%
	% PPCompareEnsemble_CPDict_WU method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the PPCompareEnsemble_CPDict_WU
	%
	% PPCompareEnsemble_CPDict_WU method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the PPCompareEnsemble_CPDict_WU
	%
	% PPCompareEnsemble_CPDict_WU methods (copy):
	%  copy - copies the PPCompareEnsemble_CPDict_WU
	%  deepclone - deep-clones the PPCompareEnsemble_CPDict_WU
	%  clone - clones the PPCompareEnsemble_CPDict_WU
	%
	% PPCompareEnsemble_CPDict_WU methods (inspection, Static):
	%  getClass - returns PPCompareEnsemble_CPDict_WU
	%  getName - returns the name of PPCompareEnsemble_CPDict_WU
	%  getDescription - returns the description of PPCompareEnsemble_CPDict_WU
	%  getProps - returns the property list of PPCompareEnsemble_CPDict_WU
	%  getPropNumber - returns the property number of PPCompareEnsemble_CPDict_WU
	...
	%  checkProp - checks whether a value has the correct format/error
	%
	% PPCompareEnsemble_CPDict_WU methods (category, Static):
	...
	%
	% PPCompareEnsemble_CPDict_WU methods (format, Static):
	...
	%
	% PPCompareEnsemble_CPDict_WU methods (GUI):
	%  getGUI - returns the element GUI
	%  getPlotElement - returns the element plot
	%  getPlotProp - returns a prop plot
	%
	% PPCompareEnsemble_CPDict_WU methods (GUI, Static):
	%  getGUIMenuImport - returns an importer menu
	%  getGUIMenuExport - returns an exporter menu
	%
	% PPCompareEnsemble_CPDict_WU properties (Constant).
	%  EL - 3
	%  EL_TAG - 'el'
	%  EL_CATEGORY - 'm'
	%  EL_FORMAT - 'it'
	...
	methods (Static) % inspection methods
		function pr_class = getClass()
			%GETCLASS returns the class of the plot property graph.
			%
			% CLASS = PPCompareEnsemble_CPDict_WU.GETCLASS() returns the class 'PPCompareEnsemble_CPDict_WU'.
			%
			% Alternative forms to call this method are:
			%  CLASS = PR.GETCLASS() returns the class of the plot property graph PR.
			%  CLASS = Element.GETCLASS(PR) returns the class of 'PR'.
			%  CLASS = Element.GETCLASS('PPCompareEnsemble_CPDict_WU') returns 'PPCompareEnsemble_CPDict_WU'.
			%
			% See also getName, getDescription.
			
			pr_class = 'PPCompareEnsemble_CPDict_WU';
		end
		function pr_name = getName()
			%GETNAME returns the name of the plot property graph.
			%
			% NAME = PPCompareEnsemble_CPDict_WU.GETNAME() returns the name of the 'plot property graph'.
			%  Plot Property Graph.
			%
			% Alternative forms to call this method are:
			%  NAME = PR.GETNAME() returns the name of the plot property graph PR.
			%  NAME = Element.GETNAME(PR) returns the name of 'PR'.
			%  NAME = Element.GETNAME('PPCompareEnsemble_CPDict_WU') returns the name of 'PPCompareEnsemble_CPDict_WU'.
			%
		...
		function pr_description = getDescription()
			%GETDESCRIPTION returns the description of the plot property graph.
			%
			% STR = PPCompareEnsemble_CPDict_WU.GETDESCRIPTION() returns the description of the 'plot property graph'.
			%  which is:
			%
			%  PPCompareEnsemble_CPDict_WU plots the comparison ensemble dictionary property associated with a graph.
			%  It also provides the buttons to navigate the graphical interface of the measures ensemble.
			...
			%  STR = Element.GETDESCRIPTION('PPCompareEnsemble_CPDict_WU') returns the description of 'PPCompareEnsemble_CPDict_WU'.
			%
		...
		function prop_list = getProps(category)
			%GETPROPS returns the property list of plot property graph.
			%
			% PROPS = PPCompareEnsemble_CPDict_WU.GETPROPS() returns the property list of plot property graph.
			%
			% PROPS = PPCompareEnsemble_CPDict_WU.GETPROPS(CATEGORY) returns the property list 
			%  of category CATEGORY.
			%
			% Alternative forms to call this method are:
			%  PROPS = PR.GETPROPS([CATEGORY]) returns the property list of the plot property graph PR.
			%  PROPS = Element.GETPROPS(PR[, CATEGORY]) returns the property list of 'PR'.
			%  PROPS = Element.GETPROPS('PPCompareEnsemble_CPDict_WU'[, CATEGORY]) returns the property list of 'PPCompareEnsemble_CPDict_WU'.
			%
		...
		function prop_number = getPropNumber()
			%GETPROPNUMBER returns the property number of plot property graph.
			%
			% N = PPCompareEnsemble_CPDict_WU.GETPROPNUMBER() returns the property number of plot property graph.
			%
			% Alternative forms to call this method are:
			%  N = PR.GETPROPNUMBER() returns the property number of the plot property graph PR.
			%  N = Element.GETPROPNUMBER(PR) returns the property number of 'PR'.
			%  N = Element.GETPROPNUMBER('PPCompareEnsemble_CPDict_WU') returns the property number of 'PPCompareEnsemble_CPDict_WU'.
			%
			% See also getProps.
		...
		function check = existsProp(prop)
			%EXISTSPROP checks whether property exists in plot property graph/error.
			%
			% CHECK = PPCompareEnsemble_CPDict_WU.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSPROP(PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PR, PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PPCompareEnsemble_CPDict_WU, PROP) checks whether PROP exists for PPCompareEnsemble_CPDict_WU.
			%
			% Element.EXISTSPROP(PROP) throws an error if the PROP does NOT exist.
			%  Error id: [BRAPH2:PPCompareEnsemble_CPDict_WU:WrongInput]
			%
			% Alternative forms to call this method are:
			...
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_WU:WrongInput]
			%  Element.EXISTSPROP(PPCompareEnsemble_CPDict_WU, PROP) throws error if PROP does NOT exist for PPCompareEnsemble_CPDict_WU.
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_WU:WrongInput]
			%
			...
			if nargout == 1
				...
				assert( ...
					PPCompareEnsemble_CPDict_WU.existsProp(prop), ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_WU:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(prop, 100, ' ...') ' is not a valid prop for PPCompareEnsemble_CPDict_WU.'] ...
					)
			end
		end
		function check = existsTag(tag)
			%EXISTSTAG checks whether tag exists in plot property graph/error.
			%
			% CHECK = PPCompareEnsemble_CPDict_WU.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSTAG(TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PR, TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PPCompareEnsemble_CPDict_WU, TAG) checks whether TAG exists for PPCompareEnsemble_CPDict_WU.
			%
			...
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_WU:WrongInput]
			%  Element.EXISTSTAG(PPCompareEnsemble_CPDict_WU, TAG) throws error if TAG does NOT exist for PPCompareEnsemble_CPDict_WU.
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_WU:WrongInput]
			%
			% See also getProps, existsTag.
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				ppcompareensemble_cpdict_wu_tag_list = { 'id'  'bkgcolor'  'el'  'prop'  'title'  'enable'  'waitbar' };
				
				check = any(strcmpi(tag, ppcompareensemble_cpdict_wu_tag_list));
			else
				assert( ...
					PPCompareEnsemble_CPDict_WU.existsTag(tag), ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_WU:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tag ' is not a valid tag for PPCompareEnsemble_CPDict_WU'] ...
					)
			end
		end
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(PPCompareEnsemble_CPDict_WU, POINTER) returns property number of POINTER of PPCompareEnsemble_CPDict_WU.
			%  PROPERTY = PR.GETPROPPROP(PPCompareEnsemble_CPDict_WU, POINTER) returns property number of POINTER of PPCompareEnsemble_CPDict_WU.
			%
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, ppcompareensemble_cpdict_wu_tag_list));
			else % numeric
				prop = pointer;
				PPCompareEnsemble_CPDict_WU.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(PPCompareEnsemble_CPDict_WU, POINTER) returns tag of POINTER of PPCompareEnsemble_CPDict_WU.
			%  TAG = PR.GETPROPTAG(PPCompareEnsemble_CPDict_WU, POINTER) returns tag of POINTER of PPCompareEnsemble_CPDict_WU.
			%
		...
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(PPCompareEnsemble_CPDict_WU, POINTER) returns category of POINTER of PPCompareEnsemble_CPDict_WU.
			%  CATEGORY = PR.GETPROPCATEGORY(PPCompareEnsemble_CPDict_WU, POINTER) returns category of POINTER of PPCompareEnsemble_CPDict_WU.
			%
			% See also Category, getPropProp, getPropTag, getPropSettings,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
			
			prop = PPCompareEnsemble_CPDict_WU.getPropProp(pointer);
		...
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(PPCompareEnsemble_CPDict_WU, POINTER) returns format of POINTER of PPCompareEnsemble_CPDict_WU.
			%  FORMAT = PR.GETPROPFORMAT(PPCompareEnsemble_CPDict_WU, POINTER) returns format of POINTER of PPCompareEnsemble_CPDict_WU.
			%
		...
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(PPCompareEnsemble_CPDict_WU, POINTER) returns description of POINTER of PPCompareEnsemble_CPDict_WU.
			%  DESCRIPTION = PR.GETPROPDESCRIPTION(PPCompareEnsemble_CPDict_WU, POINTER) returns description of POINTER of PPCompareEnsemble_CPDict_WU.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(PPCompareEnsemble_CPDict_WU, POINTER) returns settings of POINTER of PPCompareEnsemble_CPDict_WU.
			%  SETTINGS = PR.GETPROPSETTINGS(PPCompareEnsemble_CPDict_WU, POINTER) returns settings of POINTER of PPCompareEnsemble_CPDict_WU.
			%
			% See also getPropProp, getPropTag, getPropCategory,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = PPCompareEnsemble_CPDict_WU.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = PPCompareEnsemble_CPDict_WU.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULT(POINTER) returns the default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULT(PPCompareEnsemble_CPDict_WU, POINTER) returns the default value of POINTER of PPCompareEnsemble_CPDict_WU.
			%  DEFAULT = PR.GETPROPDEFAULT(PPCompareEnsemble_CPDict_WU, POINTER) returns the default value of POINTER of PPCompareEnsemble_CPDict_WU.
			%
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = PPCompareEnsemble_CPDict_WU.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = PPCompareEnsemble_CPDict_WU.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(PPCompareEnsemble_CPDict_WU, POINTER) returns the conditioned default value of POINTER of PPCompareEnsemble_CPDict_WU.
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(PPCompareEnsemble_CPDict_WU, POINTER) returns the conditioned default value of POINTER of PPCompareEnsemble_CPDict_WU.
			%
			...
			prop_default = PPCompareEnsemble_CPDict_WU.conditioning(prop, PPCompareEnsemble_CPDict_WU.getPropDefault(prop));
		end
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(PPCompareEnsemble_CPDict_WU, PROP, VALUE) checks VALUE format for PROP of PPCompareEnsemble_CPDict_WU.
			%  CHECK = PR.CHECKPROP(PPCompareEnsemble_CPDict_WU, PROP, VALUE) checks VALUE format for PROP of PPCompareEnsemble_CPDict_WU.
			% 
			...
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_WU:WrongInput]
			%  Element.CHECKPROP(PPCompareEnsemble_CPDict_WU, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PPCompareEnsemble_CPDict_WU.
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_WU:WrongInput]
			%  PR.CHECKPROP(PPCompareEnsemble_CPDict_WU, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PPCompareEnsemble_CPDict_WU.
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_WU:WrongInput]
			% 
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_WU:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' PPCompareEnsemble_CPDict_WU.getPropTag(prop) ' (' PPCompareEnsemble_CPDict_WU.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function pr = PPCompareEnsemble_CPDict_WU(varargin)
			% PPCompareEnsemble_CPDict_WU() creates a plot property graph.
			%
			% PPCompareEnsemble_CPDict_WU(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% PPCompareEnsemble_CPDict_WU(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
