classdef PPCompareEnsemble_CPDict_BUT < PlotProp
	% PPCompareEnsemble_CPDict_BUT is a plot of a binary undirect using thresholds comparison ensemble dictionary.
	...
	%
	% The list of PPCompareEnsemble_CPDict_BUT properties is:
	...
	%
	% PPCompareEnsemble_CPDict_BUT methods (constructor):
	% PPCompareEnsemble_CPDict_BUT - constructor
	%
	% PPCompareEnsemble_CPDict_BUT methods (Static):
	...
	%
	% PPCompareEnsemble_CPDict_BUT methods:
	...
	%  cb_measure_calc - e_CPDict_BUT/cb_measure_calc is a function.
	...
	%  cb_button_del - ble_CPDict_BUT/cb_button_del is a function.
	%  cb_button_calc - le_CPDict_BUT/cb_button_calc is a function.
	%  cb_button_cb - mble_CPDict_BUT/cb_button_cb is a function.
	%  set_settings - mble_CPDict_BUT/set_settings is a function.
	%  cb_close_fs - emble_CPDict_BUT/cb_close_fs is a function.
	...
	%
	% PPCompareEnsemble_CPDict_BUT methods (operators):
	%  isequal - determines whether two PPCompareEnsemble_CPDict_BUT are equal (values, locked)
	%
	% PPCompareEnsemble_CPDict_BUT methods (display):
	%  tostring - string with information about the PPCompareEnsemble_CPDict_BUT
	%  disp - displays information about the PPCompareEnsemble_CPDict_BUT
	%  tree - displays the element of PPCompareEnsemble_CPDict_BUT
	%
	% PPCompareEnsemble_CPDict_BUT method (element list):
	%  getElementList - returns a list with all subelements of PPCompareEnsemble_CPDict_BUT
	%
	% PPCompareEnsemble_CPDict_BUT method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the PPCompareEnsemble_CPDict_BUT
	%
	% PPCompareEnsemble_CPDict_BUT method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the PPCompareEnsemble_CPDict_BUT
	%
	% PPCompareEnsemble_CPDict_BUT methods (copy):
	%  copy - copies the PPCompareEnsemble_CPDict_BUT
	%  deepclone - deep-clones the PPCompareEnsemble_CPDict_BUT
	%  clone - clones the PPCompareEnsemble_CPDict_BUT
	%
	% PPCompareEnsemble_CPDict_BUT methods (inspection, Static):
	%  getClass - returns PPCompareEnsemble_CPDict_BUT
	%  getName - returns the name of PPCompareEnsemble_CPDict_BUT
	%  getDescription - returns the description of PPCompareEnsemble_CPDict_BUT
	%  getProps - returns the property list of PPCompareEnsemble_CPDict_BUT
	%  getPropNumber - returns the property number of PPCompareEnsemble_CPDict_BUT
	...
	%  checkProp - checks whether a value has the correct format/error
	%
	% PPCompareEnsemble_CPDict_BUT methods (category, Static):
	...
	%
	% PPCompareEnsemble_CPDict_BUT methods (format, Static):
	...
	%
	% PPCompareEnsemble_CPDict_BUT methods (GUI):
	%  getGUI - returns the element GUI
	%  getPlotElement - returns the element plot
	%  getPlotProp - returns a prop plot
	%
	% PPCompareEnsemble_CPDict_BUT methods (GUI, Static):
	%  getGUIMenuImport - returns an importer menu
	%  getGUIMenuExport - returns an exporter menu
	%
	% PPCompareEnsemble_CPDict_BUT properties (Constant).
	%  EL - 3
	%  EL_TAG - 'el'
	%  EL_CATEGORY - 'm'
	%  EL_FORMAT - 'it'
	...
	methods (Static) % inspection methods
		function pr_class = getClass()
			%GETCLASS returns the class of the plot property graph.
			%
			% CLASS = PPCompareEnsemble_CPDict_BUT.GETCLASS() returns the class 'PPCompareEnsemble_CPDict_BUT'.
			%
			% Alternative forms to call this method are:
			%  CLASS = PR.GETCLASS() returns the class of the plot property graph PR.
			%  CLASS = Element.GETCLASS(PR) returns the class of 'PR'.
			%  CLASS = Element.GETCLASS('PPCompareEnsemble_CPDict_BUT') returns 'PPCompareEnsemble_CPDict_BUT'.
			%
			% See also getName, getDescription.
			
			pr_class = 'PPCompareEnsemble_CPDict_BUT';
		end
		function pr_name = getName()
			%GETNAME returns the name of the plot property graph.
			%
			% NAME = PPCompareEnsemble_CPDict_BUT.GETNAME() returns the name of the 'plot property graph'.
			%  Plot Property Graph.
			%
			% Alternative forms to call this method are:
			%  NAME = PR.GETNAME() returns the name of the plot property graph PR.
			%  NAME = Element.GETNAME(PR) returns the name of 'PR'.
			%  NAME = Element.GETNAME('PPCompareEnsemble_CPDict_BUT') returns the name of 'PPCompareEnsemble_CPDict_BUT'.
			%
		...
		function pr_description = getDescription()
			%GETDESCRIPTION returns the description of the plot property graph.
			%
			% STR = PPCompareEnsemble_CPDict_BUT.GETDESCRIPTION() returns the description of the 'plot property graph'.
			%  which is:
			%
			%  PPCompareEnsemble_CPDict_BUT plots the binary undirect using thresholds comparison ensemble
			%  dictionary property associated with a graph.
			...
			%  STR = Element.GETDESCRIPTION('PPCompareEnsemble_CPDict_BUT') returns the description of 'PPCompareEnsemble_CPDict_BUT'.
			%
		...
		function prop_list = getProps(category)
			%GETPROPS returns the property list of plot property graph.
			%
			% PROPS = PPCompareEnsemble_CPDict_BUT.GETPROPS() returns the property list of plot property graph.
			%
			% PROPS = PPCompareEnsemble_CPDict_BUT.GETPROPS(CATEGORY) returns the property list 
			%  of category CATEGORY.
			%
			% Alternative forms to call this method are:
			%  PROPS = PR.GETPROPS([CATEGORY]) returns the property list of the plot property graph PR.
			%  PROPS = Element.GETPROPS(PR[, CATEGORY]) returns the property list of 'PR'.
			%  PROPS = Element.GETPROPS('PPCompareEnsemble_CPDict_BUT'[, CATEGORY]) returns the property list of 'PPCompareEnsemble_CPDict_BUT'.
			%
		...
		function prop_number = getPropNumber()
			%GETPROPNUMBER returns the property number of plot property graph.
			%
			% N = PPCompareEnsemble_CPDict_BUT.GETPROPNUMBER() returns the property number of plot property graph.
			%
			% Alternative forms to call this method are:
			%  N = PR.GETPROPNUMBER() returns the property number of the plot property graph PR.
			%  N = Element.GETPROPNUMBER(PR) returns the property number of 'PR'.
			%  N = Element.GETPROPNUMBER('PPCompareEnsemble_CPDict_BUT') returns the property number of 'PPCompareEnsemble_CPDict_BUT'.
			%
			% See also getProps.
		...
		function check = existsProp(prop)
			%EXISTSPROP checks whether property exists in plot property graph/error.
			%
			% CHECK = PPCompareEnsemble_CPDict_BUT.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSPROP(PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PR, PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PPCompareEnsemble_CPDict_BUT, PROP) checks whether PROP exists for PPCompareEnsemble_CPDict_BUT.
			%
			% Element.EXISTSPROP(PROP) throws an error if the PROP does NOT exist.
			%  Error id: [BRAPH2:PPCompareEnsemble_CPDict_BUT:WrongInput]
			%
			% Alternative forms to call this method are:
			...
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_BUT:WrongInput]
			%  Element.EXISTSPROP(PPCompareEnsemble_CPDict_BUT, PROP) throws error if PROP does NOT exist for PPCompareEnsemble_CPDict_BUT.
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_BUT:WrongInput]
			%
			...
			if nargout == 1
				...
				assert( ...
					PPCompareEnsemble_CPDict_BUT.existsProp(prop), ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_BUT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_BUT:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(prop, 100, ' ...') ' is not a valid prop for PPCompareEnsemble_CPDict_BUT.'] ...
					)
			end
		end
		function check = existsTag(tag)
			%EXISTSTAG checks whether tag exists in plot property graph/error.
			%
			% CHECK = PPCompareEnsemble_CPDict_BUT.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSTAG(TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PR, TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PPCompareEnsemble_CPDict_BUT, TAG) checks whether TAG exists for PPCompareEnsemble_CPDict_BUT.
			%
			...
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_BUT:WrongInput]
			%  Element.EXISTSTAG(PPCompareEnsemble_CPDict_BUT, TAG) throws error if TAG does NOT exist for PPCompareEnsemble_CPDict_BUT.
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_BUT:WrongInput]
			%
			% See also getProps, existsTag.
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				ppcompareensemble_cpdict_but_tag_list = { 'id'  'bkgcolor'  'el'  'prop'  'title'  'enable'  'waitbar' };
				
				check = any(strcmpi(tag, ppcompareensemble_cpdict_but_tag_list));
			else
				assert( ...
					PPCompareEnsemble_CPDict_BUT.existsTag(tag), ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_BUT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_BUT:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tag ' is not a valid tag for PPCompareEnsemble_CPDict_BUT'] ...
					)
			end
		end
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(PPCompareEnsemble_CPDict_BUT, POINTER) returns property number of POINTER of PPCompareEnsemble_CPDict_BUT.
			%  PROPERTY = PR.GETPROPPROP(PPCompareEnsemble_CPDict_BUT, POINTER) returns property number of POINTER of PPCompareEnsemble_CPDict_BUT.
			%
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, ppcompareensemble_cpdict_but_tag_list));
			else % numeric
				prop = pointer;
				PPCompareEnsemble_CPDict_BUT.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(PPCompareEnsemble_CPDict_BUT, POINTER) returns tag of POINTER of PPCompareEnsemble_CPDict_BUT.
			%  TAG = PR.GETPROPTAG(PPCompareEnsemble_CPDict_BUT, POINTER) returns tag of POINTER of PPCompareEnsemble_CPDict_BUT.
			%
		...
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(PPCompareEnsemble_CPDict_BUT, POINTER) returns category of POINTER of PPCompareEnsemble_CPDict_BUT.
			%  CATEGORY = PR.GETPROPCATEGORY(PPCompareEnsemble_CPDict_BUT, POINTER) returns category of POINTER of PPCompareEnsemble_CPDict_BUT.
			%
			% See also Category, getPropProp, getPropTag, getPropSettings,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
			
			prop = PPCompareEnsemble_CPDict_BUT.getPropProp(pointer);
		...
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(PPCompareEnsemble_CPDict_BUT, POINTER) returns format of POINTER of PPCompareEnsemble_CPDict_BUT.
			%  FORMAT = PR.GETPROPFORMAT(PPCompareEnsemble_CPDict_BUT, POINTER) returns format of POINTER of PPCompareEnsemble_CPDict_BUT.
			%
		...
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(PPCompareEnsemble_CPDict_BUT, POINTER) returns description of POINTER of PPCompareEnsemble_CPDict_BUT.
			%  DESCRIPTION = PR.GETPROPDESCRIPTION(PPCompareEnsemble_CPDict_BUT, POINTER) returns description of POINTER of PPCompareEnsemble_CPDict_BUT.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(PPCompareEnsemble_CPDict_BUT, POINTER) returns settings of POINTER of PPCompareEnsemble_CPDict_BUT.
			%  SETTINGS = PR.GETPROPSETTINGS(PPCompareEnsemble_CPDict_BUT, POINTER) returns settings of POINTER of PPCompareEnsemble_CPDict_BUT.
			%
			% See also getPropProp, getPropTag, getPropCategory,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = PPCompareEnsemble_CPDict_BUT.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = PPCompareEnsemble_CPDict_BUT.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULT(POINTER) returns the default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULT(PPCompareEnsemble_CPDict_BUT, POINTER) returns the default value of POINTER of PPCompareEnsemble_CPDict_BUT.
			%  DEFAULT = PR.GETPROPDEFAULT(PPCompareEnsemble_CPDict_BUT, POINTER) returns the default value of POINTER of PPCompareEnsemble_CPDict_BUT.
			%
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = PPCompareEnsemble_CPDict_BUT.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = PPCompareEnsemble_CPDict_BUT.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(PPCompareEnsemble_CPDict_BUT, POINTER) returns the conditioned default value of POINTER of PPCompareEnsemble_CPDict_BUT.
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(PPCompareEnsemble_CPDict_BUT, POINTER) returns the conditioned default value of POINTER of PPCompareEnsemble_CPDict_BUT.
			%
			...
			prop_default = PPCompareEnsemble_CPDict_BUT.conditioning(prop, PPCompareEnsemble_CPDict_BUT.getPropDefault(prop));
		end
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(PPCompareEnsemble_CPDict_BUT, PROP, VALUE) checks VALUE format for PROP of PPCompareEnsemble_CPDict_BUT.
			%  CHECK = PR.CHECKPROP(PPCompareEnsemble_CPDict_BUT, PROP, VALUE) checks VALUE format for PROP of PPCompareEnsemble_CPDict_BUT.
			% 
			...
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_BUT:WrongInput]
			%  Element.CHECKPROP(PPCompareEnsemble_CPDict_BUT, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PPCompareEnsemble_CPDict_BUT.
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_BUT:WrongInput]
			%  PR.CHECKPROP(PPCompareEnsemble_CPDict_BUT, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PPCompareEnsemble_CPDict_BUT.
			%   Error id: [BRAPH2:PPCompareEnsemble_CPDict_BUT:WrongInput]
			% 
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_BUT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsemble_CPDict_BUT:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' PPCompareEnsemble_CPDict_BUT.getPropTag(prop) ' (' PPCompareEnsemble_CPDict_BUT.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function pr = PPCompareEnsemble_CPDict_BUT(varargin)
			% PPCompareEnsemble_CPDict_BUT() creates a plot property graph.
			%
			% PPCompareEnsemble_CPDict_BUT(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% PPCompareEnsemble_CPDict_BUT(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
