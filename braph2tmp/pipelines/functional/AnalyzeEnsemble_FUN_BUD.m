classdef AnalyzeEnsemble_FUN_BUD < AnalyzeEnsemble
	% AnalyzeEnsemble_FUN_BUD is a graph analysis using functional data of fixed density.
	...
	%  <strong>5</strong> <strong>g_dict</strong> 	G_DICT (result, idict) is the graph (MultigraphBUD) ensemble obtained from this analysis.
	...
	%
	% AnalyzeEnsemble_FUN_BUD methods (Static):
	...
	%  getDescription - returns the description of the graph analysis with functional data of fixed density.
	%  getName - returns the name of the graph analysis with functional data of fixed density.
	...
	%
	% AnalyzeEnsemble_FUN_BUD methods (operators):
	%  isequal - determines whether two AnalyzeEnsemble_FUN_BUD are equal (values, locked)
	%
	% AnalyzeEnsemble_FUN_BUD methods (display):
	%  tostring - string with information about the AnalyzeEnsemble_FUN_BUD
	%  disp - displays information about the AnalyzeEnsemble_FUN_BUD
	%  tree - displays the element of AnalyzeEnsemble_FUN_BUD
	%
	% AnalyzeEnsemble_FUN_BUD method (element list):
	%  getElementList - returns a list with all subelements of AnalyzeEnsemble_FUN_BUD
	%
	% AnalyzeEnsemble_FUN_BUD method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the AnalyzeEnsemble_FUN_BUD
	%
	% AnalyzeEnsemble_FUN_BUD method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the AnalyzeEnsemble_FUN_BUD
	%
	% AnalyzeEnsemble_FUN_BUD methods (copy):
	%  copy - copies the AnalyzeEnsemble_FUN_BUD
	%  deepclone - deep-clones the AnalyzeEnsemble_FUN_BUD
	%  clone - clones the AnalyzeEnsemble_FUN_BUD
	%
	% AnalyzeEnsemble_FUN_BUD methods (inspection, Static):
	%  getClass - returns AnalyzeEnsemble_FUN_BUD
	%  getName - returns the name of AnalyzeEnsemble_FUN_BUD
	%  getDescription - returns the description of AnalyzeEnsemble_FUN_BUD
	%  getProps - returns the property list of AnalyzeEnsemble_FUN_BUD
	%  getPropNumber - returns the property number of AnalyzeEnsemble_FUN_BUD
	...
	%
	% AnalyzeEnsemble_FUN_BUD properties (Constant).
	%  REPETITION - 7
	...
	methods (Static) % inspection methods
		...
		function a_name = getName()
			%GETNAME returns the name of the graph analysis with functional data of fixed density.
			%
			% NAME = AnalyzeEnsemble_FUN_BUD.GETNAME() returns the name of the 'graph analysis with functional data of fixed density'.
			%  Graph Analysis With Functional Data Of Fixed Density.
			%
			% Alternative forms to call this method are:
			%  NAME = A.GETNAME() returns the name of the graph analysis with functional data of fixed density A.
			%  NAME = Element.GETNAME(A) returns the name of 'A'.
			%  NAME = Element.GETNAME('AnalyzeEnsemble_FUN_BUD') returns the name of 'AnalyzeEnsemble_FUN_BUD'.
			%
			% See also getClass, getDescription.
			
			% COMPUTATIONAL EFFICIENCY TRICK
			a_name = 'Graph Analysis With Functional Data Of Fixed Density';
		end
		function a_description = getDescription()
			%GETDESCRIPTION returns the description of the graph analysis with functional data of fixed density.
			%
			% STR = AnalyzeEnsemble_FUN_BUD.GETDESCRIPTION() returns the description of the 'graph analysis with functional data of fixed density'.
			%  which is:
			%
			%  
			%
			% Alternative forms to call this method are:
			%  STR = A.GETDESCRIPTION() returns the description of the graph analysis with functional data of fixed density A.
			%  STR = Element.GETDESCRIPTION(A) returns the description of 'A'.
			%  STR = Element.GETDESCRIPTION('AnalyzeEnsemble_FUN_BUD') returns the description of 'AnalyzeEnsemble_FUN_BUD'.
			%
			...
			switch category
				...
				case Category.PARAMETER
					prop_list = [
						...
						AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMIN
						AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMAX
		...
		function prop_number = getPropNumber()
			...
			%
			% Alternative forms to call this method are:
			%  N = A.GETPROPNUMBER() returns the property number of the graph analysis with functional data of fixed density A.
		...
		function check = existsProp(prop)
			...
			if nargout == 1
				...
				assert( ...
					AnalyzeEnsemble_FUN_BUD.existsProp(prop), ...
		...
		function check = existsTag(tag)
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				analyzeensemble_fun_bud_tag_list = { 'id'  'label'  'notes'  'gr'  'g_dict'  'me_dict'  'repetition'  'frequencyrulemin'  'frequencyrulemax'  'correlation_rule'  'negative_weight_rule'  'densities' };
				
				check = any(strcmpi(tag, analyzeensemble_fun_bud_tag_list));
			else
				assert( ...
					AnalyzeEnsemble_FUN_BUD.existsTag(tag), ...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_BUD:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_BUD:' BRAPH2.WRONG_INPUT ' ' ...
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, analyzeensemble_fun_bud_tag_list));
			else % numeric
				prop = pointer;
				AnalyzeEnsemble_FUN_BUD.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMIN
						tag = AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMIN_TAG;
					case AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMAX
						tag = AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMAX_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMIN
					prop_category = AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMIN_CATEGORY;
				case AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMAX
					prop_category = AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMAX_CATEGORY;
				case AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMIN
					prop_format = AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMIN_FORMAT;
				case AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMAX
					prop_format = AnalyzeEnsemble_FUN_BUD.FREQUENCYRULEMAX_FORMAT;
				case AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUD.G_DICT
					prop_default = IndexedDictionary('IT_CLASS', 'MultigraphBUD');
				otherwise
		...
		function prop_check = checkProp(pointer, value)
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_BUD:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_BUD:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' AnalyzeEnsemble_FUN_BUD.getPropTag(prop) ' (' AnalyzeEnsemble_FUN_BUD.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function a = AnalyzeEnsemble_FUN_BUD(varargin)
			...
			%
			% AnalyzeEnsemble_FUN_BUD(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
