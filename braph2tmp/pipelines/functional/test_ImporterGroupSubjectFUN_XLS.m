...
for prop = 1:1:prop_number
	...
	assert( ...
		...
		[BRAPH2.STR ':ImporterGroupSubjectFUN_XLS:' BRAPH2.BUG_FUNC], ...
		['ImporterGroupSubjectFUN_XLS.getr(' int2str(prop) ') must be inizialized to NoValue(). ' ...
		'Or there could be an error in ImporterGroupSubjectFUN_XLS.getr(' int2str(prop) ').'] ...
		)
	assert( ...
		isa(im.getr(TAG), 'NoValue'), ...
		[BRAPH2.STR ':ImporterGroupSubjectFUN_XLS:' BRAPH2.BUG_FUNC], ...
		['ImporterGroupSubjectFUN_XLS.getr(''' TAG ''') must be inizialized to NoValue(). ' ...
...
warning('off', 'BRAPH2:ImporterGroupSubjectFUN_XLS')
im = ImporterGroupSubjectFUN_XLS( ...
	...
	ImporterGroupSubjectFUN_XLS.GR, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.GR) ...
	);
warning('on', 'BRAPH2:ImporterGroupSubjectFUN_XLS')
	...
	switch ImporterGroupSubjectFUN_XLS.getPropCategory(prop)
		...
		case Category.RESULT
			assert( ...
				isa(im.getr(prop), 'NoValue'), ...
				[BRAPH2.STR ':ImporterGroupSubjectFUN_XLS:' BRAPH2.BUG_FUNC], ...
				['Being a result, ImporterGroupSubjectFUN_XLS.getr(' int2str(prop) ') must be inizialized to NoValue(). ' ...
				'Or there could be an error in ImporterGroupSubjectFUN_XLS.getr(' int2str(prop) ').'] ...
				)
			assert( ...
				isa(im.getr(TAG), 'NoValue'), ...
				[BRAPH2.STR ':ImporterGroupSubjectFUN_XLS:' BRAPH2.BUG_FUNC], ...
				['Being a result, ImporterGroupSubjectFUN_XLS.getr(''' TAG ''') must be inizialized to NoValue(). ' ...
				'Or there could be an error in ImporterGroupSubjectFUN_XLS.getr(''' TAG ''').'] ...
				)
	end
end
...
im_1 = ImporterGroupSubjectFUN_XLS( ...
	ImporterGroupSubjectFUN_XLS.ID, Callback('EL', im_0, 'PROP', 1), ...
	ImporterGroupSubjectFUN_XLS.LABEL, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.LABEL), ...
	ImporterGroupSubjectFUN_XLS.NOTES, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.NOTES), ...
	ImporterGroupSubjectFUN_XLS.WAITBAR, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.WAITBAR), ...
	ImporterGroupSubjectFUN_XLS.DIRECTORY, Callback('EL', im_0, 'PROP', 5), ...
	ImporterGroupSubjectFUN_XLS.BA, Callback('EL', im_0, 'PROP', 6), ...
	ImporterGroupSubjectFUN_XLS.GR, NoValue() ...
	);
...
im_2 = ImporterGroupSubjectFUN_XLS( ...
	ImporterGroupSubjectFUN_XLS.ID, Callback('EL', im_1, 'PROP', 1), ...
	ImporterGroupSubjectFUN_XLS.LABEL, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.LABEL), ...
	ImporterGroupSubjectFUN_XLS.NOTES, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.NOTES), ...
	ImporterGroupSubjectFUN_XLS.WAITBAR, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.WAITBAR), ...
	ImporterGroupSubjectFUN_XLS.DIRECTORY, Callback('EL', im_1, 'PROP', 5), ...
	ImporterGroupSubjectFUN_XLS.BA, Callback('EL', im_1, 'PROP', 6), ...
	ImporterGroupSubjectFUN_XLS.GR, NoValue() ...
	);
...
im_3 = ImporterGroupSubjectFUN_XLS( ...
	ImporterGroupSubjectFUN_XLS.ID, Callback('EL', im_2, 'PROP', 1), ...
	ImporterGroupSubjectFUN_XLS.LABEL, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.LABEL), ...
	ImporterGroupSubjectFUN_XLS.NOTES, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.NOTES), ...
	ImporterGroupSubjectFUN_XLS.WAITBAR, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.WAITBAR), ...
	ImporterGroupSubjectFUN_XLS.DIRECTORY, Callback('EL', im_2, 'PROP', 5), ...
	ImporterGroupSubjectFUN_XLS.BA, Callback('EL', im_2, 'PROP', 6), ...
	ImporterGroupSubjectFUN_XLS.GR, NoValue() ...
	);
	...
	switch ImporterGroupSubjectFUN_XLS.getPropCategory(prop)
		...
		case Category.RESULT
			...
			assert( ...
				isa(im.getr(prop),  'NoValue'), ...
				[BRAPH2.STR ':ImporterGroupSubjectFUN_XLS:' BRAPH2.BUG_FUNC], ...
				['ImporterGroupSubjectFUN_XLS.getr(' int2str(prop) ') must be a NoValue, because it has not been memorized.'] ...
				)
