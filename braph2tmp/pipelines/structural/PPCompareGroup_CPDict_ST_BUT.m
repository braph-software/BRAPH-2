classdef PPCompareGroup_CPDict_ST_BUT < PlotProp
	% PPCompareGroup_CPDict_ST_BUT is a plot of a binary undirect using thresholds comparison dictionary.
	% It is a subclass of <a href="matlab:help PlotProp">PlotProp</a>.
	%
	% PPCompareGroup_CPDict_BUT plots the binary undirect using thresholds comparison 
	...
	%
	% The list of PPCompareGroup_CPDict_ST_BUT properties is:
	...
	%
	% PPCompareGroup_CPDict_ST_BUT methods (constructor):
	% PPCompareGroup_CPDict_ST_BUT - constructor
	%
	% PPCompareGroup_CPDict_ST_BUT methods (Static):
	...
	%
	% PPCompareGroup_CPDict_ST_BUT methods:
	...
	%  cb_measure_calc - PDict_ST_BUT/cb_measure_calc is a function.
	...
	%  cb_button_del - _CPDict_ST_BUT/cb_button_del is a function.
	%  cb_button_calc - CPDict_ST_BUT/cb_button_calc is a function.
	%  cb_button_cb - p_CPDict_ST_BUT/cb_button_cb is a function.
	%  set_settings - p_CPDict_ST_BUT/set_settings is a function.
	%  cb_close_fs - up_CPDict_ST_BUT/cb_close_fs is a function.
	...
	%
	% PPCompareGroup_CPDict_ST_BUT methods (operators):
	%  isequal - determines whether two PPCompareGroup_CPDict_ST_BUT are equal (values, locked)
	%
	% PPCompareGroup_CPDict_ST_BUT methods (display):
	%  tostring - string with information about the PPCompareGroup_CPDict_ST_BUT
	%  disp - displays information about the PPCompareGroup_CPDict_ST_BUT
	%  tree - displays the element of PPCompareGroup_CPDict_ST_BUT
	%
	% PPCompareGroup_CPDict_ST_BUT method (element list):
	%  getElementList - returns a list with all subelements of PPCompareGroup_CPDict_ST_BUT
	%
	% PPCompareGroup_CPDict_ST_BUT method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the PPCompareGroup_CPDict_ST_BUT
	%
	% PPCompareGroup_CPDict_ST_BUT method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the PPCompareGroup_CPDict_ST_BUT
	%
	% PPCompareGroup_CPDict_ST_BUT methods (copy):
	%  copy - copies the PPCompareGroup_CPDict_ST_BUT
	%  deepclone - deep-clones the PPCompareGroup_CPDict_ST_BUT
	%  clone - clones the PPCompareGroup_CPDict_ST_BUT
	%
	% PPCompareGroup_CPDict_ST_BUT methods (inspection, Static):
	%  getClass - returns PPCompareGroup_CPDict_ST_BUT
	%  getName - returns the name of PPCompareGroup_CPDict_ST_BUT
	%  getDescription - returns the description of PPCompareGroup_CPDict_ST_BUT
	%  getProps - returns the property list of PPCompareGroup_CPDict_ST_BUT
	%  getPropNumber - returns the property number of PPCompareGroup_CPDict_ST_BUT
	...
	%  checkProp - checks whether a value has the correct format/error
	%
	% PPCompareGroup_CPDict_ST_BUT methods (category, Static):
	...
	%
	% PPCompareGroup_CPDict_ST_BUT methods (format, Static):
	...
	%
	% PPCompareGroup_CPDict_ST_BUT methods (GUI):
	%  getGUI - returns the element GUI
	%  getPlotElement - returns the element plot
	%  getPlotProp - returns a prop plot
	%
	% PPCompareGroup_CPDict_ST_BUT methods (GUI, Static):
	%  getGUIMenuImport - returns an importer menu
	%  getGUIMenuExport - returns an exporter menu
	%
	% PPCompareGroup_CPDict_ST_BUT properties (Constant).
	%  EL - 3
	%  EL_TAG - 'el'
	%  EL_CATEGORY - 'm'
	%  EL_FORMAT - 'it'
	...
	methods (Static) % inspection methods
		function pr_class = getClass()
			%GETCLASS returns the class of the plot property graph.
			%
			% CLASS = PPCompareGroup_CPDict_ST_BUT.GETCLASS() returns the class 'PPCompareGroup_CPDict_ST_BUT'.
			%
			% Alternative forms to call this method are:
			%  CLASS = PR.GETCLASS() returns the class of the plot property graph PR.
			%  CLASS = Element.GETCLASS(PR) returns the class of 'PR'.
			%  CLASS = Element.GETCLASS('PPCompareGroup_CPDict_ST_BUT') returns 'PPCompareGroup_CPDict_ST_BUT'.
			%
			% See also getName, getDescription.
			
			pr_class = 'PPCompareGroup_CPDict_ST_BUT';
		end
		function pr_name = getName()
			%GETNAME returns the name of the plot property graph.
			%
			% NAME = PPCompareGroup_CPDict_ST_BUT.GETNAME() returns the name of the 'plot property graph'.
			%  Plot Property Graph.
			%
			% Alternative forms to call this method are:
			%  NAME = PR.GETNAME() returns the name of the plot property graph PR.
			%  NAME = Element.GETNAME(PR) returns the name of 'PR'.
			%  NAME = Element.GETNAME('PPCompareGroup_CPDict_ST_BUT') returns the name of 'PPCompareGroup_CPDict_ST_BUT'.
			%
		...
		function pr_description = getDescription()
			%GETDESCRIPTION returns the description of the plot property graph.
			%
			% STR = PPCompareGroup_CPDict_ST_BUT.GETDESCRIPTION() returns the description of the 'plot property graph'.
			%  which is:
			%
			%  PPCompareGroup_CPDict_BUT plots the binary undirect using thresholds comparison 
			%  dictionary property associated with a graph.
			...
			%  STR = Element.GETDESCRIPTION('PPCompareGroup_CPDict_ST_BUT') returns the description of 'PPCompareGroup_CPDict_ST_BUT'.
			%
		...
		function prop_list = getProps(category)
			%GETPROPS returns the property list of plot property graph.
			%
			% PROPS = PPCompareGroup_CPDict_ST_BUT.GETPROPS() returns the property list of plot property graph.
			%
			% PROPS = PPCompareGroup_CPDict_ST_BUT.GETPROPS(CATEGORY) returns the property list 
			%  of category CATEGORY.
			%
			% Alternative forms to call this method are:
			%  PROPS = PR.GETPROPS([CATEGORY]) returns the property list of the plot property graph PR.
			%  PROPS = Element.GETPROPS(PR[, CATEGORY]) returns the property list of 'PR'.
			%  PROPS = Element.GETPROPS('PPCompareGroup_CPDict_ST_BUT'[, CATEGORY]) returns the property list of 'PPCompareGroup_CPDict_ST_BUT'.
			%
		...
		function prop_number = getPropNumber()
			%GETPROPNUMBER returns the property number of plot property graph.
			%
			% N = PPCompareGroup_CPDict_ST_BUT.GETPROPNUMBER() returns the property number of plot property graph.
			%
			% Alternative forms to call this method are:
			%  N = PR.GETPROPNUMBER() returns the property number of the plot property graph PR.
			%  N = Element.GETPROPNUMBER(PR) returns the property number of 'PR'.
			%  N = Element.GETPROPNUMBER('PPCompareGroup_CPDict_ST_BUT') returns the property number of 'PPCompareGroup_CPDict_ST_BUT'.
			%
			% See also getProps.
		...
		function check = existsProp(prop)
			%EXISTSPROP checks whether property exists in plot property graph/error.
			%
			% CHECK = PPCompareGroup_CPDict_ST_BUT.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSPROP(PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PR, PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PPCompareGroup_CPDict_ST_BUT, PROP) checks whether PROP exists for PPCompareGroup_CPDict_ST_BUT.
			%
			% Element.EXISTSPROP(PROP) throws an error if the PROP does NOT exist.
			%  Error id: [BRAPH2:PPCompareGroup_CPDict_ST_BUT:WrongInput]
			%
			% Alternative forms to call this method are:
			...
			%   Error id: [BRAPH2:PPCompareGroup_CPDict_ST_BUT:WrongInput]
			%  Element.EXISTSPROP(PPCompareGroup_CPDict_ST_BUT, PROP) throws error if PROP does NOT exist for PPCompareGroup_CPDict_ST_BUT.
			%   Error id: [BRAPH2:PPCompareGroup_CPDict_ST_BUT:WrongInput]
			%
			...
			if nargout == 1
				...
				assert( ...
					PPCompareGroup_CPDict_ST_BUT.existsProp(prop), ...
					[BRAPH2.STR ':PPCompareGroup_CPDict_ST_BUT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareGroup_CPDict_ST_BUT:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(prop, 100, ' ...') ' is not a valid prop for PPCompareGroup_CPDict_ST_BUT.'] ...
					)
			end
		end
		function check = existsTag(tag)
			%EXISTSTAG checks whether tag exists in plot property graph/error.
			%
			% CHECK = PPCompareGroup_CPDict_ST_BUT.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSTAG(TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PR, TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PPCompareGroup_CPDict_ST_BUT, TAG) checks whether TAG exists for PPCompareGroup_CPDict_ST_BUT.
			%
			...
			%   Error id: [BRAPH2:PPCompareGroup_CPDict_ST_BUT:WrongInput]
			%  Element.EXISTSTAG(PPCompareGroup_CPDict_ST_BUT, TAG) throws error if TAG does NOT exist for PPCompareGroup_CPDict_ST_BUT.
			%   Error id: [BRAPH2:PPCompareGroup_CPDict_ST_BUT:WrongInput]
			%
			% See also getProps, existsTag.
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				ppcomparegroup_cpdict_st_but_tag_list = { 'id'  'bkgcolor'  'el'  'prop'  'title'  'enable'  'waitbar' };
				
				check = any(strcmpi(tag, ppcomparegroup_cpdict_st_but_tag_list));
			else
				assert( ...
					PPCompareGroup_CPDict_ST_BUT.existsTag(tag), ...
					[BRAPH2.STR ':PPCompareGroup_CPDict_ST_BUT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareGroup_CPDict_ST_BUT:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tag ' is not a valid tag for PPCompareGroup_CPDict_ST_BUT'] ...
					)
			end
		end
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(PPCompareGroup_CPDict_ST_BUT, POINTER) returns property number of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%  PROPERTY = PR.GETPROPPROP(PPCompareGroup_CPDict_ST_BUT, POINTER) returns property number of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, ppcomparegroup_cpdict_st_but_tag_list));
			else % numeric
				prop = pointer;
				PPCompareGroup_CPDict_ST_BUT.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(PPCompareGroup_CPDict_ST_BUT, POINTER) returns tag of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%  TAG = PR.GETPROPTAG(PPCompareGroup_CPDict_ST_BUT, POINTER) returns tag of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%
		...
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(PPCompareGroup_CPDict_ST_BUT, POINTER) returns category of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%  CATEGORY = PR.GETPROPCATEGORY(PPCompareGroup_CPDict_ST_BUT, POINTER) returns category of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%
			% See also Category, getPropProp, getPropTag, getPropSettings,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
			
			prop = PPCompareGroup_CPDict_ST_BUT.getPropProp(pointer);
		...
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(PPCompareGroup_CPDict_ST_BUT, POINTER) returns format of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%  FORMAT = PR.GETPROPFORMAT(PPCompareGroup_CPDict_ST_BUT, POINTER) returns format of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%
		...
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(PPCompareGroup_CPDict_ST_BUT, POINTER) returns description of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%  DESCRIPTION = PR.GETPROPDESCRIPTION(PPCompareGroup_CPDict_ST_BUT, POINTER) returns description of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(PPCompareGroup_CPDict_ST_BUT, POINTER) returns settings of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%  SETTINGS = PR.GETPROPSETTINGS(PPCompareGroup_CPDict_ST_BUT, POINTER) returns settings of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%
			% See also getPropProp, getPropTag, getPropCategory,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = PPCompareGroup_CPDict_ST_BUT.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = PPCompareGroup_CPDict_ST_BUT.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULT(POINTER) returns the default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULT(PPCompareGroup_CPDict_ST_BUT, POINTER) returns the default value of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%  DEFAULT = PR.GETPROPDEFAULT(PPCompareGroup_CPDict_ST_BUT, POINTER) returns the default value of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = PPCompareGroup_CPDict_ST_BUT.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = PPCompareGroup_CPDict_ST_BUT.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(PPCompareGroup_CPDict_ST_BUT, POINTER) returns the conditioned default value of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(PPCompareGroup_CPDict_ST_BUT, POINTER) returns the conditioned default value of POINTER of PPCompareGroup_CPDict_ST_BUT.
			%
			...
			prop_default = PPCompareGroup_CPDict_ST_BUT.conditioning(prop, PPCompareGroup_CPDict_ST_BUT.getPropDefault(prop));
		end
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(PPCompareGroup_CPDict_ST_BUT, PROP, VALUE) checks VALUE format for PROP of PPCompareGroup_CPDict_ST_BUT.
			%  CHECK = PR.CHECKPROP(PPCompareGroup_CPDict_ST_BUT, PROP, VALUE) checks VALUE format for PROP of PPCompareGroup_CPDict_ST_BUT.
			% 
			...
			%   Error id: [BRAPH2:PPCompareGroup_CPDict_ST_BUT:WrongInput]
			%  Element.CHECKPROP(PPCompareGroup_CPDict_ST_BUT, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PPCompareGroup_CPDict_ST_BUT.
			%   Error id: [BRAPH2:PPCompareGroup_CPDict_ST_BUT:WrongInput]
			%  PR.CHECKPROP(PPCompareGroup_CPDict_ST_BUT, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PPCompareGroup_CPDict_ST_BUT.
			%   Error id: [BRAPH2:PPCompareGroup_CPDict_ST_BUT:WrongInput]
			% 
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':PPCompareGroup_CPDict_ST_BUT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareGroup_CPDict_ST_BUT:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' PPCompareGroup_CPDict_ST_BUT.getPropTag(prop) ' (' PPCompareGroup_CPDict_ST_BUT.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function pr = PPCompareGroup_CPDict_ST_BUT(varargin)
			% PPCompareGroup_CPDict_ST_BUT() creates a plot property graph.
			%
			% PPCompareGroup_CPDict_ST_BUT(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% PPCompareGroup_CPDict_ST_BUT(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
