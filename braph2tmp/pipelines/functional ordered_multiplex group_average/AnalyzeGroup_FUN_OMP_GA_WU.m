classdef AnalyzeGroup_FUN_OMP_GA_WU < AnalyzeGroup
	...
	%  <strong>5</strong> <strong>g</strong> 	G (result, item) is the average graph (OrderedMultiplexWU) obtained from this analysis.
	%  <strong>6</strong> <strong>repetition</strong> 	REPETITION(parameter, scalar) is the number of repetitions
	%  <strong>7</strong> <strong>frequencyrulemin</strong> 	FREQUENCYRULEMIN(parameter, scalar)is the minimum frequency value
	%  <strong>8</strong> <strong>frequencyrulemax</strong> 	FREQUENCYRULEMAX(parameter, scalar)is the maximum frequency value
	%  <strong>9</strong> <strong>correlation_rule</strong> 	CORRELATION_RULE (parameter, option) is the correlation type.
	%  <strong>10</strong> <strong>negative_weight_rule</strong> 	NEGATIVE_WEIGHT_RULE (parameter, option) determines how to deal with negative weights.
	%
	% AnalyzeGroup_FUN_OMP_GA_WU methods (constructor):
	% AnalyzeGroup_FUN_OMP_GA_WU - constructor
	%
	% AnalyzeGroup_FUN_OMP_GA_WU methods (Static):
	...
	%  getDescription - returns the description of the graph analysis with functional ordinal multiplex data.
	%  getName - returns the name of the graph analysis with functional ordinal multiplex data.
	...
	%
	% AnalyzeGroup_FUN_OMP_GA_WU methods (operators):
	%  isequal - determines whether two AnalyzeGroup_FUN_OMP_GA_WU are equal (values, locked)
	%
	% AnalyzeGroup_FUN_OMP_GA_WU methods (display):
	%  tostring - string with information about the AnalyzeGroup_FUN_OMP_GA_WU
	%  disp - displays information about the AnalyzeGroup_FUN_OMP_GA_WU
	%  tree - displays the element of AnalyzeGroup_FUN_OMP_GA_WU
	%
	% AnalyzeGroup_FUN_OMP_GA_WU method (element list):
	%  getElementList - returns a list with all subelements of AnalyzeGroup_FUN_OMP_GA_WU
	%
	% AnalyzeGroup_FUN_OMP_GA_WU method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the AnalyzeGroup_FUN_OMP_GA_WU
	%
	% AnalyzeGroup_FUN_OMP_GA_WU method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the AnalyzeGroup_FUN_OMP_GA_WU
	%
	% AnalyzeGroup_FUN_OMP_GA_WU methods (copy):
	%  copy - copies the AnalyzeGroup_FUN_OMP_GA_WU
	%  deepclone - deep-clones the AnalyzeGroup_FUN_OMP_GA_WU
	%  clone - clones the AnalyzeGroup_FUN_OMP_GA_WU
	%
	% AnalyzeGroup_FUN_OMP_GA_WU methods (inspection, Static):
	%  getClass - returns AnalyzeGroup_FUN_OMP_GA_WU
	%  getName - returns the name of AnalyzeGroup_FUN_OMP_GA_WU
	%  getDescription - returns the description of AnalyzeGroup_FUN_OMP_GA_WU
	%  getProps - returns the property list of AnalyzeGroup_FUN_OMP_GA_WU
	%  getPropNumber - returns the property number of AnalyzeGroup_FUN_OMP_GA_WU
	...
	%
	% AnalyzeGroup_FUN_OMP_GA_WU properties (Constant).
	%  REPETITION - 6
	...
	methods (Static) % inspection methods
		...
		function a_name = getName()
			%GETNAME returns the name of the graph analysis with functional ordinal multiplex data.
			%
			% NAME = AnalyzeGroup_FUN_OMP_GA_WU.GETNAME() returns the name of the 'graph analysis with functional ordinal multiplex data'.
			%  Graph Analysis With Functional Ordinal Multiplex Data.
			%
			% Alternative forms to call this method are:
			%  NAME = A.GETNAME() returns the name of the graph analysis with functional ordinal multiplex data A.
			%  NAME = Element.GETNAME(A) returns the name of 'A'.
			%  NAME = Element.GETNAME('AnalyzeGroup_FUN_OMP_GA_WU') returns the name of 'AnalyzeGroup_FUN_OMP_GA_WU'.
			%
			% See also getClass, getDescription.
			
			% COMPUTATIONAL EFFICIENCY TRICK
			a_name = 'Graph Analysis With Functional Ordinal Multiplex Data';
		end
		function a_description = getDescription()
			%GETDESCRIPTION returns the description of the graph analysis with functional ordinal multiplex data.
			%
			% STR = AnalyzeGroup_FUN_OMP_GA_WU.GETDESCRIPTION() returns the description of the 'graph analysis with functional ordinal multiplex data'.
			%  which is:
			%
			%  
			%
			% Alternative forms to call this method are:
			%  STR = A.GETDESCRIPTION() returns the description of the graph analysis with functional ordinal multiplex data A.
			%  STR = Element.GETDESCRIPTION(A) returns the description of 'A'.
			%  STR = Element.GETDESCRIPTION('AnalyzeGroup_FUN_OMP_GA_WU') returns the description of 'AnalyzeGroup_FUN_OMP_GA_WU'.
			%
			...
			switch category
				...
				case Category.PARAMETER
					prop_list = [
						...
						AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMIN
						AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMAX
		...
		function prop_number = getPropNumber()
			...
			%
			% Alternative forms to call this method are:
			%  N = A.GETPROPNUMBER() returns the property number of the graph analysis with functional ordinal multiplex data A.
		...
		function check = existsProp(prop)
			...
			if nargout == 1
				...
				assert( ...
					AnalyzeGroup_FUN_OMP_GA_WU.existsProp(prop), ...
		...
		function check = existsTag(tag)
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				analyzegroup_fun_omp_ga_wu_tag_list = { 'id'  'label'  'notes'  'gr'  'g'  'repetition'  'frequencyrulemin'  'frequencyrulemax'  'correlation_rule'  'negative_weight_rule' };
				
				check = any(strcmpi(tag, analyzegroup_fun_omp_ga_wu_tag_list));
			else
				assert( ...
					AnalyzeGroup_FUN_OMP_GA_WU.existsTag(tag), ...
					[BRAPH2.STR ':AnalyzeGroup_FUN_OMP_GA_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':AnalyzeGroup_FUN_OMP_GA_WU:' BRAPH2.WRONG_INPUT ' ' ...
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, analyzegroup_fun_omp_ga_wu_tag_list));
			else % numeric
				prop = pointer;
				AnalyzeGroup_FUN_OMP_GA_WU.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMIN
						tag = AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMIN_TAG;
					case AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMAX
						tag = AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMAX_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMIN
					prop_category = AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMIN_CATEGORY;
				case AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMAX
					prop_category = AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMAX_CATEGORY;
				case AnalyzeGroup_FUN_OMP_GA_WU.CORRELATION_RULE
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMIN
					prop_format = AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMIN_FORMAT;
				case AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMAX
					prop_format = AnalyzeGroup_FUN_OMP_GA_WU.FREQUENCYRULEMAX_FORMAT;
				case AnalyzeGroup_FUN_OMP_GA_WU.CORRELATION_RULE
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_FUN_OMP_GA_WU.G
					prop_description = 'G (result, item) is the average graph (OrderedMultiplexWU) obtained from this analysis.';
				otherwise
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_FUN_OMP_GA_WU.G
					prop_settings = 'OrderedMultiplexWU';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_FUN_OMP_GA_WU.G
					prop_default = OrderedMultiplexWU();
				otherwise
		...
		function prop_check = checkProp(pointer, value)
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':AnalyzeGroup_FUN_OMP_GA_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':AnalyzeGroup_FUN_OMP_GA_WU:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' AnalyzeGroup_FUN_OMP_GA_WU.getPropTag(prop) ' (' AnalyzeGroup_FUN_OMP_GA_WU.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function a = AnalyzeGroup_FUN_OMP_GA_WU(varargin)
			...
			%
			% AnalyzeGroup_FUN_OMP_GA_WU(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
