classdef PPCompareEnsembleMP_FUN_CPDict_BUD < PlotProp
	% PPCompareEnsembleMP_FUN_CPDict_BUD is a plot of a binary undirect using densities multilayer comparison ensemble dictionary.
	...
	%
	% The list of PPCompareEnsembleMP_FUN_CPDict_BUD properties is:
	...
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (constructor):
	% PPCompareEnsembleMP_FUN_CPDict_BUD - constructor
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (Static):
	...
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods:
	...
	%  cb_measure_calc - eMP_FUN_CPDict_BUD/cb_measure_calc is a function.
	...
	%  cb_button_del - bleMP_FUN_CPDict_BUD/cb_button_del is a function.
	%  cb_button_calc - leMP_FUN_CPDict_BUD/cb_button_calc is a function.
	%  cb_button_cb - mbleMP_FUN_CPDict_BUD/cb_button_cb is a function.
	%  set_settings - mbleMP_FUN_CPDict_BUD/set_settings is a function.
	%  cb_close_fs - embleMP_FUN_CPDict_BUD/cb_close_fs is a function.
	...
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (operators):
	%  isequal - determines whether two PPCompareEnsembleMP_FUN_CPDict_BUD are equal (values, locked)
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (display):
	%  tostring - string with information about the PPCompareEnsembleMP_FUN_CPDict_BUD
	%  disp - displays information about the PPCompareEnsembleMP_FUN_CPDict_BUD
	%  tree - displays the element of PPCompareEnsembleMP_FUN_CPDict_BUD
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD method (element list):
	%  getElementList - returns a list with all subelements of PPCompareEnsembleMP_FUN_CPDict_BUD
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the PPCompareEnsembleMP_FUN_CPDict_BUD
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the PPCompareEnsembleMP_FUN_CPDict_BUD
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (copy):
	%  copy - copies the PPCompareEnsembleMP_FUN_CPDict_BUD
	%  deepclone - deep-clones the PPCompareEnsembleMP_FUN_CPDict_BUD
	%  clone - clones the PPCompareEnsembleMP_FUN_CPDict_BUD
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (inspection, Static):
	%  getClass - returns PPCompareEnsembleMP_FUN_CPDict_BUD
	%  getName - returns the name of PPCompareEnsembleMP_FUN_CPDict_BUD
	%  getDescription - returns the description of PPCompareEnsembleMP_FUN_CPDict_BUD
	%  getProps - returns the property list of PPCompareEnsembleMP_FUN_CPDict_BUD
	%  getPropNumber - returns the property number of PPCompareEnsembleMP_FUN_CPDict_BUD
	...
	%  checkProp - checks whether a value has the correct format/error
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (category, Static):
	...
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (format, Static):
	...
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (GUI):
	%  getGUI - returns the element GUI
	%  getPlotElement - returns the element plot
	%  getPlotProp - returns a prop plot
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD methods (GUI, Static):
	%  getGUIMenuImport - returns an importer menu
	%  getGUIMenuExport - returns an exporter menu
	%
	% PPCompareEnsembleMP_FUN_CPDict_BUD properties (Constant).
	%  EL - 3
	%  EL_TAG - 'el'
	%  EL_CATEGORY - 'm'
	%  EL_FORMAT - 'it'
	...
	methods (Static) % inspection methods
		function pr_class = getClass()
			%GETCLASS returns the class of the plot property graph mp.
			%
			% CLASS = PPCompareEnsembleMP_FUN_CPDict_BUD.GETCLASS() returns the class 'PPCompareEnsembleMP_FUN_CPDict_BUD'.
			%
			% Alternative forms to call this method are:
			%  CLASS = PR.GETCLASS() returns the class of the plot property graph mp PR.
			%  CLASS = Element.GETCLASS(PR) returns the class of 'PR'.
			%  CLASS = Element.GETCLASS('PPCompareEnsembleMP_FUN_CPDict_BUD') returns 'PPCompareEnsembleMP_FUN_CPDict_BUD'.
			%
			% See also getName, getDescription.
			
			pr_class = 'PPCompareEnsembleMP_FUN_CPDict_BUD';
		end
		function pr_name = getName()
			%GETNAME returns the name of the plot property graph mp.
			%
			% NAME = PPCompareEnsembleMP_FUN_CPDict_BUD.GETNAME() returns the name of the 'plot property graph mp'.
			...
			%  NAME = Element.GETNAME('PPCompareEnsembleMP_FUN_CPDict_BUD') returns the name of 'PPCompareEnsembleMP_FUN_CPDict_BUD'.
			%
		...
		function pr_description = getDescription()
			%GETDESCRIPTION returns the description of the plot property graph mp.
			%
			% STR = PPCompareEnsembleMP_FUN_CPDict_BUD.GETDESCRIPTION() returns the description of the 'plot property graph mp'.
			%  which is:
			%
			%  PPCompareEnsembleMP_FUN_CPDict_BUD plots the binary undirect using densities multilayer comparison ensemble
			%  dictionary property associated with a graph.
			...
			%  STR = Element.GETDESCRIPTION('PPCompareEnsembleMP_FUN_CPDict_BUD') returns the description of 'PPCompareEnsembleMP_FUN_CPDict_BUD'.
			%
		...
		function prop_list = getProps(category)
			%GETPROPS returns the property list of plot property graph mp.
			%
			% PROPS = PPCompareEnsembleMP_FUN_CPDict_BUD.GETPROPS() returns the property list of plot property graph mp.
			%
			% PROPS = PPCompareEnsembleMP_FUN_CPDict_BUD.GETPROPS(CATEGORY) returns the property list 
			%  of category CATEGORY.
			%
			% Alternative forms to call this method are:
			%  PROPS = PR.GETPROPS([CATEGORY]) returns the property list of the plot property graph mp PR.
			%  PROPS = Element.GETPROPS(PR[, CATEGORY]) returns the property list of 'PR'.
			%  PROPS = Element.GETPROPS('PPCompareEnsembleMP_FUN_CPDict_BUD'[, CATEGORY]) returns the property list of 'PPCompareEnsembleMP_FUN_CPDict_BUD'.
			%
		...
		function prop_number = getPropNumber()
			%GETPROPNUMBER returns the property number of plot property graph mp.
			%
			% N = PPCompareEnsembleMP_FUN_CPDict_BUD.GETPROPNUMBER() returns the property number of plot property graph mp.
			%
			% Alternative forms to call this method are:
			%  N = PR.GETPROPNUMBER() returns the property number of the plot property graph mp PR.
			%  N = Element.GETPROPNUMBER(PR) returns the property number of 'PR'.
			%  N = Element.GETPROPNUMBER('PPCompareEnsembleMP_FUN_CPDict_BUD') returns the property number of 'PPCompareEnsembleMP_FUN_CPDict_BUD'.
			%
			% See also getProps.
		...
		function check = existsProp(prop)
			%EXISTSPROP checks whether property exists in plot property graph mp/error.
			%
			% CHECK = PPCompareEnsembleMP_FUN_CPDict_BUD.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSPROP(PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PR, PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PPCompareEnsembleMP_FUN_CPDict_BUD, PROP) checks whether PROP exists for PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
			% Element.EXISTSPROP(PROP) throws an error if the PROP does NOT exist.
			%  Error id: [BRAPH2:PPCompareEnsembleMP_FUN_CPDict_BUD:WrongInput]
			%
			% Alternative forms to call this method are:
			...
			%   Error id: [BRAPH2:PPCompareEnsembleMP_FUN_CPDict_BUD:WrongInput]
			%  Element.EXISTSPROP(PPCompareEnsembleMP_FUN_CPDict_BUD, PROP) throws error if PROP does NOT exist for PPCompareEnsembleMP_FUN_CPDict_BUD.
			%   Error id: [BRAPH2:PPCompareEnsembleMP_FUN_CPDict_BUD:WrongInput]
			%
			...
			if nargout == 1
				...
				assert( ...
					PPCompareEnsembleMP_FUN_CPDict_BUD.existsProp(prop), ...
					[BRAPH2.STR ':PPCompareEnsembleMP_FUN_CPDict_BUD:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsembleMP_FUN_CPDict_BUD:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(prop, 100, ' ...') ' is not a valid prop for PPCompareEnsembleMP_FUN_CPDict_BUD.'] ...
					)
			end
		end
		function check = existsTag(tag)
			%EXISTSTAG checks whether tag exists in plot property graph mp/error.
			%
			% CHECK = PPCompareEnsembleMP_FUN_CPDict_BUD.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSTAG(TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PR, TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PPCompareEnsembleMP_FUN_CPDict_BUD, TAG) checks whether TAG exists for PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
			...
			%   Error id: [BRAPH2:PPCompareEnsembleMP_FUN_CPDict_BUD:WrongInput]
			%  Element.EXISTSTAG(PPCompareEnsembleMP_FUN_CPDict_BUD, TAG) throws error if TAG does NOT exist for PPCompareEnsembleMP_FUN_CPDict_BUD.
			%   Error id: [BRAPH2:PPCompareEnsembleMP_FUN_CPDict_BUD:WrongInput]
			%
			% See also getProps, existsTag.
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				ppcompareensemblemp_fun_cpdict_bud_tag_list = { 'id'  'bkgcolor'  'el'  'prop'  'title'  'enable'  'waitbar' };
				
				check = any(strcmpi(tag, ppcompareensemblemp_fun_cpdict_bud_tag_list));
			else
				assert( ...
					PPCompareEnsembleMP_FUN_CPDict_BUD.existsTag(tag), ...
					[BRAPH2.STR ':PPCompareEnsembleMP_FUN_CPDict_BUD:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsembleMP_FUN_CPDict_BUD:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tag ' is not a valid tag for PPCompareEnsembleMP_FUN_CPDict_BUD'] ...
					)
			end
		end
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns property number of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  PROPERTY = PR.GETPROPPROP(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns property number of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, ppcompareensemblemp_fun_cpdict_bud_tag_list));
			else % numeric
				prop = pointer;
				PPCompareEnsembleMP_FUN_CPDict_BUD.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns tag of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  TAG = PR.GETPROPTAG(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns tag of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
		...
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns category of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  CATEGORY = PR.GETPROPCATEGORY(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns category of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
			% See also Category, getPropProp, getPropTag, getPropSettings,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
			
			prop = PPCompareEnsembleMP_FUN_CPDict_BUD.getPropProp(pointer);
		...
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns format of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  FORMAT = PR.GETPROPFORMAT(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns format of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
		...
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns description of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  DESCRIPTION = PR.GETPROPDESCRIPTION(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns description of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns settings of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  SETTINGS = PR.GETPROPSETTINGS(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns settings of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
			% See also getPropProp, getPropTag, getPropCategory,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = PPCompareEnsembleMP_FUN_CPDict_BUD.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = PPCompareEnsembleMP_FUN_CPDict_BUD.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULT(POINTER) returns the default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULT(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns the default value of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  DEFAULT = PR.GETPROPDEFAULT(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns the default value of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = PPCompareEnsembleMP_FUN_CPDict_BUD.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = PPCompareEnsembleMP_FUN_CPDict_BUD.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns the conditioned default value of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(PPCompareEnsembleMP_FUN_CPDict_BUD, POINTER) returns the conditioned default value of POINTER of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%
			...
			prop_default = PPCompareEnsembleMP_FUN_CPDict_BUD.conditioning(prop, PPCompareEnsembleMP_FUN_CPDict_BUD.getPropDefault(prop));
		end
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(PPCompareEnsembleMP_FUN_CPDict_BUD, PROP, VALUE) checks VALUE format for PROP of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%  CHECK = PR.CHECKPROP(PPCompareEnsembleMP_FUN_CPDict_BUD, PROP, VALUE) checks VALUE format for PROP of PPCompareEnsembleMP_FUN_CPDict_BUD.
			% 
			...
			%   Error id: [BRAPH2:PPCompareEnsembleMP_FUN_CPDict_BUD:WrongInput]
			%  Element.CHECKPROP(PPCompareEnsembleMP_FUN_CPDict_BUD, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%   Error id: [BRAPH2:PPCompareEnsembleMP_FUN_CPDict_BUD:WrongInput]
			%  PR.CHECKPROP(PPCompareEnsembleMP_FUN_CPDict_BUD, PROP, VALUE) throws error if VALUE has not a valid format for PROP of PPCompareEnsembleMP_FUN_CPDict_BUD.
			%   Error id: [BRAPH2:PPCompareEnsembleMP_FUN_CPDict_BUD:WrongInput]
			% 
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':PPCompareEnsembleMP_FUN_CPDict_BUD:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':PPCompareEnsembleMP_FUN_CPDict_BUD:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' PPCompareEnsembleMP_FUN_CPDict_BUD.getPropTag(prop) ' (' PPCompareEnsembleMP_FUN_CPDict_BUD.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function pr = PPCompareEnsembleMP_FUN_CPDict_BUD(varargin)
			% PPCompareEnsembleMP_FUN_CPDict_BUD() creates a plot property graph mp.
			%
			% PPCompareEnsembleMP_FUN_CPDict_BUD(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% PPCompareEnsembleMP_FUN_CPDict_BUD(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
