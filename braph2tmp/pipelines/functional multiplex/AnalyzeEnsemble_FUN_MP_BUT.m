classdef AnalyzeEnsemble_FUN_MP_BUT < AnalyzeEnsemble
	% AnalyzeEnsemble_FUN_MP_BUT is a graph analysis using functional multiplex data of fixed threshold.
	...
	%  <strong>5</strong> <strong>g_dict</strong> 	G_DICT (result, idict) is the graph (MultiplexBUT) ensemble obtained from this analysis.
	...
	%
	% AnalyzeEnsemble_FUN_MP_BUT methods (Static):
	...
	%  getDescription - returns the description of the graph analysis with functional multiplex data of fixed threshold.
	%  getName - returns the name of the graph analysis with functional multiplex data of fixed threshold.
	...
	%
	% AnalyzeEnsemble_FUN_MP_BUT methods (operators):
	%  isequal - determines whether two AnalyzeEnsemble_FUN_MP_BUT are equal (values, locked)
	%
	% AnalyzeEnsemble_FUN_MP_BUT methods (display):
	%  tostring - string with information about the AnalyzeEnsemble_FUN_MP_BUT
	%  disp - displays information about the AnalyzeEnsemble_FUN_MP_BUT
	%  tree - displays the element of AnalyzeEnsemble_FUN_MP_BUT
	%
	% AnalyzeEnsemble_FUN_MP_BUT method (element list):
	%  getElementList - returns a list with all subelements of AnalyzeEnsemble_FUN_MP_BUT
	%
	% AnalyzeEnsemble_FUN_MP_BUT method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the AnalyzeEnsemble_FUN_MP_BUT
	%
	% AnalyzeEnsemble_FUN_MP_BUT method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the AnalyzeEnsemble_FUN_MP_BUT
	%
	% AnalyzeEnsemble_FUN_MP_BUT methods (copy):
	%  copy - copies the AnalyzeEnsemble_FUN_MP_BUT
	%  deepclone - deep-clones the AnalyzeEnsemble_FUN_MP_BUT
	%  clone - clones the AnalyzeEnsemble_FUN_MP_BUT
	%
	% AnalyzeEnsemble_FUN_MP_BUT methods (inspection, Static):
	%  getClass - returns AnalyzeEnsemble_FUN_MP_BUT
	%  getName - returns the name of AnalyzeEnsemble_FUN_MP_BUT
	%  getDescription - returns the description of AnalyzeEnsemble_FUN_MP_BUT
	%  getProps - returns the property list of AnalyzeEnsemble_FUN_MP_BUT
	%  getPropNumber - returns the property number of AnalyzeEnsemble_FUN_MP_BUT
	...
	%
	% AnalyzeEnsemble_FUN_MP_BUT properties (Constant).
	%  REPETITION - 7
	...
	methods (Static) % inspection methods
		...
		function a_name = getName()
			%GETNAME returns the name of the graph analysis with functional multiplex data of fixed threshold.
			%
			% NAME = AnalyzeEnsemble_FUN_MP_BUT.GETNAME() returns the name of the 'graph analysis with functional multiplex data of fixed threshold'.
			%  Graph Analysis With Functional Multiplex Data Of Fixed Threshold.
			%
			% Alternative forms to call this method are:
			%  NAME = A.GETNAME() returns the name of the graph analysis with functional multiplex data of fixed threshold A.
			%  NAME = Element.GETNAME(A) returns the name of 'A'.
			%  NAME = Element.GETNAME('AnalyzeEnsemble_FUN_MP_BUT') returns the name of 'AnalyzeEnsemble_FUN_MP_BUT'.
			%
			% See also getClass, getDescription.
			
			% COMPUTATIONAL EFFICIENCY TRICK
			a_name = 'Graph Analysis With Functional Multiplex Data Of Fixed Threshold';
		end
		function a_description = getDescription()
			%GETDESCRIPTION returns the description of the graph analysis with functional multiplex data of fixed threshold.
			%
			% STR = AnalyzeEnsemble_FUN_MP_BUT.GETDESCRIPTION() returns the description of the 'graph analysis with functional multiplex data of fixed threshold'.
			%  which is:
			%
			%  
			%
			% Alternative forms to call this method are:
			%  STR = A.GETDESCRIPTION() returns the description of the graph analysis with functional multiplex data of fixed threshold A.
			%  STR = Element.GETDESCRIPTION(A) returns the description of 'A'.
			%  STR = Element.GETDESCRIPTION('AnalyzeEnsemble_FUN_MP_BUT') returns the description of 'AnalyzeEnsemble_FUN_MP_BUT'.
			%
			...
			switch category
				...
				case Category.PARAMETER
					prop_list = [
						...
						AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMIN
						AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMAX
		...
		function prop_number = getPropNumber()
			...
			%
			% Alternative forms to call this method are:
			%  N = A.GETPROPNUMBER() returns the property number of the graph analysis with functional multiplex data of fixed threshold A.
		...
		function check = existsProp(prop)
			...
			if nargout == 1
				...
				assert( ...
					AnalyzeEnsemble_FUN_MP_BUT.existsProp(prop), ...
		...
		function check = existsTag(tag)
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				analyzeensemble_fun_mp_but_tag_list = { 'id'  'label'  'notes'  'gr'  'g_dict'  'me_dict'  'repetition'  'frequencyrulemin'  'frequencyrulemax'  'correlation_rule'  'negative_weight_rule'  'thresholds' };
				
				check = any(strcmpi(tag, analyzeensemble_fun_mp_but_tag_list));
			else
				assert( ...
					AnalyzeEnsemble_FUN_MP_BUT.existsTag(tag), ...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_MP_BUT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_MP_BUT:' BRAPH2.WRONG_INPUT ' ' ...
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, analyzeensemble_fun_mp_but_tag_list));
			else % numeric
				prop = pointer;
				AnalyzeEnsemble_FUN_MP_BUT.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMIN
						tag = AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMIN_TAG;
					case AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMAX
						tag = AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMAX_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMIN
					prop_category = AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMIN_CATEGORY;
				case AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMAX
					prop_category = AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMAX_CATEGORY;
				case AnalyzeEnsemble_FUN_MP_BUT.CORRELATION_RULE
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMIN
					prop_format = AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMIN_FORMAT;
				case AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMAX
					prop_format = AnalyzeEnsemble_FUN_MP_BUT.FREQUENCYRULEMAX_FORMAT;
				case AnalyzeEnsemble_FUN_MP_BUT.CORRELATION_RULE
		...
		function prop_check = checkProp(pointer, value)
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_MP_BUT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_MP_BUT:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' AnalyzeEnsemble_FUN_MP_BUT.getPropTag(prop) ' (' AnalyzeEnsemble_FUN_MP_BUT.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function a = AnalyzeEnsemble_FUN_MP_BUT(varargin)
			...
			%
			% AnalyzeEnsemble_FUN_MP_BUT(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
	...
	methods % GUI
		function pr = getPlotProp(a, prop, varargin)
			...
			switch prop
				case AnalyzeEnsemble_FUN_MP_BUT.THRESHOLDS
					pr = PlotPropSmartVector('EL', a, 'PROP', AnalyzeEnsemble_FUN_MP_BUT.THRESHOLDS, 'MAX', 1, 'MIN', 0, varargin{:});
