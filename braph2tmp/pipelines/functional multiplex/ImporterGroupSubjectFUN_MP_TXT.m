classdef ImporterGroupSubjectFUN_MP_TXT < Importer
	...
	%  <strong>5</strong> <strong>directory</strong> 	DIRECTORY (data, string) is the directory containing the FUN MP subject group files from which to load the L layers of the subject group.
	...
	%
	% ImporterGroupSubjectFUN_MP_TXT methods (Static):
	...
	%  getDescription - returns the description of the importer of FUN MP subject group from TXT.
	%  getName - returns the name of the importer of FUN MP subject group from TXT.
	%  getClass - returns the class of the importer of FUN MP subject group from TXT.
	%
	% ImporterGroupSubjectFUN_MP_TXT methods:
	%  uigetdir - R opens a dialog box to set the directory from where to load the TXT files of the FUN MP subject group with L layers.
	...
	%
	% ImporterGroupSubjectFUN_MP_TXT methods (operators):
	%  isequal - determines whether two ImporterGroupSubjectFUN_MP_TXT are equal (values, locked)
	%
	% ImporterGroupSubjectFUN_MP_TXT methods (display):
	%  tostring - string with information about the ImporterGroupSubjectFUN_MP_TXT
	%  disp - displays information about the ImporterGroupSubjectFUN_MP_TXT
	%  tree - displays the element of ImporterGroupSubjectFUN_MP_TXT
	%
	% ImporterGroupSubjectFUN_MP_TXT method (element list):
	%  getElementList - returns a list with all subelements of ImporterGroupSubjectFUN_MP_TXT
	%
	% ImporterGroupSubjectFUN_MP_TXT method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the ImporterGroupSubjectFUN_MP_TXT
	%
	% ImporterGroupSubjectFUN_MP_TXT method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the ImporterGroupSubjectFUN_MP_TXT
	%
	% ImporterGroupSubjectFUN_MP_TXT methods (copy):
	%  copy - copies the ImporterGroupSubjectFUN_MP_TXT
	%  deepclone - deep-clones the ImporterGroupSubjectFUN_MP_TXT
	%  clone - clones the ImporterGroupSubjectFUN_MP_TXT
	%
	% ImporterGroupSubjectFUN_MP_TXT methods (inspection, Static):
	%  getClass - returns ImporterGroupSubjectFUN_MP_TXT
	%  getName - returns the name of ImporterGroupSubjectFUN_MP_TXT
	%  getDescription - returns the description of ImporterGroupSubjectFUN_MP_TXT
	%  getProps - returns the property list of ImporterGroupSubjectFUN_MP_TXT
	%  getPropNumber - returns the property number of ImporterGroupSubjectFUN_MP_TXT
	...
	%
	% ImporterGroupSubjectFUN_MP_TXT properties (Constant).
	%  DIRECTORY - 5
	...
	%
	% See also Element, Importer, ExporterGroupSubjectFUN_MP_TXT.
	...
	methods (Static) % inspection methods
		...
		function im_name = getName()
			%GETNAME returns the name of the importer of FUN MP subject group from TXT.
			%
			% NAME = ImporterGroupSubjectFUN_MP_TXT.GETNAME() returns the name of the 'importer of FUN MP subject group from TXT'.
			%  Importer Of FUN MP Subject Group From TXT.
			%
			% Alternative forms to call this method are:
			%  NAME = IM.GETNAME() returns the name of the importer of FUN MP subject group from TXT IM.
			%  NAME = Element.GETNAME(IM) returns the name of 'IM'.
			%  NAME = Element.GETNAME('ImporterGroupSubjectFUN_MP_TXT') returns the name of 'ImporterGroupSubjectFUN_MP_TXT'.
			%
			% See also getClass, getDescription.
			
			% COMPUTATIONAL EFFICIENCY TRICK
			im_name = 'Importer Of FUN MP Subject Group From TXT';
		end
		function im_description = getDescription()
			%GETDESCRIPTION returns the description of the importer of FUN MP subject group from TXT.
			%
			% STR = ImporterGroupSubjectFUN_MP_TXT.GETDESCRIPTION() returns the description of the 'importer of FUN MP subject group from TXT'.
			%  which is:
			%
			%  ImporterGroupSubjectFUN_MP_TXT imports a group of subjects with functional multiplex data from an TXT file and their covariates (optional) from another TXT file.
			%  All these files must be in the same folder; also, no other files should be in the folder.
			...
			%
			% Alternative forms to call this method are:
			%  STR = IM.GETDESCRIPTION() returns the description of the importer of FUN MP subject group from TXT IM.
			%  STR = Element.GETDESCRIPTION(IM) returns the description of 'IM'.
			%  STR = Element.GETDESCRIPTION('ImporterGroupSubjectFUN_MP_TXT') returns the description of 'ImporterGroupSubjectFUN_MP_TXT'.
			%
		...
		function prop_number = getPropNumber()
			...
			%
			% Alternative forms to call this method are:
			%  N = IM.GETPROPNUMBER() returns the property number of the importer of FUN MP subject group from TXT IM.
		...
		function check = existsProp(prop)
			...
			if nargout == 1
				...
				assert( ...
					ImporterGroupSubjectFUN_MP_TXT.existsProp(prop), ...
		...
		function check = existsTag(tag)
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				importergroupsubjectfun_mp_txt_tag_list = { 'id'  'label'  'notes'  'waitbar'  'directory'  'ba'  'gr' };
				
				check = any(strcmpi(tag, importergroupsubjectfun_mp_txt_tag_list));
			else
				assert( ...
					ImporterGroupSubjectFUN_MP_TXT.existsTag(tag), ...
					[BRAPH2.STR ':ImporterGroupSubjectFUN_MP_TXT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':ImporterGroupSubjectFUN_MP_TXT:' BRAPH2.WRONG_INPUT ' ' ...
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, importergroupsubjectfun_mp_txt_tag_list));
			else % numeric
				prop = pointer;
				ImporterGroupSubjectFUN_MP_TXT.existsProp(prop);
			end
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				case ImporterGroupSubjectFUN_MP_TXT.DIRECTORY
					prop_default = Format.getFormatDefault(Format.STRING, ImporterGroupSubjectFUN_MP_TXT.getPropSettings(prop));
				case ImporterGroupSubjectFUN_MP_TXT.BA
		...
		function prop_check = checkProp(pointer, value)
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':ImporterGroupSubjectFUN_MP_TXT:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':ImporterGroupSubjectFUN_MP_TXT:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' ImporterGroupSubjectFUN_MP_TXT.getPropTag(prop) ' (' ImporterGroupSubjectFUN_MP_TXT.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function im = ImporterGroupSubjectFUN_MP_TXT(varargin)
			...
			%
			% ImporterGroupSubjectFUN_MP_TXT(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(im, prop)
			...
			switch prop
				case ImporterGroupSubjectFUN_MP_TXT.GR
					rng(im.getPropSeed(ImporterGroupSubjectFUN_MP_TXT.GR), 'twister')
