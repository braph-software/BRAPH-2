classdef NNData_FUN_WU < NNData
	% NNData_FUN_WU produces a dataset to train or test a neural netowrk model for functional data.
	% It is a subclass of <a href="matlab:help NNData">NNData</a>.
	%
	% 
	%
	% The list of NNData_FUN_WU properties is:
	...
	%
	% NNData_FUN_WU methods (constructor):
	% NNData_FUN_WU - constructor
	%
	% NNData_FUN_WU methods (Static):
	...
	%
	% NNData_FUN_WU methods (operators):
	%  isequal - determines whether two NNData_FUN_WU are equal (values, locked)
	%
	% NNData_FUN_WU methods (display):
	%  tostring - string with information about the NNData_FUN_WU
	%  disp - displays information about the NNData_FUN_WU
	%  tree - displays the element of NNData_FUN_WU
	%
	% NNData_FUN_WU method (element list):
	%  getElementList - returns a list with all subelements of NNData_FUN_WU
	%
	% NNData_FUN_WU method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the NNData_FUN_WU
	%
	% NNData_FUN_WU method (JSON decode, Static):
	%  decodeJSON - returns a JSON string encoding the NNData_FUN_WU
	%
	% NNData_FUN_WU methods (copy):
	%  copy - copies the NNData_FUN_WU
	%  deepclone - deep-clones the NNData_FUN_WU
	%  clone - clones the NNData_FUN_WU
	%
	% NNData_FUN_WU methods (inspection, Static):
	%  getClass - returns NNData_FUN_WU
	%  getName - returns the name of NNData_FUN_WU
	%  getDescription - returns the description of NNData_FUN_WU
	%  getProps - returns the property list of NNData_FUN_WU
	%  getPropNumber - returns the property number of NNData_FUN_WU
	...
	%  checkProp - checks whether a value has the correct format/error
	%
	% NNData_FUN_WU methods (category, Static):
	...
	%
	% NNData_FUN_WU methods (format, Static):
	...
	%
	% NNData_FUN_WU methods (GUI):
	%  getGUI - returns the element GUI
	%  getPlotElement - returns the element plot
	%  getPlotProp - returns a prop plot
	%
	% NNData_FUN_WU methods (GUI, Static):
	%  getGUIMenuImport - returns an importer menu
	%  getGUIMenuExport - returns an exporter menu
	%
	% NNData_FUN_WU properties (Constant).
	%  REPETITION - 11
	...
	methods (Static) % inspection methods
		function nnd_class = getClass()
			%GETCLASS returns the class of the data for neural network.
			%
			% CLASS = NNData_FUN_WU.GETCLASS() returns the class 'NNData_FUN_WU'.
			%
			...
			%  CLASS = Element.GETCLASS('NNData_FUN_WU') returns 'NNData_FUN_WU'.
			%
			% See also getName, getDescription.
			
			nnd_class = 'NNData_FUN_WU';
		end
		function nnd_name = getName()
			%GETNAME returns the name of the data for neural network.
			%
			% NAME = NNData_FUN_WU.GETNAME() returns the name of the 'data for neural network'.
			%  Data For Neural Network.
			%
			% Alternative forms to call this method are:
			%  NAME = NND.GETNAME() returns the name of the data for neural network NND.
			%  NAME = Element.GETNAME(NND) returns the name of 'NND'.
			%  NAME = Element.GETNAME('NNData_FUN_WU') returns the name of 'NNData_FUN_WU'.
			%
		...
		function nnd_description = getDescription()
			%GETDESCRIPTION returns the description of the data for neural network.
			%
			% STR = NNData_FUN_WU.GETDESCRIPTION() returns the description of the 'data for neural network'.
			%  which is:
			%
			%  
			%
			...
			%  STR = Element.GETDESCRIPTION('NNData_FUN_WU') returns the description of 'NNData_FUN_WU'.
			%
		...
		function prop_list = getProps(category)
			%GETPROPS returns the property list of data for neural network.
			%
			% PROPS = NNData_FUN_WU.GETPROPS() returns the property list of data for neural network.
			%
			% PROPS = NNData_FUN_WU.GETPROPS(CATEGORY) returns the property list 
			...
			%  PROPS = Element.GETPROPS('NNData_FUN_WU'[, CATEGORY]) returns the property list of 'NNData_FUN_WU'.
			%
			...
			switch category
				...
				case Category.PARAMETER
					prop_list = [
						...
						NNData_FUN_WU.REPETITION
						NNData_FUN_WU.FREQUENCYRULEMIN
						NNData_FUN_WU.FREQUENCYRULEMAX
						NNData_FUN_WU.CORRELATION_RULE
						NNData_FUN_WU.NEGATIVE_WEIGHT_RULE
						];
				case Category.DATA
					prop_list = [
		...
		function prop_number = getPropNumber()
			%GETPROPNUMBER returns the property number of data for neural network.
			%
			% N = NNData_FUN_WU.GETPROPNUMBER() returns the property number of data for neural network.
			%
			% Alternative forms to call this method are:
			...
			%  N = Element.GETPROPNUMBER('NNData_FUN_WU') returns the property number of 'NNData_FUN_WU'.
			%
			% See also getProps.
		...
		function check = existsProp(prop)
			%EXISTSPROP checks whether property exists in data for neural network/error.
			%
			% CHECK = NNData_FUN_WU.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			...
			%  CHECK = Element.EXISTSPROP(NNData_FUN_WU, PROP) checks whether PROP exists for NNData_FUN_WU.
			%
			% Element.EXISTSPROP(PROP) throws an error if the PROP does NOT exist.
			%  Error id: [BRAPH2:NNData_FUN_WU:WrongInput]
			%
			% Alternative forms to call this method are:
			...
			%   Error id: [BRAPH2:NNData_FUN_WU:WrongInput]
			%  Element.EXISTSPROP(NNData_FUN_WU, PROP) throws error if PROP does NOT exist for NNData_FUN_WU.
			%   Error id: [BRAPH2:NNData_FUN_WU:WrongInput]
			%
			...
			if nargout == 1
				...
				assert( ...
					NNData_FUN_WU.existsProp(prop), ...
					[BRAPH2.STR ':NNData_FUN_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':NNData_FUN_WU:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(prop, 100, ' ...') ' is not a valid prop for NNData_FUN_WU.'] ...
					)
			end
		end
		function check = existsTag(tag)
			%EXISTSTAG checks whether tag exists in data for neural network/error.
			%
			% CHECK = NNData_FUN_WU.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			...
			%  CHECK = Element.EXISTSTAG(NNData_FUN_WU, TAG) checks whether TAG exists for NNData_FUN_WU.
			%
			...
			%   Error id: [BRAPH2:NNData_FUN_WU:WrongInput]
			%  Element.EXISTSTAG(NNData_FUN_WU, TAG) throws error if TAG does NOT exist for NNData_FUN_WU.
			%   Error id: [BRAPH2:NNData_FUN_WU:WrongInput]
			%
			% See also getProps, existsTag.
			...
			if nargout == 1
				% COMPUTATIONAL EFFICIENCY TRICK
				nndata_fun_wu_tag_list = { 'id'  'label'  'notes'  'waitbar'  'input_type'  'g'  'measures'  'target_name'  'gr'  'gr_nn'  'repetition'  'frequencyrulemin'  'frequencyrulemax'  'correlation_rule'  'negative_weight_rule' };
				
				check = any(strcmpi(tag, nndata_fun_wu_tag_list));
			else
				assert( ...
					NNData_FUN_WU.existsTag(tag), ...
					[BRAPH2.STR ':NNData_FUN_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':NNData_FUN_WU:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tag ' is not a valid tag for NNData_FUN_WU'] ...
					)
			end
		end
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(NNData_FUN_WU, POINTER) returns property number of POINTER of NNData_FUN_WU.
			%  PROPERTY = NND.GETPROPPROP(NNData_FUN_WU, POINTER) returns property number of POINTER of NNData_FUN_WU.
			%
			...
			if ischar(pointer)
				...
				prop = find(strcmpi(tag, nndata_fun_wu_tag_list));
			else % numeric
				prop = pointer;
				NNData_FUN_WU.existsProp(prop);
			end
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(NNData_FUN_WU, POINTER) returns tag of POINTER of NNData_FUN_WU.
			%  TAG = NND.GETPROPTAG(NNData_FUN_WU, POINTER) returns tag of POINTER of NNData_FUN_WU.
			%
			...
			if ischar(pointer)
				...
				switch prop
					case NNData_FUN_WU.REPETITION
						tag = NNData_FUN_WU.REPETITION_TAG;
					case NNData_FUN_WU.FREQUENCYRULEMIN
						tag = NNData_FUN_WU.FREQUENCYRULEMIN_TAG;
					case NNData_FUN_WU.FREQUENCYRULEMAX
						tag = NNData_FUN_WU.FREQUENCYRULEMAX_TAG;
					case NNData_FUN_WU.CORRELATION_RULE
						tag = NNData_FUN_WU.CORRELATION_RULE_TAG;
					case NNData_FUN_WU.NEGATIVE_WEIGHT_RULE
						tag = NNData_FUN_WU.NEGATIVE_WEIGHT_RULE_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(NNData_FUN_WU, POINTER) returns category of POINTER of NNData_FUN_WU.
			%  CATEGORY = NND.GETPROPCATEGORY(NNData_FUN_WU, POINTER) returns category of POINTER of NNData_FUN_WU.
			%
			% See also Category, getPropProp, getPropTag, getPropSettings,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
			
			prop = NNData_FUN_WU.getPropProp(pointer);
			
			switch prop
				case NNData_FUN_WU.REPETITION
					prop_category = NNData_FUN_WU.REPETITION_CATEGORY;
				case NNData_FUN_WU.FREQUENCYRULEMIN
					prop_category = NNData_FUN_WU.FREQUENCYRULEMIN_CATEGORY;
				case NNData_FUN_WU.FREQUENCYRULEMAX
					prop_category = NNData_FUN_WU.FREQUENCYRULEMAX_CATEGORY;
				case NNData_FUN_WU.CORRELATION_RULE
					prop_category = NNData_FUN_WU.CORRELATION_RULE_CATEGORY;
				case NNData_FUN_WU.NEGATIVE_WEIGHT_RULE
					prop_category = NNData_FUN_WU.NEGATIVE_WEIGHT_RULE_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(NNData_FUN_WU, POINTER) returns format of POINTER of NNData_FUN_WU.
			%  FORMAT = NND.GETPROPFORMAT(NNData_FUN_WU, POINTER) returns format of POINTER of NNData_FUN_WU.
			%
			...
			switch prop
				case NNData_FUN_WU.REPETITION
					prop_format = NNData_FUN_WU.REPETITION_FORMAT;
				case NNData_FUN_WU.FREQUENCYRULEMIN
					prop_format = NNData_FUN_WU.FREQUENCYRULEMIN_FORMAT;
				case NNData_FUN_WU.FREQUENCYRULEMAX
					prop_format = NNData_FUN_WU.FREQUENCYRULEMAX_FORMAT;
				case NNData_FUN_WU.CORRELATION_RULE
					prop_format = NNData_FUN_WU.CORRELATION_RULE_FORMAT;
				case NNData_FUN_WU.NEGATIVE_WEIGHT_RULE
					prop_format = NNData_FUN_WU.NEGATIVE_WEIGHT_RULE_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(NNData_FUN_WU, POINTER) returns description of POINTER of NNData_FUN_WU.
			%  DESCRIPTION = NND.GETPROPDESCRIPTION(NNData_FUN_WU, POINTER) returns description of POINTER of NNData_FUN_WU.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(NNData_FUN_WU, POINTER) returns settings of POINTER of NNData_FUN_WU.
			%  SETTINGS = NND.GETPROPSETTINGS(NNData_FUN_WU, POINTER) returns settings of POINTER of NNData_FUN_WU.
			%
			% See also getPropProp, getPropTag, getPropCategory,
			% getPropFormat, getPropDescription, getPropDefault,
			% checkProp.
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = NNData_FUN_WU.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = NNData_FUN_WU.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = NND.GETPROPDEFAULT(POINTER) returns the default value of POINTER of NND.
			%  DEFAULT = Element.GETPROPDEFAULT(NNData_FUN_WU, POINTER) returns the default value of POINTER of NNData_FUN_WU.
			%  DEFAULT = NND.GETPROPDEFAULT(NNData_FUN_WU, POINTER) returns the default value of POINTER of NNData_FUN_WU.
			%
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = NNData_FUN_WU.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = NNData_FUN_WU.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = NND.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of NND.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(NNData_FUN_WU, POINTER) returns the conditioned default value of POINTER of NNData_FUN_WU.
			%  DEFAULT = NND.GETPROPDEFAULTCONDITIONED(NNData_FUN_WU, POINTER) returns the conditioned default value of POINTER of NNData_FUN_WU.
			%
			...
			prop_default = NNData_FUN_WU.conditioning(prop, NNData_FUN_WU.getPropDefault(prop));
		end
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(NNData_FUN_WU, PROP, VALUE) checks VALUE format for PROP of NNData_FUN_WU.
			%  CHECK = NND.CHECKPROP(NNData_FUN_WU, PROP, VALUE) checks VALUE format for PROP of NNData_FUN_WU.
			% 
			...
			%   Error id: [BRAPH2:NNData_FUN_WU:WrongInput]
			%  Element.CHECKPROP(NNData_FUN_WU, PROP, VALUE) throws error if VALUE has not a valid format for PROP of NNData_FUN_WU.
			%   Error id: [BRAPH2:NNData_FUN_WU:WrongInput]
			%  NND.CHECKPROP(NNData_FUN_WU, PROP, VALUE) throws error if VALUE has not a valid format for PROP of NNData_FUN_WU.
			%   Error id: [BRAPH2:NNData_FUN_WU:WrongInput]
			% 
			...
			switch prop
				case NNData_FUN_WU.REPETITION
					check = Format.checkFormat(Format.SCALAR, value, NNData_FUN_WU.getPropSettings(prop));
				case NNData_FUN_WU.FREQUENCYRULEMIN
					check = Format.checkFormat(Format.SCALAR, value, NNData_FUN_WU.getPropSettings(prop));
				case NNData_FUN_WU.FREQUENCYRULEMAX
					check = Format.checkFormat(Format.SCALAR, value, NNData_FUN_WU.getPropSettings(prop));
				case NNData_FUN_WU.CORRELATION_RULE
					check = Format.checkFormat(Format.OPTION, value, NNData_FUN_WU.getPropSettings(prop));
				case NNData_FUN_WU.NEGATIVE_WEIGHT_RULE
					check = Format.checkFormat(Format.OPTION, value, NNData_FUN_WU.getPropSettings(prop));
				case NNData_FUN_WU.INPUT_TYPE
					check = Format.checkFormat(Format.OPTION, value, NNData_FUN_WU.getPropSettings(prop));
				case NNData_FUN_WU.GR_NN
					check = Format.checkFormat(Format.GROUP, value, NNData_FUN_WU.getPropSettings(prop));
				otherwise
			...
			if nargout == 1
				...
				assert( ...
					...
					[BRAPH2.STR ':NNData_FUN_WU:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':NNData_FUN_WU:' BRAPH2.WRONG_INPUT ' ' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' NNData_FUN_WU.getPropTag(prop) ' (' NNData_FUN_WU.getPropFormat(prop) ').'] ...
					)
			end
		end
	end
	methods % constructor
		function nnd = NNData_FUN_WU(varargin)
			% NNData_FUN_WU() creates a data for neural network.
			%
			% NNData_FUN_WU(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% NNData_FUN_WU(TAG, VALUE, ...) with property with tag TAG set to VALUE.
			%
