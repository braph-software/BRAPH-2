% test RandomComparisonST_MP_BUT
...
subject_class = RandomComparison.getSubjectClass('RandomComparisonST_MP_BUT');
...
for i = 1:1:numel(measures)
    randomcomparison = RandomComparisonST_MP_BUT('rc1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonST_MP_BUT('rc1', 'label', 'notes', atlas, measures{i}, group, 'RandomComparisonST_MP.RandomizationNumber', number_of_randomizations, 'RandomComparisonST_MP.ParameterValues', parameter_values);
    ...
    [BRAPH2.STR ':RandomComparisonST_MP_BUT:' BRAPH2.BUG_FUNC], ...
    'RandomComparisonST_MP_BUT does not initialize correctly the parameter of the measures')
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonST_MP_BUT:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonST_MP_BUT does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value_group)), ...
            [BRAPH2.STR ':RandomComparisonST_MP_BUT:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonST_MP_BUT does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value_group)), ...
            [BRAPH2.STR ':RandomComparisonST_MP_BUT:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonST_MP_BUT does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    randomcomparison = RandomComparisonST_MP_BUT('rc1', ...
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':RandomComparisonST_MP_BUT:' BRAPH2.WRONG_OUTPUT], ...
            'RandomComparisonST_MP_BUT does not initialize correctly with global measures')
