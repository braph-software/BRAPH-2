...
analysis = AnalysisST_MP_BUD('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}, 'density1', 0.7, 'density2', 0.5); %#ok<NASGU>

%% Test 2: Create correct ID
analysis = AnalysisST_MP_BUD('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}, 'density1', 0.7, 'density2', 0.7);

measurement_id = analysis.getMeasurementID('Degree', group1, 'density1', 0.7, 'density2', 0.7);
expected_value = [ ...
    tostring(analysis.getMeasurementClass()) ' ' ...
    tostring('Degree') ' ' ...
    tostring(analysis.getCohort().getGroups().getIndex(group1)) ' ' ...
    ['density1=' num2str(0.7)], ...
    [' density2=' num2str(0.7)] ...
    ];
...
randomcomparison_id = analysis.getRandomComparisonID('Degree', group1, 'density1', 0.7, 'density2', 0.7);
expected_value = [ ...
...
comparison_id = analysis.getComparisonID('Distance', group1, group2, 'density1', 0.7, 'density2', 0.7);
expected_value = [ ...
...
for i = 1:1:length(measures)
    ...
    calculated_measurement = analysis.getMeasurement(measure, group1, 'density1', .6, 'density2', .5);
