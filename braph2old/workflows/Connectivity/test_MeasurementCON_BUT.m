...
subject_class = Measurement.getSubjectClass('MeasurementCON_BUT');
...
for i = 1:1:numel(measures)
    measurement = MeasurementCON_BUT('m1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementCON_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementCON_BUT does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementCON_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementCON_BUT does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementCON_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementCON_BUT does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    measurement = MeasurementCON_BUT('m1', 'label', 'notes', atlas, measures{i}, group, ...
        'MeasurementCON_BUT.values', values, ...
        'MeasurementCON_BUT.average_value', average_value ...
        );
