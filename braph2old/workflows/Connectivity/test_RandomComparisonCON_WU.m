...
subject_class = RandomComparison.getSubjectClass('RandomComparisonCON_WU');
...
for i = 1:1:numel(measures)
    randomcomparison = RandomComparisonCON_WU('rc1', 'label', 'notes', atlas,  measures{i}, group);    
end
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonCON_WU('rc1', 'label', 'notes', atlas,  measures{i}, group, 'RandomComparisonCON.RandomizationNumber', number_of_randomizations);
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            'RandomComparisonCON_WU does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonCON_WU:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonCON_WU does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonCON_WU:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonCON_WU does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    confidence_interval_max = difference;
        ...
        % act
    random_comparison = RandomComparisonCON_WU('rc1', ...
        'rcomparison label', ...
        'rcomparison notes', ...
        atlas, ...
        measures{i}, ...
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(randomcomparison_difference) && ...
            ...
            [BRAPH2.STR ':RandomComparisonCON_WU:' BRAPH2.WRONG_OUTPUT], ...
            'RandomComparisonCON_WU does not initialize correctly with global measures')
