...
subject_class = Comparison.getSubjectClass('ComparisonfMRI');
...
for i = 1:1:numel(measures)
    comparison = ComparisonfMRI('c1', 'label', 'notes', atlas, measures{i}, group, group);
end
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonfMRI('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonfMRI.PermutationNumber', number_of_permutations);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_1) & ...
            ...
            ['ComparisonfMRI does not initialize correctly with global measures.']) %#ok<*NBRAK>
        assert(isequal(numel(average_value_1), 1) & ...
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(value_1) & ...
            ...
            [BRAPH2.STR ':ComparisonfMRI:' BRAPH2.BUG_FUNC], ...
            ['ComparisonfMRI does not initialize correctly with nodal measures.']) %#ok<*NBRAK>
        assert(isequal(size(average_value_1), [atlas.getBrainRegions().length(), 1]) & ...
            isequal(size(average_value_2), [atlas.getBrainRegions().length(), 1]) & ...
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(value_1) & ...
            ...
            [BRAPH2.STR ':ComparisonfMRI:' BRAPH2.BUG_FUNC], ...
            ['ComparisonfMRI does not initialize correctly with binodal measures.']) %#ok<*NBRAK>
        assert(isequal(size(average_value_1), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]) & ...
            isequal(size(average_value_2), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]) & ...
...
for i = 1:1:numel(measures)
    ...
    for j = 1:1:group.subjectnumber()
        ...
        value_1{j} = cell2mat(m_1.getValue()); %#ok<*SAGROW>
        value_2{j} = cell2mat(m_2.getValue());
    end
    
    average_value_1 = mean(reshape(cell2mat(value_1), [size(value_1{1}, 1), size(value_1{1}, 2), group.subjectnumber()]), 3);
    average_value_2 = mean(reshape(cell2mat(value_2), [size(value_2{1}, 1), size(value_2{1}, 2), group.subjectnumber()]), 3);
    ...
    comparison = ComparisonfMRI('c1', ...
        ...
        group, ...
        group, ...
        'ComparisonfMRI.PermutationNumber', number_of_permutations, ...
        'ComparisonfMRI.value_1', value_1, ...
        'ComparisonfMRI.value_2', value_2, ...
        'ComparisonfMRI.average_value_1', average_value_1, ...
        'ComparisonfMRI.average_value_2', average_value_2, ...
        'ComparisonfMRI.difference', difference, ...
        'ComparisonfMRI.all_differences', all_differences, ...
        'ComparisonfMRI.p1', p1, ...
        'ComparisonfMRI.p2', p2, ....
        'ComparisonfMRI.confidence_min', confidence_interval_min, ...
        'ComparisonfMRI.confidence_max', confidence_interval_max ...
        );
    
    comparison_value_1 = comparison.getGroupValue(1);
    comparison_value_2 = comparison.getGroupValue(2);
    comparison_average_value_1 = comparison.getGroupAverageValue(1);
    comparison_average_value_2 = comparison.getGroupAverageValue(2);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(comparison_value_1) & ...
            ...
            [BRAPH2.STR ':ComparisonfMRI:' BRAPH2.BUG_FUNC], ...
            ['ComparisonfMRI does not initialize correctly with global measures.']) %#ok<*NBRAK>
        assert(isequal(numel(comparison_average_value_1), 1) & ...
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(comparison_value_1) & ...
            ...
            [BRAPH2.STR ':ComparisonfMRI:' BRAPH2.BUG_FUNC], ...
            ['ComparisonfMRI does not initialize correctly with nodal measures.']) %#ok<*NBRAK>
        assert(isequal(size(comparison_average_value_1), [atlas.getBrainRegions().length(), 1]) & ...
            isequal(size(comparison_average_value_2), [atlas.getBrainRegions().length(), 1]) & ...
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(comparison_value_1) & ...
            ...
            [BRAPH2.STR ':ComparisonfMRI:' BRAPH2.BUG_FUNC], ...
            ['ComparisonfMRI does not initialize correctly with binodal measures.']) %#ok<*NBRAK>
        assert(isequal(size(comparison_average_value_1), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]) & ...
            isequal(size(comparison_average_value_2), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]) & ...
