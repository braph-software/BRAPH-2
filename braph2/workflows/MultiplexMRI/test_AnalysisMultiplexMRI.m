...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_all_differences) && ...
            ...
            all(all(cellfun(@(x) isequal(size(x), [1, 1]), comparison_all_differences{1}))), ...        
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with global measures') 
        
        assert(iscell(comparison_p1) && ...
            isequal(numel(comparison_p1), num_elements) && ...
            all(cellfun(@(x) isequal(size(x), [1, 1]), comparison_p1{1})), ...        
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with global measures') 

        assert(iscell(comparison_p2) && ...
            isequal(numel(comparison_p2), num_elements) && ...
            all(cellfun(@(x) isequal(size(x), [1, 1]), comparison_p2{1})), ...
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with global measures') 
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(comparison_all_differences) && ...
            isequal(numel(comparison_all_differences), num_elements*number_of_permutations) && ...
            all(all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), comparison_all_differences{1}))), ...        
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with nodal measures')  
        
        assert(iscell(comparison_p1) && ...
            isequal(numel(comparison_p1), num_elements) && ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), comparison_p1{1})), ...        
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with nodal measures') 

        assert(iscell(comparison_p2) && ...
            isequal(numel(comparison_p2), num_elements) && ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), comparison_p2{1})), ...
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with nodal measures') 
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(comparison_all_differences) && ...
            isequal(numel(comparison_all_differences), num_elements*number_of_permutations) && ...
            all(all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), comparison_all_differences{1}))), ...        
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with binodal measures') 
        
        assert(iscell(comparison_p1) && ...
            isequal(numel(comparison_p1), num_elements) && ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), comparison_p1{1})), ...        
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with binodal measures') 

        assert(iscell(comparison_p2) && ...
            isequal(numel(comparison_p2), num_elements) && ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), comparison_p2{1})), ...
            [BRAPH2.STR ':AnalysisMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMultiplexMRI.getComparison() not working with binodal measures') 
