        ...
        function initialize_data(c, varargin)
            ...
            if Measure.is_global(measure_code)  % global measure
                ...
                assert(iscell(c.getAllDifferences()) && ...
                    ...
                    all(all(cellfun(@(x) isequal(size(x), [1, 1]), c.all_differences{1}))), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
                ...
                assert(iscell(c.getP1()) && ...
                    ...
                    all(cellfun(@(x) isequal(size(x), [1, 1]), c.p1{1})), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
                ...
                assert(iscell(c.getP2()) && ...
                    ...
                    all(cellfun(@(x) isequal(size(x), [1, 1]), c.p2{1})), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
            ...
            elseif Measure.is_nodal(measure_code)  % nodal measure
                ...
                assert(iscell(c.getAllDifferences()) && ...
                    isequal(size(c.getAllDifferences()), [rows*columns, number_of_permutations]) && ...
                    all(all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), c.all_differences{1}))), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
                ...
                assert(iscell(c.getP1()) && ...
                    isequal(size(c.getP1()), [rows, columns]) && ...
                    all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), c.p1{1})), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
                ...
                assert(iscell(c.getP2()) && ...
                    isequal(size(c.getP2()), [rows, columns]) && ...
                    all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), c.p2{1})), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
            ...
            elseif Measure.is_binodal(measure_code)  % binodal measure
                ...
                assert(iscell(c.getAllDifferences()) && ...
                    isequal(size(c.getAllDifferences()), [rows*columns, number_of_permutations]) && ...
                    all(all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), c.all_differences{1}))), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
                ...
                assert(iscell(c.getP1()) && ...
                    isequal(size(c.getP1()), [rows, columns]) && ...
                    all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), c.p1{1})), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
                ...
                assert(iscell(c.getP2()) && ...
                    isequal(size(c.getP2()), [rows, columns]) && ...
                    all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), c.p2{1})), ...
                    [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2. WRONG_INPUT], ...
                    'Data not compatible with ComparisonMultiplexMRI')
