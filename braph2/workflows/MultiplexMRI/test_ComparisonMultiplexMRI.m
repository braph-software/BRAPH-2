...
subject_class = Comparison.getSubjectClass('ComparisonMultiplexMRI');
...
for i = 1:1:numel(measures)
    comparison = ComparisonMultiplexMRI('c1', 'label', 'notes', atlas, measures{i}, group, group);
end