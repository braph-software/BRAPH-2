...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonMultiplexMRI('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonMultiplexMRI.PermutationNumber', number_of_permutations);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2.BUG_FUNC], ...
            'ComparisonMultiplexMRI does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2.BUG_FUNC], ...
            'ComparisonMultiplexMRI does not initialize correctly with nodal measures')
        ...
        assert(iscell(all_differences) && ...
            isequal(numel(all_differences), num_elements*number_of_permutations) && ...
            all(all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), all_differences))), ...
            [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2.BUG_FUNC], ...
            'ComparisonMultiplexMRI does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2.BUG_FUNC], ...
            'ComparisonMultiplexMRI does not initialize correctly with binodal measures')
        ...
        assert(iscell(all_differences) && ...
            isequal(numel(all_differences), num_elements*number_of_permutations) && ...
            all(all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), all_differences))), ...
            [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2.BUG_FUNC], ...
            'ComparisonMultiplexMRI does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    comparison = ComparisonMultiplexMRI('c1', ...
        'comparison label', ...
        'comparison notes', ...
        atlas, ...
        measures{i}, ...
        group, ...
        group, ...
        'ComparisonMultiplexMRI.PermutationNumber', number_of_permutations, ...
        'ComparisonMultiplexMRI.value_1', value_1, ...
        'ComparisonMultiplexMRI.value_2', value_2, ...
        'ComparisonMultiplexMRI.difference', difference, ...
        'ComparisonMultiplexMRI.all_differences', all_differences, ...
        'ComparisonMultiplexMRI.p1', p1, ...
        'ComparisonMultiplexMRI.p2', p2, ....
        'ComparisonMultiplexMRI.confidence_min', confidence_interval_min, ...
        'ComparisonMultiplexMRI.confidence_max', confidence_interval_max ...
        );
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonMultiplexMRI does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(comparison_all_differences) && ...
            isequal(numel(comparison_all_differences), num_elements*number_of_permutations) && ...
            all(all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), comparison_all_differences))), ...        
            [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonMultiplexMRI does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(comparison_all_differences) && ...
            isequal(numel(comparison_all_differences), num_elements*number_of_permutations) && ...
            all(all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), comparison_all_differences))), ...        
            [BRAPH2.STR ':ComparisonMultiplexMRI:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonMultiplexMRI does not initialize correctly with binodal measures')
