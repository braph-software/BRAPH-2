...
subject_class = Comparison.getSubjectClass('ComparisonST_WU');
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonST_WU('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonST_WU.PermutationNumber', number_of_permutations);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            'ComparisonST_WU does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonST_WU:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_WU does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonST_WU:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_WU does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonST_WU:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonST_WU does not initialize correctly with global measures')
