    ...
    methods (Access = protected)
        ...
        function comparison = calculate_comparison(analysis, measure_code, group_1, group_2, varargin)
            ...
            comparison = Comparison.getComparison('AnalysisST_BUT', ...
                ...
                group_1, ...
                group_2, ...
                'AnalysisST_WU.PermutationNumber', M, ...
                'AnalysisST_WU.value_1', value_1, ...
                'AnalysisST_WU.value_2', value_2, ...
                'AnalysisST_WU.difference', difference_mean, ...
                'AnalysisST_WU.all_differences', difference_all_permutations, ...
                'AnalysisST_WU.p1', p1, ...
                'AnalysisST_WU.p2', p2, ...
                'AnalysisST_WU.confidence_min', ci_lower, ...
                'AnalysisST_WU.confidence_max', ci_upper ...
                );
        end
    end
