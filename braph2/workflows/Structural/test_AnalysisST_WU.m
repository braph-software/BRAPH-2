...
cohort = Cohort('Cohort MRI WU', 'cohort label', 'cohort notes', 'SubjectMRI', atlas, {sub11, sub12, sub13, sub14, sub21, sub22, sub23});
...
analysis = AnalysisMRI_WU('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}); %#ok<NASGU>

%% Test 2: Create correct ID
analysis = AnalysisMRI_WU('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {});
...
assert(ischar(measurement_id), ...
    [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisMRI_WU.getMeasurementID() not creating an ID')
assert(isequal(measurement_id, expected_value), ...
    [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisMRI_WU.getMeasurementID() not creating correct ID')
...
assert(ischar(randomcomparison_id), ...
    [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisMRI_WU.getRandomComparisonID() not creating an ID')
assert(isequal(randomcomparison_id, expected_value), ...
    [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisMRI_WU.getRandomComparisonID() not creating correct ID')
...
assert(ischar(comparison_id), ...
    [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisMRI_WU.getComparisonID() not creating an ID')
assert(isequal(comparison_id, expected_value), ...
    [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisMRI_WU.getComparisonID() not creating correct ID')
...
for i = 1:1:length(measures)
    ...
    assert(~isempty(calculated_measurement), ...
        [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.BUG_FUNC], ...
        'AnalysisMRI_WU.getMeasurement() not working')
    ...
    for j = 1:1:numel(measurement_keys)
        ...
        if Measure.is_global(measure)
            ...
            assert(isequal(calculated_measurement.getMeasureCode(), measure), ...
                [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.BUG_FUNC], ...
                'AnalysisMRI_WU.calculateMeasurement() not working for global')
            assert(iscell(calculated_value) && ...
                isequal(numel(calculated_value), 1) && ...
                all(cellfun(@(x) isequal(size(x), [1, 1]), calculated_value)), ...
                [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.BUG_FUNC], ...
                'AnalysisMRI_WU does not initialize correctly with global measures')
            
        elseif Measure.is_nodal(measure)
            
            assert(isequal(calculated_measurement.getMeasureCode(), measure), ...
                [BRAPH2.STR ':AnalysisMRI_WU:calculateMeasurement'], ...
                'AnalysisMRI_WU.calculateMeasurement() not working for nodal')
            assert(iscell(calculated_value) && ...
                isequal(numel(calculated_value), 1) && ...
                all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), calculated_value)), ...
                [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.BUG_FUNC], ...
                'AnalysisMRI_WU does not initialize correctly with nodal measures')
        
        elseif Measure.is_binodal(measure)
            
            assert(isequal(calculated_measurement.getMeasureCode(), measure), ...
                [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.BUG_FUNC], ...
                'AnalysisMRI_WU.calculateMeasurement() not working for binodal')
            assert(iscell(calculated_value) && ...
                isequal(numel(calculated_value), 1) && ...
                all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), calculated_value)), ...
                [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.BUG_FUNC], ...
                'AnalysisMRI_WU does not initialize correctly with binodal measures')
        end
    end
end
...
for i = 1:1:numel(measures)
    ...
    assert(~isempty(calculated_comparison), ...
        [BRAPH2.STR ':AnalysisMRI_WU:calculateComparison'], ...
        ['AnalysisMRI_WU.calculateComparison() not working']) %#ok<*NBRAK>
    
    assert(analysis.getRandomComparisons().length() == 1, ...
        [BRAPH2.STR ':AnalysisMRI_WU:calculateComparison'], ...
        ['AnalysisMRI_WU.calculateComparison() not working'])
    ...
    if Measure.is_global(measures{i})
        assert(iscell(randomcomparison_value_group) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI_WU.getRandomComparison() not working with global measures') 
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(randomcomparison_value_group) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI_WU.getRandomComparison() not working with nodal measures') 
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(randomcomparison_value_group) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI_WU.getRandomComparison() not working with binodal measures') 
...
for i = 1:1:numel(measures)
    ...
    assert(~isempty(calculated_comparison), ...
        [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.BUG_FUNC], ...
        'AnalysisMRI_WU.getComparison() not working')
    ...
    if Measure.is_global(measures{i})
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI_WU.getComparison() not working with global measures') 
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI_WU.getComparison() not working with nodal measures') 
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI_WU.getComparison() not working with binodal measures') 
