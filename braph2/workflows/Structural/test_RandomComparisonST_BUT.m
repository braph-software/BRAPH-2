...
subject_class = RandomComparison.getSubjectClass('RandomComparisonST_BUT');
...
for i = 1:1:numel(measures)
    randomcomparison = RandomComparisonST_BUT('rc1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonST_BUT('rc1', 'label', 'notes', atlas, measures{i}, group, 'RandomComparisonST_WU.RandomizationNumber', number_of_randomizations);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_group) && ...
            ...
            'RandomComparisonST_BUT does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonST_BUT:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonST_BUT does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonST_BUT:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonST_BUT does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    randomcomparison = RandomComparisonST_BUT('rc1', ...
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':RandomComparisonST_BUT:' BRAPH2.WRONG_OUTPUT], ...
            'RandomComparisonST_BUT does not initialize correctly with global measures')
