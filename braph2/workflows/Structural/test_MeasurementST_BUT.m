...
subject_class = Measurement.getSubjectClass('MeasurementST_BUT');
...
for i = 1:1:numel(measures)
    measurement = MeasurementST_BUT('m1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value) & ...
            ...
            [BRAPH2.STR ':MeasurementST_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementST_BUT does not initialize correctly with global measures.')
