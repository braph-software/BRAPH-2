...
subject_class = Comparison.getSubjectClass('ComparisonST_BUD');
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonST_BUD('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonST.PermutationNumber', number_of_permutations, 'ComparisonST.ParameterValues', parameter_values);
    ...
    [BRAPH2.STR ':ComparisonST_BUD:' BRAPH2.BUG_FUNC], ...
    'ComparisonST_BUD does not initialize correctly the parameter of the measures')
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonST_BUD:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_BUD does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value_1)), ...
            [BRAPH2.STR ':ComparisonST_BUD:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_BUD does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value_1)), ...
            [BRAPH2.STR ':ComparisonST_BUD:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_BUD does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    comparison = ComparisonST_BUD('c1', ...
        'comparison label', ...
        'comparison notes', ...
        atlas, ...
        measures{i}, ...
        group, ...
        group, ...
        'ComparisonST.PermutationNumber', number_of_permutations, ...
        'ComparisonST.value_1', value_1, ...
        'ComparisonST.value_2', value_2, ...
        'ComparisonST.difference', difference, ...
        'ComparisonST.all_differences', all_differences, ...
        'ComparisonST.p1', p1, ...
        'ComparisonST.p2', p2, ....
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonST_BUD:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonST_BUD does not initialize correctly with global measures')
