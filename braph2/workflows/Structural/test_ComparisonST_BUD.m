...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonST_BUD('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonST.PermutationNumber', number_of_permutations, 'ComparisonST.ParameterValuesLength', parameter_values_length);
