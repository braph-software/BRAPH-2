...
subject_class = Comparison.getSubjectClass('ComparisonST_BUT');
...
for i = 1:1:numel(measures)
    comparison = ComparisonST_BUT('c1', 'label', 'notes', atlas, measures{i}, group, group);
end
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonST_BUT('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonST_WU.PermutationNumber', number_of_permutations);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            'ComparisonST_BUT does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonST_BUT:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_BUT does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonST_BUT:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_BUT does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    comparison = ComparisonST_BUT('c1', ...
        'comparison label', ...
        'comparison notes', ...
        atlas, ...
        measures{i}, ...
        group, ...
        group, ...
        'ComparisonST_WU.PermutationNumber', number_of_permutations, ...
        'ComparisonST_WU.value_1', value_1, ...
        'ComparisonST_WU.value_2', value_2, ...
        'ComparisonST_WU.difference', difference, ...
        'ComparisonST_WU.all_differences', all_differences, ...
        'ComparisonST_WU.p1', p1, ...
        'ComparisonST_WU.p2', p2, ....
        'ComparisonST_WU.confidence_min', confidence_interval_min, ...
        'ComparisonST_WU.confidence_max', confidence_interval_max ...
        );
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonST_BUT:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonST_BUT does not initialize correctly with global measures')
