...
for i = 1:1:numel(measures)
    ...
    calculated_comparison = analysis.getRandomComparison(measure, group1, 'RandomizationNumber', number_of_randomizations, 'RandomComparisonST.ParameterValues', parameter_value_group, 'threshold', .6);
    ...
    [BRAPH2.STR ':AnalysisST_BUT:' BRAPH2.BUG_FUNC], ...
    'AnalysisST_BUT.getRandomComparison() does not initialize correctly the parameter of the measures')
...
for i = 1:1:numel(measures)
    measure = measures{i};
    analysis = AnalysisST_BUT('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}, 'threshold', 0.6);
    ...
    calculated_comparison = analysis.getComparison(measure, group1, group2, 'PermutationNumber', number_of_permutations, 'ComparisonST.ParameterValues', parameter_value_group, 'threshold', 0.6);
    
    assert(~isempty(calculated_comparison), ...
        [BRAPH2.STR ':AnalysisST_BUT:' BRAPH2.BUG_FUNC], ...
        'AnalysisST_BUT.getComparison() not working')
    ...
    [BRAPH2.STR ':AnalysisST_BUT:' BRAPH2.BUG_FUNC], ...
    'AnalysisST_BUT.getComparison() does not initialize correctly the parameter of the measures')
    ...
    if Measure.is_global(measure)
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisST_BUT:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisST_BUT.getComparison() not working with global measures') 
    ...
    elseif Measure.is_nodal(measure)
        assert(iscell(comparison_values_1) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), comparison_values_1)), ...
            [BRAPH2.STR ':AnalysisST_BUT:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisST_BUT.getComparison() not working with nodal measures') 
    ...
    elseif Measure.is_binodal(measure)
        assert(iscell(comparison_values_1) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), comparison_values_1)), ...
            [BRAPH2.STR ':AnalysisST_BUT:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisST_BUT.getComparison() not working with binodal measures') 
