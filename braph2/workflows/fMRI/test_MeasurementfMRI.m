...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values) & ...
            ...
            'MeasurementfMRI does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementfMRI:' BRAPH2.BUG_FUNC], ...
            'MeasurementfMRI does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementfMRI:' BRAPH2.BUG_FUNC], ...
            'MeasurementfMRI does not initialize correctly with binodal measures')
