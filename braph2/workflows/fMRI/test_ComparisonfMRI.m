   ...
   % assert
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            ['ComparisonfMRI does not initialize correctly with global measures.'])
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_2) && ...
            ...
            [BRAPH2.STR ':ComparisonfMRI:' BRAPH2.BUG_FUNC], ...
            ['ComparisonfMRI does not initialize correctly with nodal measures.'])
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_2) && ...
            ...
            [BRAPH2.STR ':ComparisonfMRI:' BRAPH2.BUG_FUNC], ...
            ['ComparisonfMRI does not initialize correctly with binodal measures.'])
...
for i = 1:1:numel(measures)
    ...
    for j = 1:1:group.subjectnumber()
        ...
        m_1  = Measure.getMeasure(measures{i}, g);        
        value_1{j} = cell2mat(m_1.getValue()); %#ok<*SAGROW>
        value_2{j} = cell2mat(m_1.getValue());
    end
