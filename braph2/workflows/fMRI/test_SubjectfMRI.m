...
load_cohort = SubjectfMRI.load_from_txt(sub_class, atlas, 'Directory', [save_dir_path filesep() group.getID()]);
...
load_cohort = SubjectfMRI.load_from_json(sub_class, atlas, 'Directory', [save_dir_path filesep() group.getID()]);
