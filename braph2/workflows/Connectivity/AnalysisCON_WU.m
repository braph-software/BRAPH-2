        ...
        function analysis = load_from_json(tmp, varargin)
            ...
            for i = 1:1:length(raw.Measurements)
                ...
                measurement = Measurement.getMeasurement(analysis.getMeasurementClass(), ...
                    ...
                    group,  ...
                    'MeasurementCON.values', num2cell(raw.Measurements(i).value), ...
            ...
            for i = 1:1:length(raw.Comparisons)                
                comparison = Comparison.getComparison(analysis.getComparisonClass(), ...
                    ...
                    'ComparisonCON.values_1', raw.Comparisons(i).value1, ...
                    'ComparisonCON.average_values_1', raw.Comparisons(i).avgvalue1, ...
                    'ComparisonCON.values_2', raw.Comparisons(i).value2, ...
                    'ComparisonCON.average_values_2', raw.Comparisons(i).avgvalue2, ...
                    'ComparisonCON.difference', {raw.Comparisons(i).difference}, ...
                    'ComparisonCON.all_differences', raw.Comparisons(i).alldifferences, ...
            ...
            for i = 1:1:length(raw.RandomComparisons)
                random_comparison = RandomComparison.getRandomComparison(analysis.getRandomComparisonClass(), ...
                    ...
                    raw.RandomComparisons(i).lab, ...  % comparison label
                    ...
                    'RandomComparisonCON.value_group', raw.RandomComparisons(i).value, ...
                    'RandomComparisonCON.value_random', raw.RandomComparisons(i).ranvalue, ...
                    'RandomComparisonCON.average_value_group', raw.RandomComparisons(i).avgvalue, ...
                    'RandomComparisonCON.average_value_random', raw.RandomComparisons(i).ranavgvalue, ...
                    'RandomComparisonCON.difference', {raw.RandomComparisons(i).difference}, ...
                    'RandomComparisonCON.all_differences', raw.RandomComparisons(i).alldifferences, ...
