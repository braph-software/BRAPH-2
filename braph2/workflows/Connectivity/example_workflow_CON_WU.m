...
if filterindex
    ...
    atlas_file = [fileparts(which('example_workflow_CON_WU.m')) filesep() 'example data ST (MRI)' filesep() 'desikan_atlas.xlsx'];
end
...
% else
%     group1_file = [fileparts(which('example_workflow_CON_WU.m')) filesep() 'example data CON (DTI)' filesep() 'xls' filesep() 'CON_group1.xlsx'];
% end
% clear file path filterindex;
% 
% cohort = SubjectCON.load_from_xls(atlas, 'File', group1_file);
% 
...
% else    
%     group2_file = [fileparts(which('example_workflow_CON_WU.m')) filesep() 'example data CON (DTI)' filesep() 'xls' filesep() 'CON_group2.xlsx'];
% end
% clear file path filterindex;
% 
% cohort = SubjectCON.load_from_xls(cohort', 'File', group2_file);
% 
