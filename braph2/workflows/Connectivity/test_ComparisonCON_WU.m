...
subject_class = Comparison.getSubjectClass('ComparisonCON_WU');
...
for i = 1:1:numel(measures)
    comparison = ComparisonCON_WU('c1', 'label', 'notes', atlas, measures{i}, group, group);
end
...
%     
%     comparison = ComparisonCON_WU('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonCON.PermutationNumber', number_of_permutations);
%     
...
%             [BRAPH2.STR ':ComparisonCON_WU:' BRAPH2.BUG_FUNC], ...
%             'ComparisonCON_WU does not initialize correctly with global measures')
%                 
...
%             [BRAPH2.STR ':ComparisonCON_WU:' BRAPH2.BUG_FUNC], ...
%             'ComparisonCON_WU does not initialize correctly with nodal measures')
%         
%         assert(iscell(values_2) && ...
%             isequal(numel(values_2), group.subjectnumber()) && ...
...
%             [BRAPH2.STR ':ComparisonCON_WU:' BRAPH2.BUG_FUNC], ...
%             'ComparisonCON_WU does not initialize correctly with binodal measures')
%         
%         assert(iscell(values_2) && ...
%             isequal(numel(values_2), group.subjectnumber()) && ...
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonCON_WU:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonCON_WU does not initialize correctly with global measures')
