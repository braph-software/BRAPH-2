...
subject_class = Comparison.getSubjectClass('ComparisonCON_BUD');
...
graph_type = AnalysisCON_BUD.getGraphType();
measures = Graph.getCompatibleMeasureList(graph_type);

%% Test 1: Instantiation
for i = 1:1:numel(measures)
    comparison = ComparisonCON_BUD('c1', 'label', 'notes', atlas, measures{i}, group, group);
end
...
%     
%     comparison = ComparisonCON_BUD('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonCON.PermutationNumber', number_of_permutations);
%     
%     values = comparison.getComparisonProperties('ComparisonCON.values_1');    
%     values_2 = comparison.getComparisonProperties('ComparisonCON.values_2');
%     average_values_1 = comparison.getComparisonProperties('ComparisonCON.average_values_1');
%     average_values_2 = comparison.getComparisonProperties('ComparisonCON.average_values_2');
%     difference = comparison.getComparisonProperties('ComparisonCON.difference');  % difference
%     all_differences = comparison.getComparisonProperties('ComparisonCON.all_differences'); % all differences obtained through the permutation test
%     p1 = comparison.getComparisonProperties('ComparisonCON.p1'); % p value single tailed
%     p2 = comparison.getComparisonProperties('ComparisonCON.p2');  % p value double tailed
%     confidence_interval_min = comparison.getComparisonProperties('ComparisonCON.confidence_min');  % min value of the 95% confidence interval
%     confidence_interval_max = comparison.getComparisonProperties('ComparisonCON.confidence_max'); % max value of the 95% confidence interval
%     
...
%             [BRAPH2.STR ':ComparisonCON_BUD:' BRAPH2.BUG_FUNC], ...
%             'ComparisonCON_BUD does not initialize correctly with global measures')
%                 
...
%             [BRAPH2.STR ':ComparisonCON_BUD:' BRAPH2.BUG_FUNC], ...
%             'ComparisonCON_BUD does not initialize correctly with nodal measures')
%         
%         assert(iscell(values_2) && ...
%             isequal(numel(values_2), group.subjectnumber()) && ...
...
%             [BRAPH2.STR ':ComparisonCON_BUD:' BRAPH2.BUG_FUNC], ...
%             'ComparisonCON_BUD does not initialize correctly with binodal measures')
%         
%         assert(iscell(values_2) && ...
%             isequal(numel(values_2), group.subjectnumber()) && ...
...
for i = 1:1:numel(measures)
    ...
    data_dict([calling_class '.confidence_max']) = average_values;
        ...
        % act
    comparison = ComparisonCON_BUD('c1', ...
        'comparison label', ...
        'comparison notes', ...
        atlas, ...
        measures{i}, ...
     ...
     comparison_difference = comparison.getComparisonProperties('ComparisonCON.difference');  % difference
     comparison_all_differences = comparison.getComparisonProperties('ComparisonCON.all_differences'); % all differences obtained through the permutation test
     comparison_p1 = comparison.getComparisonProperties('ComparisonCON.p1'); % p value single tailed
     comparison_p2 = comparison.getComparisonProperties('ComparisonCON.p2');  % p value double tailed
     comparison_confidence_interval_min = comparison.getComparisonProperties('ComparisonCON.confidence_min');  % min value of the 95% confidence interval
     comparison_confidence_interval_max = comparison.getComparisonProperties('ComparisonCON.confidence_max'); % max value of the 95% confidence interval
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonCON_BUD:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonCON_BUD does not initialize correctly with global measures')
