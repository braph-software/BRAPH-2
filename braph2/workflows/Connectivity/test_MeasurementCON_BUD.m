...
subject_class = Measurement.getSubjectClass('MeasurementCON_BUD');
...
for i = 1:1:numel(measures)
    measurement = MeasurementCON_BUD('m1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementCON_BUD:' BRAPH2.BUG_FUNC], ...
            'MeasurementCON_BUD does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementCON_BUD:' BRAPH2.BUG_FUNC], ...
            'MeasurementCON_BUD does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementCON_BUD:' BRAPH2.BUG_FUNC], ...
            'MeasurementCON_BUD does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    measurement = MeasurementCON_BUD('m1', 'label', 'notes', atlas, measures{i}, group, ...
        'MeasurementCON_BUD.values', values, ...
        'MeasurementCON_BUD.average_value', average_value ...
        );
