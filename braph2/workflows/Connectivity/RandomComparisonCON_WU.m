classdef RandomComparisonCON_WU < RandomComparison
    % RandomComparisonCON_WU A random comparison of connectivity data with weighted undirected graphs
    % RandomComparisonCON_WU is a subclass of Comparison, it implements the
    % initialization of data methods.
    %
    % RandomComparisonCON_WU implements the initialization of the data which the
    % class will save. It checks if the data being saved has correct
    % dimensions. Structural data can be for example DTI data.
    %
    % RandomComparisonCON_WU constructor methods:
    %  RandomComparisonCON_WU              - Constructor
    %
    % RandomComparisonCON_WU basic methods:
    %  disp                         - displays the comparison
    %
    % RandomComparisonCON_WU get methods:
    ...
    %
    % RandomComparisonCON_WU initialze data (Access=protected):
    %  initialize_data              - initializes and checks the data
    %
    % RandomComparisonCON_WU descriptive methods (Static):
    ...
    %
    % RandomComparisonCON_WU plot methods (Static):
    %  getRandomComparisonSettingsPanel - returns a UIPanel
    %
    % See also Comparison, AnalysisCON_WU, MeasurementCON_WU, ComparisonCON_WU.
    ...
    methods  % Constructor
        function rc =  RandomComparisonCON_WU(id, label, notes, atlas, measure_code, group, varargin)
            % RANDOMCOMPARISONCON_WU(ID, LABEL, NOTES, ATLAS, MEASURE_CODE, GROUP)
            % creates a comparison with ID, LABEL, ATLAS, MEASURE_CODE,
            % with the data from GROUP_1 and a random group. It initializes the
            % RANDOMCOMPARISONCON_WU with default settings.
            %
            % RANDOMCOMPARISONCON_WU(ID, LABEL, NOTES, ATLAS, MEASURE_CODE, GROUP, PROPERTY, VALUE, ...) 
            % creates a comparison with ID, LABEL, ATLAS, MEASURE_CODE,
            % with the data from GROUP_1 and a random group. It initializes the
            % RANDOMCOMPARISONCON_WU with VALUE settings.
            %
            % See also MeasurementCON_WU, ComparisonCON_WU, AnalysisCON_WU.
            ...
            assert(ismember(measure_code, measure_list), ...
                [BRAPH2.STR ':RandomComparisonCON_WU:' BRAPH2.BUG_FUNC], ...
                'RandomComparisonCON_WU measure_code is not compatible with the permited Measures.');
    ...
    methods  % Basic function
        function disp(rc)
            ...
            % information about the difference of the RandomComparisonCON_WU.
            % 
            % See also Comparison
    ...
    methods (Access=protected)  % Initialize data
        function initialize_data(rc, varargin)
            ...
            %  'RandomComparisonCON.RandomizationNumber'  - number of randomizations
            %  'RandomComparisonCON.value_group'     - value of the group
            %  'RandomComparisonCON.value_random'    - value of random group
            %  'RandomComparisonCON.average_value_group'  - average of group values
            %  'RandomComparisonCON.average_value_random' - average of random values
            %  'RandomComparisonCON.difference'      - value of difference
            %  'RandomComparisonCON.all_differences' - value of all differences
            %  'RandomComparisonCON.p1'              - single tail p-value
            %  'RandomComparisonCON.p2'              - double tail p-value
            %  'RandomComparisonCON.confidence_min'  - min value in confidence interval
            %  'RandomComparisonCON.confidence_max'  - max value in confidence interval
            %
            ...
            number_of_randomizations = rc.getSettings('RandomComparisonCON.RandomizationNumber');
            
            if Measure.is_global(measure_code)  % global measure
                rc.value_group = get_from_varargin( ...
                    repmat({0}, 1, group.subjectnumber()), ...
                    'RandomComparisonCON.value_group', ...
                    varargin{:});
                ...
                rc.value_random = get_from_varargin( ...
                    repmat({0}, 1, group.subjectnumber()), ...
                    'RandomComparisonCON.value_random', ...
                    varargin{:});
                ...
                rc.average_value_group = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonCON.average_value_group', ...
                    varargin{:});                
                ...
                rc.average_value_random = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonCON.average_value_random', ...
                    varargin{:});                
                ...
                rc.difference = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonCON.difference', ...
                    varargin{:});
                ...
                rc.all_differences = get_from_varargin( ...
                    ...
                    'RandomComparisonCON.all_differences', ...
                    varargin{:});
                ...
                rc.confidence_interval_min = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonCON.confidence_min', ...
                    varargin{:});
                ...
                rc.confidence_interval_max = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonCON.confidence_max', ...
                    varargin{:});
    ...
    methods (Static)  % Descriptive functions
        function measurement_class = getClass() %#ok<*INUSD>
            % GETCLASS returns the class of connectivity random comparison
            %
            % ANALYSIS_CLASS = GETCLASS(ANALYSIS) returns the class of 
            % random comparison. In this case 'RandomComparisonCON_WU'.
            %
            % See also getList, getName, getDescription.
            
            measurement_class = 'RandomComparisonCON_WU';
        end
        function name = getName()
            % GETNAME returns the name of connectivity random comparison
            %
            % NAME = GETNAME() returns the name, RandomComparison CON WU.
            %
            % See also getList, getClass, getDescription.
            
            name = 'RandomComparison CON WU';
        end
        function description = getDescription()
            % GETDESCRIPTION returns the description of connectivity random comparison 
            %
            % DESCRIPTION = GETDESCRIPTION() returns the description
            % of RandomComparisonCON_WU.
            %
            % See also getList, getClass, getName.
            
            % comparison description missing
            description = 'CON random comparison with weighted graphs.';
        end
        ...
        function analysis_class = getAnalysisClass()
            ...
            % analysis the random comparison is part of, 'RandomComparisonCON_WU'.
            %
            % See also getList, getClass, getName.
        ...
        function subject_class = getSubjectClass()
            % GETSUBJETCLASS returns the class of connectivity random comparison subject
            %
            % SUBJECT_CLASS = GETSUBJECT_CLASS() returns the class
            % of RandomComparisonCON_WU subject, 'SubjectCON'.
            %
        ...
        function available_settings = getAvailableSettings()
            % GETAVAILABLESETTINGS returns the available settings of connectivity random comparison
            %
            % AVAILABLE_SETTINGS = GETAVAILABLESETTINGS() returns the 
            % available settings of RandomComparisonCON_WU.
            %
            % See also getClass, getName, getDescription
            
            available_settings = {
                'RandomComparisonCON.RandomizationNumber', BRAPH2.NUMERIC, 1000, {}; ...
                'RandomComparisonCON.AttemptsPerEdge', BRAPH2.NUMERIC, 5, {}; ...
                'RandomComparisonCON.NumberOfWeights', BRAPH2.NUMERIC, 1, {}; ...
                };
        end
        function sub = getRandomComparison(random_comparison_class, id, label, notes, atlas, measure_code, group, varargin)
            ...
            % returns a new RandomComparisonCON_WU object with RANDOMCOMPARISON_CLASS,
