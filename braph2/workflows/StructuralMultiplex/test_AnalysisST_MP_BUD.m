...
for i = 1:1:numel(measures)
    measure = measures{i};
    analysis = AnalysisST_MP_BUD('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}, 'density', 0.6);
    ...
    calculated_comparison = analysis.getComparison(measure, group1, group2, 'PermutationNumber', number_of_permutations, 'ComparisonST_MP.ParameterValues', parameter_value_group, 'density', 0.6);
