...
subject_class = Measurement.getSubjectClass('MeasurementST_MP_BUT');
...
for i = 1:1:numel(measures)
    measurement = MeasurementST_MP_BUT('m1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value) & ...
            ...
            [BRAPH2.STR ':MeasurementST_MP_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementST_MP_BUT does not initialize correctly with global measures.')
    elseif Measure.is_nodal(measures{i})
        assert(iscell(value) & ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value)), ...
            [BRAPH2.STR ':MeasurementST_MP_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementST_MP_BUT does not initialize correctly with nodal measures')
    elseif Measure.is_binodal(measures{i})
        assert(iscell(value) & ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value)), ...
            [BRAPH2.STR ':MeasurementST_MP_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementST_MP_BUT does not initialize correctly with binodal measures')
    end
end
