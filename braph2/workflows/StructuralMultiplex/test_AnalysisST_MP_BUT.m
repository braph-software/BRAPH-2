...
cohort = Cohort('Cohort ST MP BUT', 'cohort label', 'cohort notes', 'SubjectST_MP', atlas, {sub1, sub2, sub3, sub4, sub5, sub6});
...
analysis = AnalysisST_MP_BUT('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}, 'threshold', 0.7); %#ok<NASGU>

%% Test 2: Create correct ID
analysis = AnalysisST_MP_BUT('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}, 'threshold', 0.7);

measurement_id = analysis.getMeasurementID('Degree', group1, 'threshold', 0.7);
expected_value = [ ...
    tostring(analysis.getMeasurementClass()) ' ' ...
    tostring('Degree') ' ' ...
    tostring(analysis.getCohort().getGroups().getIndex(group1)) ' ' ...
    ['threshold=' num2str(0.7)], ...
    ];
...
randomcomparison_id = analysis.getRandomComparisonID('Degree', group1, 'threshold', 0.7);
expected_value = [ ...
...
comparison_id = analysis.getComparisonID('Distance', group1, group2, 'threshold', 0.7);
expected_value = [ ...
...
for i = 1:1:length(measures)
    measure = measures{i};
    analysis = AnalysisST_MP_BUT('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}, 'threshold', .6);
...
for i = 1:1:numel(measures)
    ...
    measurement_group = analysis.getMeasurement(measure, group1, 'threshold', .6);
    ...
    calculated_comparison = analysis.getRandomComparison(measure, group1, 'RandomizationNumber', number_of_randomizations, 'RandomComparisonST_MP.ParameterValues', parameter_value_group, 'threshold', .6);
