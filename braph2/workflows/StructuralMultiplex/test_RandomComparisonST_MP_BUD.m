% test RandomComparisonST_MP_BUD
...
subject_class = RandomComparison.getSubjectClass('RandomComparisonST_MP_BUD');
...
for i = 1:1:numel(measures)
    randomcomparison = RandomComparisonST_MP_BUD('rc1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonST_MP_BUD('rc1', 'label', 'notes', atlas, measures{i}, group, 'RandomComparisonST_MP.RandomizationNumber', number_of_randomizations, 'RandomComparisonST_MP.ParameterValues', parameter_values);
    ...
    [BRAPH2.STR ':RandomComparisonST_MP_BUD:' BRAPH2.BUG_FUNC], ...
    'RandomComparisonST_MP_BUD does not initialize correctly the parameter of the measures')
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_group) && ...
            isequal(numel(value_group), num_elements) && ...
            ...
            [BRAPH2.STR ':RandomComparisonST_MP_BUD:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonST_MP_BUD does not initialize correctly with global measures')
        
        assert(iscell(value_random) && ...
            isequal(numel(value_random), num_elements) && ...
        ...
        assert(iscell(all_differences) && ...
            isequal(numel(all_differences), num_elements*number_of_randomizations) && ...
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value_group)), ...
            [BRAPH2.STR ':RandomComparisonST_MP_BUD:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonST_MP_BUD does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value_group)), ...
            [BRAPH2.STR ':RandomComparisonST_MP_BUD:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonST_MP_BUD does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    randomcomparison = RandomComparisonST_MP_BUD('rc1', ...
        'random comparison label', ...
        'random comparison notes', ...
        atlas, ...
        measures{i}, ...
        group, ...
        'RandomComparisonST_MP.RandomizationNumber', number_of_randomizations, ...
        ...
        'RandomComparisonST_MP.confidence_min', confidence_interval_min, ...
        'RandomComparisonST_MP.confidence_max', confidence_interval_max , ...
        'RandomComparisonST_MP.ParameterValues', parameter_values ...
        );
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_value_group) && ...
            isequal(numel(comparison_value_group), num_elements) && ...
        ...
        assert(iscell(comparison_value_random) && ...
            isequal(numel(comparison_value_random), num_elements) && ...
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':RandomComparisonST_MP_BUD:' BRAPH2.WRONG_OUTPUT], ...
            'RandomComparisonST_MP_BUD does not initialize correctly with global measures')
        
        assert(iscell(comparison_all_differences) && ...
            isequal(numel(comparison_all_differences), num_elements*number_of_randomizations) && ...
