        ...
        function initialize_data(c, varargin)
            ...
            if Measure.is_global(measure_code)  % global measure
                ...
                assert(iscell(c.getAllDifferences()) && ...
                    ...
                    all(all(cellfun(@(x) isequal(size(x, 2), 1), c.getAllDifferences()))) && ...
                    all(all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), c.getAllDifferences()))), ...
                    [BRAPH2.STR ':' class(c) ':' BRAPH2. WRONG_INPUT], ...
                    ['Data not compatible with: ' class(c)])
            ...
            elseif Measure.is_nodal(measure_code)  % nodal measure
                ...
                assert(iscell(c.getAllDifferences()) && ...
                    isequal(size(c.getAllDifferences()), [rows*columns, number_of_permutations]) && ...
                    all(all(cellfun(@(x) isequal(size(x, 1), atlas.getBrainRegions().length()), c.getAllDifferences()))) && ...
                    all(all(cellfun(@(x) isequal(size(x, 2), 1), c.getAllDifferences()))) && ...
                    all(all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), c.getAllDifferences()))), ...
                    [BRAPH2.STR ':' class(c) ':' BRAPH2. WRONG_INPUT], ...
                    ['Data not compatible with: ' class(c)])
            ...
            elseif Measure.is_binodal(measure_code)  % binodal measure
                ...
                assert(iscell(c.getAllDifferences()) && ...
                    isequal(size(c.getAllDifferences()), [rows*columns, number_of_permutations]) && ...
                    all(all(cellfun(@(x) isequal(size(x, 1), atlas.getBrainRegions().length()), c.getAllDifferences()))) && ...
                    all(all(cellfun(@(x) isequal(size(x, 2), atlas.getBrainRegions().length()), c.getAllDifferences()))) && ...
                    all(all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), c.getAllDifferences()))), ...
                    [BRAPH2.STR ':' class(c) ':' BRAPH2. WRONG_INPUT], ...
                    ['Data not compatible with: ' class(c)])
