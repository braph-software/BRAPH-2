...
subject_class = Comparison.getSubjectClass('ComparisonST_MP_WU');
...
for i = 1:1:numel(measures)
    comparison = ComparisonST_MP_WU('c1', 'label', 'notes', atlas, measures{i}, group, group);
end
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonST_MP_WU('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonST_MP.PermutationNumber', number_of_permutations, 'ComparisonST_MP.ParameterValuesLength', parameter_values_length);
    ...
    [BRAPH2.STR ':ComparisonST_MP_WU:' BRAPH2.BUG_FUNC], ...
    'ComparisonST_MP_WU does not initialize correctly the parameter of the measures')
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonST_MP_WU:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_MP_WU does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value_1)), ...
            [BRAPH2.STR ':ComparisonST_MP_WU:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_MP_WU does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value_1)), ...
            [BRAPH2.STR ':ComparisonST_MP_WU:' BRAPH2.BUG_FUNC], ...
            'ComparisonST_MP_WU does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    comparison = ComparisonST_MP_WU('c1', ...
        'comparison label', ...
        'comparison notes', ...
        atlas, ...
        measures{i}, ...
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonST_MP_WU:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonST_MP_WU does not initialize correctly with global measures')
