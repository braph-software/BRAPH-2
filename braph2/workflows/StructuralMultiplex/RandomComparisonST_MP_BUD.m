classdef RandomComparisonST_MP_BUD < RandomComparisonST_MP_WU
    ...
    % generated group. The data from the groups it compares have a fixed
    % density. Structural data can be for example MRI or/and PET data.
    %
    ...
    methods (Access = protected) % Set functions
        function setDensity(rc, density)
            ...
            %
            % SETDENSITY(RC, DENSITY) sets the fixed density of
            % the data values.
            %
            % See also getDensity.
