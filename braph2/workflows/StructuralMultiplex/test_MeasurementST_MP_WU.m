...
subject_class = Measurement.getSubjectClass('MeasurementST_MP_WU');
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value) & ...
            ...
            'MeasurementST_MP_WU does not initialize correctly with global measures.')
    elseif Measure.is_nodal(measures{i})
        assert(iscell(value) & ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value)), ...
            [BRAPH2.STR ':MeasurementST_MP_WU:' BRAPH2.BUG_FUNC], ...
            'MeasurementST_MP_WU does not initialize correctly with nodal measures')
    elseif Measure.is_binodal(measures{i})
        assert(iscell(value) & ...
            ...
            all(cellfun(@(x) isequal(size(x, 3), parameter_values_length), value)), ...
            [BRAPH2.STR ':MeasurementST_MP_WU:' BRAPH2.BUG_FUNC], ...
            'MeasurementST_MP_WU does not initialize correctly with binodal measures')
    end
end
