...
subject_class = Measurement.getSubjectClass('MeasurementFNC_WU');
...
for i = 1:1:numel(measures)
    measurement = MeasurementFNC_WU('m1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values) & ...
            ...
            'MeasurementFNC_WU does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementFNC_WU:' BRAPH2.BUG_FUNC], ...
            'MeasurementFNC_WU does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementFNC_WU:' BRAPH2.BUG_FUNC], ...
            'MeasurementFNC_WU does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    measurement = MeasurementFNC_WU('m1', 'label', 'notes', atlas, measures{i}, group, ...
        'MeasurementFNC_WU.values', values, ...
        'MeasurementFNC_WU.average_value', average_value ...
        );
