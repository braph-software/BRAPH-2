...
subject_class = Comparison.getSubjectClass('ComparisonFNC_BUD');
...
for i = 1:1:numel(measures)
    comparison = ComparisonFNC_BUD('c1', 'label', 'notes', atlas, measures{i}, group, group);
end
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonFNC_BUD('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonFNC.PermutationNumber', number_of_permutations);
   ...
   % assert
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonFNC_BUD:' BRAPH2.BUG_FUNC], ...
            ['ComparisonFNC_BUD does not initialize correctly with global measures.'])
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_2) && ...
            ...
            [BRAPH2.STR ':ComparisonFNC_BUD:' BRAPH2.BUG_FUNC], ...
            ['ComparisonFNC_BUD does not initialize correctly with nodal measures.'])
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonFNC_BUD:' BRAPH2.BUG_FUNC], ...
            ['ComparisonFNC_BUD does not initialize correctly with global measures.']) %#ok<*NBRAK>
        
        assert(iscell(value_2) && ...
            isequal(numel(value_2), group.subjectnumber()) && ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), value_2)), ...
            [BRAPH2.STR ':ComparisonFNC_BUD:' BRAPH2.BUG_FUNC], ...
            ['ComparisonFNC_BUD does not initialize correctly with binodal measures.'])
...
for i = 1:1:numel(measures)
    ...
    % act
    comparison = ComparisonFNC_BUD('c1', ...
        'comparison label', ...
        'comparison notes', ...
        atlas, ...
        measures{i}, ...
