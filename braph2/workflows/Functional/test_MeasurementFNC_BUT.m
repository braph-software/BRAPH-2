...
subject_class = Measurement.getSubjectClass('MeasurementFNC_BUT');
...
for i = 1:1:numel(measures)
    measurement = MeasurementFNC_BUT('m1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementFNC_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementFNC_BUT does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementFNC_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementFNC_BUT does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementFNC_BUT:' BRAPH2.BUG_FUNC], ...
            'MeasurementFNC_BUT does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    measurement = MeasurementFNC_BUT('m1', 'label', 'notes', atlas, measures{i}, group, ...
        'MeasurementFNC_BUT.values', values, ...
        'MeasurementFNC_BUT.average_value', average_value ...
        );
