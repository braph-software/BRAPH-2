...
subject_class = RandomComparison.getSubjectClass('RandomComparisonFNC_WU');
...
for i = 1:1:numel(measures)
    randomcomparison = RandomComparisonFNC_WU('rc1', 'label', 'notes', atlas,  measures{i}, group);    
end
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonFNC_WU('rc1', 'label', 'notes', atlas,  measures{i}, group, 'RandomComparisonFNC.RandomizationNumber', number_of_randomizations);
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            'RandomComparisonFNC_WU does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonFNC_WU:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonFNC_WU does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonFNC_WU:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonFNC_WU does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    confidence_interval_max = difference;
        ...
        % act
    random_comparison = RandomComparisonFNC_WU('rc1', ...
        'rcomparison label', ...
        'rcomparison notes', ...
        atlas, ...
        measures{i}, ...
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(randomcomparison_difference) && ...
            ...
            [BRAPH2.STR ':RandomComparisonFNC_WU:' BRAPH2.WRONG_OUTPUT], ...
            'RandomComparisonFNC_WU does not initialize correctly with global measures')
