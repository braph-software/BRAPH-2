...
subject_class = RandomComparison.getSubjectClass('RandomComparisonFNC_BUT');
...
for i = 1:1:numel(measures)
    randomcomparison = RandomComparisonFNC_BUT('rc1', 'label', 'notes', atlas,  measures{i}, group);    
end
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonFNC_BUT('rc1', 'label', 'notes', atlas,  measures{i}, group, 'RandomComparisonFNC.RandomizationNumber', number_of_randomizations);
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonFNC_BUT:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonFNC_BUT does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonFNC_BUT:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonFNC_BUT does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonFNC_BUT:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonFNC_BUT does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    confidence_interval_max = difference;
        ...
        % act
    random_comparison = RandomComparisonFNC_BUT('rc1', ...
        'rcomparison label', ...
        'rcomparison notes', ...
        atlas, ...
        measures{i}, ...
        group, ...
        group, ...
        'RandomComparisonFNC.RandomizationNumber', number_of_randomizations, ...
        'RandomComparisonFNC.value_group', values, ...
        'RandomComparisonFNC.value_random', values, ...
        'RandomComparisonFNC.average_value_group', average_values, ...
        'RandomComparisonFNC.average_value_random', average_values, ...
        ...
        'RandomComparisonFNC.confidence_min', confidence_interval_min, ...
        'RandomComparisonFNC.confidence_max', confidence_interval_max ...
        );
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(randomcomparison_difference) && ...
            ...
            [BRAPH2.STR ':RandomComparisonFNC_BUT:' BRAPH2.WRONG_OUTPUT], ...
            'RandomComparisonFNC_BUT does not initialize correctly with global measures')
