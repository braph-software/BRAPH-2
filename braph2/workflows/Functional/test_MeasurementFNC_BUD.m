...
subject_class = Measurement.getSubjectClass('MeasurementFNC_BUD');
...
for i = 1:1:numel(measures)
    measurement = MeasurementFNC_BUD('m1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementFNC_BUD:' BRAPH2.BUG_FUNC], ...
            'MeasurementFNC_BUD does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementFNC_BUD:' BRAPH2.BUG_FUNC], ...
            'MeasurementFNC_BUD does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(values) & ...
            ...
            [BRAPH2.STR ':MeasurementFNC_BUD:' BRAPH2.BUG_FUNC], ...
            'MeasurementFNC_BUD does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    measurement = MeasurementFNC_BUD('m1', 'label', 'notes', atlas, measures{i}, group, ...
        'MeasurementFNC_BUD.values', values, ...
        'MeasurementFNC_BUD.average_value', average_value ...
        );
