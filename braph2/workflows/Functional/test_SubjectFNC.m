...
% act
JSON.Serialize(SubjectFNC.save_to_json(cohort), save_dir_rule, save_dir_path);

load_cohort = SubjectFNC.load_from_json(atlas, sub_class, save_dir_rule, save_dir_path);
