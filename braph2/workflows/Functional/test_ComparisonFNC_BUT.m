...
subject_class = Comparison.getSubjectClass('ComparisonFNC_BUT');
...
for i = 1:1:numel(measures)
    comparison = ComparisonFNC_BUT('c1', 'label', 'notes', atlas, measures{i}, group, group);
end
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonFNC_BUT('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonFNC.PermutationNumber', number_of_permutations);
   ...
   % assert
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonFNC_BUT:' BRAPH2.BUG_FUNC], ...
            ['ComparisonFNC_BUT does not initialize correctly with global measures.'])
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_2) && ...
            ...
            [BRAPH2.STR ':ComparisonFNC_BUT:' BRAPH2.BUG_FUNC], ...
            ['ComparisonFNC_BUT does not initialize correctly with nodal measures.'])
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonFNC_BUT:' BRAPH2.BUG_FUNC], ...
            ['ComparisonFNC_BUT does not initialize correctly with global measures.']) %#ok<*NBRAK>
        
        assert(iscell(value_2) && ...
            isequal(numel(value_2), group.subjectnumber()) && ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), value_2)), ...
            [BRAPH2.STR ':ComparisonFNC_BUT:' BRAPH2.BUG_FUNC], ...
            ['ComparisonFNC_BUT does not initialize correctly with binodal measures.'])
...
for i = 1:1:numel(measures)
    ...
    for j = 1:1:group.subjectnumber()
        ...
        g = Graph.getGraph('GraphBUT', A);        
        m  = Measure.getMeasure(measures{i}, g);        
        value{j} = cell2mat(m.getValue());  %#ok<SAGROW>
    end
    
    average_values = {mean(reshape(cell2mat(value), [size(value{1}, 1), size(value{1}, 2), group.subjectnumber()]), 3)};
   
    % for the dimensions 
    difference  = average_values;
    all_differences = repmat(value(1), 1, number_of_permutations);
    ...
    % act
    comparison = ComparisonFNC_BUT('c1', ...
        'comparison label', ...
        'comparison notes', ...
        atlas, ...
        measures{i}, ...
        group, ...
        group, ...
        'ComparisonFNC.PermutationNumber', number_of_permutations, ...
        'ComparisonFNC.value_1', value, ...
        'ComparisonFNC.value_2', value, ...
        'ComparisonFNC.average_value_1', average_values, ...
        'ComparisonFNC.average_value_2', average_values, ...
        'ComparisonFNC.difference', difference, ...
        'ComparisonFNC.all_differences', all_differences, ...
        'ComparisonFNC.p1', p1, ...
        'ComparisonFNC.p2', p2, ....
        'ComparisonFNC.confidence_min', confidence_interval_min, ...
        'ComparisonFNC.confidence_max', confidence_interval_max ...
        );
