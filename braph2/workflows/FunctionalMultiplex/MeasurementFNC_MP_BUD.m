classdef MeasurementFNC_MP_BUD < MeasurementFNC_MP_WU
    % MeasurementFNC_MP_BUD A measurement of functional data with BU graphs at fixed density
    % MeasurementFNC_MP_BUD is a subclass of MeasurementFNC_MP_WU.
    %
    % MeasurementFNC_MP_BUD store a measurement of functional data with BU
    % graphs at fixes density, for this it inherit the MeasurementFNC_MP_WU
    ...
    %
    % MeasurementFNC_MP_BUD plot methods (Static):
    ...
    methods (Static)  % Descriptive functions
        function class = getClass()
            ...
            % measurement. In this case 'MeasurementFNC_MP_BUD'.
            %
            % See also getList, getName, getDescription.
            
            class = 'MeasurementFNC_MP_BUD';
        end
