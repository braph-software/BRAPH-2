classdef RandomComparisonMRI_WU < RandomComparison
    properties
    ...
    methods  % Constructor
        function rc =  RandomComparisonMRI_WU(id, label, notes, atlas, measure_code, group, varargin)
    ...
    methods (Access=protected)  % Initialize data
        function initialize_data(rc, varargin)
            ...
            number_of_randomizations = rc.getSettings('RandomComparisonMRI_WU.RandomizationNumber');
            
            if Measure.is_global(measure_code)  % global measure
                rc.value_group = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonMRI_WU.value_group', ...
                    varargin{:});
                assert(iscell(rc.getGroupValue()) && ...
                    isequal(size(rc.getGroupValue()), [1, 1]) && ...
                    all(cellfun(@(x) isequal(size(x), [1, 1]), rc.getGroupValue())), ...
                    [BRAPH2.STR ':RandomComparisonMRI_WU:' BRAPH2.WRONG_INPUT], ...
                    'Data not compatible with RandomComparisonMRI_WU')
                
                rc.value_random = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonMRI_WU.value_random', ...
                    varargin{:});
                ...
                rc.difference = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonMRI_WU.difference', ...
                    varargin{:});
                ...
                rc.all_differences = get_from_varargin( ...
                    ...
                    'RandomComparisonMRI_WU.all_differences', ...
                    varargin{:});
                ...
                rc.confidence_interval_min = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonMRI_WU.confidence_min', ...
                    varargin{:});
                ...
                rc.confidence_interval_max = get_from_varargin( ...
                    {0}, ...
                    'RandomComparisonMRI_WU.confidence_max', ...
                    varargin{:});
    ...
    methods (Static)  % Descriptive functions
        function measurement_class = getClass() %#ok<*INUSD>
            measurement_class = 'RandomComparisonMRI_WU';
        end
        function name = getName()
            name = 'RandomComparison MRI WU';
        end
        function description = getDescription()
            % comparison description missing
            description = 'MRI random comparison with weighted graphs.';
        end
        ...
        function available_settings = getAvailableSettings()
            available_settings = {
                'RandomComparisonMRI_WU.RandomizationNumber', BRAPH2.NUMERIC, 1000, {}; ...
                'RandomComparisonMRI_WU.AttemptsPerEdge', BRAPH2.NUMERIC, 5, {}; ...
                'RandomComparisonMRI_WU.NumberOfWeights', BRAPH2.NUMERIC, 1, {}; ...
                };
        end
