...
subject_class = RandomComparison.getSubjectClass('RandomComparisonMRI_WU');
...
for i = 1:1:numel(measures)
    randomcomparison = RandomComparisonMRI_WU('rc1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonMRI_WU('rc1', 'label', 'notes', atlas, measures{i}, group, 'RandomComparisonMRI_WU.RandomizationNumber', number_of_randomizations);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonMRI_WU:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonMRI_WU does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonMRI_WU:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonMRI_WU does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_group) && ...
            ...
            [BRAPH2.STR ':RandomComparisonMRI_WU:' BRAPH2.BUG_FUNC], ...
            'RandomComparisonMRI_WU does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    randomcomparison = RandomComparisonMRI_WU('rc1', ...
        'random comparison label', ...
        'random comparison notes', ...
        atlas, ...
        measures{i}, ...
        group, ...
        'RandomComparisonMRI_WU.RandomizationNumber', number_of_randomizations, ...
        ...
        'RandomComparisonMRI_WU.confidence_min', confidence_interval_min, ...
        'RandomComparisonMRI_WU.confidence_max', confidence_interval_max ...
        );
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':RandomComparisonMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
            'RandomComparisonMRI_WU does not initialize correctly with global measures')
