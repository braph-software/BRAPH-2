classdef AnalysisMRI_WU < Analysis
    methods  % Constructor
        function analysis = AnalysisMRI_WU(id, label, notes, cohort, measurements, randomcomparisons, comparisons, varargin)
    ...
    methods (Access = protected)  % Calculation functions
        function g = get_graph_for_subjects(analysis, subjects)
            ...
            correlation_rule = analysis.getSettings('AnalysisMRI_WU.CorrelationRule');
            negative_weight_rule = analysis.getSettings('AnalysisMRI_WU.NegativeWeightRule');
        ...
        function measurement = calculate_measurement(analysis, measure_code, group, varargin)
            ...
            measurement = Measurement.getMeasurement('MeasurementMRI_WU', ...
                ...
                measure_code, ...
                group,  ...
                'MeasurementMRI_WU.value', measurement_value ...
                );
        end
...
% ci_lower = quantiles(difference_all_permutations, 40, {2, 40});
            ...
            randomcomparison = RandomComparison.getRandomComparison('RandomComparisonMRI_WU', ...
                ...
                measure_code, ...
                group, ...
                'RandomComparisonMRI_WU.RandomizationNumber', M, ...
                'RandomComparisonMRI_WU.AttemptsPerEdge', attempts_per_edge, ...
                'RandomComparisonMRI_WU.NumberOfWeights', number_of_weights, ...
                'RandomComparisonMRI_WU.values_group', value_group, ...
                'RandomComparisonMRI_WU.values_random', value_random, ...
                'RandomComparisonMRI_WU.difference', difference, ...
                'RandomComparisonMRI_WU.all_differences', all_differences, ...
                'RandomComparisonMRI_WU.p1', p1, ...
                'RandomComparisonMRI_WU.p2', p2, ....
                'RandomComparisonMRI_WU.confidence_min', ci_lower, ...
                'RandomComparisonMRI_WU.confidence_max', ci_upper ...
                );
        end
        function comparison = calculate_comparison(analysis, measure_code, group_1, group_2, varargin)
            ...
            is_longitudinal = analysis.getSettings('AnalysisMRI_WU.Longitudinal');
...
% ci_lower = quantiles(difference_all_permutations, 40, {2, 40});
            ...
            comparison = Comparison.getComparison('ComparisonMRI_WU', ...
                ...
                group_1, ...
                group_2, ...
                'ComparisonMRI_WU.PermutationNumber', M, ...
                'ComparisonMRI_WU.value_1', value_1, ...
                'ComparisonMRI_WU.value_2', value_2, ...
                'ComparisonMRI_WU.difference', difference_mean, ...
                'ComparisonMRI_WU.all_differences', difference_all_permutations, ...
                'ComparisonMRI_WU.p1', p1, ...
                'ComparisonMRI_WU.p2', p2, ...
                'ComparisonMRI_WU.confidence_min', ci_lower, ...
                'ComparisonMRI_WU.confidence_max', ci_upper ...
                );
        end
    end
    methods (Static)  % Descriptive functions
        ...
        function name = getName()
            name = 'Analysis Structural MRI WU';
        end
        function description = getDescription()
            description = [ ...
                'Analysis based on structural MRI data using weighted graphs, ' ...
        ...
        function measurement_class = getMeasurementClass()
            measurement_class =  'MeasurementMRI_WU';
        end
        function randomcomparison_class = getRandomComparisonClass()
            randomcomparison_class = 'RandomComparisonMRI_WU';
        end
        function comparison_class = getComparisonClass()
            comparison_class = 'ComparisonMRI_WU';
        end
        function available_settings = getAvailableSettings(m) %#ok<INUSD>
            available_settings = {
                {'AnalysisMRI_WU.CorrelationRule', BRAPH2.STRING, 'pearson', Correlation.CORRELATION_RULE_LIST}, ...
                {'AnalysisMRI_WU.NegativeWeightRule', BRAPH2.STRING, 'zero', Correlation.NEGATIVE_WEIGHT_RULE_LIST}, ...
                {'AnalysisMRI_WU.Longitudinal', BRAPH2.LOGICAL, false, {false, true}} ...
                };
        end
    end
end