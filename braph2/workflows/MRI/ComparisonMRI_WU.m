classdef ComparisonMRI_WU < Comparison
    properties
    ...
    methods  % Constructor
        function c =  ComparisonMRI_WU(id, label, notes, atlas, measure_code, group_1, group_2, varargin)
...
% TODO: Add assert that the measure_code is in the measure list.
        ...
        function initialize_data(c, varargin)
            ...
            if Measure.is_global(measure_code)  % global measure
                ...
                c.all_differences = get_from_varargin( ...
                    ...
                    'ComparisonMRI_WU.all_differences', ...
                    varargin{:});
                ...
                c.confidence_interval_min = get_from_varargin( ...
                    {0}, ...
                    'ComparisonMRI_WU.confidence_interval_min', ...
                    varargin{:});
                ...
                c.confidence_interval_max = get_from_varargin( ...
                    {0}, ...
                    'ComparisonMRI_WU.confidence_interval_max', ...
                    varargin{:});
    ...
    methods (Static)  % Descriptive functions
        function class = getClass()
            class = 'ComparisonMRI_WU';
        end
        function name = getName()
            name = 'Comparison MRI WU';
        end
        function description = getDescription()
            description = 'MRI comparison using weighted graphs.';
        end
        ...
        function available_settings = getAvailableSettings()
            available_settings = {
                'ComparisonMRI_WU.PermutationNumber', BRAPH2.NUMERIC, 1000, {};
                };
        end
