...
assert(ischar(randomcomparison_id), ...
    [BRAPH2.STR ':AnalysisMRI:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisMRI.getRandomComparisonID() not creating an ID')
assert(isequal(randomcomparison_id, expected_value), ...
    [BRAPH2.STR ':AnalysisMRI:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisMRI.getRandomComparisonID() not creating correct ID')
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(randomcomparison_value_group) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI.getRandomComparison() not working with global measures') 
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(randomcomparison_value_group) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI.getRandomComparison() not working with nodal measures') 
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(randomcomparison_value_group) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI.getRandomComparison() not working with binodal measures') 
...
for i = 1:1:numel(measures)
    ...
    assert(~isempty(calculated_comparison), ...
        [BRAPH2.STR ':AnalysisMRI:' BRAPH2.BUG_FUNC], ...
        'AnalysisMRI.getComparison() not working')
    ...
    if Measure.is_global(measures{i})
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI.getComparison() not working with global measures') 
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisMRI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisMRI.getComparison() not working with nodal measures') 
