...
for i = 1:1:numel(measures)
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(isequal(size(p1), [atlas.getBrainRegions().length(), 1]) && ...
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(isequal(size(p1), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]) && ...
