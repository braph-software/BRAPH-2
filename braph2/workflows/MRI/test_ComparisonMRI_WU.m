...
subject_class = Comparison.getSubjectClass('ComparisonMRI_WU');
...
for i = 1:1:numel(measures)
    comparison = ComparisonMRI_WU('c1', 'label', 'notes', atlas, measures{i}, group, group);
end
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonMRI_WU('c1', 'label', 'notes', atlas, measures{i}, group, group, 'ComparisonMRI_WU.PermutationNumber', number_of_permutations);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonMRI_WU:' BRAPH2.BUG_FUNC], ...
            'ComparisonMRI_WU does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonMRI_WU:' BRAPH2.BUG_FUNC], ...
            'ComparisonMRI_WU does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(value_1) && ...
            ...
            [BRAPH2.STR ':ComparisonMRI_WU:' BRAPH2.BUG_FUNC], ...
            'ComparisonMRI_WU does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    % act
    comparison = ComparisonMRI_WU('c1', ...
        'comparison label', ...
        'comparison notes', ...
        atlas, ...
        measures{i}, ...
        group, ...
        group, ...
        'ComparisonMRI_WU.PermutationNumber', number_of_permutations, ...
        'ComparisonMRI_WU.value_1', value_1, ...
        'ComparisonMRI_WU.value_2', value_2, ...
        'ComparisonMRI_WU.difference', difference, ...
        'ComparisonMRI_WU.all_differences', all_differences, ...
        'ComparisonMRI_WU.p1', p1, ...
        'ComparisonMRI_WU.p2', p2, ....
        'ComparisonMRI_WU.confidence_min', confidence_interval_min, ...
        'ComparisonMRI_WU.confidence_max', confidence_interval_max ...
        );
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonMRI_WU:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonMRI_WU does not initialize correctly with global measures')
