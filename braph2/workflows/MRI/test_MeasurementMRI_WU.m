...
subject_class = Measurement.getSubjectClass('MeasurementMRI_WU');
...
for i = 1:1:numel(measures)
    measurement = MeasurementMRI_WU('m1', 'label', 'notes', atlas, measures{i}, group);
end
...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(value) & ...
            ...
            [BRAPH2.STR ':MeasurementMRI_WU:' BRAPH2.BUG_FUNC], ...
            'MeasurementMRI_WU does not initialize correctly with global measures.')
...
for i=1:1:numel(measures)
    ...
    % act
    measurement = MeasurementMRI_WU('m1', 'label', 'notes', atlas, measures{i}, group, ...
        'MeasurementMRI_WU.Value', m.getValue() ...
        );
