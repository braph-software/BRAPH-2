...
for i = 1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(values) && ...
            ...
            'ComparisonDTI does not initialize correctly with global measures')
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(values) && ...
            ...
            [BRAPH2.STR ':ComparisonDTI:' BRAPH2.BUG_FUNC], ...
            'ComparisonDTI does not initialize correctly with nodal measures')
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(values) && ...
            ...
            [BRAPH2.STR ':ComparisonDTI:' BRAPH2.BUG_FUNC], ...
            'ComparisonDTI does not initialize correctly with binodal measures')
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonDTI('c1', ...
        ...
        'ComparisonDTI.values_1', values, ...
        'ComparisonDTI.values_2', values, ...
        'ComparisonDTI.average_values_1', average_values, ...
        'ComparisonDTI.average_values_2', average_values, ...
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_difference) && ...
            ...
            [BRAPH2.STR ':ComparisonDTI:' BRAPH2.WRONG_OUTPUT], ...
            'ComparisonDTI does not initialize correctly with global measures')
