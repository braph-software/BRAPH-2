classdef NNDataPoint_CON_FUN_MP_REG < NNDataPoint
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of a data point for regression with connectivity-functional multiplex data.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of a data point for regression with connectivity-functional multiplex data.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of a data point for regression with connectivity-functional multiplex data.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for a data point for regression with connectivity-functional multiplex data.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of a data point for regression with connectivity-functional multiplex data.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about a data point for regression with connectivity-functional multiplex data.
	...
	%  <strong>10</strong> <strong>SUB</strong> 	SUB (data, item) is a subject with connectivity-functional multiplex data.
	%  <strong>11</strong> <strong>TARGET_IDS</strong> 	TARGET_IDS (parameter, stringlist) is a list of variable-of-interest IDs to be used as regression targets.
	%
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nndatapoint_con_fun_mp_reg_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'INPUT'  'TARGET'  'SUB'  'TARGET_IDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_con_fun_mp_reg_category_list = { 1  1  3  4  2  2  6  5  5  4  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_con_fun_mp_reg_format_list = { 2  2  8  2  2  2  2  16  16  8  3 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_con_fun_mp_reg_description_list = { 'NAME (constant, string) is the name of a data point for regression with connectivity-functional multiplex data.'  'DESCRIPTION (constant, string) is the description of a data point for regression with connectivity-functional multiplex data.'  'TEMPLATE (parameter, item) is the template of a data point for regression with connectivity-functional multiplex data.'  'ID (data, string) is a few-letter code for a data point for regression with connectivity-functional multiplex data.'  'LABEL (metadata, string) is an extended label of a data point for regression with connectivity-functional multiplex data.'  'NOTES (metadata, string) are some specific notes about a data point for regression with connectivity-functional multiplex data.'  'TOSTRING (query, string) returns a string that represents the object.'  'INPUT (result, cell) is the input value for this data point.'  'TARGET (result, cell) is the target value for this data point.'  'SUB (data, item) is a subject with connectivity-functional multiplex data.'  'TARGET_IDS (parameter, stringlist) is a list of variable-of-interest IDs to be used as regression targets.' };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 10 % NNDataPoint_CON_FUN_MP_REG.SUB
					prop_settings = 'SubjectCON_FUN_MP';
				case 11 % NNDataPoint_CON_FUN_MP_REG.TARGET_IDS
					prop_settings = Format.getFormatSettings(3);
				case 3 % NNDataPoint_CON_FUN_MP_REG.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % NNDataPoint_CON_FUN_MP_REG.NAME
					prop_default = 'NNDataPoint_CON_FUN_MP_REG';
				case 2 % NNDataPoint_CON_FUN_MP_REG.DESCRIPTION
				...
				case 3 % NNDataPoint_CON_FUN_MP_REG.TEMPLATE
					prop_default = Format.getFormatDefault(8, NNDataPoint_CON_FUN_MP_REG.getPropSettings(prop));
				case 4 % NNDataPoint_CON_FUN_MP_REG.ID
					prop_default = 'NNDataPoint_CON_FUN_MP_REG ID';
				case 5 % NNDataPoint_CON_FUN_MP_REG.LABEL
					prop_default = 'NNDataPoint_CON_FUN_MP_REG label';
				case 6 % NNDataPoint_CON_FUN_MP_REG.NOTES
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(dp, prop, varargin)
			...
			switch prop
				case 8 % NNDataPoint_CON_FUN_MP_REG.INPUT
				...
				case 9 % NNDataPoint_CON_FUN_MP_REG.TARGET
