function create_data_NN_CLA_CON_FUN_MP_TXT(data_dir, random_seed)
%CREATE_DATA_NN_CLA_CON_FUN_MP_TXT creates connectivity-functional data for neural network classification analysis
%
% CREATE_DATA_NN_CLA_CON_FUN_MP_TXT() creates connectivity-functional data in default folder 'Example
%  data NN CLA CON TXT'.
%
% CREATE_DATA_NN_CLA_CON_FUN_MP_TXT(DATA_DIR) creates connectivity-functional data in DATA_DIR folder.
%
% CREATE_DATA_NN_CLA_CON_FUN_MP_TXT(DATA_DIR, RANDOM_SEED) cretes connectivity-functional data in
%  DATA_DIR folder with a specified RANDOM_SEED.
%
% See also create_data_nn_cla_con_fun_mp_xls.

if nargin < 1
    data_dir = [fileparts(which('NNDataPoint_CON_FUN_MP_CLA')) filesep 'Example data NN CLA CON_FUN_MP TXT'];
end
...
if ~isdir(data_dir)
    ...
    gr_name1 = 'CON_FUN_MP_Group1_TXT';
    vois1 = [
        {{'Subject ID'} {'Age'} {'Sex'}}
    ...
    for i_tab = 1:1:N_subjects_group1
        ...
        file_name = [data_dir filesep() 'Functional' filesep() gr_name1 filesep() sub_id{i_tab} '.txt'];
        writetable(T_gr11, file_name, 'Delimiter', '\t', 'WriteRowNames', false, 'WriteVariableNames', false)
    end
    ...
    for i_tab = 1:1:N_subjects_group1
        ...
        file_name = [data_dir filesep() 'Connectivity' filesep() gr_name1 filesep() sub_id{i_tab} '.txt'];
        writetable(T_gr12, file_name, 'Delimiter', '\t', 'WriteRowNames', false, 'WriteVariableNames', false)
    end
    writetable(table(vois1), [data_dir filesep() 'Connectivity' filesep() gr_name1 '.vois.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
    writetable(table(vois1), [data_dir filesep() 'Functional' filesep() gr_name1 '.vois.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
    ...
    gr2_name = 'CON_FUN_MP_Group2_TXT';
    vois2 = [
        {{'Subject ID'} {'Age'} {'Sex'}}
        {{} {} {['{' sprintf(' ''%s'' ', sex_options{:}) '}']}}
        ];
    ...
    for i_tab = N_subjects_group1+1:1:N_subjects_group1 + N_subjects_group2
        ...
        file_name = [data_dir filesep() 'Functional' filesep() gr2_name filesep() sub_id{i_tab} '.txt'];
        writetable(T_gr21, file_name, 'Delimiter', '\t', 'WriteRowNames', false, 'WriteVariableNames', false)
    end
    ...
    for i_tab = N_subjects_group1+1:1:N_subjects_group1 + N_subjects_group2
        ...
        file_name = [data_dir filesep() 'Connectivity' filesep() gr2_name filesep() sub_id{i_tab} '.txt'];
        writetable(T_gr22, file_name, 'Delimiter', '\t', 'WriteRowNames', false, 'WriteVariableNames', false)
    end  
    writetable(table(vois2), [data_dir filesep() 'Connectivity' filesep() gr2_name '.vois.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
    writetable(table(vois2), [data_dir filesep() 'Functional' filesep() gr2_name '.vois.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
    ...
    gr3_name = 'CON_FUN_MP_Group3_TXT';
    vois3 = [
        {{'Subject ID'} {'Age'} {'Sex'}}
        {{} {} {['{' sprintf(' ''%s'' ', sex_options{:}) '}']}}
        ];
    ...
    for i_tab = N_subjects_group1+N_subjects_group2+1:1:N_subjects_group1+N_subjects_group2+N_subjects_group3
        ...
        file_name = [data_dir filesep() 'Functional' filesep() gr3_name filesep() sub_id{i_tab} '.txt'];
        writetable(T_gr31, file_name, 'Delimiter', '\t', 'WriteRowNames', false, 'WriteVariableNames', false)
    end
    ...
    for i_tab = N_subjects_group1+N_subjects_group2+1:1:N_subjects_group1+N_subjects_group2+N_subjects_group3
        ...
        file_name = [data_dir filesep() 'Connectivity' filesep() gr3_name filesep() sub_id{i_tab} '.txt'];
        writetable(T_gr32, file_name, 'Delimiter', '\t', 'WriteRowNames', false, 'WriteVariableNames', false)
    end
    writetable(table(vois3), [data_dir filesep() 'Connectivity' filesep() gr3_name '.vois.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
    writetable(table(vois3), [data_dir filesep() 'Functional' filesep() gr3_name '.vois.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
