classdef NNDataPoint_CON_FUN_MP_CLA < NNDataPoint
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nndatapoint_con_fun_mp_cla_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'INPUT'  'TARGET'  'SUB'  'TARGET_IDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_con_fun_mp_cla_category_list = { 1  1  3  4  2  2  5  5  4  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_con_fun_mp_cla_format_list = { 2  2  8  2  2  2  16  16  8  3 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % NNDataPoint_CON_FUN_MP_CLA.SUB
					prop_settings = 'SubjectCON_FUN_MP';
				case 10 % NNDataPoint_CON_FUN_MP_CLA.TARGET_IDS
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(dp, prop, varargin)
			...
			switch prop
				case 7 % NNDataPoint_CON_FUN_MP_CLA.INPUT
				...
				case 8 % NNDataPoint_CON_FUN_MP_CLA.TARGET
