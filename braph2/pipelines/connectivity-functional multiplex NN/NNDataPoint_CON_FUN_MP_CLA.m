	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNDataPoint_CON_FUN_MP_CLA.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the data point for classification with connectivity-functional multiplex data.';
