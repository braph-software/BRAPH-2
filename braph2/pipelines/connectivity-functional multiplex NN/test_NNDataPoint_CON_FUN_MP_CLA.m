...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	dp_1 = NNDataPoint_CON_FUN_MP_CLA( ...
		...
		NNDataPoint_CON_FUN_MP_CLA.INPUT, NNDataPoint_CON_FUN_MP_CLA.getNoValue(), ...
		NNDataPoint_CON_FUN_MP_CLA.TARGET, NNDataPoint_CON_FUN_MP_CLA.getNoValue(), ...
		NNDataPoint_CON_FUN_MP_CLA.SUB, dp_0.getCallback(10), ..., ...
		NNDataPoint_CON_FUN_MP_CLA.TARGET_IDS, dp_0.getCallback(11) ... ...
		);
	...
	dp_2 = NNDataPoint_CON_FUN_MP_CLA( ...
		...
		NNDataPoint_CON_FUN_MP_CLA.INPUT, NNDataPoint_CON_FUN_MP_CLA.getNoValue(), ...
		NNDataPoint_CON_FUN_MP_CLA.TARGET, NNDataPoint_CON_FUN_MP_CLA.getNoValue(), ...
		NNDataPoint_CON_FUN_MP_CLA.SUB, dp_1.getCallback(10), ..., ...
		NNDataPoint_CON_FUN_MP_CLA.TARGET_IDS, dp_1.getCallback(11) ... ...
		);
	...
	dp_3 = NNDataPoint_CON_FUN_MP_CLA( ...
		...
		NNDataPoint_CON_FUN_MP_CLA.INPUT, NNDataPoint_CON_FUN_MP_CLA.getNoValue(), ...
		NNDataPoint_CON_FUN_MP_CLA.TARGET, NNDataPoint_CON_FUN_MP_CLA.getNoValue(), ...
		NNDataPoint_CON_FUN_MP_CLA.SUB, dp_2.getCallback(10), ..., ...
		NNDataPoint_CON_FUN_MP_CLA.TARGET_IDS, dp_2.getCallback(11) ... ...
		);
