function create_data_NN_CLA_FUN_TXT(data_dir, random_seed)
%CREATE_DATA_NN_CLA_FUN_TXT creates functional data for neural network classification analysis
%
% CREATE_DATA_NN_CLA_FUN_TXT() creates functional data in default folder 'Example
%  data NN CLA FUN XLS'.
%
% CREATE_DATA_NN_CLA_FUN_TXT(DATA_DIR) creates functional data in DATA_DIR folder.
%
...
if ~isdir(data_dir)
    ...
    for i_gr = 1:1:10 % subject number
        ...
        writetable(array2table(R), [gr1_dir filesep() sub_id '.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
    ...
    for i_gr = 11:1:20 % subject number
        ...
        writetable(array2table(R), [gr2_dir filesep() sub_id '.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
    ...
    for i_gr = 21:1:30  % subject number
        ...
        writetable(array2table(R), [gr3_dir filesep() sub_id '.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
