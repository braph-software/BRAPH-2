classdef ExporterGroupSubjectFUN_MP_TXT < Exporter
	...
	%  <strong>11</strong> <strong>PUT_DIR</strong> 	PUT_DIR (query, item) opens a dialog box to set the directory where to save the group of subjects with functional multiplex data.
	%  <strong>12</strong> <strong>SAVE</strong> 	SAVE (result, empty) saves the group of subjects with functional multiplex data in TXT files in the selected directory.
	%
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				exportergroupsubjectfun_mp_txt_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'GR'  'DIRECTORY'  'PUT_DIR'  'SAVE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			exportergroupsubjectfun_mp_txt_category_list = { 1  1  3  4  2  2  6  9  4  4  6  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			exportergroupsubjectfun_mp_txt_format_list = { 2  2  8  2  2  2  2  4  8  2  8  1 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % ExporterGroupSubjectFUN_MP_TXT.GR
					prop_settings = 'Group';
				case 10 % ExporterGroupSubjectFUN_MP_TXT.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 11 % ExporterGroupSubjectFUN_MP_TXT.PUT_DIR
					prop_settings = 'ExporterGroupSubjectFUN_MP_TXT';
				case 12 % ExporterGroupSubjectFUN_MP_TXT.SAVE
