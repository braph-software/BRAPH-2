classdef AnalyzeEnsemble_FUN_MP_BUT < AnalyzeEnsemble
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the ensemble-based graph analysis with functional multiplex data of fixed threshold.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the ensemble-based graph analysis with functional multiplex data of fixed threshold.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the ensemble-based graph analysis with functional multiplex data of fixed threshold.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the ensemble-based graph analysis with functional multiplex data of fixed threshold.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the ensemble-based graph analysis with functional multiplex data of fixed threshold.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the ensemble-based graph analysis with functional multiplex data of fixed threshold.
	...
	%  <strong>10</strong> <strong>G_DICT</strong> 	G_DICT (result, idict) is the graph (MultiplexBUT) ensemble obtained from this analysis.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzeensemble_fun_mp_but_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'GR'  'GRAPH_TEMPLATE'  'G_DICT'  'ME_DICT'  'MEASUREENSEMBLE'  'REPETITION'  'F_MIN'  'F_MAX'  'CORRELATION_RULE'  'NEGATIVE_WEIGHT_RULE'  'THRESHOLDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_fun_mp_but_category_list = { 1  1  3  4  2  2  9  4  3  5  5  6  3  3  3  3  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_fun_mp_but_format_list = { 2  2  8  2  2  2  4  8  8  10  10  8  11  11  11  5  5  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 13 % AnalyzeEnsemble_FUN_MP_BUT.REPETITION
					prop_settings = Format.getFormatSettings(11);
				case 14 % AnalyzeEnsemble_FUN_MP_BUT.F_MIN
					prop_settings = Format.getFormatSettings(11);
				case 15 % AnalyzeEnsemble_FUN_MP_BUT.F_MAX
					prop_settings = Format.getFormatSettings(11);
				case 16 % AnalyzeEnsemble_FUN_MP_BUT.CORRELATION_RULE
					prop_settings = Correlation.CORRELATION_RULE_LIST(1:3);
				case 17 % AnalyzeEnsemble_FUN_MP_BUT.NEGATIVE_WEIGHT_RULE
					prop_settings = Correlation.NEGATIVE_WEIGHT_RULE_LIST;
				case 18 % AnalyzeEnsemble_FUN_MP_BUT.THRESHOLDS
					prop_settings = Format.getFormatSettings(12);
				case 3 % AnalyzeEnsemble_FUN_MP_BUT.TEMPLATE
					prop_settings = 'AnalyzeEnsemble_FUN_MP_BUT';
				case 9 % AnalyzeEnsemble_FUN_MP_BUT.GRAPH_TEMPLATE
					prop_settings = 'MultiplexBUT';
				case 10 % AnalyzeEnsemble_FUN_MP_BUT.G_DICT
					prop_settings = 'MultiplexBUT';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 18 % AnalyzeEnsemble_FUN_MP_BUT.THRESHOLDS
					prop_default = [-1:.5:1];
				case 1 % AnalyzeEnsemble_FUN_MP_BUT.NAME
					prop_default = 'AnalyzeEnsemble_FUN_MP_BUT';
				case 2 % AnalyzeEnsemble_FUN_MP_BUT.DESCRIPTION
				...
				case 4 % AnalyzeEnsemble_FUN_MP_BUT.ID
					prop_default = 'AnalyzeEnsemble_FUN_MP_BUT ID';
				case 5 % AnalyzeEnsemble_FUN_MP_BUT.LABEL
					prop_default = 'AnalyzeEnsemble_FUN_MP_BUT label';
				case 6 % AnalyzeEnsemble_FUN_MP_BUT.NOTES
					prop_default = 'AnalyzeEnsemble_FUN_MP_BUT notes';
				case 8 % AnalyzeEnsemble_FUN_MP_BUT.GR
