classdef SubjectFUN_MP < Subject
	...
	%  <strong>12</strong> <strong>FUN_MP</strong> 	FUN_MP (data, cell) is a cell containing L matrices with each column corresponding to the time series of a brain region.
	%
	...
	properties (Constant) % properties
		...
		FUN_MP = 12; %CET: Computational Efficiency Trick
		FUN_MP_TAG = 'FUN_MP';
		FUN_MP_CATEGORY = 4;
		FUN_MP_FORMAT = 16;
	end
	...
	methods (Static) % inspection
		...
		function check_out = existsTag(tag)
			...
			check = any(strcmp(tag, { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'VOI_DICT'  'BA'  'L'  'LAYERLABELS'  'ALAYERLABELS'  'FUN_MP' })); %CET: Computational Efficiency Trick
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				prop = find(strcmp(pointer, { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'VOI_DICT'  'BA'  'L'  'LAYERLABELS'  'ALAYERLABELS'  'FUN_MP' })); % tag = pointer %CET: Computational Efficiency Trick
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				subjectfun_mp_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'VOI_DICT'  'BA'  'L'  'LAYERLABELS'  'ALAYERLABELS'  'FUN_MP' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			subjectfun_mp_category_list = { 1  1  3  4  2  2  4  4  4  2  6  4 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			subjectfun_mp_format_list = { 2  2  8  2  2  2  10  8  11  3  3  16 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 8 % SubjectFUN_MP.BA
					prop_settings = 'BrainAtlas';
				case 9 % SubjectFUN_MP.L
					prop_settings = Format.getFormatSettings(11);
				case 10 % SubjectFUN_MP.LAYERLABELS
					prop_settings = Format.getFormatSettings(3);
				case 11 % SubjectFUN_MP.ALAYERLABELS
					prop_settings = Format.getFormatSettings(3);
				case 12 % SubjectFUN_MP.FUN_MP
