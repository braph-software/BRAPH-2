classdef ImporterGroupSubjectFUN_MP_XLS < Importer
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the FUN MP subject group importer from XLS/XLSX.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the FUN MP subject group importer from XLS/XLSX.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the FUN MP subject group importer from XLS/XLSX.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the FUN MP subject group importer from XLS/XLSX.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the FUN MP subject group importer from XLS/XLSX.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the FUN MP subject group importer from XLS/XLSX.
	%  <strong>7</strong> <strong>TOSTRING</strong> 	TOSTRING (query, string) returns a string that represents the object.
	%  <strong>8</strong> <strong>WAITBAR</strong> 	WAITBAR (gui, logical) detemines whether to show the waitbar.
	%  <strong>9</strong> <strong>DIRECTORY</strong> 	DIRECTORY (data, string) is the directory containing the FUN MP subject folders from which to load the L layers of the group.
	%  <strong>10</strong> <strong>GET_DIR</strong> 	GET_DIR (query, item) opens a dialog box to set the directory from where to load the XLS/XLSX files of the FUN MP subject group with L layers.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				importergroupsubjectfun_mp_xls_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'DIRECTORY'  'GET_DIR'  'BA'  'GR' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectfun_mp_xls_category_list = { 1  1  3  4  2  2  6  9  4  6  4  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectfun_mp_xls_format_list = { 2  2  8  2  2  2  2  4  2  8  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % ImporterGroupSubjectFUN_MP_XLS.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 10 % ImporterGroupSubjectFUN_MP_XLS.GET_DIR
					prop_settings = 'ImporterGroupSubjectFUN_MP_XLS';
				case 11 % ImporterGroupSubjectFUN_MP_XLS.BA
					prop_settings = 'BrainAtlas';
				case 12 % ImporterGroupSubjectFUN_MP_XLS.GR
					prop_settings = 'Group';
				case 3 % ImporterGroupSubjectFUN_MP_XLS.TEMPLATE
					prop_settings = 'ImporterGroupSubjectFUN_MP_XLS';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % ImporterGroupSubjectFUN_MP_XLS.NAME
					prop_default = 'ImporterGroupSubjectFUN_MP_XLS';
				case 2 % ImporterGroupSubjectFUN_MP_XLS.DESCRIPTION
				...
				case 3 % ImporterGroupSubjectFUN_MP_XLS.TEMPLATE
					prop_default = Format.getFormatDefault(8, ImporterGroupSubjectFUN_MP_XLS.getPropSettings(prop));
				case 4 % ImporterGroupSubjectFUN_MP_XLS.ID
					prop_default = 'ImporterGroupSubjectFUN_MP_XLS ID';
				case 5 % ImporterGroupSubjectFUN_MP_XLS.LABEL
					prop_default = 'ImporterGroupSubjectFUN_MP_XLS label';
				case 6 % ImporterGroupSubjectFUN_MP_XLS.NOTES
