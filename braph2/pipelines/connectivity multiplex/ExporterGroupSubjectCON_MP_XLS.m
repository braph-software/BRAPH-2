classdef ExporterGroupSubjectCON_MP_XLS < Exporter
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the CON MP subject group exporter in XLSX.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the CON MP subject group exporter in XLSX.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the CON MP subject group exporter in XLSX.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the CON MP subject group exporter in XLSX.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the CON MP subject group exporter in XLSX.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the CON MP subject group exporter in XLSX.
	%  <strong>7</strong> <strong>WAITBAR</strong> 	WAITBAR (gui, logical) detemines whether to show the waitbar.
	%  <strong>8</strong> <strong>GR</strong> 	GR (data, item) is a group of subjects with connectivity multiplex data.
	%  <strong>9</strong> <strong>DIRECTORY</strong> 	DIRECTORY (data, string) is the directory name where to save the group of subjects with connectivity multiplex data.
	...
	%  <strong>11</strong> <strong>SAVE</strong> 	SAVE (result, empty) saves the group of subjects with connectivity multiplex data in XLSX files in the selected directory.
	%
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				exportergroupsubjectcon_mp_xls_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'GR'  'DIRECTORY'  'PUT_DIR'  'SAVE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			exportergroupsubjectcon_mp_xls_category_list = { 1  1  3  4  2  2  9  4  4  6  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			exportergroupsubjectcon_mp_xls_format_list = { 2  2  8  2  2  2  4  8  2  8  1 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 8 % ExporterGroupSubjectCON_MP_XLS.GR
					prop_settings = 'Group';
				case 9 % ExporterGroupSubjectCON_MP_XLS.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 10 % ExporterGroupSubjectCON_MP_XLS.PUT_DIR
					prop_settings = 'ExporterGroupSubjectCON_MP_XLS';
				case 11 % ExporterGroupSubjectCON_MP_XLS.SAVE
					prop_settings = Format.getFormatSettings(1);
				case 3 % ExporterGroupSubjectCON_MP_XLS.TEMPLATE
					prop_settings = 'ExporterGroupSubjectCON_MP_XLS';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % ExporterGroupSubjectCON_MP_XLS.NAME
					prop_default = 'ExporterGroupSubjectCON_MP_XLS';
				case 2 % ExporterGroupSubjectCON_MP_XLS.DESCRIPTION
				...
				case 3 % ExporterGroupSubjectCON_MP_XLS.TEMPLATE
					prop_default = Format.getFormatDefault(8, ExporterGroupSubjectCON_MP_XLS.getPropSettings(prop));
				case 4 % ExporterGroupSubjectCON_MP_XLS.ID
					prop_default = 'ExporterGroupSubjectCON_MP_XLS ID';
				case 5 % ExporterGroupSubjectCON_MP_XLS.LABEL
					prop_default = 'ExporterGroupSubjectCON_MP_XLS label';
				case 6 % ExporterGroupSubjectCON_MP_XLS.NOTES
