classdef ExporterGroupSubjectCON_MP_XLS < Exporter
	...
	%  <strong>12</strong> <strong>SAVE</strong> 	SAVE (result, empty) saves the group of subjects with connectivity multiplex data in XLSX files in the selected directory.
	%
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				exportergroupsubjectcon_mp_xls_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'GR'  'DIRECTORY'  'PUT_DIR'  'SAVE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			exportergroupsubjectcon_mp_xls_category_list = { 1  1  3  4  2  2  6  9  4  4  6  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			exportergroupsubjectcon_mp_xls_format_list = { 2  2  8  2  2  2  2  4  8  2  8  1 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % ExporterGroupSubjectCON_MP_XLS.GR
					prop_settings = 'Group';
				case 10 % ExporterGroupSubjectCON_MP_XLS.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 11 % ExporterGroupSubjectCON_MP_XLS.PUT_DIR
					prop_settings = 'ExporterGroupSubjectCON_MP_XLS';
				case 12 % ExporterGroupSubjectCON_MP_XLS.SAVE
