classdef ImporterGroupSubjectCON_MP_XLS < Importer
	...
	%  <strong>9</strong> <strong>DIRECTORY</strong> 	DIRECTORY (data, string) is the directory containing the CON MP subject folders from which to load the L layers of the group.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				importergroupsubjectcon_mp_xls_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'DIRECTORY'  'GET_DIR'  'BA'  'GR' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectcon_mp_xls_category_list = { 1  1  3  4  2  2  6  9  4  6  4  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectcon_mp_xls_format_list = { 2  2  8  2  2  2  2  4  2  8  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % ImporterGroupSubjectCON_MP_XLS.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 10 % ImporterGroupSubjectCON_MP_XLS.GET_DIR
					prop_settings = 'ImporterGroupSubjectCON_MP_XLS';
				case 11 % ImporterGroupSubjectCON_MP_XLS.BA
					prop_settings = 'BrainAtlas';
				case 12 % ImporterGroupSubjectCON_MP_XLS.GR
					prop_settings = 'Group';
