classdef ImporterGroupSubjectCON_MP_TXT < Importer
	...
	%  <strong>8</strong> <strong>DIRECTORY</strong> 	DIRECTORY (data, string) is the directory containing the CON MP subject group files from which to load the L layers of the subject group.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				importergroupsubjectcon_mp_txt_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'DIRECTORY'  'GET_DIR'  'BA'  'GR' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectcon_mp_txt_category_list = { 1  1  3  4  2  2  9  4  6  4  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectcon_mp_txt_format_list = { 2  2  8  2  2  2  4  2  8  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 8 % ImporterGroupSubjectCON_MP_TXT.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 9 % ImporterGroupSubjectCON_MP_TXT.GET_DIR
					prop_settings = 'ImporterGroupSubjectCON_MP_TXT';
				case 10 % ImporterGroupSubjectCON_MP_TXT.BA
					prop_settings = 'BrainAtlas';
				case 11 % ImporterGroupSubjectCON_MP_TXT.GR
					prop_settings = 'Group';
