	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzeensemble_con_bud_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'GR'  'GRAPH_TEMPLATE'  'G_DICT'  'ME_DICT'  'MEASUREENSEMBLE'  'DENSITIES' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_bud_category_list = { 1  1  3  4  2  2  9  4  3  5  5  6  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_bud_format_list = { 2  2  8  2  2  2  4  8  8  10  10  8  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 13 % AnalyzeEnsemble_CON_BUD.DENSITIES
					prop_settings = Format.getFormatSettings(12);
				case 3 % AnalyzeEnsemble_CON_BUD.TEMPLATE
					prop_settings = 'AnalyzeEnsemble_CON_BUD';
				case 9 % AnalyzeEnsemble_CON_BUD.GRAPH_TEMPLATE
					prop_settings = 'MultigraphBUD';
				case 10 % AnalyzeEnsemble_CON_BUD.G_DICT
					prop_settings = 'MultigraphBUD';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 8 % AnalyzeEnsemble_CON_BUD.GR
