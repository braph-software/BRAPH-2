classdef ExporterGroupSubjectCON_XLS < Exporter
	...
	%  <strong>11</strong> <strong>SAVE</strong> 	SAVE (result, empty) saves the group of subjects with connectivity data in XLSX files in the selected directory.
	%
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				exportergroupsubjectcon_xls_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'GR'  'DIRECTORY'  'PUT_DIR'  'SAVE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			exportergroupsubjectcon_xls_category_list = { 1  1  3  4  2  2  9  4  4  6  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			exportergroupsubjectcon_xls_format_list = { 2  2  8  2  2  2  4  8  2  8  1 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 8 % ExporterGroupSubjectCON_XLS.GR
					prop_settings = 'Group';
				case 9 % ExporterGroupSubjectCON_XLS.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 10 % ExporterGroupSubjectCON_XLS.PUT_DIR
					prop_settings = 'ExporterGroupSubjectCON_XLS';
				case 11 % ExporterGroupSubjectCON_XLS.SAVE
