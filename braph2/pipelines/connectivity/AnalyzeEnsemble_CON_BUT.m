	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzeensemble_con_but_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'GR'  'GRAPH_TEMPLATE'  'G_DICT'  'ME_DICT'  'MEASUREENSEMBLE'  'THRESHOLDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_but_category_list = { 1  1  3  4  2  2  6  9  4  3  5  5  6  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_but_format_list = { 2  2  8  2  2  2  2  4  8  8  10  10  8  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 14 % AnalyzeEnsemble_CON_BUT.THRESHOLDS
					prop_settings = Format.getFormatSettings(12);
				case 3 % AnalyzeEnsemble_CON_BUT.TEMPLATE
					prop_settings = 'AnalyzeEnsemble_CON_BUT';
				case 10 % AnalyzeEnsemble_CON_BUT.GRAPH_TEMPLATE
					prop_settings = 'MultigraphBUT';
				case 11 % AnalyzeEnsemble_CON_BUT.G_DICT
					prop_settings = 'MultigraphBUT';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 9 % AnalyzeEnsemble_CON_BUT.GR
