classdef ImporterGroupSubjectCON_TXT < Importer
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the CON subject group importer from TXT.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the CON subject group importer from TXT.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the CON subject group importer from TXT.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the CON subject group importer from TXT.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the CON subject group importer from TXT.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the CON subject group importer from TXT.
	%  <strong>7</strong> <strong>WAITBAR</strong> 	WAITBAR (gui, logical) detemines whether to show the waitbar.
	%  <strong>8</strong> <strong>DIRECTORY</strong> 	DIRECTORY (data, string) is the directory containing the CON subject group files from which to load the subject group.
	%  <strong>9</strong> <strong>GET_DIR</strong> 	GET_DIR (query, item) opens a dialog box to set the directory from where to load the TXT files of the CON subject group.
	%  <strong>10</strong> <strong>BA</strong> 	BA (data, item) is a brain atlas.
	%  <strong>11</strong> <strong>GR</strong> 	GR (result, item) is a group of subjects with connectivity data.
	%
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				importergroupsubjectcon_txt_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'DIRECTORY'  'GET_DIR'  'BA'  'GR' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectcon_txt_category_list = { 1  1  3  4  2  2  9  4  6  4  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectcon_txt_format_list = { 2  2  8  2  2  2  4  2  8  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 8 % ImporterGroupSubjectCON_TXT.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 9 % ImporterGroupSubjectCON_TXT.GET_DIR
					prop_settings = 'ImporterGroupSubjectCON_TXT';
				case 10 % ImporterGroupSubjectCON_TXT.BA
					prop_settings = 'BrainAtlas';
				case 11 % ImporterGroupSubjectCON_TXT.GR
					prop_settings = 'Group';
				case 3 % ImporterGroupSubjectCON_TXT.TEMPLATE
					prop_settings = 'ImporterGroupSubjectCON_TXT';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % ImporterGroupSubjectCON_TXT.NAME
					prop_default = 'ImporterGroupSubjectCON_TXT';
				case 2 % ImporterGroupSubjectCON_TXT.DESCRIPTION
				...
				case 3 % ImporterGroupSubjectCON_TXT.TEMPLATE
					prop_default = Format.getFormatDefault(8, ImporterGroupSubjectCON_TXT.getPropSettings(prop));
				case 4 % ImporterGroupSubjectCON_TXT.ID
					prop_default = 'ImporterGroupSubjectCON_TXT ID';
				case 5 % ImporterGroupSubjectCON_TXT.LABEL
					prop_default = 'ImporterGroupSubjectCON_TXT label';
				case 6 % ImporterGroupSubjectCON_TXT.NOTES
