classdef AnalyzeEnsemble_CON_WD < AnalyzeEnsemble
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the ensenmble-based graph analysis using connectivity data.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the ensenmble-based graph analysis using connectivity data.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the ensenmble-based graph analysis using connectivity data.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the ensenmble-based graph analysis using connectivity data.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the ensenmble-based graph analysis using connectivity data.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the ensenmble-based graph analysis using connectivity data.
	...
	%  <strong>11</strong> <strong>G_DICT</strong> 	G_DICT (result, idict) is the graph (GraphWD) ensemble obtained from this analysis.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzeensemble_con_wd_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'GR'  'GRAPH_TEMPLATE'  'G_DICT'  'ME_DICT'  'MEASUREENSEMBLE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_wd_category_list = { 1  1  3  4  2  2  6  9  4  3  5  5  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_wd_format_list = { 2  2  8  2  2  2  2  4  8  8  10  10  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 3 % AnalyzeEnsemble_CON_WD.TEMPLATE
					prop_settings = 'AnalyzeEnsemble_CON_WD';
				case 10 % AnalyzeEnsemble_CON_WD.GRAPH_TEMPLATE
					prop_settings = 'GraphWD';
				case 11 % AnalyzeEnsemble_CON_WD.G_DICT
					prop_settings = 'GraphWD';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % AnalyzeEnsemble_CON_WD.NAME
					prop_default = 'AnalyzeEnsemble_CON_WD';
				case 2 % AnalyzeEnsemble_CON_WD.DESCRIPTION
				...
				case 4 % AnalyzeEnsemble_CON_WD.ID
					prop_default = 'AnalyzeEnsemble_CON_WD ID';
				case 5 % AnalyzeEnsemble_CON_WD.LABEL
					prop_default = 'AnalyzeEnsemble_CON_WD label';
				case 6 % AnalyzeEnsemble_CON_WD.NOTES
					prop_default = 'AnalyzeEnsemble_CON_WD notes';
				case 9 % AnalyzeEnsemble_CON_WD.GR
