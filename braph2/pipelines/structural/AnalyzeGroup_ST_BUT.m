classdef AnalyzeGroup_ST_BUT < AnalyzeGroup
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the group-based graph analysis with structural data at fixed threshold.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the group-based graph analysis with structural data at fixed threshold.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the group-based graph analysis with structural data at fixed threshold.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the group-based graph analysis with structural data at fixed threshold.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the group-based graph analysis with structural data at fixed threshold.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the group-based graph analysis with structural data at fixed threshold.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzegroup_st_but_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'GR'  'G'  'CORRELATION_RULE'  'NEGATIVE_WEIGHT_RULE'  'THRESHOLDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzegroup_st_but_category_list = { 1  1  3  4  2  2  9  4  5  3  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzegroup_st_but_format_list = { 2  2  8  2  2  2  4  8  8  5  5  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 10 % AnalyzeGroup_ST_BUT.CORRELATION_RULE
					prop_settings = Correlation.CORRELATION_RULE_LIST;
				case 11 % AnalyzeGroup_ST_BUT.NEGATIVE_WEIGHT_RULE
					prop_settings = Correlation.NEGATIVE_WEIGHT_RULE_LIST;
				case 12 % AnalyzeGroup_ST_BUT.THRESHOLDS
					prop_settings = Format.getFormatSettings(12);
				case 3 % AnalyzeGroup_ST_BUT.TEMPLATE
					prop_settings = 'AnalyzeGroup_ST_BUT';
				case 9 % AnalyzeGroup_ST_BUT.G
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 12 % AnalyzeGroup_ST_BUT.THRESHOLDS
					prop_default = [-1:.5:1];
				case 1 % AnalyzeGroup_ST_BUT.NAME
					prop_default = 'AnalyzeGroup_ST_BUT';
				case 2 % AnalyzeGroup_ST_BUT.DESCRIPTION
				...
				case 4 % AnalyzeGroup_ST_BUT.ID
					prop_default = 'AnalyzeGroup_ST_BUT ID';
				case 5 % AnalyzeGroup_ST_BUT.LABEL
					prop_default = 'AnalyzeGroup_ST_BUT label';
				case 6 % AnalyzeGroup_ST_BUT.NOTES
					prop_default = 'AnalyzeGroup_ST_BUT notes';
				case 8 % AnalyzeGroup_ST_BUT.GR
