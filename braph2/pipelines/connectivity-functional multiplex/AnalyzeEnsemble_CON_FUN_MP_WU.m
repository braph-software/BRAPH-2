classdef AnalyzeEnsemble_CON_FUN_MP_WU < AnalyzeEnsemble
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the ensemble-based graph analysis with connectivity and functional multiplex data.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the ensemble-based graph analysis with connectivity and functional multiplex data.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the ensemble-based graph analysis with connectivity and functional multiplex data.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the ensemble-based graph analysis with connectivity and functional multiplex data.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the ensemble-based graph analysis with connectivity and functional multiplex data.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the ensemble-based graph analysis with connectivity and functional multiplex data.
	...
	%  <strong>10</strong> <strong>G_DICT</strong> 	G_DICT (result, idict) is the multiplex (MultiplexWU) ensemble obtained from this analysis.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzeensemble_con_fun_mp_wu_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'GR'  'GRAPH_TEMPLATE'  'G_DICT'  'ME_DICT'  'MEASUREENSEMBLE'  'REPETITION'  'F_MIN'  'F_MAX'  'CORRELATION_RULE'  'NEGATIVE_WEIGHT_RULE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_fun_mp_wu_category_list = { 1  1  3  4  2  2  9  4  3  5  5  6  3  3  3  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_fun_mp_wu_format_list = { 2  2  8  2  2  2  4  8  8  10  10  8  11  11  11  5  5 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 13 % AnalyzeEnsemble_CON_FUN_MP_WU.REPETITION
					prop_settings = Format.getFormatSettings(11);
				case 14 % AnalyzeEnsemble_CON_FUN_MP_WU.F_MIN
					prop_settings = Format.getFormatSettings(11);
				case 15 % AnalyzeEnsemble_CON_FUN_MP_WU.F_MAX
					prop_settings = Format.getFormatSettings(11);
				case 16 % AnalyzeEnsemble_CON_FUN_MP_WU.CORRELATION_RULE
					prop_settings = Correlation.CORRELATION_RULE_LIST(1:3);
				case 17 % AnalyzeEnsemble_CON_FUN_MP_WU.NEGATIVE_WEIGHT_RULE
					prop_settings = Correlation.NEGATIVE_WEIGHT_RULE_LIST;
				case 3 % AnalyzeEnsemble_CON_FUN_MP_WU.TEMPLATE
					prop_settings = 'AnalyzeEnsemble_CON_FUN_MP_WU';
				case 9 % AnalyzeEnsemble_CON_FUN_MP_WU.GRAPH_TEMPLATE
					prop_settings = 'MultiplexWU';
				case 10 % AnalyzeEnsemble_CON_FUN_MP_WU.G_DICT
					prop_settings = 'MultiplexWU';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % AnalyzeEnsemble_CON_FUN_MP_WU.NAME
					prop_default = 'AnalyzeEnsemble_CON_FUN_MP_WU';
				case 2 % AnalyzeEnsemble_CON_FUN_MP_WU.DESCRIPTION
				...
				case 4 % AnalyzeEnsemble_CON_FUN_MP_WU.ID
					prop_default = 'AnalyzeEnsemble_CON_FUN_MP_WU ID';
				case 5 % AnalyzeEnsemble_CON_FUN_MP_WU.LABEL
					prop_default = 'AnalyzeEnsemble_CON_FUN_MP_WU label';
				case 6 % AnalyzeEnsemble_CON_FUN_MP_WU.NOTES
					prop_default = 'AnalyzeEnsemble_CON_FUN_MP_WU notes';
				case 8 % AnalyzeEnsemble_CON_FUN_MP_WU.GR
