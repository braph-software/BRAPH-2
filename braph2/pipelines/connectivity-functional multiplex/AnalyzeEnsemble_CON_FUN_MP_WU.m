classdef AnalyzeEnsemble_CON_FUN_MP_WU < AnalyzeEnsemble
	...
	%  <strong>11</strong> <strong>G_DICT</strong> 	G_DICT (result, idict) is the multiplex (MultiplexWU) ensemble obtained from this analysis.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzeensemble_con_fun_mp_wu_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'GR'  'GRAPH_TEMPLATE'  'G_DICT'  'ME_DICT'  'MEASUREENSEMBLE'  'REPETITION'  'F_MIN'  'F_MAX'  'CORRELATION_RULE'  'NEGATIVE_WEIGHT_RULE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_fun_mp_wu_category_list = { 1  1  3  4  2  2  6  9  4  3  5  5  6  3  3  3  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_con_fun_mp_wu_format_list = { 2  2  8  2  2  2  2  4  8  8  10  10  8  11  11  11  5  5 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 14 % AnalyzeEnsemble_CON_FUN_MP_WU.REPETITION
					prop_settings = Format.getFormatSettings(11);
				case 15 % AnalyzeEnsemble_CON_FUN_MP_WU.F_MIN
					prop_settings = Format.getFormatSettings(11);
				case 16 % AnalyzeEnsemble_CON_FUN_MP_WU.F_MAX
					prop_settings = Format.getFormatSettings(11);
				case 17 % AnalyzeEnsemble_CON_FUN_MP_WU.CORRELATION_RULE
					prop_settings = Correlation.CORRELATION_RULE_LIST(1:3);
				case 18 % AnalyzeEnsemble_CON_FUN_MP_WU.NEGATIVE_WEIGHT_RULE
				...
				case 10 % AnalyzeEnsemble_CON_FUN_MP_WU.GRAPH_TEMPLATE
					prop_settings = 'MultiplexWU';
				case 11 % AnalyzeEnsemble_CON_FUN_MP_WU.G_DICT
					prop_settings = 'MultiplexWU';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 9 % AnalyzeEnsemble_CON_FUN_MP_WU.GR
