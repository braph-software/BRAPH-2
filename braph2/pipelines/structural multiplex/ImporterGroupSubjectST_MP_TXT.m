classdef ImporterGroupSubjectST_MP_TXT < Importer
	...
	%  <strong>10</strong> <strong>GET_DIR</strong> 	GET_DIR (query, item) opens a dialog box to set the directory from where to load the TXT files of the ST MP subject group with L layers.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				importergroupsubjectst_mp_txt_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'DIRECTORY'  'GET_DIR'  'BA'  'GR' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectst_mp_txt_category_list = { 1  1  3  4  2  2  6  9  4  6  4  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectst_mp_txt_format_list = { 2  2  8  2  2  2  2  4  2  8  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % ImporterGroupSubjectST_MP_TXT.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 10 % ImporterGroupSubjectST_MP_TXT.GET_DIR
					prop_settings = 'ImporterGroupSubjectST_MP_TXT';
				case 11 % ImporterGroupSubjectST_MP_TXT.BA
					prop_settings = 'BrainAtlas';
				case 12 % ImporterGroupSubjectST_MP_TXT.GR
					prop_settings = 'Group';
