	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzegroup_st_mp_wu_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'GR'  'G'  'CORRELATION_RULE'  'NEGATIVE_WEIGHT_RULE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzegroup_st_mp_wu_category_list = { 1  1  3  4  2  2  9  4  5  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzegroup_st_mp_wu_format_list = { 2  2  8  2  2  2  4  8  8  5  5 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 10 % AnalyzeGroup_ST_MP_WU.CORRELATION_RULE
					prop_settings = Correlation.CORRELATION_RULE_LIST;
				case 11 % AnalyzeGroup_ST_MP_WU.NEGATIVE_WEIGHT_RULE
				...
				case 9 % AnalyzeGroup_ST_MP_WU.G
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 8 % AnalyzeGroup_ST_MP_WU.GR
