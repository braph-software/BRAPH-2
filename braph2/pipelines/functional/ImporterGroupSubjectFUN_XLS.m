classdef ImporterGroupSubjectFUN_XLS < Importer
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the FUN subject group importer from XLS/XLSX.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the FUN subject group importer from XLS/XLSX.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the FUN subject group importer from XLS/XLSX.
	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 2 % ImporterGroupSubjectFUN_XLS.DESCRIPTION
				...
				case 4 % ImporterGroupSubjectFUN_XLS.ID
					prop_default = 'ImporterGroupSubjectFUN_XLS ID';
				case 5 % ImporterGroupSubjectFUN_XLS.LABEL
					prop_default = 'ImporterGroupSubjectFUN_XLS label';
				case 6 % ImporterGroupSubjectFUN_XLS.NOTES
