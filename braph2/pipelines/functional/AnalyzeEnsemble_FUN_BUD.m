classdef AnalyzeEnsemble_FUN_BUD < AnalyzeEnsemble
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the ensemble-based graph analysis with functional data of fixed density.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the ensemble-based graph analysis with functional data of fixed density.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the ensemble-based graph analysis with functional data of fixed density.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the ensemble-based graph analysis with functional data of fixed density.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the ensemble-based graph analysis with functional data of fixed density.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the ensemble-based graph analysis with functional data of fixed density.
	...
	%  <strong>10</strong> <strong>G_DICT</strong> 	G_DICT (result, idict) is the graph (MultigraphBUD) ensemble obtained from this analysis.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzeensemble_fun_bud_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'GR'  'GRAPH_TEMPLATE'  'G_DICT'  'ME_DICT'  'MEASUREENSEMBLE'  'REPETITION'  'F_MIN'  'F_MAX'  'CORRELATION_RULE'  'NEGATIVE_WEIGHT_RULE'  'DENSITIES' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_fun_bud_category_list = { 1  1  3  4  2  2  9  4  3  5  5  6  3  3  3  3  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_fun_bud_format_list = { 2  2  8  2  2  2  4  8  8  10  10  8  11  11  11  5  5  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 13 % AnalyzeEnsemble_FUN_BUD.REPETITION
					prop_settings = Format.getFormatSettings(11);
				case 14 % AnalyzeEnsemble_FUN_BUD.F_MIN
					prop_settings = Format.getFormatSettings(11);
				case 15 % AnalyzeEnsemble_FUN_BUD.F_MAX
					prop_settings = Format.getFormatSettings(11);
				case 16 % AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE
					prop_settings = Correlation.CORRELATION_RULE_LIST(1:3);
				case 17 % AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE
					prop_settings = Correlation.NEGATIVE_WEIGHT_RULE_LIST;
				case 18 % AnalyzeEnsemble_FUN_BUD.DENSITIES
					prop_settings = Format.getFormatSettings(12);
				case 9 % AnalyzeEnsemble_FUN_BUD.GRAPH_TEMPLATE
					prop_settings = 'MultigraphBUD';
				case 10 % AnalyzeEnsemble_FUN_BUD.G_DICT
					prop_settings = 'MultigraphBUD';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 18 % AnalyzeEnsemble_FUN_BUD.DENSITIES
					prop_default = [1:1:10];
				case 1 % AnalyzeEnsemble_FUN_BUD.NAME
					prop_default = 'AnalyzeEnsemble_FUN_BUD';
				case 2 % AnalyzeEnsemble_FUN_BUD.DESCRIPTION
				...
				case 4 % AnalyzeEnsemble_FUN_BUD.ID
					prop_default = 'AnalyzeEnsemble_FUN_BUD ID';
				case 5 % AnalyzeEnsemble_FUN_BUD.LABEL
					prop_default = 'AnalyzeEnsemble_FUN_BUD label';
				case 6 % AnalyzeEnsemble_FUN_BUD.NOTES
					prop_default = 'AnalyzeEnsemble_FUN_BUD notes';
				case 8 % AnalyzeEnsemble_FUN_BUD.GR
