classdef ImporterGroupSubjectFUN_TXT < Importer
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the FUN subject group importer from TXT.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the FUN subject group importer from TXT.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the FUN subject group importer from TXT.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the FUN subject group importer from TXT.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the FUN subject group importer from TXT.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the FUN subject group importer from TXT.
	...
	%  <strong>10</strong> <strong>GET_DIR</strong> 	GET_DIR (query, item) opens a dialog box to set the directory from where to load the TXT files of the FUN subject group.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				importergroupsubjectfun_txt_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'DIRECTORY'  'GET_DIR'  'BA'  'GR' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectfun_txt_category_list = { 1  1  3  4  2  2  6  9  4  6  4  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectfun_txt_format_list = { 2  2  8  2  2  2  2  4  2  8  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % ImporterGroupSubjectFUN_TXT.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 10 % ImporterGroupSubjectFUN_TXT.GET_DIR
					prop_settings = 'ImporterGroupSubjectFUN_TXT';
				case 11 % ImporterGroupSubjectFUN_TXT.BA
					prop_settings = 'BrainAtlas';
				case 12 % ImporterGroupSubjectFUN_TXT.GR
					prop_settings = 'Group';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % ImporterGroupSubjectFUN_TXT.NAME
					prop_default = 'ImporterGroupSubjectFUN_TXT';
				case 2 % ImporterGroupSubjectFUN_TXT.DESCRIPTION
				...
				case 4 % ImporterGroupSubjectFUN_TXT.ID
					prop_default = 'ImporterGroupSubjectFUN_TXT ID';
				case 5 % ImporterGroupSubjectFUN_TXT.LABEL
					prop_default = 'ImporterGroupSubjectFUN_TXT label';
				case 6 % ImporterGroupSubjectFUN_TXT.NOTES
