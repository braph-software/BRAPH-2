classdef ImporterGroupSubjectFUN_TXT < Importer
	...
	%  <strong>9</strong> <strong>GET_DIR</strong> 	GET_DIR (query, item) opens a dialog box to set the directory from where to load the TXT files of the FUN subject group.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				importergroupsubjectfun_txt_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'DIRECTORY'  'GET_DIR'  'BA'  'GR' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectfun_txt_category_list = { 1  1  3  4  2  2  9  4  6  4  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			importergroupsubjectfun_txt_format_list = { 2  2  8  2  2  2  4  2  8  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 8 % ImporterGroupSubjectFUN_TXT.DIRECTORY
					prop_settings = Format.getFormatSettings(2);
				case 9 % ImporterGroupSubjectFUN_TXT.GET_DIR
					prop_settings = 'ImporterGroupSubjectFUN_TXT';
				case 10 % ImporterGroupSubjectFUN_TXT.BA
					prop_settings = 'BrainAtlas';
				case 11 % ImporterGroupSubjectFUN_TXT.GR
					prop_settings = 'Group';
				otherwise
