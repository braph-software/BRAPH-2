...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	im_1 = ImporterGroupSubjectFUN_XLS( ...
		...
		ImporterGroupSubjectFUN_XLS.NOTES, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.NOTES), ...
		ImporterGroupSubjectFUN_XLS.TOSTRING, ImporterGroupSubjectFUN_XLS.getNoValue(), ...
		ImporterGroupSubjectFUN_XLS.WAITBAR, im_0.getCallback(8), ..., ...
		ImporterGroupSubjectFUN_XLS.DIRECTORY, im_0.getCallback(9), ..., ...
		ImporterGroupSubjectFUN_XLS.GET_DIR, ImporterGroupSubjectFUN_XLS.getNoValue(), ...
		ImporterGroupSubjectFUN_XLS.BA, im_0.getCallback(11), ..., ...
		ImporterGroupSubjectFUN_XLS.GR, ImporterGroupSubjectFUN_XLS.getNoValue() ...
		);
	...
	im_2 = ImporterGroupSubjectFUN_XLS( ...
		...
		ImporterGroupSubjectFUN_XLS.NOTES, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.NOTES), ...
		ImporterGroupSubjectFUN_XLS.TOSTRING, ImporterGroupSubjectFUN_XLS.getNoValue(), ...
		ImporterGroupSubjectFUN_XLS.WAITBAR, im_1.getCallback(8), ..., ...
		ImporterGroupSubjectFUN_XLS.DIRECTORY, im_1.getCallback(9), ..., ...
		ImporterGroupSubjectFUN_XLS.GET_DIR, ImporterGroupSubjectFUN_XLS.getNoValue(), ...
		ImporterGroupSubjectFUN_XLS.BA, im_1.getCallback(11), ..., ...
		ImporterGroupSubjectFUN_XLS.GR, ImporterGroupSubjectFUN_XLS.getNoValue() ...
		);
	...
	im_3 = ImporterGroupSubjectFUN_XLS( ...
		...
		ImporterGroupSubjectFUN_XLS.NOTES, ImporterGroupSubjectFUN_XLS.getPropDefault(ImporterGroupSubjectFUN_XLS.NOTES), ...
		ImporterGroupSubjectFUN_XLS.TOSTRING, ImporterGroupSubjectFUN_XLS.getNoValue(), ...
		ImporterGroupSubjectFUN_XLS.WAITBAR, im_2.getCallback(8), ..., ...
		ImporterGroupSubjectFUN_XLS.DIRECTORY, im_2.getCallback(9), ..., ...
		ImporterGroupSubjectFUN_XLS.GET_DIR, ImporterGroupSubjectFUN_XLS.getNoValue(), ...
		ImporterGroupSubjectFUN_XLS.BA, im_2.getCallback(11), ..., ...
		ImporterGroupSubjectFUN_XLS.GR, ImporterGroupSubjectFUN_XLS.getNoValue() ...
		);
