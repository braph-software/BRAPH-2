classdef AnalyzeEnsemble_FUN_BUT < AnalyzeEnsemble
	...
	%  <strong>11</strong> <strong>G_DICT</strong> 	G_DICT (result, idict) is the graph (MultigraphBUT) ensemble obtained from this analysis.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzeensemble_fun_but_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'GR'  'GRAPH_TEMPLATE'  'G_DICT'  'ME_DICT'  'MEASUREENSEMBLE'  'REPETITION'  'F_MIN'  'F_MAX'  'CORRELATION_RULE'  'NEGATIVE_WEIGHT_RULE'  'THRESHOLDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_fun_but_category_list = { 1  1  3  4  2  2  6  9  4  3  5  5  6  3  3  3  3  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzeensemble_fun_but_format_list = { 2  2  8  2  2  2  2  4  8  8  10  10  8  11  11  11  5  5  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 14 % AnalyzeEnsemble_FUN_BUT.REPETITION
					prop_settings = Format.getFormatSettings(11);
				case 15 % AnalyzeEnsemble_FUN_BUT.F_MIN
					prop_settings = Format.getFormatSettings(11);
				case 16 % AnalyzeEnsemble_FUN_BUT.F_MAX
					prop_settings = Format.getFormatSettings(11);
				case 17 % AnalyzeEnsemble_FUN_BUT.CORRELATION_RULE
					prop_settings = Correlation.CORRELATION_RULE_LIST(1:3);
				case 18 % AnalyzeEnsemble_FUN_BUT.NEGATIVE_WEIGHT_RULE
					prop_settings = Correlation.NEGATIVE_WEIGHT_RULE_LIST;
				case 19 % AnalyzeEnsemble_FUN_BUT.THRESHOLDS
					prop_settings = Format.getFormatSettings(12);
				case 10 % AnalyzeEnsemble_FUN_BUT.GRAPH_TEMPLATE
					prop_settings = 'MultigraphBUT';
				case 11 % AnalyzeEnsemble_FUN_BUT.G_DICT
					prop_settings = 'MultigraphBUT';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 9 % AnalyzeEnsemble_FUN_BUT.GR
