classdef NNRegressorMLP_CrossValidationPF_Scatter < PanelFig
	...
	properties (Constant) % properties
		...
		H_PREDICTIONS = PanelFig.getPropNumber() + 6;
		H_PREDICTIONS_TAG = 'H_PREDICTIONS';
		H_PREDICTIONS_CATEGORY = Category.EVANESCENT;
		H_PREDICTIONS_FORMAT = Format.HANDLELIST;
		
		PREDICTIONS = PanelFig.getPropNumber() + 7;
		PREDICTIONS_TAG = 'PREDICTIONS';
		PREDICTIONS_CATEGORY = Category.FIGURE;
		PREDICTIONS_FORMAT = Format.LOGICAL;
		
		PREDICTION_DICT = PanelFig.getPropNumber() + 8;
		PREDICTION_DICT_TAG = 'PREDICTION_DICT';
		PREDICTION_DICT_CATEGORY = Category.FIGURE;
		PREDICTION_DICT_FORMAT = Format.IDICT;
		
		H_LINE_PREDICTION = PanelFig.getPropNumber() + 9;
		H_LINE_PREDICTION_TAG = 'H_LINE_PREDICTION';
		H_LINE_PREDICTION_CATEGORY = Category.EVANESCENT;
		H_LINE_PREDICTION_FORMAT = Format.HANDLE;
		
		ST_LINE_PREDICTION = PanelFig.getPropNumber() + 10;
		ST_LINE_PREDICTION_TAG = 'ST_LINE_PREDICTION';
		ST_LINE_PREDICTION_CATEGORY = Category.FIGURE;
		ST_LINE_PREDICTION_FORMAT = Format.ITEM;
		
		LISTENER_ST_LINE_PREDICTION = PanelFig.getPropNumber() + 11;
		LISTENER_ST_LINE_PREDICTION_TAG = 'LISTENER_ST_LINE_PREDICTION';
		LISTENER_ST_LINE_PREDICTION_CATEGORY = Category.EVANESCENT;
		LISTENER_ST_LINE_PREDICTION_FORMAT = Format.HANDLE;
		
		H_LINE_BASE = PanelFig.getPropNumber() + 12;
		H_LINE_BASE_TAG = 'H_LINE_BASE';
		H_LINE_BASE_CATEGORY = Category.EVANESCENT;
		H_LINE_BASE_FORMAT = Format.HANDLE;
		
		ST_LINE_BASE = PanelFig.getPropNumber() + 13;
		ST_LINE_BASE_TAG = 'ST_LINE_BASE';
		ST_LINE_BASE_CATEGORY = Category.FIGURE;
		ST_LINE_BASE_FORMAT = Format.ITEM;
		
		LISTENER_ST_LINE_BASE = PanelFig.getPropNumber() + 14;
	...
	methods (Static) % inspection
			...
			if nargin == 0
				prop_list = [ ...
					PanelFig.getProps() ...
						...
						NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION ...
						NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION ...
						NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION ...
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION
						tag = NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION_TAG;
					case NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION
						tag = NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION_TAG;
					case NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION
						tag = NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION
					prop_category = NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION_CATEGORY;
				case NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION
					prop_category = NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION_CATEGORY;
				case NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION
					prop_category = NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION_CATEGORY;
				case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_BASE
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION
					prop_format = NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION_FORMAT;
				case NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION
					prop_format = NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION_FORMAT;
				case NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION
					prop_format = NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION_FORMAT;
				case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_BASE
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION
					prop_description = 'H_LINE_PREDICTION (evanescent, handle) is the handle for the prediction line.';
				case NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION
					prop_description = 'ST_LINE_PREDICTION (figure, item) determines the line settings.';
				case NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION
					prop_description = 'LISTENER_ST_LINE_PREDICTION (evanescent, handle) contains the listener to the measure line settings to update the pushbutton.';
				case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_BASE
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION % __NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_PREDICTION__
					check = Format.checkFormat(Format.HANDLE, value, NNRegressorMLP_CrossValidationPF_Scatter.getPropSettings(prop));
				case NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION % __NNRegressorMLP_CrossValidationPF_Scatter.ST_LINE_PREDICTION__
					check = Format.checkFormat(Format.ITEM, value, NNRegressorMLP_CrossValidationPF_Scatter.getPropSettings(prop));
				case NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION % __NNRegressorMLP_CrossValidationPF_Scatter.LISTENER_ST_LINE_PREDICTION__
					check = Format.checkFormat(Format.HANDLE, value, NNRegressorMLP_CrossValidationPF_Scatter.getPropSettings(prop));
			...
			switch prop
				...
				case NNRegressorMLP_CrossValidationPF_Scatter.PREDICTIONS % __NNRegressorMLP_CrossValidationPF_Scatter.PREDICTIONS__
					if ~pf.get('PREDICTIONS') % false
                        ...
                        h_predictions = pf.get('H_PREDICTIONS');
					    for i = 1:1:length(h_predictions)
					        set(h_predictions{i}, 'Visible', true)
					    end
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pf, prop, varargin)
			...
			switch prop
				...
				case NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_BASE % __NNRegressorMLP_CrossValidationPF_Scatter.H_LINE_BASE__
					value = plot(pf.get('H_AXES'), [0], [0], 'x', 'LineWidth', 2);
