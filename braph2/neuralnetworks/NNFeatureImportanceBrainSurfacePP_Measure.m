classdef NNFeatureImportanceBrainSurfacePP_Measure < PanelProp
	%NNFeatureImportanceBrainSurfacePP_Measure plots the panel to manage the feature importance of a neural network analysis with graph measures.
	...
	%
	% The list of NNFeatureImportanceBrainSurfacePP_Measure properties is:
	...
	%  <strong>46</strong> <strong>GUI_FI_DICT</strong> 	GUI_FI_DICT (gui, idict) contains the GUIs for the feature measures.
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (constructor):
	%  NNFeatureImportanceBrainSurfacePP_Measure - constructor
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods:
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (display):
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (miscellanea):
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (save/load, Static):
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Measure method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the panel property feature importance
	%
	% NNFeatureImportanceBrainSurfacePP_Measure method (JSON decode, Static):
	%   decodeJSON - returns a JSON string encoding the panel property feature importance
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (inspection, Static):
	%  getClass - returns the class of the panel property feature importance
	%  getSubclasses - returns all subclasses of NNFeatureImportanceBrainSurfacePP_Measure
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (GUI):
	%  getPanelProp - returns a prop panel
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (GUI, Static):
	%  getGUIMenuImport - returns the importer menu
	%  getGUIMenuExport - returns the exporter menu
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (category, Static):
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Measure methods (format, Static):
	...
	%
	% To print full list of constants, click here <a href="matlab:metaclass = ?NNFeatureImportanceBrainSurfacePP_Measure; properties = metaclass.PropertyList;for i = 1:1:length(properties), if properties(i).Constant, disp([properties(i).Name newline() tostring(properties(i).DefaultValue) newline()]), end, end">NNFeatureImportanceBrainSurfacePP_Measure constants</a>.
	%
	%
	...
	properties (Constant) % properties
		...
		GUI_FI_DICT = 46; %CET: Computational Efficiency Trick
		GUI_FI_DICT_TAG = 'GUI_FI_DICT';
		GUI_FI_DICT_CATEGORY = 9;
		GUI_FI_DICT_FORMAT = 10;
	end
	methods % constructor
		function pr = NNFeatureImportanceBrainSurfacePP_Measure(varargin)
			%NNFeatureImportanceBrainSurfacePP_Measure() creates a panel property feature importance.
			%
			% NNFeatureImportanceBrainSurfacePP_Measure(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% NNFeatureImportanceBrainSurfacePP_Measure(TAG, VALUE, ...) with property TAG set to VALUE.
			%
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = NNFeatureImportanceBrainSurfacePP_Measure.GETBUILD() returns the build of 'NNFeatureImportanceBrainSurfacePP_Measure'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the panel property feature importance PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('NNFeatureImportanceBrainSurfacePP_Measure') returns the build of 'NNFeatureImportanceBrainSurfacePP_Measure'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('NNFeatureImportanceBrainSurfacePP_Measure')
		...
		function pr_class = getClass()
			%GETCLASS returns the class of the panel property feature importance.
			%
			% CLASS = NNFeatureImportanceBrainSurfacePP_Measure.GETCLASS() returns the class 'NNFeatureImportanceBrainSurfacePP_Measure'.
			%
			% Alternative forms to call this method are:
			%  CLASS = PR.GETCLASS() returns the class of the panel property feature importance PR.
			%  CLASS = Element.GETCLASS(PR) returns the class of 'PR'.
			%  CLASS = Element.GETCLASS('NNFeatureImportanceBrainSurfacePP_Measure') returns 'NNFeatureImportanceBrainSurfacePP_Measure'.
			%
			% Note that the Element.GETCLASS(PR) and Element.GETCLASS('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			
			pr_class = 'NNFeatureImportanceBrainSurfacePP_Measure';
		end
		function subclass_list = getSubclasses()
			%GETSUBCLASSES returns all subclasses of the panel property feature importance.
			%
			% LIST = NNFeatureImportanceBrainSurfacePP_Measure.GETSUBCLASSES() returns all subclasses of 'NNFeatureImportanceBrainSurfacePP_Measure'.
			%
			% Alternative forms to call this method are:
			%  LIST = PR.GETSUBCLASSES() returns all subclasses of the panel property feature importance PR.
			%  LIST = Element.GETSUBCLASSES(PR) returns all subclasses of 'PR'.
			%  LIST = Element.GETSUBCLASSES('NNFeatureImportanceBrainSurfacePP_Measure') returns all subclasses of 'NNFeatureImportanceBrainSurfacePP_Measure'.
			%
			% Note that the Element.GETSUBCLASSES(PR) and Element.GETSUBCLASSES('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			% See also subclasses.
			
			subclass_list = { 'NNFeatureImportanceBrainSurfacePP_Measure' }; %CET: Computational Efficiency Trick
		end
		function prop_list = getProps(category)
			%GETPROPS returns the property list of panel property feature importance.
			%
			% PROPS = NNFeatureImportanceBrainSurfacePP_Measure.GETPROPS() returns the property list of panel property feature importance
			%  as a row vector.
			%
			% PROPS = NNFeatureImportanceBrainSurfacePP_Measure.GETPROPS(CATEGORY) returns the property list 
			%  of category CATEGORY.
			%
			% Alternative forms to call this method are:
			%  PROPS = PR.GETPROPS([CATEGORY]) returns the property list of the panel property feature importance PR.
			%  PROPS = Element.GETPROPS(PR[, CATEGORY]) returns the property list of 'PR'.
			%  PROPS = Element.GETPROPS('NNFeatureImportanceBrainSurfacePP_Measure'[, CATEGORY]) returns the property list of 'NNFeatureImportanceBrainSurfacePP_Measure'.
			%
			% Note that the Element.GETPROPS(PR) and Element.GETPROPS('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			switch category
				...
				case 8 % Category.FIGURE
					prop_list = 14;
				case 9 % Category.GUI
					prop_list = [9 13 25 26 37 38 39 40 41 42 45 46];
				otherwise
					prop_list = [];
			end
		end
		function prop_number = getPropNumber(varargin)
			...
			%
			% N = NNFeatureImportanceBrainSurfacePP_Measure.GETPROPNUMBER() returns the property number of panel property feature importance.
			%
			% N = NNFeatureImportanceBrainSurfacePP_Measure.GETPROPNUMBER(CATEGORY) returns the property number of panel property feature importance
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
			%  N = PR.GETPROPNUMBER([CATEGORY]) returns the property number of the panel property feature importance PR.
			%  N = Element.GETPROPNUMBER(PR) returns the property number of 'PR'.
			%  N = Element.GETPROPNUMBER('NNFeatureImportanceBrainSurfacePP_Measure') returns the property number of 'NNFeatureImportanceBrainSurfacePP_Measure'.
			%
			% Note that the Element.GETPROPNUMBER(PR) and Element.GETPROPNUMBER('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
		...
		function check_out = existsProp(prop)
			...
			%
			% CHECK = NNFeatureImportanceBrainSurfacePP_Measure.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSPROP(PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PR, PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(NNFeatureImportanceBrainSurfacePP_Measure, PROP) checks whether PROP exists for NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Element.EXISTSPROP(PROP) throws an error if the PROP does NOT exist.
			%  Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Measure:WrongInput]
			%
			% Alternative forms to call this method are:
			...
			%   Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Measure:WrongInput]
			%  Element.EXISTSPROP(NNFeatureImportanceBrainSurfacePP_Measure, PROP) throws error if PROP does NOT exist for NNFeatureImportanceBrainSurfacePP_Measure.
			%   Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Measure:WrongInput]
			%
			% Note that the Element.EXISTSPROP(PR) and Element.EXISTSPROP('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			elseif ~check
				error( ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Measure:' 'WrongInput'], ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Measure:' 'WrongInput' '\n' ...
					'The value ' tostring(prop, 100, ' ...') ' is not a valid prop for NNFeatureImportanceBrainSurfacePP_Measure.'] ...
					)
			end
		end
		function check_out = existsTag(tag)
			...
			%
			% CHECK = NNFeatureImportanceBrainSurfacePP_Measure.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSTAG(TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PR, TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(NNFeatureImportanceBrainSurfacePP_Measure, TAG) checks whether TAG exists for NNFeatureImportanceBrainSurfacePP_Measure.
			%
			...
			%   Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Measure:WrongInput]
			%  Element.EXISTSTAG(NNFeatureImportanceBrainSurfacePP_Measure, TAG) throws error if TAG does NOT exist for NNFeatureImportanceBrainSurfacePP_Measure.
			%   Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Measure:WrongInput]
			%
			% Note that the Element.EXISTSTAG(PR) and Element.EXISTSTAG('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			% See also getProps, existsTag.
			
			check = any(strcmp(tag, { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'D'  'ENABLE'  'ROWNAME'  'COLUMNNAME'  'MENU_EXPORT'  'TABLE_HEIGHT'  'SELECTED'  'TABLE'  'CONTEXTMENU'  'GUI_B_DICT'  'GUI_FI_DICT' })); %CET: Computational Efficiency Trick
			...
			elseif ~check
				error( ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Measure:' 'WrongInput'], ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Measure:' 'WrongInput' '\n' ...
					'The value ' tag ' is not a valid tag for NNFeatureImportanceBrainSurfacePP_Measure.'] ...
					)
			end
		end
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns property number of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%  PROPERTY = PR.GETPROPPROP(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns property number of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Note that the Element.GETPROPPROP(PR) and Element.GETPROPPROP('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			if ischar(pointer)
				prop = find(strcmp(pointer, { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'D'  'ENABLE'  'ROWNAME'  'COLUMNNAME'  'MENU_EXPORT'  'TABLE_HEIGHT'  'SELECTED'  'TABLE'  'CONTEXTMENU'  'GUI_B_DICT'  'GUI_FI_DICT' })); % tag = pointer %CET: Computational Efficiency Trick
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns tag of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%  TAG = PR.GETPROPTAG(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns tag of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Note that the Element.GETPROPTAG(PR) and Element.GETPROPTAG('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nnfeatureimportancebrainsurfacepp_measure_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'D'  'ENABLE'  'ROWNAME'  'COLUMNNAME'  'MENU_EXPORT'  'TABLE_HEIGHT'  'SELECTED'  'TABLE'  'CONTEXTMENU'  'GUI_B_DICT'  'GUI_FI_DICT' };
				tag = nnfeatureimportancebrainsurfacepp_measure_tag_list{pointer}; % prop = pointer
			end
		end
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns category of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%  CATEGORY = PR.GETPROPCATEGORY(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns category of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Note that the Element.GETPROPCATEGORY(PR) and Element.GETPROPCATEGORY('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			% See also Category, getPropProp, getPropTag, getPropSettings,
			%  getPropFormat, getPropDescription, getPropDefault, checkProp.
			
			prop = NNFeatureImportanceBrainSurfacePP_Measure.getPropProp(pointer);
			
			%CET: Computational Efficiency Trick
			nnfeatureimportancebrainsurfacepp_measure_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  2  9  9  9  9  9  9  7  7  9  9 };
			prop_category = nnfeatureimportancebrainsurfacepp_measure_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns format of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%  FORMAT = PR.GETPROPFORMAT(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns format of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Note that the Element.GETPROPFORMAT(PR) and Element.GETPROPFORMAT('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			%CET: Computational Efficiency Trick
			nnfeatureimportancebrainsurfacepp_measure_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  8  5  3  3  4  22  13  18  18  10  10 };
			prop_format = nnfeatureimportancebrainsurfacepp_measure_format_list{prop};
		end
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns description of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%  DESCRIPTION = PR.GETPROPDESCRIPTION(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns description of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Note that the Element.GETPROPDESCRIPTION(PR) and Element.GETPROPDESCRIPTION('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns settings of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%  SETTINGS = PR.GETPROPSETTINGS(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns settings of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Note that the Element.GETPROPSETTINGS(PR) and Element.GETPROPSETTINGS('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			switch prop %CET: Computational Efficiency Trick
				case 36 % NNFeatureImportanceBrainSurfacePP_Measure.D
					prop_settings = Format.getFormatSettings(8);
				case 37 % NNFeatureImportanceBrainSurfacePP_Measure.ENABLE
					prop_settings = {'on', 'off'};
				case 38 % NNFeatureImportanceBrainSurfacePP_Measure.ROWNAME
					prop_settings = Format.getFormatSettings(3);
				case 39 % NNFeatureImportanceBrainSurfacePP_Measure.COLUMNNAME
					prop_settings = Format.getFormatSettings(3);
				case 40 % NNFeatureImportanceBrainSurfacePP_Measure.MENU_EXPORT
					prop_settings = Format.getFormatSettings(4);
				case 41 % NNFeatureImportanceBrainSurfacePP_Measure.TABLE_HEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 42 % NNFeatureImportanceBrainSurfacePP_Measure.SELECTED
					prop_settings = Format.getFormatSettings(13);
				case 43 % NNFeatureImportanceBrainSurfacePP_Measure.TABLE
					prop_settings = Format.getFormatSettings(18);
				case 44 % NNFeatureImportanceBrainSurfacePP_Measure.CONTEXTMENU
					prop_settings = Format.getFormatSettings(18);
				case 45 % NNFeatureImportanceBrainSurfacePP_Measure.GUI_B_DICT
					prop_settings = 'GUIFig';
				case 46 % NNFeatureImportanceBrainSurfacePP_Measure.GUI_FI_DICT
					prop_settings = 'GUIElement';
				case 4 % NNFeatureImportanceBrainSurfacePP_4
					prop_settings = 'NNFeatureImportanceBrainSurfacePP_Measure';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = NNFeatureImportanceBrainSurfacePP_Measure.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = NNFeatureImportanceBrainSurfacePP_Measure.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULT(POINTER) returns the default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULT(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns the default value of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%  DEFAULT = PR.GETPROPDEFAULT(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns the default value of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Note that the Element.GETPROPDEFAULT(PR) and Element.GETPROPDEFAULT('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 41 % NNFeatureImportanceBrainSurfacePP_Measure.TABLE_HEIGHT
					prop_default = 240;
				case 42 % NNFeatureImportanceBrainSurfacePP_Measure.SELECTED
					prop_default = Format.getFormatDefault(13, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 43 % NNFeatureImportanceBrainSurfacePP_Measure.TABLE
					prop_default = Format.getFormatDefault(18, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 44 % NNFeatureImportanceBrainSurfacePP_Measure.CONTEXTMENU
					prop_default = Format.getFormatDefault(18, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 45 % NNFeatureImportanceBrainSurfacePP_Measure.GUI_B_DICT
					prop_default = Format.getFormatDefault(10, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 46 % NNFeatureImportanceBrainSurfacePP_Measure.GUI_FI_DICT
					prop_default = Format.getFormatDefault(10, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 1 % NNFeatureImportanceBrainSurfacePP_1
					prop_default = 'NNFeatureImportanceBrainSurfacePP_Measure';
				...
				case 4 % NNFeatureImportanceBrainSurfacePP_4
					prop_default = Format.getFormatDefault(8, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 5 % NNFeatureImportanceBrainSurfacePP_5
					prop_default = 'NNFeatureImportanceBrainSurfacePP_Measure ID';
				case 6 % NNFeatureImportanceBrainSurfacePP_6
					prop_default = 'NNFeatureImportanceBrainSurfacePP_Measure label';
				case 7 % NNFeatureImportanceBrainSurfacePP_7
					prop_default = 'NNFeatureImportanceBrainSurfacePP_Measure notes';
				case 23 % NNFeatureImportanceBrainSurfacePP_Measure.EL
					prop_default = NNFeatureImportanceBrainSurface();
				case 24 % NNFeatureImportanceBrainSurfacePP_Measure.PROP
					prop_default = 11;
				otherwise
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = NNFeatureImportanceBrainSurfacePP_Measure.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = NNFeatureImportanceBrainSurfacePP_Measure.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns the conditioned default value of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(NNFeatureImportanceBrainSurfacePP_Measure, POINTER) returns the conditioned default value of POINTER of NNFeatureImportanceBrainSurfacePP_Measure.
			%
			% Note that the Element.GETPROPDEFAULTCONDITIONED(PR) and Element.GETPROPDEFAULTCONDITIONED('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			prop_default = NNFeatureImportanceBrainSurfacePP_Measure.conditioning(prop, NNFeatureImportanceBrainSurfacePP_Measure.getPropDefault(prop));
		end
	end
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(NNFeatureImportanceBrainSurfacePP_Measure, PROP, VALUE) checks VALUE format for PROP of NNFeatureImportanceBrainSurfacePP_Measure.
			%  CHECK = PR.CHECKPROP(NNFeatureImportanceBrainSurfacePP_Measure, PROP, VALUE) checks VALUE format for PROP of NNFeatureImportanceBrainSurfacePP_Measure.
			% 
			...
			%   Error id: BRAPH2:NNFeatureImportanceBrainSurfacePP_Measure:WrongInput
			%  Element.CHECKPROP(NNFeatureImportanceBrainSurfacePP_Measure, PROP, VALUE) throws error if VALUE has not a valid format for PROP of NNFeatureImportanceBrainSurfacePP_Measure.
			%   Error id: BRAPH2:NNFeatureImportanceBrainSurfacePP_Measure:WrongInput
			%  PR.CHECKPROP(NNFeatureImportanceBrainSurfacePP_Measure, PROP, VALUE) throws error if VALUE has not a valid format for PROP of NNFeatureImportanceBrainSurfacePP_Measure.
			%   Error id: BRAPH2:NNFeatureImportanceBrainSurfacePP_Measure:WrongInput]
			% 
			% Note that the Element.CHECKPROP(PR) and Element.CHECKPROP('NNFeatureImportanceBrainSurfacePP_Measure')
			%  are less computationally efficient.
			%
			...
			switch prop
				case 36 % NNFeatureImportanceBrainSurfacePP_Measure.D
					check = Format.checkFormat(8, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 37 % NNFeatureImportanceBrainSurfacePP_Measure.ENABLE
					check = Format.checkFormat(5, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 38 % NNFeatureImportanceBrainSurfacePP_Measure.ROWNAME
					check = Format.checkFormat(3, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 39 % NNFeatureImportanceBrainSurfacePP_Measure.COLUMNNAME
					check = Format.checkFormat(3, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 40 % NNFeatureImportanceBrainSurfacePP_Measure.MENU_EXPORT
					check = Format.checkFormat(4, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 41 % NNFeatureImportanceBrainSurfacePP_Measure.TABLE_HEIGHT
					check = Format.checkFormat(22, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 42 % NNFeatureImportanceBrainSurfacePP_Measure.SELECTED
					check = Format.checkFormat(13, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 43 % NNFeatureImportanceBrainSurfacePP_Measure.TABLE
					check = Format.checkFormat(18, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 44 % NNFeatureImportanceBrainSurfacePP_Measure.CONTEXTMENU
					check = Format.checkFormat(18, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 45 % NNFeatureImportanceBrainSurfacePP_Measure.GUI_B_DICT
					check = Format.checkFormat(10, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 46 % NNFeatureImportanceBrainSurfacePP_Measure.GUI_FI_DICT
					check = Format.checkFormat(10, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
				case 4 % NNFeatureImportanceBrainSurfacePP_4
					check = Format.checkFormat(8, value, NNFeatureImportanceBrainSurfacePP_Measure.getPropSettings(prop));
			...
			elseif ~check
				error( ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Measure:' 'WrongInput'], ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Measure:' 'WrongInput' '\n' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' NNFeatureImportanceBrainSurfacePP_Measure.getPropTag(prop) ' (' NNFeatureImportanceBrainSurfacePP_Measure.getFormatTag(NNFeatureImportanceBrainSurfacePP_Measure.getPropFormat(prop)) ').'] ...
					)
			end
		end
	end
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 20 % NNFeatureImportanceBrainSurfacePP_Measure.X_DRAW
				...
				case 21 % NNFeatureImportanceBrainSurfacePP_Measure.UPDATE
				...
				case 22 % NNFeatureImportanceBrainSurfacePP_Measure.REDRAW
				...
				case 16 % NNFeatureImportanceBrainSurfacePP_Measure.SHOW
				...
				case 17 % NNFeatureImportanceBrainSurfacePP_Measure.HIDE
				...
				case 18 % NNFeatureImportanceBrainSurfacePP_Measure.DELETE
				...
				case 19 % NNFeatureImportanceBrainSurfacePP_Measure.CLOSE
