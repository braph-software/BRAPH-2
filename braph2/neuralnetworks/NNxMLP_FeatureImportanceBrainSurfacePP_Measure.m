classdef NNxMLP_FeatureImportanceBrainSurfacePP_Measure < PanelProp
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nnxmlp_featureimportancebrainsurfacepp_measure_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  2  9  9  9  9  9  9  7  7  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nnxmlp_featureimportancebrainsurfacepp_measure_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  8  5  3  3  4  22  13  18  18  10  10 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 37 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.ENABLE
					prop_settings = {'on', 'off'};
				case 38 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.ROWNAME
					prop_settings = Format.getFormatSettings(3);
				case 39 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.COLUMNNAME
					prop_settings = Format.getFormatSettings(3);
				case 40 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.MENU_EXPORT
					prop_settings = Format.getFormatSettings(4);
				case 41 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.TABLE_HEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 42 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.SELECTED
					prop_settings = Format.getFormatSettings(13);
				case 43 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.TABLE
					prop_settings = Format.getFormatSettings(18);
				case 44 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.CONTEXTMENU
					prop_settings = Format.getFormatSettings(18);
				case 45 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.GUI_B_DICT
					prop_settings = 'GUIFig';
				case 46 % NNxMLP_FeatureImportanceBrainSurfacePP_Measure.GUI_FI_DICT
