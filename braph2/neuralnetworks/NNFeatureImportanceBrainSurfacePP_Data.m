classdef NNFeatureImportanceBrainSurfacePP_Data < PanelProp
	%NNFeatureImportanceBrainSurfacePP_Data plots the panel to manage the feature importance of a neural network analysis with the data of subjects.
	% It is a subclass of <a href="matlab:help PanelProp">PanelProp</a>.
	%
	% A panel for feature importance of a neural network analysis with the data of subjects (NNFeatureImportanceBrainSurfacePP_Data) 
	...
	%
	% The list of NNFeatureImportanceBrainSurfacePP_Data properties is:
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (constructor):
	%  NNFeatureImportanceBrainSurfacePP_Data - constructor
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods:
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (display):
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (miscellanea):
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (save/load, Static):
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Data method (JSON encode):
	%  encodeJSON - returns a JSON string encoding the panel property feature importance
	%
	% NNFeatureImportanceBrainSurfacePP_Data method (JSON decode, Static):
	%   decodeJSON - returns a JSON string encoding the panel property feature importance
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (inspection, Static):
	%  getClass - returns the class of the panel property feature importance
	%  getSubclasses - returns all subclasses of NNFeatureImportanceBrainSurfacePP_Data
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (GUI):
	%  getPanelProp - returns a prop panel
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (GUI, Static):
	%  getGUIMenuImport - returns the importer menu
	%  getGUIMenuExport - returns the exporter menu
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (category, Static):
	...
	%
	% NNFeatureImportanceBrainSurfacePP_Data methods (format, Static):
	...
	%
	% To print full list of constants, click here <a href="matlab:metaclass = ?NNFeatureImportanceBrainSurfacePP_Data; properties = metaclass.PropertyList;for i = 1:1:length(properties), if properties(i).Constant, disp([properties(i).Name newline() tostring(properties(i).DefaultValue) newline()]), end, end">NNFeatureImportanceBrainSurfacePP_Data constants</a>.
	%
	%
	...
	methods % constructor
		function pr = NNFeatureImportanceBrainSurfacePP_Data(varargin)
			%NNFeatureImportanceBrainSurfacePP_Data() creates a panel property feature importance.
			%
			% NNFeatureImportanceBrainSurfacePP_Data(PROP, VALUE, ...) with property PROP initialized to VALUE.
			%
			% NNFeatureImportanceBrainSurfacePP_Data(TAG, VALUE, ...) with property TAG set to VALUE.
			%
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = NNFeatureImportanceBrainSurfacePP_Data.GETBUILD() returns the build of 'NNFeatureImportanceBrainSurfacePP_Data'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the panel property feature importance PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('NNFeatureImportanceBrainSurfacePP_Data') returns the build of 'NNFeatureImportanceBrainSurfacePP_Data'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('NNFeatureImportanceBrainSurfacePP_Data')
		...
		function pr_class = getClass()
			%GETCLASS returns the class of the panel property feature importance.
			%
			% CLASS = NNFeatureImportanceBrainSurfacePP_Data.GETCLASS() returns the class 'NNFeatureImportanceBrainSurfacePP_Data'.
			%
			% Alternative forms to call this method are:
			%  CLASS = PR.GETCLASS() returns the class of the panel property feature importance PR.
			%  CLASS = Element.GETCLASS(PR) returns the class of 'PR'.
			%  CLASS = Element.GETCLASS('NNFeatureImportanceBrainSurfacePP_Data') returns 'NNFeatureImportanceBrainSurfacePP_Data'.
			%
			% Note that the Element.GETCLASS(PR) and Element.GETCLASS('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			
			pr_class = 'NNFeatureImportanceBrainSurfacePP_Data';
		end
		function subclass_list = getSubclasses()
			%GETSUBCLASSES returns all subclasses of the panel property feature importance.
			%
			% LIST = NNFeatureImportanceBrainSurfacePP_Data.GETSUBCLASSES() returns all subclasses of 'NNFeatureImportanceBrainSurfacePP_Data'.
			%
			% Alternative forms to call this method are:
			%  LIST = PR.GETSUBCLASSES() returns all subclasses of the panel property feature importance PR.
			%  LIST = Element.GETSUBCLASSES(PR) returns all subclasses of 'PR'.
			%  LIST = Element.GETSUBCLASSES('NNFeatureImportanceBrainSurfacePP_Data') returns all subclasses of 'NNFeatureImportanceBrainSurfacePP_Data'.
			%
			% Note that the Element.GETSUBCLASSES(PR) and Element.GETSUBCLASSES('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			% See also subclasses.
			
			subclass_list = { 'NNFeatureImportanceBrainSurfacePP_Data' }; %CET: Computational Efficiency Trick
		end
		function prop_list = getProps(category)
			%GETPROPS returns the property list of panel property feature importance.
			%
			% PROPS = NNFeatureImportanceBrainSurfacePP_Data.GETPROPS() returns the property list of panel property feature importance
			%  as a row vector.
			%
			% PROPS = NNFeatureImportanceBrainSurfacePP_Data.GETPROPS(CATEGORY) returns the property list 
			%  of category CATEGORY.
			%
			% Alternative forms to call this method are:
			%  PROPS = PR.GETPROPS([CATEGORY]) returns the property list of the panel property feature importance PR.
			%  PROPS = Element.GETPROPS(PR[, CATEGORY]) returns the property list of 'PR'.
			%  PROPS = Element.GETPROPS('NNFeatureImportanceBrainSurfacePP_Data'[, CATEGORY]) returns the property list of 'NNFeatureImportanceBrainSurfacePP_Data'.
			%
			% Note that the Element.GETPROPS(PR) and Element.GETPROPS('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
		...
		function prop_number = getPropNumber(varargin)
			...
			%
			% N = NNFeatureImportanceBrainSurfacePP_Data.GETPROPNUMBER() returns the property number of panel property feature importance.
			%
			% N = NNFeatureImportanceBrainSurfacePP_Data.GETPROPNUMBER(CATEGORY) returns the property number of panel property feature importance
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
			%  N = PR.GETPROPNUMBER([CATEGORY]) returns the property number of the panel property feature importance PR.
			%  N = Element.GETPROPNUMBER(PR) returns the property number of 'PR'.
			%  N = Element.GETPROPNUMBER('NNFeatureImportanceBrainSurfacePP_Data') returns the property number of 'NNFeatureImportanceBrainSurfacePP_Data'.
			%
			% Note that the Element.GETPROPNUMBER(PR) and Element.GETPROPNUMBER('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
		...
		function check_out = existsProp(prop)
			...
			%
			% CHECK = NNFeatureImportanceBrainSurfacePP_Data.EXISTSPROP(PROP) checks whether the property PROP exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSPROP(PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(PR, PROP) checks whether PROP exists for PR.
			%  CHECK = Element.EXISTSPROP(NNFeatureImportanceBrainSurfacePP_Data, PROP) checks whether PROP exists for NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Element.EXISTSPROP(PROP) throws an error if the PROP does NOT exist.
			%  Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Data:WrongInput]
			%
			% Alternative forms to call this method are:
			...
			%   Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Data:WrongInput]
			%  Element.EXISTSPROP(NNFeatureImportanceBrainSurfacePP_Data, PROP) throws error if PROP does NOT exist for NNFeatureImportanceBrainSurfacePP_Data.
			%   Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Data:WrongInput]
			%
			% Note that the Element.EXISTSPROP(PR) and Element.EXISTSPROP('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			...
			elseif ~check
				error( ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Data:' 'WrongInput'], ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Data:' 'WrongInput' '\n' ...
					'The value ' tostring(prop, 100, ' ...') ' is not a valid prop for NNFeatureImportanceBrainSurfacePP_Data.'] ...
					)
			end
		end
		function check_out = existsTag(tag)
			...
			%
			% CHECK = NNFeatureImportanceBrainSurfacePP_Data.EXISTSTAG(TAG) checks whether a property with tag TAG exists.
			%
			% Alternative forms to call this method are:
			%  CHECK = PR.EXISTSTAG(TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(PR, TAG) checks whether TAG exists for PR.
			%  CHECK = Element.EXISTSTAG(NNFeatureImportanceBrainSurfacePP_Data, TAG) checks whether TAG exists for NNFeatureImportanceBrainSurfacePP_Data.
			%
			...
			%   Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Data:WrongInput]
			%  Element.EXISTSTAG(NNFeatureImportanceBrainSurfacePP_Data, TAG) throws error if TAG does NOT exist for NNFeatureImportanceBrainSurfacePP_Data.
			%   Error id: [BRAPH2:NNFeatureImportanceBrainSurfacePP_Data:WrongInput]
			%
			% Note that the Element.EXISTSTAG(PR) and Element.EXISTSTAG('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			% See also getProps, existsTag.
			...
			elseif ~check
				error( ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Data:' 'WrongInput'], ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Data:' 'WrongInput' '\n' ...
					'The value ' tag ' is not a valid tag for NNFeatureImportanceBrainSurfacePP_Data.'] ...
					)
			end
		end
		function prop = getPropProp(pointer)
			...
			%  PROPERTY = Element.GETPROPPROP(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns property number of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%  PROPERTY = PR.GETPROPPROP(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns property number of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Note that the Element.GETPROPPROP(PR) and Element.GETPROPPROP('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
		...
		function tag = getPropTag(pointer)
			...
			%  TAG = Element.GETPROPTAG(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns tag of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%  TAG = PR.GETPROPTAG(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns tag of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Note that the Element.GETPROPTAG(PR) and Element.GETPROPTAG('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nnfeatureimportancebrainsurfacepp_data_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'D'  'XSLIDERSHOW'  'XSLIDERLABELS'  'XSLIDERHEIGHT'  'XSLIDER'  'YSLIDERSHOW'  'YSLIDERLABELS'  'YSLIDERWIDTH'  'YSLIDER'  'XYSLIDERLOCK'  'ENABLE'  'ROWNAME'  'COLUMNNAME'  'MENU_EXPORT'  'TABLE_HEIGHT'  'TABLE'  'CONTEXTMENU'  'MAP_TO_CELL' };
				tag = nnfeatureimportancebrainsurfacepp_data_tag_list{pointer}; % prop = pointer
			end
		end
		function prop_category = getPropCategory(pointer)
			...
			%  CATEGORY = Element.GETPROPCATEGORY(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns category of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%  CATEGORY = PR.GETPROPCATEGORY(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns category of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Note that the Element.GETPROPCATEGORY(PR) and Element.GETPROPCATEGORY('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			% See also Category, getPropProp, getPropTag, getPropSettings,
			%  getPropFormat, getPropDescription, getPropDefault, checkProp.
			
			prop = NNFeatureImportanceBrainSurfacePP_Data.getPropProp(pointer);
			
			%CET: Computational Efficiency Trick
			nnfeatureimportancebrainsurfacepp_data_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  2  9  9  9  7  9  9  9  7  9  9  9  9  9  9  7  7  6 };
			prop_category = nnfeatureimportancebrainsurfacepp_data_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%  FORMAT = Element.GETPROPFORMAT(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns format of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%  FORMAT = PR.GETPROPFORMAT(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns format of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Note that the Element.GETPROPFORMAT(PR) and Element.GETPROPFORMAT('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			...
			%CET: Computational Efficiency Trick
			nnfeatureimportancebrainsurfacepp_data_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  8  4  3  22  18  4  3  22  18  4  5  3  3  4  22  18  18  1 };
			prop_format = nnfeatureimportancebrainsurfacepp_data_format_list{prop};
		end
		function prop_description = getPropDescription(pointer)
			...
			%  DESCRIPTION = Element.GETPROPDESCRIPTION(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns description of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%  DESCRIPTION = PR.GETPROPDESCRIPTION(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns description of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Note that the Element.GETPROPDESCRIPTION(PR) and Element.GETPROPDESCRIPTION('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
		...
		function prop_settings = getPropSettings(pointer)
			...
			%  SETTINGS = Element.GETPROPSETTINGS(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns settings of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%  SETTINGS = PR.GETPROPSETTINGS(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns settings of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Note that the Element.GETPROPSETTINGS(PR) and Element.GETPROPSETTINGS('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			...
			switch prop %CET: Computational Efficiency Trick
				case 36 % NNFeatureImportanceBrainSurfacePP_Data.D
					prop_settings = Format.getFormatSettings(8);
				case 37 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERSHOW
					prop_settings = Format.getFormatSettings(4);
				case 38 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERLABELS
					prop_settings = Format.getFormatSettings(3);
				case 39 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERHEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 40 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDER
					prop_settings = Format.getFormatSettings(18);
				case 41 % NNFeatureImportanceBrainSurfacePP_Data.YSLIDERSHOW
					prop_settings = Format.getFormatSettings(4);
				case 42 % NNFeatureImportanceBrainSurfacePP_Data.YSLIDERLABELS
					prop_settings = Format.getFormatSettings(3);
				case 43 % NNFeatureImportanceBrainSurfacePP_Data.YSLIDERWIDTH
					prop_settings = Format.getFormatSettings(22);
				case 44 % NNFeatureImportanceBrainSurfacePP_Data.YSLIDER
					prop_settings = Format.getFormatSettings(18);
				case 45 % NNFeatureImportanceBrainSurfacePP_Data.XYSLIDERLOCK
					prop_settings = Format.getFormatSettings(4);
				case 46 % NNFeatureImportanceBrainSurfacePP_Data.ENABLE
					prop_settings = {'on', 'off'};
				case 47 % NNFeatureImportanceBrainSurfacePP_Data.ROWNAME
					prop_settings = Format.getFormatSettings(3);
				case 48 % NNFeatureImportanceBrainSurfacePP_Data.COLUMNNAME
					prop_settings = Format.getFormatSettings(3);
				case 49 % NNFeatureImportanceBrainSurfacePP_Data.MENU_EXPORT
					prop_settings = Format.getFormatSettings(4);
				case 50 % NNFeatureImportanceBrainSurfacePP_Data.TABLE_HEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 51 % NNFeatureImportanceBrainSurfacePP_Data.TABLE
					prop_settings = Format.getFormatSettings(18);
				case 52 % NNFeatureImportanceBrainSurfacePP_Data.CONTEXTMENU
					prop_settings = Format.getFormatSettings(18);
				case 53 % NNFeatureImportanceBrainSurfacePP_Data.MAP_TO_CELL
					prop_settings = Format.getFormatSettings(1);
				case 4 % NNFeatureImportanceBrainSurfacePP_Data.TEMPLATE
					prop_settings = 'NNFeatureImportanceBrainSurfacePP_Data';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			%GETPROPDEFAULT returns the default value of a property.
			%
			% DEFAULT = NNFeatureImportanceBrainSurfacePP_Data.GETPROPDEFAULT(PROP) returns the default 
			%  value of the property PROP.
			%
			% DEFAULT = NNFeatureImportanceBrainSurfacePP_Data.GETPROPDEFAULT(TAG) returns the default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULT(POINTER) returns the default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULT(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns the default value of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%  DEFAULT = PR.GETPROPDEFAULT(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns the default value of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Note that the Element.GETPROPDEFAULT(PR) and Element.GETPROPDEFAULT('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 37 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERSHOW
					prop_default = true;
				case 38 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERLABELS
					prop_default = Format.getFormatDefault(3, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 39 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERHEIGHT
					prop_default = 36;
				case 40 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDER
					prop_default = Format.getFormatDefault(18, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 41 % NNFeatureImportanceBrainSurfacePP_Data.YSLIDERSHOW
					prop_default = true;
				case 42 % NNFeatureImportanceBrainSurfacePP_Data.YSLIDERLABELS
					prop_default = Format.getFormatDefault(3, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				...
				case 52 % NNFeatureImportanceBrainSurfacePP_Data.CONTEXTMENU
					prop_default = Format.getFormatDefault(18, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 53 % NNFeatureImportanceBrainSurfacePP_Data.MAP_TO_CELL
					prop_default = Format.getFormatDefault(1, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 1 % NNFeatureImportanceBrainSurfacePP_Data.ELCLASS
					prop_default = 'NNFeatureImportanceBrainSurfacePP_Data';
				case 2 % NNFeatureImportanceBrainSurfacePP_Data.NAME
					prop_default = 'A Panel for Feature Importance of a Neural Network Analysis';
				case 3 % NNFeatureImportanceBrainSurfacePP_Data.DESCRIPTION
					prop_default = 'A panel for feature importance of a neural network analysis with the data of subjects (NNFeatureImportanceBrainSurfacePP_Data) plots the panel to show the feature importance, matching the layer number and node number as of the subject data. It is supposed to be used with the property FEATURE_IMPORTANCE of NNClassifierMLP_Evaluator, NNClassifierMLP_CrossValidation, NNRegressorMLP_Evaluator, and NNRegressorMLP_CrossValidation.';
				case 4 % NNFeatureImportanceBrainSurfacePP_Data.TEMPLATE
					prop_default = Format.getFormatDefault(8, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 5 % NNFeatureImportanceBrainSurfacePP_Data.ID
					prop_default = 'NNFeatureImportanceBrainSurfacePP_Data ID';
				case 6 % NNFeatureImportanceBrainSurfacePP_Data.LABEL
					prop_default = 'NNFeatureImportanceBrainSurfacePP_Data label';
				case 7 % NNFeatureImportanceBrainSurfacePP_Data.NOTES
					prop_default = 'NNFeatureImportanceBrainSurfacePP_Data notes';
				case 23 % NNFeatureImportanceBrainSurfacePP_Data.EL
					prop_default = NNFeatureImportanceBrainSurface();
				case 24 % NNFeatureImportanceBrainSurfacePP_Data.PROP
					prop_default = 11;
				otherwise
		...
		function prop_default = getPropDefaultConditioned(pointer)
			%GETPROPDEFAULTCONDITIONED returns the conditioned default value of a property.
			%
			% DEFAULT = NNFeatureImportanceBrainSurfacePP_Data.GETPROPDEFAULTCONDITIONED(PROP) returns the conditioned default 
			%  value of the property PROP.
			%
			% DEFAULT = NNFeatureImportanceBrainSurfacePP_Data.GETPROPDEFAULTCONDITIONED(TAG) returns the conditioned default 
			%  value of the property with tag TAG.
			%
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(POINTER) returns the conditioned default value of POINTER of PR.
			%  DEFAULT = Element.GETPROPDEFAULTCONDITIONED(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns the conditioned default value of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%  DEFAULT = PR.GETPROPDEFAULTCONDITIONED(NNFeatureImportanceBrainSurfacePP_Data, POINTER) returns the conditioned default value of POINTER of NNFeatureImportanceBrainSurfacePP_Data.
			%
			% Note that the Element.GETPROPDEFAULTCONDITIONED(PR) and Element.GETPROPDEFAULTCONDITIONED('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			...
			prop_default = NNFeatureImportanceBrainSurfacePP_Data.conditioning(prop, NNFeatureImportanceBrainSurfacePP_Data.getPropDefault(prop));
		end
	end
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  CHECK = Element.CHECKPROP(NNFeatureImportanceBrainSurfacePP_Data, PROP, VALUE) checks VALUE format for PROP of NNFeatureImportanceBrainSurfacePP_Data.
			%  CHECK = PR.CHECKPROP(NNFeatureImportanceBrainSurfacePP_Data, PROP, VALUE) checks VALUE format for PROP of NNFeatureImportanceBrainSurfacePP_Data.
			% 
			...
			%   Error id: BRAPH2:NNFeatureImportanceBrainSurfacePP_Data:WrongInput
			%  Element.CHECKPROP(NNFeatureImportanceBrainSurfacePP_Data, PROP, VALUE) throws error if VALUE has not a valid format for PROP of NNFeatureImportanceBrainSurfacePP_Data.
			%   Error id: BRAPH2:NNFeatureImportanceBrainSurfacePP_Data:WrongInput
			%  PR.CHECKPROP(NNFeatureImportanceBrainSurfacePP_Data, PROP, VALUE) throws error if VALUE has not a valid format for PROP of NNFeatureImportanceBrainSurfacePP_Data.
			%   Error id: BRAPH2:NNFeatureImportanceBrainSurfacePP_Data:WrongInput]
			% 
			% Note that the Element.CHECKPROP(PR) and Element.CHECKPROP('NNFeatureImportanceBrainSurfacePP_Data')
			%  are less computationally efficient.
			%
			...
			switch prop
				case 36 % NNFeatureImportanceBrainSurfacePP_Data.D
					check = Format.checkFormat(8, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 37 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERSHOW
					check = Format.checkFormat(4, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 38 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERLABELS
					check = Format.checkFormat(3, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 39 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDERHEIGHT
					check = Format.checkFormat(22, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 40 % NNFeatureImportanceBrainSurfacePP_Data.XSLIDER
					check = Format.checkFormat(18, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 41 % NNFeatureImportanceBrainSurfacePP_Data.YSLIDERSHOW
					check = Format.checkFormat(4, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 42 % NNFeatureImportanceBrainSurfacePP_Data.YSLIDERLABELS
					check = Format.checkFormat(3, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				...
				case 45 % NNFeatureImportanceBrainSurfacePP_Data.XYSLIDERLOCK
					check = Format.checkFormat(4, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 46 % NNFeatureImportanceBrainSurfacePP_Data.ENABLE
					check = Format.checkFormat(5, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 47 % NNFeatureImportanceBrainSurfacePP_Data.ROWNAME
					check = Format.checkFormat(3, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 48 % NNFeatureImportanceBrainSurfacePP_Data.COLUMNNAME
					check = Format.checkFormat(3, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				...
				case 52 % NNFeatureImportanceBrainSurfacePP_Data.CONTEXTMENU
					check = Format.checkFormat(18, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 53 % NNFeatureImportanceBrainSurfacePP_Data.MAP_TO_CELL
					check = Format.checkFormat(1, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				case 4 % NNFeatureImportanceBrainSurfacePP_Data.TEMPLATE
					check = Format.checkFormat(8, value, NNFeatureImportanceBrainSurfacePP_Data.getPropSettings(prop));
				otherwise
					if prop <= 35
			...
			elseif ~check
				error( ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Data:' 'WrongInput'], ...
					['BRAPH2' ':NNFeatureImportanceBrainSurfacePP_Data:' 'WrongInput' '\n' ...
					'The value ' tostring(value, 100, ' ...') ' is not a valid property ' NNFeatureImportanceBrainSurfacePP_Data.getPropTag(prop) ' (' NNFeatureImportanceBrainSurfacePP_Data.getFormatTag(NNFeatureImportanceBrainSurfacePP_Data.getPropFormat(prop)) ').'] ...
					)
			end
		end
	end
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 20 % NNFeatureImportanceBrainSurfacePP_Data.X_DRAW
				...
				case 21 % NNFeatureImportanceBrainSurfacePP_Data.UPDATE
				...
				case 22 % NNFeatureImportanceBrainSurfacePP_Data.REDRAW
				...
				case 18 % NNFeatureImportanceBrainSurfacePP_Data.DELETE
