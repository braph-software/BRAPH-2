...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	nn = NNClassifierMLP( ...
		...
		NNClassifierMLP.TARGET_IDS, NNClassifierMLP.getNoValue(), ...
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nn_1 = NNClassifierMLP( ...
		NNClassifierMLP.NAME, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.DESCRIPTION, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TEMPLATE, nn_0.getCallback(3), ..., ...
		NNClassifierMLP.ID, nn_0.getCallback(4), ..., ...
		NNClassifierMLP.LABEL, NNClassifierMLP.getPropDefault(NNClassifierMLP.LABEL), ...
		NNClassifierMLP.NOTES, NNClassifierMLP.getPropDefault(NNClassifierMLP.NOTES), ...
		NNClassifierMLP.TOSTRING, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.D, nn_0.getCallback(8), ..., ...
		NNClassifierMLP.DP_CLASSES, nn_0.getCallback(9), ..., ...
		NNClassifierMLP.EPOCHS, nn_0.getCallback(10), ..., ...
		NNClassifierMLP.BATCH, nn_0.getCallback(11), ..., ...
		NNClassifierMLP.SHUFFLE, nn_0.getCallback(12), ..., ...
		NNClassifierMLP.SOLVER, nn_0.getCallback(13), ..., ...
		NNClassifierMLP.MODEL, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.INPUTS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TARGETS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TRAIN, NNClassifierMLP.getNoValue(), ...
		...
		NNClassifierMLP.PREDICT, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TARGET_IDS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.LAYERS, nn_0.getCallback(22), ..., ...
		NNClassifierMLP.WAITBAR, nn_0.getCallback(23), ..., ...
		NNClassifierMLP.INTERRUPTIBLE, nn_0.getCallback(24), ..., ...
		NNClassifierMLP.FEATURE_IMPORTANCE, NNClassifierMLP.getNoValue() ...
		);
	...
	nn_2 = NNClassifierMLP( ...
		NNClassifierMLP.NAME, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.DESCRIPTION, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TEMPLATE, nn_1.getCallback(3), ..., ...
		NNClassifierMLP.ID, nn_1.getCallback(4), ..., ...
		NNClassifierMLP.LABEL, NNClassifierMLP.getPropDefault(NNClassifierMLP.LABEL), ...
		NNClassifierMLP.NOTES, NNClassifierMLP.getPropDefault(NNClassifierMLP.NOTES), ...
		NNClassifierMLP.TOSTRING, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.D, nn_1.getCallback(8), ..., ...
		NNClassifierMLP.DP_CLASSES, nn_1.getCallback(9), ..., ...
		NNClassifierMLP.EPOCHS, nn_1.getCallback(10), ..., ...
		NNClassifierMLP.BATCH, nn_1.getCallback(11), ..., ...
		NNClassifierMLP.SHUFFLE, nn_1.getCallback(12), ..., ...
		NNClassifierMLP.SOLVER, nn_1.getCallback(13), ..., ...
		NNClassifierMLP.MODEL, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.INPUTS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TARGETS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TRAIN, NNClassifierMLP.getNoValue(), ...
		...
		NNClassifierMLP.PREDICT, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TARGET_IDS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.LAYERS, nn_1.getCallback(22), ..., ...
		NNClassifierMLP.WAITBAR, nn_1.getCallback(23), ..., ...
		NNClassifierMLP.INTERRUPTIBLE, nn_1.getCallback(24), ..., ...
		NNClassifierMLP.FEATURE_IMPORTANCE, NNClassifierMLP.getNoValue() ...
		);
	...
	nn_3 = NNClassifierMLP( ...
		NNClassifierMLP.NAME, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.DESCRIPTION, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TEMPLATE, nn_2.getCallback(3), ..., ...
		NNClassifierMLP.ID, nn_2.getCallback(4), ..., ...
		NNClassifierMLP.LABEL, NNClassifierMLP.getPropDefault(NNClassifierMLP.LABEL), ...
		NNClassifierMLP.NOTES, NNClassifierMLP.getPropDefault(NNClassifierMLP.NOTES), ...
		NNClassifierMLP.TOSTRING, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.D, nn_2.getCallback(8), ..., ...
		NNClassifierMLP.DP_CLASSES, nn_2.getCallback(9), ..., ...
		NNClassifierMLP.EPOCHS, nn_2.getCallback(10), ..., ...
		NNClassifierMLP.BATCH, nn_2.getCallback(11), ..., ...
		NNClassifierMLP.SHUFFLE, nn_2.getCallback(12), ..., ...
		NNClassifierMLP.SOLVER, nn_2.getCallback(13), ..., ...
		NNClassifierMLP.MODEL, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.INPUTS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TARGETS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TRAIN, NNClassifierMLP.getNoValue(), ...
		...
		NNClassifierMLP.PREDICT, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.TARGET_IDS, NNClassifierMLP.getNoValue(), ...
		NNClassifierMLP.LAYERS, nn_2.getCallback(22), ..., ...
		NNClassifierMLP.WAITBAR, nn_2.getCallback(23), ..., ...
		NNClassifierMLP.INTERRUPTIBLE, nn_2.getCallback(24), ..., ...
		NNClassifierMLP.FEATURE_IMPORTANCE, NNClassifierMLP.getNoValue() ...
		);
