classdef NNRegressorMLP < NNBase
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the neural network multi-layer perceptron regressor.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the neural network multi-layer perceptron regressor.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the neural network multi-layer perceptron regressor.
	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 2 % NNRegressorMLP.DESCRIPTION
				...
				case 4 % NNRegressorMLP.ID
					prop_default = 'NNRegressorMLP ID';
				case 5 % NNRegressorMLP.LABEL
