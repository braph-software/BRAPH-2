...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	nne = NNRegressorMLP_Evaluator( ...
		...
		NNRegressorMLP_Evaluator.P, NNRegressorMLP_Evaluator.getPropDefault(NNRegressorMLP_Evaluator.P), ...
		NNRegressorMLP_Evaluator.PERM_SEEDS, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.FEATURE_IMPORTANCE, NNRegressorMLP_Evaluator.getNoValue() ...
		);
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nne_1 = NNRegressorMLP_Evaluator( ...
		NNRegressorMLP_Evaluator.NAME, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.DESCRIPTION, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.TEMPLATE, nne_0.getCallback(3), ..., ...
		NNRegressorMLP_Evaluator.ID, nne_0.getCallback(4), ..., ...
		NNRegressorMLP_Evaluator.LABEL, NNRegressorMLP_Evaluator.getPropDefault(NNRegressorMLP_Evaluator.LABEL), ...
		NNRegressorMLP_Evaluator.NOTES, NNRegressorMLP_Evaluator.getPropDefault(NNRegressorMLP_Evaluator.NOTES), ...
		NNRegressorMLP_Evaluator.TOSTRING, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.NN, nne_0.getCallback(8), ..., ...
		NNRegressorMLP_Evaluator.D, nne_0.getCallback(9), ..., ...
		NNRegressorMLP_Evaluator.GROUND_TRUTH, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.CORR, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.DET, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.MAE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.MSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.RMSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.P, nne_0.getCallback(16), ..., ...
		NNRegressorMLP_Evaluator.PERM_SEEDS, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.FEATURE_IMPORTANCE, NNRegressorMLP_Evaluator.getNoValue() ...
		);
	...
	nne_2 = NNRegressorMLP_Evaluator( ...
		NNRegressorMLP_Evaluator.NAME, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.DESCRIPTION, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.TEMPLATE, nne_1.getCallback(3), ..., ...
		NNRegressorMLP_Evaluator.ID, nne_1.getCallback(4), ..., ...
		NNRegressorMLP_Evaluator.LABEL, NNRegressorMLP_Evaluator.getPropDefault(NNRegressorMLP_Evaluator.LABEL), ...
		NNRegressorMLP_Evaluator.NOTES, NNRegressorMLP_Evaluator.getPropDefault(NNRegressorMLP_Evaluator.NOTES), ...
		NNRegressorMLP_Evaluator.TOSTRING, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.NN, nne_1.getCallback(8), ..., ...
		NNRegressorMLP_Evaluator.D, nne_1.getCallback(9), ..., ...
		NNRegressorMLP_Evaluator.GROUND_TRUTH, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.CORR, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.DET, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.MAE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.MSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.RMSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.P, nne_1.getCallback(16), ..., ...
		NNRegressorMLP_Evaluator.PERM_SEEDS, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.FEATURE_IMPORTANCE, NNRegressorMLP_Evaluator.getNoValue() ...
		);
	...
	nne_3 = NNRegressorMLP_Evaluator( ...
		NNRegressorMLP_Evaluator.NAME, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.DESCRIPTION, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.TEMPLATE, nne_2.getCallback(3), ..., ...
		NNRegressorMLP_Evaluator.ID, nne_2.getCallback(4), ..., ...
		NNRegressorMLP_Evaluator.LABEL, NNRegressorMLP_Evaluator.getPropDefault(NNRegressorMLP_Evaluator.LABEL), ...
		NNRegressorMLP_Evaluator.NOTES, NNRegressorMLP_Evaluator.getPropDefault(NNRegressorMLP_Evaluator.NOTES), ...
		NNRegressorMLP_Evaluator.TOSTRING, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.NN, nne_2.getCallback(8), ..., ...
		NNRegressorMLP_Evaluator.D, nne_2.getCallback(9), ..., ...
		NNRegressorMLP_Evaluator.GROUND_TRUTH, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.CORR, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.DET, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.MAE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.MSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.RMSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.P, nne_2.getCallback(16), ..., ...
		NNRegressorMLP_Evaluator.PERM_SEEDS, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.FEATURE_IMPORTANCE, NNRegressorMLP_Evaluator.getNoValue() ...
		);
