...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nne_1 = NNRegressorMLP_Evaluator( ...
		...
		NNRegressorMLP_Evaluator.MSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.RMSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.P, nne_0.getCallback(17), ..., ...
		NNRegressorMLP_Evaluator.PERM_SEEDS, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.FEATURE_IMPORTANCE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.PFSP, nne_0.getCallback(20) ... ...
		);
	...
	nne_2 = NNRegressorMLP_Evaluator( ...
		...
		NNRegressorMLP_Evaluator.MSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.RMSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.P, nne_1.getCallback(17), ..., ...
		NNRegressorMLP_Evaluator.PERM_SEEDS, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.FEATURE_IMPORTANCE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.PFSP, nne_1.getCallback(20) ... ...
		);
	...
	nne_3 = NNRegressorMLP_Evaluator( ...
		...
		NNRegressorMLP_Evaluator.MSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.RMSE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.P, nne_2.getCallback(17), ..., ...
		NNRegressorMLP_Evaluator.PERM_SEEDS, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.FEATURE_IMPORTANCE, NNRegressorMLP_Evaluator.getNoValue(), ...
		NNRegressorMLP_Evaluator.PFSP, nne_2.getCallback(20) ... ...
		);
