classdef NNxMLP_FeatureImportanceAcrossMeasures < NNxMLP_FeatureImportance
	...
	%  <strong>20</strong> <strong>COMP_FEATURE_INDICES</strong> 	COMP_FEATURE_INDICES (result, cell) provides the indices of combined features, represented as a cell array containing sets of feature indices, such as {[1, 2], [2, 3], [1, 3]}.
	...
	methods (Static) % inspection
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nnxmlp_featureimportanceacrossmeasures_format_list = { 2  2  2  8  2  2  2  2  8  8  11  12  4  4  4  11  4  11  16  16  8  11  12  16  12  12  16  1  1  1  1  1 };
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(nnfiam, prop, varargin)
			...
			switch prop
				...
				case 20 % NNxMLP_FeatureImportanceAcrossMeasures.COMP_FEATURE_INDICES
					rng_settings_ = rng(); rng(nnfiam.getPropSeed(20), 'twister')
