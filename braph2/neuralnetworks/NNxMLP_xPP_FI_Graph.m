classdef NNxMLP_xPP_FI_Graph < PanelProp
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = subclasses('NNxMLP_xPP_FI_Graph', [], [], true);
		end
		function prop_list = getProps(category)
			...
			if nargin == 0
				prop_list = [ ...
					PanelProp.getProps() ...
						NNxMLP_xPP_FI_Graph.D ...
						NNxMLP_xPP_FI_Graph.XSLIDERSHOW ...
						NNxMLP_xPP_FI_Graph.XSLIDERLABELS ...
						NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT ...
						NNxMLP_xPP_FI_Graph.XSLIDER ...
						NNxMLP_xPP_FI_Graph.YSLIDERSHOW ...
						NNxMLP_xPP_FI_Graph.YSLIDERLABELS ...
						NNxMLP_xPP_FI_Graph.YSLIDERWIDTH ...
						NNxMLP_xPP_FI_Graph.YSLIDER ...
						NNxMLP_xPP_FI_Graph.XYSLIDERLOCK ...
						NNxMLP_xPP_FI_Graph.ENABLE ...
						NNxMLP_xPP_FI_Graph.ROWNAME ...
						NNxMLP_xPP_FI_Graph.COLUMNNAME ...
						NNxMLP_xPP_FI_Graph.MENU_EXPORT ...
						NNxMLP_xPP_FI_Graph.TABLE_HEIGHT ...
						NNxMLP_xPP_FI_Graph.TABLE ...
						NNxMLP_xPP_FI_Graph.CONTEXTMENU ...
						NNxMLP_xPP_FI_Graph.MAP_TO_CELL ...
						];
				return
			end
		...
		function prop_number = getPropNumber(varargin)
			...
			prop_number = numel(NNxMLP_xPP_FI_Graph.getProps(varargin{:}));
		end
		function check_out = existsProp(prop)
			...
			check = any(prop == NNxMLP_xPP_FI_Graph.getProps());
			
			if nargout == 1
				check_out = check;
			elseif ~check
				error( ...
					[BRAPH2.STR ':NNxMLP_xPP_FI_Graph:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':NNxMLP_xPP_FI_Graph:' BRAPH2.WRONG_INPUT '\n' ...
		...
		function check_out = existsTag(tag)
			...
			nnxmlp_xpp_fi_graph_tag_list = cellfun(@(x) NNxMLP_xPP_FI_Graph.getPropTag(x), num2cell(NNxMLP_xPP_FI_Graph.getProps()), 'UniformOutput', false);
			check = any(strcmp(tag, nnxmlp_xpp_fi_graph_tag_list));
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				nnxmlp_xpp_fi_graph_tag_list = cellfun(@(x) NNxMLP_xPP_FI_Graph.getPropTag(x), num2cell(NNxMLP_xPP_FI_Graph.getProps()), 'UniformOutput', false);
				prop = find(strcmp(pointer, nnxmlp_xpp_fi_graph_tag_list)); % tag = pointer
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case NNxMLP_xPP_FI_Graph.D
						tag = NNxMLP_xPP_FI_Graph.D_TAG;
					case NNxMLP_xPP_FI_Graph.XSLIDERSHOW
						tag = NNxMLP_xPP_FI_Graph.XSLIDERSHOW_TAG;
					case NNxMLP_xPP_FI_Graph.XSLIDERLABELS
						tag = NNxMLP_xPP_FI_Graph.XSLIDERLABELS_TAG;
					case NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT
						tag = NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT_TAG;
					case NNxMLP_xPP_FI_Graph.XSLIDER
						tag = NNxMLP_xPP_FI_Graph.XSLIDER_TAG;
					case NNxMLP_xPP_FI_Graph.YSLIDERSHOW
						tag = NNxMLP_xPP_FI_Graph.YSLIDERSHOW_TAG;
					case NNxMLP_xPP_FI_Graph.YSLIDERLABELS
						tag = NNxMLP_xPP_FI_Graph.YSLIDERLABELS_TAG;
					case NNxMLP_xPP_FI_Graph.YSLIDERWIDTH
						tag = NNxMLP_xPP_FI_Graph.YSLIDERWIDTH_TAG;
					case NNxMLP_xPP_FI_Graph.YSLIDER
						tag = NNxMLP_xPP_FI_Graph.YSLIDER_TAG;
					case NNxMLP_xPP_FI_Graph.XYSLIDERLOCK
						tag = NNxMLP_xPP_FI_Graph.XYSLIDERLOCK_TAG;
					case NNxMLP_xPP_FI_Graph.ENABLE
						tag = NNxMLP_xPP_FI_Graph.ENABLE_TAG;
					case NNxMLP_xPP_FI_Graph.ROWNAME
						tag = NNxMLP_xPP_FI_Graph.ROWNAME_TAG;
					case NNxMLP_xPP_FI_Graph.COLUMNNAME
						tag = NNxMLP_xPP_FI_Graph.COLUMNNAME_TAG;
					case NNxMLP_xPP_FI_Graph.MENU_EXPORT
						tag = NNxMLP_xPP_FI_Graph.MENU_EXPORT_TAG;
					case NNxMLP_xPP_FI_Graph.TABLE_HEIGHT
						tag = NNxMLP_xPP_FI_Graph.TABLE_HEIGHT_TAG;
					case NNxMLP_xPP_FI_Graph.TABLE
						tag = NNxMLP_xPP_FI_Graph.TABLE_TAG;
					case NNxMLP_xPP_FI_Graph.CONTEXTMENU
						tag = NNxMLP_xPP_FI_Graph.CONTEXTMENU_TAG;
					case NNxMLP_xPP_FI_Graph.MAP_TO_CELL
						tag = NNxMLP_xPP_FI_Graph.MAP_TO_CELL_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case NNxMLP_xPP_FI_Graph.D
					prop_category = NNxMLP_xPP_FI_Graph.D_CATEGORY;
				case NNxMLP_xPP_FI_Graph.XSLIDERSHOW
					prop_category = NNxMLP_xPP_FI_Graph.XSLIDERSHOW_CATEGORY;
				case NNxMLP_xPP_FI_Graph.XSLIDERLABELS
					prop_category = NNxMLP_xPP_FI_Graph.XSLIDERLABELS_CATEGORY;
				case NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT
					prop_category = NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT_CATEGORY;
				case NNxMLP_xPP_FI_Graph.XSLIDER
					prop_category = NNxMLP_xPP_FI_Graph.XSLIDER_CATEGORY;
				case NNxMLP_xPP_FI_Graph.YSLIDERSHOW
					prop_category = NNxMLP_xPP_FI_Graph.YSLIDERSHOW_CATEGORY;
				case NNxMLP_xPP_FI_Graph.YSLIDERLABELS
					prop_category = NNxMLP_xPP_FI_Graph.YSLIDERLABELS_CATEGORY;
				case NNxMLP_xPP_FI_Graph.YSLIDERWIDTH
					prop_category = NNxMLP_xPP_FI_Graph.YSLIDERWIDTH_CATEGORY;
				case NNxMLP_xPP_FI_Graph.YSLIDER
					prop_category = NNxMLP_xPP_FI_Graph.YSLIDER_CATEGORY;
				case NNxMLP_xPP_FI_Graph.XYSLIDERLOCK
					prop_category = NNxMLP_xPP_FI_Graph.XYSLIDERLOCK_CATEGORY;
				case NNxMLP_xPP_FI_Graph.ENABLE
					prop_category = NNxMLP_xPP_FI_Graph.ENABLE_CATEGORY;
				case NNxMLP_xPP_FI_Graph.ROWNAME
					prop_category = NNxMLP_xPP_FI_Graph.ROWNAME_CATEGORY;
				case NNxMLP_xPP_FI_Graph.COLUMNNAME
					prop_category = NNxMLP_xPP_FI_Graph.COLUMNNAME_CATEGORY;
				case NNxMLP_xPP_FI_Graph.MENU_EXPORT
					prop_category = NNxMLP_xPP_FI_Graph.MENU_EXPORT_CATEGORY;
				case NNxMLP_xPP_FI_Graph.TABLE_HEIGHT
					prop_category = NNxMLP_xPP_FI_Graph.TABLE_HEIGHT_CATEGORY;
				case NNxMLP_xPP_FI_Graph.TABLE
					prop_category = NNxMLP_xPP_FI_Graph.TABLE_CATEGORY;
				case NNxMLP_xPP_FI_Graph.CONTEXTMENU
					prop_category = NNxMLP_xPP_FI_Graph.CONTEXTMENU_CATEGORY;
				case NNxMLP_xPP_FI_Graph.MAP_TO_CELL
					prop_category = NNxMLP_xPP_FI_Graph.MAP_TO_CELL_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case NNxMLP_xPP_FI_Graph.D
					prop_format = NNxMLP_xPP_FI_Graph.D_FORMAT;
				case NNxMLP_xPP_FI_Graph.XSLIDERSHOW
					prop_format = NNxMLP_xPP_FI_Graph.XSLIDERSHOW_FORMAT;
				case NNxMLP_xPP_FI_Graph.XSLIDERLABELS
					prop_format = NNxMLP_xPP_FI_Graph.XSLIDERLABELS_FORMAT;
				case NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT
					prop_format = NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT_FORMAT;
				case NNxMLP_xPP_FI_Graph.XSLIDER
					prop_format = NNxMLP_xPP_FI_Graph.XSLIDER_FORMAT;
				case NNxMLP_xPP_FI_Graph.YSLIDERSHOW
					prop_format = NNxMLP_xPP_FI_Graph.YSLIDERSHOW_FORMAT;
				case NNxMLP_xPP_FI_Graph.YSLIDERLABELS
					prop_format = NNxMLP_xPP_FI_Graph.YSLIDERLABELS_FORMAT;
				case NNxMLP_xPP_FI_Graph.YSLIDERWIDTH
					prop_format = NNxMLP_xPP_FI_Graph.YSLIDERWIDTH_FORMAT;
				case NNxMLP_xPP_FI_Graph.YSLIDER
					prop_format = NNxMLP_xPP_FI_Graph.YSLIDER_FORMAT;
				case NNxMLP_xPP_FI_Graph.XYSLIDERLOCK
					prop_format = NNxMLP_xPP_FI_Graph.XYSLIDERLOCK_FORMAT;
				case NNxMLP_xPP_FI_Graph.ENABLE
					prop_format = NNxMLP_xPP_FI_Graph.ENABLE_FORMAT;
				case NNxMLP_xPP_FI_Graph.ROWNAME
					prop_format = NNxMLP_xPP_FI_Graph.ROWNAME_FORMAT;
				case NNxMLP_xPP_FI_Graph.COLUMNNAME
					prop_format = NNxMLP_xPP_FI_Graph.COLUMNNAME_FORMAT;
				case NNxMLP_xPP_FI_Graph.MENU_EXPORT
					prop_format = NNxMLP_xPP_FI_Graph.MENU_EXPORT_FORMAT;
				case NNxMLP_xPP_FI_Graph.TABLE_HEIGHT
					prop_format = NNxMLP_xPP_FI_Graph.TABLE_HEIGHT_FORMAT;
				case NNxMLP_xPP_FI_Graph.TABLE
					prop_format = NNxMLP_xPP_FI_Graph.TABLE_FORMAT;
				case NNxMLP_xPP_FI_Graph.CONTEXTMENU
					prop_format = NNxMLP_xPP_FI_Graph.CONTEXTMENU_FORMAT;
				case NNxMLP_xPP_FI_Graph.MAP_TO_CELL
					prop_format = NNxMLP_xPP_FI_Graph.MAP_TO_CELL_FORMAT;
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case NNxMLP_xPP_FI_Graph.XSLIDERSHOW
					prop_default = true;
				case NNxMLP_xPP_FI_Graph.XSLIDERLABELS
					prop_default = Format.getFormatDefault(Format.STRINGLIST, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT
					prop_default = s(3);
				case NNxMLP_xPP_FI_Graph.XSLIDER
					prop_default = Format.getFormatDefault(Format.HANDLE, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.YSLIDERSHOW
					prop_default = true;
				case NNxMLP_xPP_FI_Graph.YSLIDERLABELS
					prop_default = Format.getFormatDefault(Format.STRINGLIST, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				...
				case NNxMLP_xPP_FI_Graph.CONTEXTMENU
					prop_default = Format.getFormatDefault(Format.HANDLE, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.MAP_TO_CELL
					prop_default = Format.getFormatDefault(Format.EMPTY, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.ELCLASS
				...
				case NNxMLP_xPP_FI_Graph.TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.ID
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  Error id: €BRAPH2.STR€:NNxMLP_xPP_FI_Graph:€BRAPH2.WRONG_INPUT€
			% 
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			...
			switch prop
				case NNxMLP_xPP_FI_Graph.D % __NNxMLP_xPP_FI_Graph.D__
					check = Format.checkFormat(Format.ITEM, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.XSLIDERSHOW % __NNxMLP_xPP_FI_Graph.XSLIDERSHOW__
					check = Format.checkFormat(Format.LOGICAL, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.XSLIDERLABELS % __NNxMLP_xPP_FI_Graph.XSLIDERLABELS__
					check = Format.checkFormat(Format.STRINGLIST, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT % __NNxMLP_xPP_FI_Graph.XSLIDERHEIGHT__
					check = Format.checkFormat(Format.SIZE, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.XSLIDER % __NNxMLP_xPP_FI_Graph.XSLIDER__
					check = Format.checkFormat(Format.HANDLE, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.YSLIDERSHOW % __NNxMLP_xPP_FI_Graph.YSLIDERSHOW__
					check = Format.checkFormat(Format.LOGICAL, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.YSLIDERLABELS % __NNxMLP_xPP_FI_Graph.YSLIDERLABELS__
					check = Format.checkFormat(Format.STRINGLIST, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.YSLIDERWIDTH % __NNxMLP_xPP_FI_Graph.YSLIDERWIDTH__
					check = Format.checkFormat(Format.SIZE, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.YSLIDER % __NNxMLP_xPP_FI_Graph.YSLIDER__
					check = Format.checkFormat(Format.HANDLE, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.XYSLIDERLOCK % __NNxMLP_xPP_FI_Graph.XYSLIDERLOCK__
					check = Format.checkFormat(Format.LOGICAL, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.ENABLE % __NNxMLP_xPP_FI_Graph.ENABLE__
					check = Format.checkFormat(Format.OPTION, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.ROWNAME % __NNxMLP_xPP_FI_Graph.ROWNAME__
					check = Format.checkFormat(Format.STRINGLIST, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.COLUMNNAME % __NNxMLP_xPP_FI_Graph.COLUMNNAME__
					check = Format.checkFormat(Format.STRINGLIST, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.MENU_EXPORT % __NNxMLP_xPP_FI_Graph.MENU_EXPORT__
					check = Format.checkFormat(Format.LOGICAL, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.TABLE_HEIGHT % __NNxMLP_xPP_FI_Graph.TABLE_HEIGHT__
					check = Format.checkFormat(Format.SIZE, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.TABLE % __NNxMLP_xPP_FI_Graph.TABLE__
					check = Format.checkFormat(Format.HANDLE, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.CONTEXTMENU % __NNxMLP_xPP_FI_Graph.CONTEXTMENU__
					check = Format.checkFormat(Format.HANDLE, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.MAP_TO_CELL % __NNxMLP_xPP_FI_Graph.MAP_TO_CELL__
					check = Format.checkFormat(Format.EMPTY, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				case NNxMLP_xPP_FI_Graph.TEMPLATE % __NNxMLP_xPP_FI_Graph.TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, NNxMLP_xPP_FI_Graph.getPropSettings(prop));
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case NNxMLP_xPP_FI_Graph.X_DRAW % __NNxMLP_xPP_FI_Graph.X_DRAW__
				...
				case NNxMLP_xPP_FI_Graph.UPDATE % __NNxMLP_xPP_FI_Graph.UPDATE__
				...
				case NNxMLP_xPP_FI_Graph.REDRAW % __NNxMLP_xPP_FI_Graph.REDRAW__
				...
				case NNxMLP_xPP_FI_Graph.DELETE % __NNxMLP_xPP_FI_Graph.DELETE__
