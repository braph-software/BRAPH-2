...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	nnfib = NNFeatureImportanceBrainSurface( ...
		...
		NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE, NNFeatureImportanceBrainSurface.getPropDefault(NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE) ...
		);
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nnfib_1 = NNFeatureImportanceBrainSurface( ...
		...
		NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE, nnfib_0.getCallback(11) ... ...
		);
	...
	nnfib_2 = NNFeatureImportanceBrainSurface( ...
		...
		NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE, nnfib_1.getCallback(11) ... ...
		);
	...
	nnfib_3 = NNFeatureImportanceBrainSurface( ...
		...
		NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE, nnfib_2.getCallback(11) ... ...
		);
