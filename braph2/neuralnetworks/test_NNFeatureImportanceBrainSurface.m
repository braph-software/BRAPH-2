...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	nnfib = NNFeatureImportanceBrainSurface( ...
		...
		NNFeatureImportanceBrainSurface.EVALUATOR_LIST, NNFeatureImportanceBrainSurface.getPropDefault(NNFeatureImportanceBrainSurface.EVALUATOR_LIST), ...
		NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE, NNFeatureImportanceBrainSurface.getNoValue() ...
		);
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nnfib_1 = NNFeatureImportanceBrainSurface( ...
		...
		NNFeatureImportanceBrainSurface.EVALUATOR_LIST, nnfib_0.getCallback(10), ..., ...
		NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE, NNFeatureImportanceBrainSurface.getNoValue() ...
		);
	...
	nnfib_2 = NNFeatureImportanceBrainSurface( ...
		...
		NNFeatureImportanceBrainSurface.EVALUATOR_LIST, nnfib_1.getCallback(10), ..., ...
		NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE, NNFeatureImportanceBrainSurface.getNoValue() ...
		);
	...
	nnfib_3 = NNFeatureImportanceBrainSurface( ...
		...
		NNFeatureImportanceBrainSurface.EVALUATOR_LIST, nnfib_2.getCallback(10), ..., ...
		NNFeatureImportanceBrainSurface.AV_FEATURE_IMPORTANCE, NNFeatureImportanceBrainSurface.getNoValue() ...
		);
