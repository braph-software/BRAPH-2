...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	nncv = NNClassifierMLP_CrossValidation( ...
		...
		NNClassifierMLP_CrossValidation.P, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.P), ...
		...
		NNClassifierMLP_CrossValidation.AV_FEATURE_IMPORTANCE, NNClassifierMLP_CrossValidation.getNoValue() ...
		);
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nncv_1 = NNClassifierMLP_CrossValidation( ...
		NNClassifierMLP_CrossValidation.NAME, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.DESCRIPTION, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.TEMPLATE, nncv_0.getCallback(3), ..., ...
		NNClassifierMLP_CrossValidation.ID, nncv_0.getCallback(4), ..., ...
		NNClassifierMLP_CrossValidation.LABEL, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.LABEL), ...
		NNClassifierMLP_CrossValidation.NOTES, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.NOTES), ...
		NNClassifierMLP_CrossValidation.TOSTRING, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.KFOLDS, nncv_0.getCallback(8), ..., ...
		NNClassifierMLP_CrossValidation.SPLIT, nncv_0.getCallback(9), ..., ...
		NNClassifierMLP_CrossValidation.D, nncv_0.getCallback(10), ..., ...
		NNClassifierMLP_CrossValidation.NN_TEMPLATE, nncv_0.getCallback(11), ..., ...
		NNClassifierMLP_CrossValidation.NNEVALUATOR_TEMPLATE, nncv_0.getCallback(12), ..., ...
		NNClassifierMLP_CrossValidation.DSP, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.DCO, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.D_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.NN_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.EVALUATOR_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.EPOCHS, nncv_0.getCallback(18), ..., ...
		NNClassifierMLP_CrossValidation.BATCH, nncv_0.getCallback(19), ..., ...
		NNClassifierMLP_CrossValidation.SHUFFLE, nncv_0.getCallback(20), ..., ...
		NNClassifierMLP_CrossValidation.SOLVER, nncv_0.getCallback(21), ..., ...
		NNClassifierMLP_CrossValidation.VERBOSE, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.VERBOSE), ...
		NNClassifierMLP_CrossValidation.PLOT_TRAINING, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.PLOT_TRAINING), ...
		NNClassifierMLP_CrossValidation.TRAIN, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.P, nncv_0.getCallback(25), ..., ...
		NNClassifierMLP_CrossValidation.AV_AUC, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.AV_MACRO_AUC, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.C_MATRIX, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.AV_FEATURE_IMPORTANCE, NNClassifierMLP_CrossValidation.getNoValue() ...
	...
	nncv_2 = NNClassifierMLP_CrossValidation( ...
		NNClassifierMLP_CrossValidation.NAME, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.DESCRIPTION, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.TEMPLATE, nncv_1.getCallback(3), ..., ...
		NNClassifierMLP_CrossValidation.ID, nncv_1.getCallback(4), ..., ...
		NNClassifierMLP_CrossValidation.LABEL, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.LABEL), ...
		NNClassifierMLP_CrossValidation.NOTES, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.NOTES), ...
		NNClassifierMLP_CrossValidation.TOSTRING, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.KFOLDS, nncv_1.getCallback(8), ..., ...
		NNClassifierMLP_CrossValidation.SPLIT, nncv_1.getCallback(9), ..., ...
		NNClassifierMLP_CrossValidation.D, nncv_1.getCallback(10), ..., ...
		NNClassifierMLP_CrossValidation.NN_TEMPLATE, nncv_1.getCallback(11), ..., ...
		NNClassifierMLP_CrossValidation.NNEVALUATOR_TEMPLATE, nncv_1.getCallback(12), ..., ...
		NNClassifierMLP_CrossValidation.DSP, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.DCO, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.D_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.NN_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.EVALUATOR_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.EPOCHS, nncv_1.getCallback(18), ..., ...
		NNClassifierMLP_CrossValidation.BATCH, nncv_1.getCallback(19), ..., ...
		NNClassifierMLP_CrossValidation.SHUFFLE, nncv_1.getCallback(20), ..., ...
		NNClassifierMLP_CrossValidation.SOLVER, nncv_1.getCallback(21), ..., ...
		NNClassifierMLP_CrossValidation.VERBOSE, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.VERBOSE), ...
		NNClassifierMLP_CrossValidation.PLOT_TRAINING, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.PLOT_TRAINING), ...
		NNClassifierMLP_CrossValidation.TRAIN, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.P, nncv_1.getCallback(25), ..., ...
		NNClassifierMLP_CrossValidation.AV_AUC, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.AV_MACRO_AUC, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.C_MATRIX, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.AV_FEATURE_IMPORTANCE, NNClassifierMLP_CrossValidation.getNoValue() ...
	...
	nncv_3 = NNClassifierMLP_CrossValidation( ...
		NNClassifierMLP_CrossValidation.NAME, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.DESCRIPTION, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.TEMPLATE, nncv_2.getCallback(3), ..., ...
		NNClassifierMLP_CrossValidation.ID, nncv_2.getCallback(4), ..., ...
		NNClassifierMLP_CrossValidation.LABEL, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.LABEL), ...
		NNClassifierMLP_CrossValidation.NOTES, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.NOTES), ...
		NNClassifierMLP_CrossValidation.TOSTRING, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.KFOLDS, nncv_2.getCallback(8), ..., ...
		NNClassifierMLP_CrossValidation.SPLIT, nncv_2.getCallback(9), ..., ...
		NNClassifierMLP_CrossValidation.D, nncv_2.getCallback(10), ..., ...
		NNClassifierMLP_CrossValidation.NN_TEMPLATE, nncv_2.getCallback(11), ..., ...
		NNClassifierMLP_CrossValidation.NNEVALUATOR_TEMPLATE, nncv_2.getCallback(12), ..., ...
		NNClassifierMLP_CrossValidation.DSP, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.DCO, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.D_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.NN_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.EVALUATOR_LIST, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.EPOCHS, nncv_2.getCallback(18), ..., ...
		NNClassifierMLP_CrossValidation.BATCH, nncv_2.getCallback(19), ..., ...
		NNClassifierMLP_CrossValidation.SHUFFLE, nncv_2.getCallback(20), ..., ...
		NNClassifierMLP_CrossValidation.SOLVER, nncv_2.getCallback(21), ..., ...
		NNClassifierMLP_CrossValidation.VERBOSE, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.VERBOSE), ...
		NNClassifierMLP_CrossValidation.PLOT_TRAINING, NNClassifierMLP_CrossValidation.getPropDefault(NNClassifierMLP_CrossValidation.PLOT_TRAINING), ...
		NNClassifierMLP_CrossValidation.TRAIN, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.P, nncv_2.getCallback(25), ..., ...
		NNClassifierMLP_CrossValidation.AV_AUC, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.AV_MACRO_AUC, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.C_MATRIX, NNClassifierMLP_CrossValidation.getNoValue(), ...
		NNClassifierMLP_CrossValidation.AV_FEATURE_IMPORTANCE, NNClassifierMLP_CrossValidation.getNoValue() ...
