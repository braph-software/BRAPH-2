classdef NNClassifierMLP_CrossValidationPF_ROC < PanelFig
	%NNClassifierMLP_CrossValidationPF_ROC is the base element to plot an ensemble-based comparison.
	...
	methods % constructor
		function pf = NNClassifierMLP_CrossValidationPF_ROC(varargin)
			%NNClassifierMLP_CrossValidationPF_ROC() creates a panel ensemble-based comparison figure.
			%
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			%
			% PROPS = NNClassifierMLP_CrossValidationPF_ROC.GETPROPS() returns the property list of panel ensemble-based comparison figure
			%  as a row vector.
			%
		...
		function prop_number = getPropNumber(varargin)
			...
			%
			% N = NNClassifierMLP_CrossValidationPF_ROC.GETPROPNUMBER() returns the property number of panel ensemble-based comparison figure.
			%
			% N = NNClassifierMLP_CrossValidationPF_ROC.GETPROPNUMBER(CATEGORY) returns the property number of panel ensemble-based comparison figure
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNClassifierMLP_CrossValidationPF_ROC.X_VALUES
					prop_description = 'X_VALUES (metadata, matrix) is the ROC X value.';
				case NNClassifierMLP_CrossValidationPF_ROC.Y_VALUES
					prop_description = 'Y_VALUES (metadata, matrix) is the ROC Y value.';
				case NNClassifierMLP_CrossValidationPF_ROC.SETUP
				...
				case NNClassifierMLP_CrossValidationPF_ROC.H_ROC
					prop_description = 'H_ROC (evanescent, handlelist) is the set of handles for the prediction plots.';
				case NNClassifierMLP_CrossValidationPF_ROC.ROC
					prop_description = 'ROC (figure, logical) determines whether the prediction plot are shown.';
				case NNClassifierMLP_CrossValidationPF_ROC.ROC_DICT
					prop_description = 'ROC_DICT (figure, idict) contains the prediction plot for each target.';
				case NNClassifierMLP_CrossValidationPF_ROC.H_TITLE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case NNClassifierMLP_CrossValidationPF_ROC.NAME
					prop_default = 'NNClassifierMLP_CrossValidationPF_ROC';
				case NNClassifierMLP_CrossValidationPF_ROC.DESCRIPTION
					prop_default = 'NNClassifierMLP_CrossValidationPF_ROC manages the basic functionalities to plot of an ensemble-based comparison.';
				case NNClassifierMLP_CrossValidationPF_ROC.TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, NNClassifierMLP_CrossValidationPF_ROC.getPropSettings(prop));
				case NNClassifierMLP_CrossValidationPF_ROC.ID
