classdef NNClassifierMLP_CrossValidation < NNCrossValidation
	...
	%  <strong>26</strong> <strong>AV_AUC</strong> 	AV_AUC (result, rvector) provides the average value of the area under the receiver operating characteristic curve across k folds.
	%  <strong>27</strong> <strong>AV_MACRO_AUC</strong> 	AV_MACRO_AUC (result, scalar) provides the metric of the average macro AUC value across k folds.
	%  <strong>28</strong> <strong>C_MATRIX</strong> 	C_MATRIX (result, matrix) provides the confusion matrix across k folds.
	%  <strong>29</strong> <strong>AV_FEATURE_IMPORTANCE</strong> 	AV_FEATURE_IMPORTANCE (result, cell) averages the feature importances across k folds.
	%
	...
	properties (Constant) % properties
		...
		AV_AUC = 26; %CET: Computational Efficiency Trick
		AV_AUC_TAG = 'AV_AUC';
		AV_AUC_CATEGORY = 5;
		AV_AUC_FORMAT = 12;
		
		AV_MACRO_AUC = 27; %CET: Computational Efficiency Trick
		AV_MACRO_AUC_TAG = 'AV_MACRO_AUC';
		AV_MACRO_AUC_CATEGORY = 5;
		AV_MACRO_AUC_FORMAT = 11;
		
		C_MATRIX = 28; %CET: Computational Efficiency Trick
		C_MATRIX_TAG = 'C_MATRIX';
		C_MATRIX_CATEGORY = 5;
		C_MATRIX_FORMAT = 14;
		
		AV_FEATURE_IMPORTANCE = 29; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			switch category
				...
				case 5 % Category.RESULT
					prop_list = [13 14 15 16 17 26 27 28 29];
		...
		function check_out = existsTag(tag)
			...
			check = any(strcmp(tag, { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'KFOLDS'  'SPLIT'  'D'  'NN_TEMPLATE'  'NNEVALUATOR_TEMPLATE'  'DSP'  'DCO'  'D_LIST'  'NN_LIST'  'EVALUATOR_LIST'  'EPOCHS'  'BATCH'  'SHUFFLE'  'SOLVER'  'VERBOSE'  'PLOT_TRAINING'  'TRAIN'  'P'  'AV_AUC'  'AV_MACRO_AUC'  'C_MATRIX'  'AV_FEATURE_IMPORTANCE' })); %CET: Computational Efficiency Trick
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nnclassifiermlp_crossvalidation_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'KFOLDS'  'SPLIT'  'D'  'NN_TEMPLATE'  'NNEVALUATOR_TEMPLATE'  'DSP'  'DCO'  'D_LIST'  'NN_LIST'  'EVALUATOR_LIST'  'EPOCHS'  'BATCH'  'SHUFFLE'  'SOLVER'  'VERBOSE'  'PLOT_TRAINING'  'TRAIN'  'P'  'AV_AUC'  'AV_MACRO_AUC'  'C_MATRIX'  'AV_FEATURE_IMPORTANCE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nnclassifiermlp_crossvalidation_category_list = { 1  1  3  4  2  2  6  4  4  4  3  3  5  5  5  5  5  3  3  3  3  2  2  6  3  5  5  5  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nnclassifiermlp_crossvalidation_format_list = { 2  2  8  2  2  2  2  11  16  9  8  8  9  9  9  9  9  11  11  5  5  4  5  1  11  12  11  14  16 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 25 % NNClassifierMLP_CrossValidation.P
					prop_settings = Format.getFormatSettings(11);
				case 26 % NNClassifierMLP_CrossValidation.AV_AUC
					prop_settings = Format.getFormatSettings(12);
				case 27 % NNClassifierMLP_CrossValidation.AV_MACRO_AUC
					prop_settings = Format.getFormatSettings(11);
				case 28 % NNClassifierMLP_CrossValidation.C_MATRIX
					prop_settings = Format.getFormatSettings(14);
				case 29 % NNClassifierMLP_CrossValidation.AV_FEATURE_IMPORTANCE
					prop_settings = Format.getFormatSettings(16);
				case 3 % NNClassifierMLP_CrossValidation.TEMPLATE
					prop_settings = 'NNClassifierMLP_CrossValidation';
				case 11 % NNClassifierMLP_CrossValidation.NN_TEMPLATE
					prop_settings = 'NNClassifierMLP';
				case 12 % NNClassifierMLP_CrossValidation.NNEVALUATOR_TEMPLATE
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(nncv, prop, varargin)
			...
			switch prop
				...
				case 16 % NNClassifierMLP_CrossValidation.NN_LIST
				...
				case 17 % NNClassifierMLP_CrossValidation.EVALUATOR_LIST
