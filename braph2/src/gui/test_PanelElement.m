...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	pe_1 = PanelElement( ...
		PanelElement.NAME, PanelElement.getNoValue(), ...
		PanelElement.DESCRIPTION, PanelElement.getNoValue(), ...
		PanelElement.TEMPLATE, pe_0.getCallback(3), ..., ...
		PanelElement.ID, pe_0.getCallback(4), ..., ...
		PanelElement.LABEL, PanelElement.getPropDefault(PanelElement.LABEL), ...
		PanelElement.NOTES, PanelElement.getPropDefault(PanelElement.NOTES), ...
		PanelElement.WAITBAR, pe_0.getCallback(7), ..., ...
		PanelElement.H_WAITBAR, PanelElement.getNoValue(), ...
		PanelElement.DRAW, PanelElement.getNoValue(), ...
		PanelElement.DRAWN, PanelElement.getNoValue(), ...
		PanelElement.PARENT, pe_0.getCallback(11), ..., ...
		PanelElement.BKGCOLOR, pe_0.getCallback(12), ..., ...
		PanelElement.H, PanelElement.getNoValue(), ...
		PanelElement.SHOW, PanelElement.getNoValue(), ...
		PanelElement.HIDE, PanelElement.getNoValue(), ...
		PanelElement.DELETE, PanelElement.getNoValue(), ...
		PanelElement.CLOSE, PanelElement.getNoValue(), ...
		PanelElement.EL, pe_0.getCallback(18), ..., ...
		PanelElement.PR_ORDER, pe_0.getCallback(19), ..., ...
		PanelElement.PR_TITLE, pe_0.getCallback(20), ..., ...
		PanelElement.PR_VISIBLE, pe_0.getCallback(21), ..., ...
		PanelElement.PR_DICT, PanelElement.getNoValue(), ...
		PanelElement.MIN_WIDTH, pe_0.getCallback(23), ..., ...
		PanelElement.RESIZEX, PanelElement.getNoValue(), ...
		PanelElement.RESIZEY, PanelElement.getNoValue(), ...
		PanelElement.LISTENER_PPHEIGHT, PanelElement.getNoValue() ...
		);
	...
	pe_2 = PanelElement( ...
		PanelElement.NAME, PanelElement.getNoValue(), ...
		PanelElement.DESCRIPTION, PanelElement.getNoValue(), ...
		PanelElement.TEMPLATE, pe_1.getCallback(3), ..., ...
		PanelElement.ID, pe_1.getCallback(4), ..., ...
		PanelElement.LABEL, PanelElement.getPropDefault(PanelElement.LABEL), ...
		PanelElement.NOTES, PanelElement.getPropDefault(PanelElement.NOTES), ...
		PanelElement.WAITBAR, pe_1.getCallback(7), ..., ...
		PanelElement.H_WAITBAR, PanelElement.getNoValue(), ...
		PanelElement.DRAW, PanelElement.getNoValue(), ...
		PanelElement.DRAWN, PanelElement.getNoValue(), ...
		PanelElement.PARENT, pe_1.getCallback(11), ..., ...
		PanelElement.BKGCOLOR, pe_1.getCallback(12), ..., ...
		PanelElement.H, PanelElement.getNoValue(), ...
		PanelElement.SHOW, PanelElement.getNoValue(), ...
		PanelElement.HIDE, PanelElement.getNoValue(), ...
		PanelElement.DELETE, PanelElement.getNoValue(), ...
		PanelElement.CLOSE, PanelElement.getNoValue(), ...
		PanelElement.EL, pe_1.getCallback(18), ..., ...
		PanelElement.PR_ORDER, pe_1.getCallback(19), ..., ...
		PanelElement.PR_TITLE, pe_1.getCallback(20), ..., ...
		PanelElement.PR_VISIBLE, pe_1.getCallback(21), ..., ...
		PanelElement.PR_DICT, PanelElement.getNoValue(), ...
		PanelElement.MIN_WIDTH, pe_1.getCallback(23), ..., ...
		PanelElement.RESIZEX, PanelElement.getNoValue(), ...
		PanelElement.RESIZEY, PanelElement.getNoValue(), ...
		PanelElement.LISTENER_PPHEIGHT, PanelElement.getNoValue() ...
		);
	...
	pe_3 = PanelElement( ...
		PanelElement.NAME, PanelElement.getNoValue(), ...
		PanelElement.DESCRIPTION, PanelElement.getNoValue(), ...
		PanelElement.TEMPLATE, pe_2.getCallback(3), ..., ...
		PanelElement.ID, pe_2.getCallback(4), ..., ...
		PanelElement.LABEL, PanelElement.getPropDefault(PanelElement.LABEL), ...
		PanelElement.NOTES, PanelElement.getPropDefault(PanelElement.NOTES), ...
		PanelElement.WAITBAR, pe_2.getCallback(7), ..., ...
		PanelElement.H_WAITBAR, PanelElement.getNoValue(), ...
		PanelElement.DRAW, PanelElement.getNoValue(), ...
		PanelElement.DRAWN, PanelElement.getNoValue(), ...
		PanelElement.PARENT, pe_2.getCallback(11), ..., ...
		PanelElement.BKGCOLOR, pe_2.getCallback(12), ..., ...
		PanelElement.H, PanelElement.getNoValue(), ...
		PanelElement.SHOW, PanelElement.getNoValue(), ...
		PanelElement.HIDE, PanelElement.getNoValue(), ...
		PanelElement.DELETE, PanelElement.getNoValue(), ...
		PanelElement.CLOSE, PanelElement.getNoValue(), ...
		PanelElement.EL, pe_2.getCallback(18), ..., ...
		PanelElement.PR_ORDER, pe_2.getCallback(19), ..., ...
		PanelElement.PR_TITLE, pe_2.getCallback(20), ..., ...
		PanelElement.PR_VISIBLE, pe_2.getCallback(21), ..., ...
		PanelElement.PR_DICT, PanelElement.getNoValue(), ...
		PanelElement.MIN_WIDTH, pe_2.getCallback(23), ..., ...
		PanelElement.RESIZEX, PanelElement.getNoValue(), ...
		PanelElement.RESIZEY, PanelElement.getNoValue(), ...
		PanelElement.LISTENER_PPHEIGHT, PanelElement.getNoValue() ...
		);
