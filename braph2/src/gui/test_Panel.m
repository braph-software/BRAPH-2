...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	pn_1 = Panel( ...
		...
		Panel.NOTES, Panel.getPropDefault(Panel.NOTES), ...
		Panel.TOSTRING, Panel.getNoValue(), ...
		Panel.WAITBAR, pn_0.getCallback(8), ..., ...
		Panel.H_WAITBAR, Panel.getNoValue(), ...
		Panel.DRAW, Panel.getNoValue(), ...
		Panel.DRAWN, Panel.getNoValue(), ...
		Panel.PARENT, pn_0.getCallback(12), ..., ...
		Panel.BKGCOLOR, pn_0.getCallback(13), ..., ...
		Panel.H, Panel.getNoValue(), ...
		Panel.SHOW, Panel.getNoValue(), ...
		Panel.HIDE, Panel.getNoValue(), ...
		Panel.DELETE, Panel.getNoValue(), ...
	...
	pn_2 = Panel( ...
		...
		Panel.NOTES, Panel.getPropDefault(Panel.NOTES), ...
		Panel.TOSTRING, Panel.getNoValue(), ...
		Panel.WAITBAR, pn_1.getCallback(8), ..., ...
		Panel.H_WAITBAR, Panel.getNoValue(), ...
		Panel.DRAW, Panel.getNoValue(), ...
		Panel.DRAWN, Panel.getNoValue(), ...
		Panel.PARENT, pn_1.getCallback(12), ..., ...
		Panel.BKGCOLOR, pn_1.getCallback(13), ..., ...
		Panel.H, Panel.getNoValue(), ...
		Panel.SHOW, Panel.getNoValue(), ...
		Panel.HIDE, Panel.getNoValue(), ...
		Panel.DELETE, Panel.getNoValue(), ...
	...
	pn_3 = Panel( ...
		...
		Panel.NOTES, Panel.getPropDefault(Panel.NOTES), ...
		Panel.TOSTRING, Panel.getNoValue(), ...
		Panel.WAITBAR, pn_2.getCallback(8), ..., ...
		Panel.H_WAITBAR, Panel.getNoValue(), ...
		Panel.DRAW, Panel.getNoValue(), ...
		Panel.DRAWN, Panel.getNoValue(), ...
		Panel.PARENT, pn_2.getCallback(12), ..., ...
		Panel.BKGCOLOR, pn_2.getCallback(13), ..., ...
		Panel.H, Panel.getNoValue(), ...
		Panel.SHOW, Panel.getNoValue(), ...
		Panel.HIDE, Panel.getNoValue(), ...
		Panel.DELETE, Panel.getNoValue(), ...
