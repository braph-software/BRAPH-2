...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	pn_1 = Panel( ...
		Panel.NAME, Panel.getNoValue(), ...
		Panel.DESCRIPTION, Panel.getNoValue(), ...
		Panel.TEMPLATE, pn_0.getCallback(3), ..., ...
		Panel.ID, pn_0.getCallback(4), ..., ...
		Panel.LABEL, Panel.getPropDefault(Panel.LABEL), ...
		Panel.NOTES, Panel.getPropDefault(Panel.NOTES), ...
		Panel.WAITBAR, pn_0.getCallback(7), ..., ...
		Panel.H_WAITBAR, Panel.getNoValue(), ...
		Panel.DRAW, Panel.getNoValue(), ...
		Panel.DRAWN, Panel.getNoValue(), ...
		Panel.PARENT, pn_0.getCallback(11), ..., ...
		Panel.BKGCOLOR, pn_0.getCallback(12), ..., ...
		Panel.H, Panel.getNoValue(), ...
		Panel.SHOW, Panel.getNoValue(), ...
		Panel.HIDE, Panel.getNoValue(), ...
		Panel.DELETE, Panel.getNoValue(), ...
	...
	pn_2 = Panel( ...
		Panel.NAME, Panel.getNoValue(), ...
		Panel.DESCRIPTION, Panel.getNoValue(), ...
		Panel.TEMPLATE, pn_1.getCallback(3), ..., ...
		Panel.ID, pn_1.getCallback(4), ..., ...
		Panel.LABEL, Panel.getPropDefault(Panel.LABEL), ...
		Panel.NOTES, Panel.getPropDefault(Panel.NOTES), ...
		Panel.WAITBAR, pn_1.getCallback(7), ..., ...
		Panel.H_WAITBAR, Panel.getNoValue(), ...
		Panel.DRAW, Panel.getNoValue(), ...
		Panel.DRAWN, Panel.getNoValue(), ...
		Panel.PARENT, pn_1.getCallback(11), ..., ...
		Panel.BKGCOLOR, pn_1.getCallback(12), ..., ...
		Panel.H, Panel.getNoValue(), ...
		Panel.SHOW, Panel.getNoValue(), ...
		Panel.HIDE, Panel.getNoValue(), ...
		Panel.DELETE, Panel.getNoValue(), ...
	...
	pn_3 = Panel( ...
		Panel.NAME, Panel.getNoValue(), ...
		Panel.DESCRIPTION, Panel.getNoValue(), ...
		Panel.TEMPLATE, pn_2.getCallback(3), ..., ...
		Panel.ID, pn_2.getCallback(4), ..., ...
		Panel.LABEL, Panel.getPropDefault(Panel.LABEL), ...
		Panel.NOTES, Panel.getPropDefault(Panel.NOTES), ...
		Panel.WAITBAR, pn_2.getCallback(7), ..., ...
		Panel.H_WAITBAR, Panel.getNoValue(), ...
		Panel.DRAW, Panel.getNoValue(), ...
		Panel.DRAWN, Panel.getNoValue(), ...
		Panel.PARENT, pn_2.getCallback(11), ..., ...
		Panel.BKGCOLOR, pn_2.getCallback(12), ..., ...
		Panel.H, Panel.getNoValue(), ...
		Panel.SHOW, Panel.getNoValue(), ...
		Panel.HIDE, Panel.getNoValue(), ...
		Panel.DELETE, Panel.getNoValue(), ...
