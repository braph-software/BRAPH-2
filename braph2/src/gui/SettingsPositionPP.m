		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case SettingsPositionPP.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the prop panel for position settings.';
				case SettingsPositionPP.NAME
					prop_description = 'NAME (constant, string) is the name of the prop panel for position settings.';
				case SettingsPositionPP.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the prop panel for position settings.';
				case SettingsPositionPP.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the prop panel for position settings.';
				case SettingsPositionPP.ID
					prop_description = 'ID (data, string) is a few-letter code for the prop panel for position settings.';
				case SettingsPositionPP.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the prop panel for position settings.';
				case SettingsPositionPP.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the prop panel for position settings.';
				case SettingsPositionPP.EL
					prop_description = 'EL (data, item) is the element.';
				case SettingsPositionPP.PROP
					prop_description = 'PROP (data, scalar) is the property number.';
				case SettingsPositionPP.HEIGHT
					prop_description = 'HEIGHT (gui, size) is the pixel height of the prop panel for position settings.';
