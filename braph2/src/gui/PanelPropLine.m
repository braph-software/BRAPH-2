classdef PanelPropLine < PanelProp
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the line property panel.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the line property panel.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the line property panel.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the line property panel.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the line property panel.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the line property panel.
	...
	%  <strong>34</strong> <strong>DROPDOWN</strong> 	DROPDOWN (evanescent, handle) is the marker value dropdown.
	%  <strong>35</strong> <strong>AXES</strong> 	AXES (evanescent, handle) is the marker value axes.
	%  <strong>36</strong> <strong>LN</strong> 	LN (evanescent, handle) is the marker value line.
	%
	...
	properties (Constant) % properties
		DROPDOWN = 34; %CET: Computational Efficiency Trick
		DROPDOWN_TAG = 'DROPDOWN';
		DROPDOWN_CATEGORY = 7;
		DROPDOWN_FORMAT = 18;
		
		AXES = 35; %CET: Computational Efficiency Trick
		AXES_TAG = 'AXES';
		AXES_CATEGORY = 7;
		AXES_FORMAT = 18;
		
		LN = 36; %CET: Computational Efficiency Trick
		LN_TAG = 'LN';
		LN_CATEGORY = 7;
		LN_FORMAT = 18;
	end
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			switch category
				...
				case 7 % Category.EVANESCENT
					prop_list = [8 13 25 26 28 29 30 31 32 33 34 35 36];
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				panelpropline_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'DROPDOWN'  'AXES'  'LN' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			panelpropline_category_list = { 1  1  3  4  2  2  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  7  7  7 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			panelpropline_format_list = { 2  2  8  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  18  18  18 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 34 % PanelPropLine.DROPDOWN
					prop_settings = Format.getFormatSettings(18);
				case 35 % PanelPropLine.AXES
					prop_settings = Format.getFormatSettings(18);
				case 36 % PanelPropLine.LN
					prop_settings = Format.getFormatSettings(18);
				case 3 % PanelPropLine.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 36 % PanelPropLine.LN
					prop_default = Format.getFormatDefault(18, PanelPropLine.getPropSettings(prop));
				case 1 % PanelPropLine.NAME
					prop_default = 'PanelPropLine';
				case 2 % PanelPropLine.DESCRIPTION
				...
				case 4 % PanelPropLine.ID
					prop_default = 'PanelPropLine ID';
				case 5 % PanelPropLine.LABEL
					prop_default = 'PanelPropLine label';
				case 6 % PanelPropLine.NOTES
					prop_default = 'PanelPropLine notes';
				case 21 % PanelPropLine.EL
					prop_default = SettingsLine();
				case 22 % PanelPropLine.PROP
					prop_default = 17;
				case 23 % PanelPropLine.HEIGHT
					prop_default = 48;
				otherwise
