		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropLine.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the line prop panel.';
				case PanelPropLine.NAME
					prop_description = 'NAME (constant, string) is the name of the line prop panel.';
				case PanelPropLine.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the line prop panel.';
				case PanelPropLine.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the line prop panel.';
				case PanelPropLine.ID
					prop_description = 'ID (data, string) is a few-letter code for the line prop panel.';
				case PanelPropLine.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the line prop panel.';
				case PanelPropLine.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the line prop panel.';
