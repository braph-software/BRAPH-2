classdef PanelPropScalar < PanelProp
	%PanelPropScalar plots the panel of a prop scalar.
	...
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the scalar prop panel.
	%  <strong>2</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the scalar prop panel.
	%  <strong>3</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the scalar prop panel.
	%  <strong>4</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the scalar prop panel.
	%  <strong>5</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the scalar prop panel.
	%  <strong>6</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the scalar prop panel.
	%  <strong>7</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the scalar prop panel.
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 3 % PanelPropScalar.DESCRIPTION
					prop_default = 'A Scalar Prop Panel (PanelPropScalar) plots the panel for a SCALAR prop with a numeric edit field. It works for all categories.';
				case 4 % PanelPropScalar.TEMPLATE
