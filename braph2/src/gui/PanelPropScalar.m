		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropScalar.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the scalar prop panel.';
				case PanelPropScalar.NAME
					prop_description = 'NAME (constant, string) is the name of the scalar prop panel.';
				case PanelPropScalar.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the scalar prop panel.';
				case PanelPropScalar.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the scalar prop panel.';
				case PanelPropScalar.ID
					prop_description = 'ID (data, string) is a few-letter code for the scalar prop panel.';
				case PanelPropScalar.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the scalar prop panel.';
				case PanelPropScalar.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the scalar prop panel.';
