		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropAlpha.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the alpha prop panel.';
				case PanelPropAlpha.NAME
					prop_description = 'NAME (constant, string) is the name of the alpha prop panel.';
				case PanelPropAlpha.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the alpha prop panel.';
				case PanelPropAlpha.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the alpha prop panel.';
				case PanelPropAlpha.ID
					prop_description = 'ID (data, string) is a few-letter code for the alpha prop panel.';
				case PanelPropAlpha.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the alpha prop panel.';
				case PanelPropAlpha.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the alpha prop panel.';
