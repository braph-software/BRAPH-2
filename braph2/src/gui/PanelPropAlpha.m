classdef PanelPropAlpha < PanelProp
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the alpha property panel.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the alpha property panel.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the alpha property panel.
	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 2 % PanelPropAlpha.DESCRIPTION
				...
				case 4 % PanelPropAlpha.ID
					prop_default = 'PanelPropAlpha ID';
				case 5 % PanelPropAlpha.LABEL
