...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	st_1 = SettingsArea( ...
		...
		SettingsArea.LABEL, SettingsArea.getPropDefault(SettingsArea.LABEL), ...
		SettingsArea.NOTES, SettingsArea.getPropDefault(SettingsArea.NOTES), ...
		SettingsArea.PANEL, st_0.getCallback(7), ..., ...
		SettingsArea.PROP, st_0.getCallback(8), ..., ...
		SettingsArea.TAG, st_0.getCallback(9), ..., ...
		SettingsArea.I, st_0.getCallback(10), ..., ...
		SettingsArea.H, SettingsArea.getNoValue(), ...
		SettingsArea.SETUP, SettingsArea.getNoValue(), ...
		SettingsArea.VISIBLE, st_0.getCallback(13), ..., ...
		SettingsArea.X, st_0.getCallback(14), ..., ...
		SettingsArea.Y, st_0.getCallback(15), ..., ...
		SettingsArea.Z, st_0.getCallback(16), ..., ...
		SettingsArea.FACECOLOR, st_0.getCallback(17), ..., ...
		SettingsArea.FACEALPHA, st_0.getCallback(18), ..., ...
		SettingsArea.EDGECOLOR, st_0.getCallback(19), ..., ...
		SettingsArea.EDGEALPHA, st_0.getCallback(20) ... ...
		);
	...
	st_2 = SettingsArea( ...
		...
		SettingsArea.LABEL, SettingsArea.getPropDefault(SettingsArea.LABEL), ...
		SettingsArea.NOTES, SettingsArea.getPropDefault(SettingsArea.NOTES), ...
		SettingsArea.PANEL, st_1.getCallback(7), ..., ...
		SettingsArea.PROP, st_1.getCallback(8), ..., ...
		SettingsArea.TAG, st_1.getCallback(9), ..., ...
		SettingsArea.I, st_1.getCallback(10), ..., ...
		SettingsArea.H, SettingsArea.getNoValue(), ...
		SettingsArea.SETUP, SettingsArea.getNoValue(), ...
		SettingsArea.VISIBLE, st_1.getCallback(13), ..., ...
		SettingsArea.X, st_1.getCallback(14), ..., ...
		SettingsArea.Y, st_1.getCallback(15), ..., ...
		SettingsArea.Z, st_1.getCallback(16), ..., ...
		SettingsArea.FACECOLOR, st_1.getCallback(17), ..., ...
		SettingsArea.FACEALPHA, st_1.getCallback(18), ..., ...
		SettingsArea.EDGECOLOR, st_1.getCallback(19), ..., ...
		SettingsArea.EDGEALPHA, st_1.getCallback(20) ... ...
		);
	...
	st_3 = SettingsArea( ...
		...
		SettingsArea.LABEL, SettingsArea.getPropDefault(SettingsArea.LABEL), ...
		SettingsArea.NOTES, SettingsArea.getPropDefault(SettingsArea.NOTES), ...
		SettingsArea.PANEL, st_2.getCallback(7), ..., ...
		SettingsArea.PROP, st_2.getCallback(8), ..., ...
		SettingsArea.TAG, st_2.getCallback(9), ..., ...
		SettingsArea.I, st_2.getCallback(10), ..., ...
		SettingsArea.H, SettingsArea.getNoValue(), ...
		SettingsArea.SETUP, SettingsArea.getNoValue(), ...
		SettingsArea.VISIBLE, st_2.getCallback(13), ..., ...
		SettingsArea.X, st_2.getCallback(14), ..., ...
		SettingsArea.Y, st_2.getCallback(15), ..., ...
		SettingsArea.Z, st_2.getCallback(16), ..., ...
		SettingsArea.FACECOLOR, st_2.getCallback(17), ..., ...
		SettingsArea.FACEALPHA, st_2.getCallback(18), ..., ...
		SettingsArea.EDGECOLOR, st_2.getCallback(19), ..., ...
		SettingsArea.EDGEALPHA, st_2.getCallback(20) ... ...
		);
