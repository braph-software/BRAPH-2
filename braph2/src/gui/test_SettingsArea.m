...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	st_1 = SettingsArea( ...
		SettingsArea.NAME, SettingsArea.getNoValue(), ...
		SettingsArea.DESCRIPTION, SettingsArea.getNoValue(), ...
		SettingsArea.TEMPLATE, st_0.getCallback(3), ..., ...
		SettingsArea.ID, st_0.getCallback(4), ..., ...
		SettingsArea.LABEL, SettingsArea.getPropDefault(SettingsArea.LABEL), ...
		SettingsArea.NOTES, SettingsArea.getPropDefault(SettingsArea.NOTES), ...
		SettingsArea.TOSTRING, SettingsArea.getNoValue(), ...
		SettingsArea.PANEL, st_0.getCallback(8), ..., ...
		SettingsArea.PROP, st_0.getCallback(9), ..., ...
		SettingsArea.TAG, st_0.getCallback(10), ..., ...
		SettingsArea.I, st_0.getCallback(11), ..., ...
		SettingsArea.H, SettingsArea.getNoValue(), ...
		SettingsArea.SETUP, SettingsArea.getNoValue(), ...
		SettingsArea.VISIBLE, st_0.getCallback(14), ..., ...
		SettingsArea.X, st_0.getCallback(15), ..., ...
		SettingsArea.Y, st_0.getCallback(16), ..., ...
		SettingsArea.Z, st_0.getCallback(17), ..., ...
		SettingsArea.FACECOLOR, st_0.getCallback(18), ..., ...
		SettingsArea.FACEALPHA, st_0.getCallback(19), ..., ...
		SettingsArea.EDGECOLOR, st_0.getCallback(20), ..., ...
		SettingsArea.EDGEALPHA, st_0.getCallback(21) ... ...
		);
	...
	st_2 = SettingsArea( ...
		SettingsArea.NAME, SettingsArea.getNoValue(), ...
		SettingsArea.DESCRIPTION, SettingsArea.getNoValue(), ...
		SettingsArea.TEMPLATE, st_1.getCallback(3), ..., ...
		SettingsArea.ID, st_1.getCallback(4), ..., ...
		SettingsArea.LABEL, SettingsArea.getPropDefault(SettingsArea.LABEL), ...
		SettingsArea.NOTES, SettingsArea.getPropDefault(SettingsArea.NOTES), ...
		SettingsArea.TOSTRING, SettingsArea.getNoValue(), ...
		SettingsArea.PANEL, st_1.getCallback(8), ..., ...
		SettingsArea.PROP, st_1.getCallback(9), ..., ...
		SettingsArea.TAG, st_1.getCallback(10), ..., ...
		SettingsArea.I, st_1.getCallback(11), ..., ...
		SettingsArea.H, SettingsArea.getNoValue(), ...
		SettingsArea.SETUP, SettingsArea.getNoValue(), ...
		SettingsArea.VISIBLE, st_1.getCallback(14), ..., ...
		SettingsArea.X, st_1.getCallback(15), ..., ...
		SettingsArea.Y, st_1.getCallback(16), ..., ...
		SettingsArea.Z, st_1.getCallback(17), ..., ...
		SettingsArea.FACECOLOR, st_1.getCallback(18), ..., ...
		SettingsArea.FACEALPHA, st_1.getCallback(19), ..., ...
		SettingsArea.EDGECOLOR, st_1.getCallback(20), ..., ...
		SettingsArea.EDGEALPHA, st_1.getCallback(21) ... ...
		);
	...
	st_3 = SettingsArea( ...
		SettingsArea.NAME, SettingsArea.getNoValue(), ...
		SettingsArea.DESCRIPTION, SettingsArea.getNoValue(), ...
		SettingsArea.TEMPLATE, st_2.getCallback(3), ..., ...
		SettingsArea.ID, st_2.getCallback(4), ..., ...
		SettingsArea.LABEL, SettingsArea.getPropDefault(SettingsArea.LABEL), ...
		SettingsArea.NOTES, SettingsArea.getPropDefault(SettingsArea.NOTES), ...
		SettingsArea.TOSTRING, SettingsArea.getNoValue(), ...
		SettingsArea.PANEL, st_2.getCallback(8), ..., ...
		SettingsArea.PROP, st_2.getCallback(9), ..., ...
		SettingsArea.TAG, st_2.getCallback(10), ..., ...
		SettingsArea.I, st_2.getCallback(11), ..., ...
		SettingsArea.H, SettingsArea.getNoValue(), ...
		SettingsArea.SETUP, SettingsArea.getNoValue(), ...
		SettingsArea.VISIBLE, st_2.getCallback(14), ..., ...
		SettingsArea.X, st_2.getCallback(15), ..., ...
		SettingsArea.Y, st_2.getCallback(16), ..., ...
		SettingsArea.Z, st_2.getCallback(17), ..., ...
		SettingsArea.FACECOLOR, st_2.getCallback(18), ..., ...
		SettingsArea.FACEALPHA, st_2.getCallback(19), ..., ...
		SettingsArea.EDGECOLOR, st_2.getCallback(20), ..., ...
		SettingsArea.EDGEALPHA, st_2.getCallback(21) ... ...
		);
