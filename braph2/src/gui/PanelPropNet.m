classdef PanelPropNet < PanelProp
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the neural network property panel.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the neural network property panel.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the neural network property panel.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the neural network property panel.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the neural network property panel.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the neural network property panel.
	...
	%  <strong>37</strong> <strong>MSG_FLAG</strong> 	MSG_FLAG (gui, logical) determines whether to show the message box about the neural network visualization window.
	%
	...
	properties (Constant) % properties
		...
		MSG_FLAG = 37; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				panelpropnet_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'BUTTON_TEXT'  'BUTTON'  'MSG_FLAG' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			panelpropnet_category_list = { 1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  9  7  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			panelpropnet_format_list = { 2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  2  18  4 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 35 % PanelPropNet.BUTTON_TEXT
					prop_settings = Format.getFormatSettings(2);
				case 36 % PanelPropNet.BUTTON
					prop_settings = Format.getFormatSettings(18);
				case 37 % PanelPropNet.MSG_FLAG
					prop_settings = Format.getFormatSettings(4);
				case 3 % PanelPropNet.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 37 % PanelPropNet.MSG_FLAG
					prop_default = true;
				case 1 % PanelPropNet.NAME
					prop_default = 'PanelPropNet';
				case 2 % PanelPropNet.DESCRIPTION
				...
				case 4 % PanelPropNet.ID
					prop_default = 'PanelPropNet ID';
				case 5 % PanelPropNet.LABEL
					prop_default = 'PanelPropNet label';
				case 6 % PanelPropNet.NOTES
					prop_default = 'PanelPropNet notes';
				case 22 % PanelPropNet.EL
					prop_default = PanelProp();
				case 23 % PanelPropNet.PROP
					prop_default = 22;
				case 24 % PanelPropNet.HEIGHT
					prop_default = 48;
				otherwise
