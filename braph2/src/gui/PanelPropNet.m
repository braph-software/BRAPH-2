		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropNet.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the neural network prop panel.';
				case PanelPropNet.NAME
					prop_description = 'NAME (constant, string) is the name of the neural network prop panel.';
				case PanelPropNet.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the neural network prop panel.';
				case PanelPropNet.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the neural network prop panel.';
				case PanelPropNet.ID
					prop_description = 'ID (data, string) is a few-letter code for the neural network prop panel.';
				case PanelPropNet.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the neural network prop panel.';
				case PanelPropNet.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the neural network prop panel.';
