classdef PanelPropIDict < PanelProp
	%PanelPropIDict plots the panel of a prop idict.
	...
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the idict prop panel.
	%  <strong>2</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the idict prop panel.
	%  <strong>3</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the idict prop panel.
	%  <strong>4</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the idict prop panel.
	%  <strong>5</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the idict prop panel.
	%  <strong>6</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the idict prop panel.
	%  <strong>7</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the idict prop panel.
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 3 % PanelPropIDict.DESCRIPTION
					prop_default = 'An Indexed-Dictionary Prop Panel (PanelPropIDict) plots the panel for a IDICT prop with a button. It works for all categories.';
				case 4 % PanelPropIDict.TEMPLATE
					prop_default = Format.getFormatDefault(8, PanelPropIDict.getPropSettings(prop));
