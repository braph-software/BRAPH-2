		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropString.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the string prop panel.';
				case PanelPropString.NAME
					prop_description = 'NAME (constant, string) is the name of the string prop panel.';
				case PanelPropString.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the string prop panel.';
				case PanelPropString.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the string prop panel.';
				case PanelPropString.ID
					prop_description = 'ID (data, string) is a few-letter code for the string prop panel.';
				case PanelPropString.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the string prop panel.';
				case PanelPropString.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the string prop panel.';
