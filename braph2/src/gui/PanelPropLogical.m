		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropLogical.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the logical prop panel.';
				case PanelPropLogical.NAME
					prop_description = 'NAME (constant, string) is the name of the logical prop panel.';
				case PanelPropLogical.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the logical prop panel.';
				case PanelPropLogical.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the logical prop panel.';
				case PanelPropLogical.ID
					prop_description = 'ID (data, string) is a few-letter code for the logical prop panel.';
				case PanelPropLogical.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the logical prop panel.';
				case PanelPropLogical.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the logical prop panel.';
