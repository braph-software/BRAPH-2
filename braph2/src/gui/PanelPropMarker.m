classdef PanelPropMarker < PanelProp
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			panelpropmarker_category_list = { 1  1  3  4  2  2  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  7  7  7 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			panelpropmarker_format_list = { 2  2  8  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  18  18  18 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 34 % PanelPropMarker.DROPDOWN
					prop_settings = Format.getFormatSettings(18);
				case 35 % PanelPropMarker.AXES
					prop_settings = Format.getFormatSettings(18);
				case 36 % PanelPropMarker.LN
					prop_settings = Format.getFormatSettings(18);
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 21 % PanelPropMarker.EL
					prop_default = SettingsSymbol();
				case 22 % PanelPropMarker.PROP
					prop_default = 17;
				case 23 % PanelPropMarker.HEIGHT
					prop_default = 48;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 18 % PanelPropMarker.X_DRAW
				...
				case 19 % PanelPropMarker.UPDATE
				...
				case 20 % PanelPropMarker.REDRAW
				...
				case 16 % PanelPropMarker.DELETE
