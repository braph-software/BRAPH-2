...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	pc_1 = PipelineCode( ...
		...
		PipelineCode.TEXT_BEFORE_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_BEFORE_EXEC), ...
		PipelineCode.TEXT_AFTER_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_AFTER_EXEC), ...
		PipelineCode.MONIKER, pc_0.getCallback(9), ..., ...
		PipelineCode.CODE, pc_0.getCallback(10), ..., ...
		PipelineCode.EL, pc_0.getCallback(11) ... ...
		);
	...
	pc_2 = PipelineCode( ...
		...
		PipelineCode.TEXT_BEFORE_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_BEFORE_EXEC), ...
		PipelineCode.TEXT_AFTER_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_AFTER_EXEC), ...
		PipelineCode.MONIKER, pc_1.getCallback(9), ..., ...
		PipelineCode.CODE, pc_1.getCallback(10), ..., ...
		PipelineCode.EL, pc_1.getCallback(11) ... ...
		);
	...
	pc_3 = PipelineCode( ...
		...
		PipelineCode.TEXT_BEFORE_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_BEFORE_EXEC), ...
		PipelineCode.TEXT_AFTER_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_AFTER_EXEC), ...
		PipelineCode.MONIKER, pc_2.getCallback(9), ..., ...
		PipelineCode.CODE, pc_2.getCallback(10), ..., ...
		PipelineCode.EL, pc_2.getCallback(11) ... ...
		);
