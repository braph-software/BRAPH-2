...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	pc_1 = PipelineCode( ...
		PipelineCode.NAME, PipelineCode.getNoValue(), ...
		PipelineCode.DESCRIPTION, PipelineCode.getNoValue(), ...
		PipelineCode.TEMPLATE, pc_0.getCallback(3), ..., ...
		PipelineCode.ID, pc_0.getCallback(4), ..., ...
		PipelineCode.LABEL, PipelineCode.getPropDefault(PipelineCode.LABEL), ...
		PipelineCode.NOTES, PipelineCode.getPropDefault(PipelineCode.NOTES), ...
		PipelineCode.TOSTRING, PipelineCode.getNoValue(), ...
		PipelineCode.TEXT_BEFORE_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_BEFORE_EXEC), ...
		PipelineCode.TEXT_AFTER_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_AFTER_EXEC), ...
		PipelineCode.MONIKER, pc_0.getCallback(10), ..., ...
		PipelineCode.CODE, pc_0.getCallback(11), ..., ...
		PipelineCode.EL, pc_0.getCallback(12) ... ...
		);
	...
	pc_2 = PipelineCode( ...
		PipelineCode.NAME, PipelineCode.getNoValue(), ...
		PipelineCode.DESCRIPTION, PipelineCode.getNoValue(), ...
		PipelineCode.TEMPLATE, pc_1.getCallback(3), ..., ...
		PipelineCode.ID, pc_1.getCallback(4), ..., ...
		PipelineCode.LABEL, PipelineCode.getPropDefault(PipelineCode.LABEL), ...
		PipelineCode.NOTES, PipelineCode.getPropDefault(PipelineCode.NOTES), ...
		PipelineCode.TOSTRING, PipelineCode.getNoValue(), ...
		PipelineCode.TEXT_BEFORE_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_BEFORE_EXEC), ...
		PipelineCode.TEXT_AFTER_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_AFTER_EXEC), ...
		PipelineCode.MONIKER, pc_1.getCallback(10), ..., ...
		PipelineCode.CODE, pc_1.getCallback(11), ..., ...
		PipelineCode.EL, pc_1.getCallback(12) ... ...
		);
	...
	pc_3 = PipelineCode( ...
		PipelineCode.NAME, PipelineCode.getNoValue(), ...
		PipelineCode.DESCRIPTION, PipelineCode.getNoValue(), ...
		PipelineCode.TEMPLATE, pc_2.getCallback(3), ..., ...
		PipelineCode.ID, pc_2.getCallback(4), ..., ...
		PipelineCode.LABEL, PipelineCode.getPropDefault(PipelineCode.LABEL), ...
		PipelineCode.NOTES, PipelineCode.getPropDefault(PipelineCode.NOTES), ...
		PipelineCode.TOSTRING, PipelineCode.getNoValue(), ...
		PipelineCode.TEXT_BEFORE_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_BEFORE_EXEC), ...
		PipelineCode.TEXT_AFTER_EXEC, PipelineCode.getPropDefault(PipelineCode.TEXT_AFTER_EXEC), ...
		PipelineCode.MONIKER, pc_2.getCallback(10), ..., ...
		PipelineCode.CODE, pc_2.getCallback(11), ..., ...
		PipelineCode.EL, pc_2.getCallback(12) ... ...
		);
