...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	pip_1 = Pipeline( ...
		Pipeline.NAME, Pipeline.getNoValue(), ...
		Pipeline.DESCRIPTION, Pipeline.getNoValue(), ...
		Pipeline.TEMPLATE, pip_0.getCallback(3), ..., ...
		Pipeline.ID, pip_0.getCallback(4), ..., ...
		Pipeline.LABEL, Pipeline.getPropDefault(Pipeline.LABEL), ...
		Pipeline.NOTES, Pipeline.getPropDefault(Pipeline.NOTES), ...
		Pipeline.PS_DICT, pip_0.getCallback(7) ... ...
		);
	...
	pip_2 = Pipeline( ...
		Pipeline.NAME, Pipeline.getNoValue(), ...
		Pipeline.DESCRIPTION, Pipeline.getNoValue(), ...
		Pipeline.TEMPLATE, pip_1.getCallback(3), ..., ...
		Pipeline.ID, pip_1.getCallback(4), ..., ...
		Pipeline.LABEL, Pipeline.getPropDefault(Pipeline.LABEL), ...
		Pipeline.NOTES, Pipeline.getPropDefault(Pipeline.NOTES), ...
		Pipeline.PS_DICT, pip_1.getCallback(7) ... ...
		);
	...
	pip_3 = Pipeline( ...
		Pipeline.NAME, Pipeline.getNoValue(), ...
		Pipeline.DESCRIPTION, Pipeline.getNoValue(), ...
		Pipeline.TEMPLATE, pip_2.getCallback(3), ..., ...
		Pipeline.ID, pip_2.getCallback(4), ..., ...
		Pipeline.LABEL, Pipeline.getPropDefault(Pipeline.LABEL), ...
		Pipeline.NOTES, Pipeline.getPropDefault(Pipeline.NOTES), ...
		Pipeline.PS_DICT, pip_2.getCallback(7) ... ...
		);
