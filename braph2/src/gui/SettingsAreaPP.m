		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case SettingsAreaPP.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the prop panel for area settings.';
				case SettingsAreaPP.NAME
					prop_description = 'NAME (constant, string) is the name of the prop panel for area settings.';
				case SettingsAreaPP.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the prop panel for area settings.';
				case SettingsAreaPP.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the prop panel for area settings.';
				case SettingsAreaPP.ID
					prop_description = 'ID (data, string) is a few-letter code for the prop panel for area settings.';
				case SettingsAreaPP.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the prop panel for area settings.';
				case SettingsAreaPP.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the prop panel for area settings.';
