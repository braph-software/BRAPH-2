		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropStringTextArea.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the string prop panel with a text-area.';
				case PanelPropStringTextArea.NAME
					prop_description = 'NAME (constant, string) is the name of the string prop panel with a text-area.';
				case PanelPropStringTextArea.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the string prop panel with a text-area.';
				case PanelPropStringTextArea.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the string prop panel with a text-area.';
				case PanelPropStringTextArea.ID
					prop_description = 'ID (data, string) is a few-letter code for the string prop panel with a text-area.';
				case PanelPropStringTextArea.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the string prop panel with a text-area.';
				case PanelPropStringTextArea.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the string prop panel with a text-area.';
