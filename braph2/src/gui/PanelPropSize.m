		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropSize.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the size prop panel.';
				case PanelPropSize.NAME
					prop_description = 'NAME (constant, string) is the name of the size prop panel.';
				case PanelPropSize.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the size prop panel.';
				case PanelPropSize.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the size prop panel.';
				case PanelPropSize.ID
					prop_description = 'ID (data, string) is a few-letter code for the size prop panel.';
				case PanelPropSize.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the size prop panel.';
				case PanelPropSize.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the size prop panel.';
