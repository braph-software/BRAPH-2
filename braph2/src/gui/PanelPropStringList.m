		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropStringList.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the string-list prop panel.';
				case PanelPropStringList.NAME
					prop_description = 'NAME (constant, string) is the name of the string-list prop panel.';
				case PanelPropStringList.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the string-list prop panel.';
				case PanelPropStringList.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the string-list prop panel.';
				case PanelPropStringList.ID
					prop_description = 'ID (data, string) is a few-letter code for the string-list prop panel.';
				case PanelPropStringList.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the string-list prop panel.';
				case PanelPropStringList.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the string-list prop panel.';
