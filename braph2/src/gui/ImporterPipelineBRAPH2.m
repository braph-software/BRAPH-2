classdef ImporterPipelineBRAPH2 < Importer
	...
	%  <strong>8</strong> <strong>FILE</strong> 	FILE (data, string) is the BRAPH2 file from where to load the pipeline.
	%  <strong>9</strong> <strong>GET_FILE</strong> 	GET_FILE (query, item) opens a dialog box to get the BRAPH2 file from where to load the pipeline.
	%  <strong>10</strong> <strong>PIP</strong> 	PIP (result, item) is a pipeline.
	%
	...
	methods (Static) % inspection
		...
		function check_out = existsTag(tag)
			...
			check = any(strcmp(tag, { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'FILE'  'GET_FILE'  'PIP' })); %CET: Computational Efficiency Trick
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				prop = find(strcmp(pointer, { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'FILE'  'GET_FILE'  'PIP' })); % tag = pointer %CET: Computational Efficiency Trick
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				importerpipelinebraph2_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'FILE'  'GET_FILE'  'PIP' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			importerpipelinebraph2_category_list = { 1  1  3  4  2  2  9  4  6  5 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			importerpipelinebraph2_format_list = { 2  2  8  2  2  2  4  2  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 8 % ImporterPipelineBRAPH2.FILE
					prop_settings = Format.getFormatSettings(2);
				case 9 % ImporterPipelineBRAPH2.GET_FILE
					prop_settings = 'ImporterPipelineBRAPH2';
				case 10 % ImporterPipelineBRAPH2.PIP
