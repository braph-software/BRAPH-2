...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	ps_1 = PipelineSection( ...
		PipelineSection.NAME, PipelineSection.getNoValue(), ...
		PipelineSection.DESCRIPTION, PipelineSection.getNoValue(), ...
		PipelineSection.TEMPLATE, ps_0.getCallback(3), ..., ...
		PipelineSection.ID, ps_0.getCallback(4), ..., ...
		PipelineSection.LABEL, PipelineSection.getPropDefault(PipelineSection.LABEL), ...
		PipelineSection.NOTES, PipelineSection.getPropDefault(PipelineSection.NOTES), ...
		PipelineSection.TOSTRING, PipelineSection.getNoValue(), ...
		PipelineSection.PC_DICT, ps_0.getCallback(8) ... ...
		);
	...
	ps_2 = PipelineSection( ...
		PipelineSection.NAME, PipelineSection.getNoValue(), ...
		PipelineSection.DESCRIPTION, PipelineSection.getNoValue(), ...
		PipelineSection.TEMPLATE, ps_1.getCallback(3), ..., ...
		PipelineSection.ID, ps_1.getCallback(4), ..., ...
		PipelineSection.LABEL, PipelineSection.getPropDefault(PipelineSection.LABEL), ...
		PipelineSection.NOTES, PipelineSection.getPropDefault(PipelineSection.NOTES), ...
		PipelineSection.TOSTRING, PipelineSection.getNoValue(), ...
		PipelineSection.PC_DICT, ps_1.getCallback(8) ... ...
		);
	...
	ps_3 = PipelineSection( ...
		PipelineSection.NAME, PipelineSection.getNoValue(), ...
		PipelineSection.DESCRIPTION, PipelineSection.getNoValue(), ...
		PipelineSection.TEMPLATE, ps_2.getCallback(3), ..., ...
		PipelineSection.ID, ps_2.getCallback(4), ..., ...
		PipelineSection.LABEL, PipelineSection.getPropDefault(PipelineSection.LABEL), ...
		PipelineSection.NOTES, PipelineSection.getPropDefault(PipelineSection.NOTES), ...
		PipelineSection.TOSTRING, PipelineSection.getNoValue(), ...
		PipelineSection.PC_DICT, ps_2.getCallback(8) ... ...
		);
