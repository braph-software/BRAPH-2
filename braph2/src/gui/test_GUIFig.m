...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	gui_1 = GUIFig( ...
		...
		GUIFig.NOTES, GUIFig.getPropDefault(GUIFig.NOTES), ...
		GUIFig.TOSTRING, GUIFig.getNoValue(), ...
		GUIFig.WAITBAR, gui_0.getCallback(8), ..., ...
		GUIFig.DRAW, GUIFig.getNoValue(), ...
		GUIFig.DRAWN, GUIFig.getNoValue(), ...
		GUIFig.TITLE, gui_0.getCallback(11), ..., ...
		GUIFig.POSITION, gui_0.getCallback(12), ..., ...
		GUIFig.BKGCOLOR, gui_0.getCallback(13), ..., ...
		GUIFig.H_MENUBAR, GUIFig.getNoValue(), ...
		GUIFig.MENUBAR, gui_0.getCallback(15), ..., ...
		GUIFig.H_MENU_ABOUT, GUIFig.getNoValue(), ...
		GUIFig.MENU_ABOUT, gui_0.getCallback(17), ..., ...
		GUIFig.H_TOOLBAR, GUIFig.getNoValue(), ...
		GUIFig.H_TOOLS, GUIFig.getNoValue(), ...
		GUIFig.TOOLBAR, gui_0.getCallback(20), ..., ...
		GUIFig.TOOL_ABOUT, gui_0.getCallback(21), ..., ...
		GUIFig.CLOSEREQ, gui_0.getCallback(22), ..., ...
		GUIFig.H, GUIFig.getNoValue(), ...
		GUIFig.RESIZE, GUIFig.getNoValue(), ...
		GUIFig.SHOW, GUIFig.getNoValue(), ...
		GUIFig.HIDE, GUIFig.getNoValue(), ...
		GUIFig.DELETE, GUIFig.getNoValue(), ...
		GUIFig.CLOSE, GUIFig.getNoValue(), ...
		GUIFig.PF, gui_0.getCallback(29), ..., ...
		GUIFig.FILE, GUIFig.getPropDefault(GUIFig.FILE), ...
		GUIFig.TEXT_FILE, GUIFig.getNoValue(), ...
		GUIFig.GUI_LAYOUT, gui_0.getCallback(32), ..., ...
		GUIFig.GUI_SETTINGS, gui_0.getCallback(33), ..., ...
		GUIFig.H_MENU_FILE, GUIFig.getNoValue(), ...
		GUIFig.MENU_FILE, gui_0.getCallback(35), ..., ...
		GUIFig.H_MENU_PRINT, GUIFig.getNoValue(), ...
		GUIFig.MENU_PRINT, gui_0.getCallback(37), ..., ...
		GUIFig.H_MENU_GUI_SETTINGS, GUIFig.getNoValue(), ...
		GUIFig.MENU_GUI_SETTINGS, gui_0.getCallback(39), ..., ...
		GUIFig.H_MENU_PERSONALIZE, GUIFig.getNoValue(), ...
		GUIFig.MENU_PERSONALIZE, gui_0.getCallback(41), ..., ...
		GUIFig.TOOL_FILE, gui_0.getCallback(42), ..., ...
		GUIFig.TOOL_PRINT, gui_0.getCallback(43), ..., ...
		GUIFig.TOOL_GUI_SETTINGS, gui_0.getCallback(44) ... ...
		);
	...
	gui_2 = GUIFig( ...
		...
		GUIFig.NOTES, GUIFig.getPropDefault(GUIFig.NOTES), ...
		GUIFig.TOSTRING, GUIFig.getNoValue(), ...
		GUIFig.WAITBAR, gui_1.getCallback(8), ..., ...
		GUIFig.DRAW, GUIFig.getNoValue(), ...
		GUIFig.DRAWN, GUIFig.getNoValue(), ...
		GUIFig.TITLE, gui_1.getCallback(11), ..., ...
		GUIFig.POSITION, gui_1.getCallback(12), ..., ...
		GUIFig.BKGCOLOR, gui_1.getCallback(13), ..., ...
		GUIFig.H_MENUBAR, GUIFig.getNoValue(), ...
		GUIFig.MENUBAR, gui_1.getCallback(15), ..., ...
		GUIFig.H_MENU_ABOUT, GUIFig.getNoValue(), ...
		GUIFig.MENU_ABOUT, gui_1.getCallback(17), ..., ...
		GUIFig.H_TOOLBAR, GUIFig.getNoValue(), ...
		GUIFig.H_TOOLS, GUIFig.getNoValue(), ...
		GUIFig.TOOLBAR, gui_1.getCallback(20), ..., ...
		GUIFig.TOOL_ABOUT, gui_1.getCallback(21), ..., ...
		GUIFig.CLOSEREQ, gui_1.getCallback(22), ..., ...
		GUIFig.H, GUIFig.getNoValue(), ...
		GUIFig.RESIZE, GUIFig.getNoValue(), ...
		GUIFig.SHOW, GUIFig.getNoValue(), ...
		GUIFig.HIDE, GUIFig.getNoValue(), ...
		GUIFig.DELETE, GUIFig.getNoValue(), ...
		GUIFig.CLOSE, GUIFig.getNoValue(), ...
		GUIFig.PF, gui_1.getCallback(29), ..., ...
		GUIFig.FILE, GUIFig.getPropDefault(GUIFig.FILE), ...
		GUIFig.TEXT_FILE, GUIFig.getNoValue(), ...
		GUIFig.GUI_LAYOUT, gui_1.getCallback(32), ..., ...
		GUIFig.GUI_SETTINGS, gui_1.getCallback(33), ..., ...
		GUIFig.H_MENU_FILE, GUIFig.getNoValue(), ...
		GUIFig.MENU_FILE, gui_1.getCallback(35), ..., ...
		GUIFig.H_MENU_PRINT, GUIFig.getNoValue(), ...
		GUIFig.MENU_PRINT, gui_1.getCallback(37), ..., ...
		GUIFig.H_MENU_GUI_SETTINGS, GUIFig.getNoValue(), ...
		GUIFig.MENU_GUI_SETTINGS, gui_1.getCallback(39), ..., ...
		GUIFig.H_MENU_PERSONALIZE, GUIFig.getNoValue(), ...
		GUIFig.MENU_PERSONALIZE, gui_1.getCallback(41), ..., ...
		GUIFig.TOOL_FILE, gui_1.getCallback(42), ..., ...
		GUIFig.TOOL_PRINT, gui_1.getCallback(43), ..., ...
		GUIFig.TOOL_GUI_SETTINGS, gui_1.getCallback(44) ... ...
		);
	...
	gui_3 = GUIFig( ...
		...
		GUIFig.NOTES, GUIFig.getPropDefault(GUIFig.NOTES), ...
		GUIFig.TOSTRING, GUIFig.getNoValue(), ...
		GUIFig.WAITBAR, gui_2.getCallback(8), ..., ...
		GUIFig.DRAW, GUIFig.getNoValue(), ...
		GUIFig.DRAWN, GUIFig.getNoValue(), ...
		GUIFig.TITLE, gui_2.getCallback(11), ..., ...
		GUIFig.POSITION, gui_2.getCallback(12), ..., ...
		GUIFig.BKGCOLOR, gui_2.getCallback(13), ..., ...
		GUIFig.H_MENUBAR, GUIFig.getNoValue(), ...
		GUIFig.MENUBAR, gui_2.getCallback(15), ..., ...
		GUIFig.H_MENU_ABOUT, GUIFig.getNoValue(), ...
		GUIFig.MENU_ABOUT, gui_2.getCallback(17), ..., ...
		GUIFig.H_TOOLBAR, GUIFig.getNoValue(), ...
		GUIFig.H_TOOLS, GUIFig.getNoValue(), ...
		GUIFig.TOOLBAR, gui_2.getCallback(20), ..., ...
		GUIFig.TOOL_ABOUT, gui_2.getCallback(21), ..., ...
		GUIFig.CLOSEREQ, gui_2.getCallback(22), ..., ...
		GUIFig.H, GUIFig.getNoValue(), ...
		GUIFig.RESIZE, GUIFig.getNoValue(), ...
		GUIFig.SHOW, GUIFig.getNoValue(), ...
		GUIFig.HIDE, GUIFig.getNoValue(), ...
		GUIFig.DELETE, GUIFig.getNoValue(), ...
		GUIFig.CLOSE, GUIFig.getNoValue(), ...
		GUIFig.PF, gui_2.getCallback(29), ..., ...
		GUIFig.FILE, GUIFig.getPropDefault(GUIFig.FILE), ...
		GUIFig.TEXT_FILE, GUIFig.getNoValue(), ...
		GUIFig.GUI_LAYOUT, gui_2.getCallback(32), ..., ...
		GUIFig.GUI_SETTINGS, gui_2.getCallback(33), ..., ...
		GUIFig.H_MENU_FILE, GUIFig.getNoValue(), ...
		GUIFig.MENU_FILE, gui_2.getCallback(35), ..., ...
		GUIFig.H_MENU_PRINT, GUIFig.getNoValue(), ...
		GUIFig.MENU_PRINT, gui_2.getCallback(37), ..., ...
		GUIFig.H_MENU_GUI_SETTINGS, GUIFig.getNoValue(), ...
		GUIFig.MENU_GUI_SETTINGS, gui_2.getCallback(39), ..., ...
		GUIFig.H_MENU_PERSONALIZE, GUIFig.getNoValue(), ...
		GUIFig.MENU_PERSONALIZE, gui_2.getCallback(41), ..., ...
		GUIFig.TOOL_FILE, gui_2.getCallback(42), ..., ...
		GUIFig.TOOL_PRINT, gui_2.getCallback(43), ..., ...
		GUIFig.TOOL_GUI_SETTINGS, gui_2.getCallback(44) ... ...
		);
