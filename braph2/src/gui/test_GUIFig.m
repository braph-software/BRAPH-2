...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	gui_1 = GUIFig( ...
		GUIFig.NAME, GUIFig.getNoValue(), ...
		GUIFig.DESCRIPTION, GUIFig.getNoValue(), ...
		GUIFig.TEMPLATE, gui_0.getCallback(3), ..., ...
		GUIFig.ID, gui_0.getCallback(4), ..., ...
		GUIFig.LABEL, GUIFig.getPropDefault(GUIFig.LABEL), ...
		GUIFig.NOTES, GUIFig.getPropDefault(GUIFig.NOTES), ...
		GUIFig.WAITBAR, gui_0.getCallback(7), ..., ...
		GUIFig.DRAW, GUIFig.getNoValue(), ...
		GUIFig.DRAWN, GUIFig.getNoValue(), ...
		GUIFig.TITLE, gui_0.getCallback(10), ..., ...
		GUIFig.POSITION, gui_0.getCallback(11), ..., ...
		GUIFig.BKGCOLOR, gui_0.getCallback(12), ..., ...
		GUIFig.H_MENUBAR, GUIFig.getNoValue(), ...
		GUIFig.MENUBAR, gui_0.getCallback(14), ..., ...
		GUIFig.H_MENU_ABOUT, GUIFig.getNoValue(), ...
		GUIFig.MENU_ABOUT, gui_0.getCallback(16), ..., ...
		GUIFig.H_TOOLBAR, GUIFig.getNoValue(), ...
		GUIFig.H_TOOLS, GUIFig.getNoValue(), ...
		GUIFig.TOOLBAR, gui_0.getCallback(19), ..., ...
		GUIFig.TOOL_ABOUT, gui_0.getCallback(20), ..., ...
		GUIFig.CLOSEREQ, gui_0.getCallback(21), ..., ...
		GUIFig.H, GUIFig.getNoValue(), ...
		GUIFig.RESIZE, GUIFig.getNoValue(), ...
		GUIFig.SHOW, GUIFig.getNoValue(), ...
		GUIFig.HIDE, GUIFig.getNoValue(), ...
		GUIFig.DELETE, GUIFig.getNoValue(), ...
		GUIFig.CLOSE, GUIFig.getNoValue(), ...
		GUIFig.PF, gui_0.getCallback(28), ..., ...
		GUIFig.FILE, GUIFig.getPropDefault(GUIFig.FILE), ...
		GUIFig.TEXT_FILE, GUIFig.getNoValue(), ...
		GUIFig.GUI_LAYOUT, gui_0.getCallback(31), ..., ...
		GUIFig.GUI_SETTINGS, gui_0.getCallback(32), ..., ...
		GUIFig.H_MENU_FILE, GUIFig.getNoValue(), ...
		GUIFig.MENU_FILE, gui_0.getCallback(34), ..., ...
		GUIFig.H_MENU_PRINT, GUIFig.getNoValue(), ...
		GUIFig.MENU_PRINT, gui_0.getCallback(36), ..., ...
		GUIFig.H_MENU_GUI_SETTINGS, GUIFig.getNoValue(), ...
		GUIFig.MENU_GUI_SETTINGS, gui_0.getCallback(38), ..., ...
		GUIFig.H_MENU_PERSONALIZE, GUIFig.getNoValue(), ...
		GUIFig.MENU_PERSONALIZE, gui_0.getCallback(40), ..., ...
		GUIFig.TOOL_FILE, gui_0.getCallback(41), ..., ...
		GUIFig.TOOL_PRINT, gui_0.getCallback(42), ..., ...
		GUIFig.TOOL_GUI_SETTINGS, gui_0.getCallback(43) ... ...
		);
	...
	gui_2 = GUIFig( ...
		GUIFig.NAME, GUIFig.getNoValue(), ...
		GUIFig.DESCRIPTION, GUIFig.getNoValue(), ...
		GUIFig.TEMPLATE, gui_1.getCallback(3), ..., ...
		GUIFig.ID, gui_1.getCallback(4), ..., ...
		GUIFig.LABEL, GUIFig.getPropDefault(GUIFig.LABEL), ...
		GUIFig.NOTES, GUIFig.getPropDefault(GUIFig.NOTES), ...
		GUIFig.WAITBAR, gui_1.getCallback(7), ..., ...
		GUIFig.DRAW, GUIFig.getNoValue(), ...
		GUIFig.DRAWN, GUIFig.getNoValue(), ...
		GUIFig.TITLE, gui_1.getCallback(10), ..., ...
		GUIFig.POSITION, gui_1.getCallback(11), ..., ...
		GUIFig.BKGCOLOR, gui_1.getCallback(12), ..., ...
		GUIFig.H_MENUBAR, GUIFig.getNoValue(), ...
		GUIFig.MENUBAR, gui_1.getCallback(14), ..., ...
		GUIFig.H_MENU_ABOUT, GUIFig.getNoValue(), ...
		GUIFig.MENU_ABOUT, gui_1.getCallback(16), ..., ...
		GUIFig.H_TOOLBAR, GUIFig.getNoValue(), ...
		GUIFig.H_TOOLS, GUIFig.getNoValue(), ...
		GUIFig.TOOLBAR, gui_1.getCallback(19), ..., ...
		GUIFig.TOOL_ABOUT, gui_1.getCallback(20), ..., ...
		GUIFig.CLOSEREQ, gui_1.getCallback(21), ..., ...
		GUIFig.H, GUIFig.getNoValue(), ...
		GUIFig.RESIZE, GUIFig.getNoValue(), ...
		GUIFig.SHOW, GUIFig.getNoValue(), ...
		GUIFig.HIDE, GUIFig.getNoValue(), ...
		GUIFig.DELETE, GUIFig.getNoValue(), ...
		GUIFig.CLOSE, GUIFig.getNoValue(), ...
		GUIFig.PF, gui_1.getCallback(28), ..., ...
		GUIFig.FILE, GUIFig.getPropDefault(GUIFig.FILE), ...
		GUIFig.TEXT_FILE, GUIFig.getNoValue(), ...
		GUIFig.GUI_LAYOUT, gui_1.getCallback(31), ..., ...
		GUIFig.GUI_SETTINGS, gui_1.getCallback(32), ..., ...
		GUIFig.H_MENU_FILE, GUIFig.getNoValue(), ...
		GUIFig.MENU_FILE, gui_1.getCallback(34), ..., ...
		GUIFig.H_MENU_PRINT, GUIFig.getNoValue(), ...
		GUIFig.MENU_PRINT, gui_1.getCallback(36), ..., ...
		GUIFig.H_MENU_GUI_SETTINGS, GUIFig.getNoValue(), ...
		GUIFig.MENU_GUI_SETTINGS, gui_1.getCallback(38), ..., ...
		GUIFig.H_MENU_PERSONALIZE, GUIFig.getNoValue(), ...
		GUIFig.MENU_PERSONALIZE, gui_1.getCallback(40), ..., ...
		GUIFig.TOOL_FILE, gui_1.getCallback(41), ..., ...
		GUIFig.TOOL_PRINT, gui_1.getCallback(42), ..., ...
		GUIFig.TOOL_GUI_SETTINGS, gui_1.getCallback(43) ... ...
		);
	...
	gui_3 = GUIFig( ...
		GUIFig.NAME, GUIFig.getNoValue(), ...
		GUIFig.DESCRIPTION, GUIFig.getNoValue(), ...
		GUIFig.TEMPLATE, gui_2.getCallback(3), ..., ...
		GUIFig.ID, gui_2.getCallback(4), ..., ...
		GUIFig.LABEL, GUIFig.getPropDefault(GUIFig.LABEL), ...
		GUIFig.NOTES, GUIFig.getPropDefault(GUIFig.NOTES), ...
		GUIFig.WAITBAR, gui_2.getCallback(7), ..., ...
		GUIFig.DRAW, GUIFig.getNoValue(), ...
		GUIFig.DRAWN, GUIFig.getNoValue(), ...
		GUIFig.TITLE, gui_2.getCallback(10), ..., ...
		GUIFig.POSITION, gui_2.getCallback(11), ..., ...
		GUIFig.BKGCOLOR, gui_2.getCallback(12), ..., ...
		GUIFig.H_MENUBAR, GUIFig.getNoValue(), ...
		GUIFig.MENUBAR, gui_2.getCallback(14), ..., ...
		GUIFig.H_MENU_ABOUT, GUIFig.getNoValue(), ...
		GUIFig.MENU_ABOUT, gui_2.getCallback(16), ..., ...
		GUIFig.H_TOOLBAR, GUIFig.getNoValue(), ...
		GUIFig.H_TOOLS, GUIFig.getNoValue(), ...
		GUIFig.TOOLBAR, gui_2.getCallback(19), ..., ...
		GUIFig.TOOL_ABOUT, gui_2.getCallback(20), ..., ...
		GUIFig.CLOSEREQ, gui_2.getCallback(21), ..., ...
		GUIFig.H, GUIFig.getNoValue(), ...
		GUIFig.RESIZE, GUIFig.getNoValue(), ...
		GUIFig.SHOW, GUIFig.getNoValue(), ...
		GUIFig.HIDE, GUIFig.getNoValue(), ...
		GUIFig.DELETE, GUIFig.getNoValue(), ...
		GUIFig.CLOSE, GUIFig.getNoValue(), ...
		GUIFig.PF, gui_2.getCallback(28), ..., ...
		GUIFig.FILE, GUIFig.getPropDefault(GUIFig.FILE), ...
		GUIFig.TEXT_FILE, GUIFig.getNoValue(), ...
		GUIFig.GUI_LAYOUT, gui_2.getCallback(31), ..., ...
		GUIFig.GUI_SETTINGS, gui_2.getCallback(32), ..., ...
		GUIFig.H_MENU_FILE, GUIFig.getNoValue(), ...
		GUIFig.MENU_FILE, gui_2.getCallback(34), ..., ...
		GUIFig.H_MENU_PRINT, GUIFig.getNoValue(), ...
		GUIFig.MENU_PRINT, gui_2.getCallback(36), ..., ...
		GUIFig.H_MENU_GUI_SETTINGS, GUIFig.getNoValue(), ...
		GUIFig.MENU_GUI_SETTINGS, gui_2.getCallback(38), ..., ...
		GUIFig.H_MENU_PERSONALIZE, GUIFig.getNoValue(), ...
		GUIFig.MENU_PERSONALIZE, gui_2.getCallback(40), ..., ...
		GUIFig.TOOL_FILE, gui_2.getCallback(41), ..., ...
		GUIFig.TOOL_PRINT, gui_2.getCallback(42), ..., ...
		GUIFig.TOOL_GUI_SETTINGS, gui_2.getCallback(43) ... ...
		);
