		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropItemList.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the item-list prop panel.';
				case PanelPropItemList.NAME
					prop_description = 'NAME (constant, string) is the name of the item-list prop panel.';
				case PanelPropItemList.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the item-list prop panel.';
				case PanelPropItemList.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the item-list prop panel.';
				case PanelPropItemList.ID
					prop_description = 'ID (data, string) is a few-letter code for the item-list prop panel.';
				case PanelPropItemList.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the item-list prop panel.';
				case PanelPropItemList.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the item-list prop panel.';
