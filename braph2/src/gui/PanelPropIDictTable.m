		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropIDictTable.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the idict prop panel with table.';
				case PanelPropIDictTable.NAME
					prop_description = 'NAME (constant, string) is the name of the idict prop panel with table.';
				case PanelPropIDictTable.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the idict prop panel with table.';
				case PanelPropIDictTable.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the idict prop panel with table.';
				case PanelPropIDictTable.ID
					prop_description = 'ID (data, string) is a few-letter code for the idict prop panel with table.';
				case PanelPropIDictTable.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the idict prop panel with table.';
				case PanelPropIDictTable.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the idict prop panel with table.';
