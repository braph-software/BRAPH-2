classdef SettingsAxisPP < SettingsPP
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the settings axis panel.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the settings axis panel.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the settings axis panel.
	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 2 % SettingsAxisPP.DESCRIPTION
				...
				case 4 % SettingsAxisPP.ID
					prop_default = 'SettingsAxisPP ID';
				case 5 % SettingsAxisPP.LABEL
