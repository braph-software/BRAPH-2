		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case SettingsSurfacePP.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the prop panel for surface settings.';
				case SettingsSurfacePP.NAME
					prop_description = 'NAME (constant, string) is the name of the prop panel for surface settings.';
				case SettingsSurfacePP.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the prop panel for surface settings.';
				case SettingsSurfacePP.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the prop panel for surface settings.';
				case SettingsSurfacePP.ID
					prop_description = 'ID (data, string) is a few-letter code for the prop panel for surface settings.';
				case SettingsSurfacePP.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the prop panel for surface settings.';
				case SettingsSurfacePP.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the prop panel for surface settings.';
				case SettingsSurfacePP.EL
					prop_description = 'EL (data, item) is the element.';
				case SettingsSurfacePP.PROP
					prop_description = 'PROP (data, scalar) is the property number.';
				case SettingsSurfacePP.HEIGHT
					prop_description = 'HEIGHT (gui, size) is the pixel height of the prop panel for surface settings.';
