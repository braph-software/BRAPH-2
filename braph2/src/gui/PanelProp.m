		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelProp.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the prop panel.';
				case PanelProp.NAME
					prop_description = 'NAME (constant, string) is the name of the prop panel.';
				case PanelProp.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the prop panel.';
				case PanelProp.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the prop panel.';
				case PanelProp.ID
					prop_description = 'ID (data, string) is a few-letter code for the prop panel.';
				case PanelProp.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the prop panel.';
				case PanelProp.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the prop panel.';
				case PanelProp.DRAW
					prop_description = 'DRAW (query, logical) draws the prop panel.';
				case PanelProp.SHOW
