...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	me_1 = MeasureEnsemble( ...
		...
		MeasureEnsemble.NOTES, MeasureEnsemble.getPropDefault(MeasureEnsemble.NOTES), ...
		MeasureEnsemble.TOSTRING, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.MEASURE, me_0.getCallback(8), ..., ...
		MeasureEnsemble.A, me_0.getCallback(9), ..., ...
		MeasureEnsemble.M, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.PFME, me_0.getCallback(11), ..., ...
		MeasureEnsemble.PFBG, me_0.getCallback(12) ... ...
		);
	...
	me_2 = MeasureEnsemble( ...
		...
		MeasureEnsemble.NOTES, MeasureEnsemble.getPropDefault(MeasureEnsemble.NOTES), ...
		MeasureEnsemble.TOSTRING, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.MEASURE, me_1.getCallback(8), ..., ...
		MeasureEnsemble.A, me_1.getCallback(9), ..., ...
		MeasureEnsemble.M, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.PFME, me_1.getCallback(11), ..., ...
		MeasureEnsemble.PFBG, me_1.getCallback(12) ... ...
		);
	...
	me_3 = MeasureEnsemble( ...
		...
		MeasureEnsemble.NOTES, MeasureEnsemble.getPropDefault(MeasureEnsemble.NOTES), ...
		MeasureEnsemble.TOSTRING, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.MEASURE, me_2.getCallback(8), ..., ...
		MeasureEnsemble.A, me_2.getCallback(9), ..., ...
		MeasureEnsemble.M, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.PFME, me_2.getCallback(11), ..., ...
		MeasureEnsemble.PFBG, me_2.getCallback(12) ... ...
		);
