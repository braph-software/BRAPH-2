...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	me_1 = MeasureEnsemble( ...
		MeasureEnsemble.NAME, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.DESCRIPTION, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.TEMPLATE, me_0.getCallback(3), ..., ...
		MeasureEnsemble.ID, me_0.getCallback(4), ..., ...
		MeasureEnsemble.LABEL, MeasureEnsemble.getPropDefault(MeasureEnsemble.LABEL), ...
		MeasureEnsemble.NOTES, MeasureEnsemble.getPropDefault(MeasureEnsemble.NOTES), ...
		MeasureEnsemble.MEASURE, me_0.getCallback(7), ..., ...
		MeasureEnsemble.A, me_0.getCallback(8), ..., ...
		MeasureEnsemble.M, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.PFME, me_0.getCallback(10), ..., ...
		MeasureEnsemble.PFBG, me_0.getCallback(11) ... ...
		);
	...
	me_2 = MeasureEnsemble( ...
		MeasureEnsemble.NAME, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.DESCRIPTION, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.TEMPLATE, me_1.getCallback(3), ..., ...
		MeasureEnsemble.ID, me_1.getCallback(4), ..., ...
		MeasureEnsemble.LABEL, MeasureEnsemble.getPropDefault(MeasureEnsemble.LABEL), ...
		MeasureEnsemble.NOTES, MeasureEnsemble.getPropDefault(MeasureEnsemble.NOTES), ...
		MeasureEnsemble.MEASURE, me_1.getCallback(7), ..., ...
		MeasureEnsemble.A, me_1.getCallback(8), ..., ...
		MeasureEnsemble.M, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.PFME, me_1.getCallback(10), ..., ...
		MeasureEnsemble.PFBG, me_1.getCallback(11) ... ...
		);
	...
	me_3 = MeasureEnsemble( ...
		MeasureEnsemble.NAME, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.DESCRIPTION, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.TEMPLATE, me_2.getCallback(3), ..., ...
		MeasureEnsemble.ID, me_2.getCallback(4), ..., ...
		MeasureEnsemble.LABEL, MeasureEnsemble.getPropDefault(MeasureEnsemble.LABEL), ...
		MeasureEnsemble.NOTES, MeasureEnsemble.getPropDefault(MeasureEnsemble.NOTES), ...
		MeasureEnsemble.MEASURE, me_2.getCallback(7), ..., ...
		MeasureEnsemble.A, me_2.getCallback(8), ..., ...
		MeasureEnsemble.M, MeasureEnsemble.getNoValue(), ...
		MeasureEnsemble.PFME, me_2.getCallback(10), ..., ...
		MeasureEnsemble.PFBG, me_2.getCallback(11) ... ...
		);
