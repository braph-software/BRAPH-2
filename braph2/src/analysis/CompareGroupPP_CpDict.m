	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				comparegrouppp_cpdict_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'TABLE_HEIGHT'  'SELECTED'  'TABLE'  'CONTEXTMENU'  'GUI_F_DICT'  'GUI_CP_DICT'  'GUI_BG_DICT' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			comparegrouppp_cpdict_category_list = { 1  1  3  4  2  2  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  9  9  7  7  9  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			comparegrouppp_cpdict_format_list = { 2  2  8  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  22  13  18  18  10  10  10 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 34 % CompareGroupPP_CpDict.TABLE_HEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 35 % CompareGroupPP_CpDict.SELECTED
					prop_settings = Format.getFormatSettings(13);
				case 36 % CompareGroupPP_CpDict.TABLE
					prop_settings = Format.getFormatSettings(18);
				case 37 % CompareGroupPP_CpDict.CONTEXTMENU
					prop_settings = Format.getFormatSettings(18);
				case 38 % CompareGroupPP_CpDict.GUI_F_DICT
					prop_settings = 'GUIFig';
				case 39 % CompareGroupPP_CpDict.GUI_CP_DICT
					prop_settings = 'GUIElement';
				case 40 % CompareGroupPP_CpDict.GUI_BG_DICT
					prop_settings = 'GUIFig';
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 6 % CompareGroupPP_CpDict.NOTES
					prop_default = 'CompareGroupPP_CpDict';
				case 21 % CompareGroupPP_CpDict.EL
					prop_default = CompareGroup();
				case 22 % CompareGroupPP_CpDict.PROP
					prop_default = 18;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 18 % CompareGroupPP_CpDict.X_DRAW
				...
				case 19 % CompareGroupPP_CpDict.UPDATE
				...
				case 20 % CompareGroupPP_CpDict.REDRAW
				...
				case 14 % CompareGroupPP_CpDict.SHOW
				...
				case 15 % CompareGroupPP_CpDict.HIDE
				...
				case 16 % CompareGroupPP_CpDict.DELETE
				...
				case 17 % CompareGroupPP_CpDict.CLOSE
