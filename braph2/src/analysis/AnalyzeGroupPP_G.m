	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				analyzegrouppp_g_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'TABLE_HEIGHT'  'SELECTED'  'TABLE'  'CONTEXTMENU'  'GUI_G_PL'  'GUI_G_EL'  'GUI_F_DICT'  'GUI_M_DICT' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzegrouppp_g_category_list = { 1  1  3  4  2  2  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  9  9  7  7  9  9  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			analyzegrouppp_g_format_list = { 2  2  8  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  22  13  18  18  8  8  10  10 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 34 % AnalyzeGroupPP_G.TABLE_HEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 35 % AnalyzeGroupPP_G.SELECTED
					prop_settings = Format.getFormatSettings(13);
				case 36 % AnalyzeGroupPP_G.TABLE
					prop_settings = Format.getFormatSettings(18);
				case 37 % AnalyzeGroupPP_G.CONTEXTMENU
					prop_settings = Format.getFormatSettings(18);
				case 38 % AnalyzeGroupPP_G.GUI_G_PL
					prop_settings = 'GUIFig';
				case 39 % AnalyzeGroupPP_G.GUI_G_EL
					prop_settings = 'GUIElement';
				case 40 % AnalyzeGroupPP_G.GUI_F_DICT
					prop_settings = 'GUIFig';
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 6 % AnalyzeGroupPP_G.NOTES
					prop_default = 'AnalyzeGroupPP_G';
				case 21 % AnalyzeGroupPP_G.EL
					prop_default = AnalyzeGroup();
				case 22 % AnalyzeGroupPP_G.PROP
					prop_default = 9;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 18 % AnalyzeGroupPP_G.X_DRAW
				...
				case 19 % AnalyzeGroupPP_G.UPDATE
				...
				case 20 % AnalyzeGroupPP_G.REDRAW
				...
				case 16 % AnalyzeGroupPP_G.DELETE
				...
				case 17 % AnalyzeGroupPP_G.CLOSE
