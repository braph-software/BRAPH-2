	...
	methods (Static) % inspection
			...
			if nargin == 0
				prop_list = [ ...
					PanelProp.getProps() ...
						...
						CompareEnsemblePP_CpDict.GUI_B_DICT ...
						];
				return
			end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case CompareEnsemblePP_CpDict.GUI_B_DICT
						tag = CompareEnsemblePP_CpDict.GUI_B_DICT_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case CompareEnsemblePP_CpDict.GUI_B_DICT
					prop_category = CompareEnsemblePP_CpDict.GUI_B_DICT_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case CompareEnsemblePP_CpDict.GUI_B_DICT
					prop_format = CompareEnsemblePP_CpDict.GUI_B_DICT_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case CompareEnsemblePP_CpDict.GUI_B_DICT
					prop_description = 'GUI_B_DICT (gui, idict) contains the GUIs for the brain graph comparison figures.';
		...
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case CompareEnsemblePP_CpDict.GUI_CP_DICT % __CompareEnsemblePP_CpDict.GUI_CP_DICT__
					check = Format.checkFormat(Format.IDICT, value, CompareEnsemblePP_CpDict.getPropSettings(prop));
				case CompareEnsemblePP_CpDict.GUI_B_DICT % __CompareEnsemblePP_CpDict.GUI_B_DICT__
					check = Format.checkFormat(Format.IDICT, value, CompareEnsemblePP_CpDict.getPropSettings(prop));
