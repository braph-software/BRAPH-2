classdef ComparisonEnsemblePF < PanelFig
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the panel ensemble-based comparison figure.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the panel ensemble-based comparison figure.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the panel ensemble-based comparison figure.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the panel ensemble-based comparison figure.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the panel ensemble-based comparison figure.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the panel ensemble-based comparison figure.
	...
	%  <strong>25</strong> <strong>CP</strong> 	CP (metadata, item) is the ensemble-based comparison.
	%  <strong>26</strong> <strong>SETUP</strong> 	SETUP (query, empty) calculates the ensemble-based comparison value and stores it to be implemented in the subelements.
	%  <strong>27</strong> <strong>H_AREA</strong> 	H_AREA (evanescent, handle) is the handle for the ensemble-based comparison confidence area.
	...
	%  <strong>30</strong> <strong>H_LINE_DIFF</strong> 	H_LINE_DIFF (evanescent, handle) is the handle for the ensemble-based comparison line.
	...
	%  <strong>33</strong> <strong>H_LINE_CIL</strong> 	H_LINE_CIL (evanescent, handle) is the handle for the lower confidence interval of the ensemble-based comparison line.
	...
	%  <strong>36</strong> <strong>H_LINE_CIU</strong> 	H_LINE_CIU (evanescent, handle) is the handle for the upper confidence interval of the ensemble-based comparison line.
	...
	properties (Constant) % properties
		...
		CP = 25; %CET: Computational Efficiency Trick
		CP_TAG = 'CP';
		CP_CATEGORY = 2;
		CP_FORMAT = 8;
		
		SETUP = 26; %CET: Computational Efficiency Trick
		SETUP_TAG = 'SETUP';
		SETUP_CATEGORY = 6;
		SETUP_FORMAT = 1;
		
		H_AREA = 27; %CET: Computational Efficiency Trick
		H_AREA_TAG = 'H_AREA';
		H_AREA_CATEGORY = 7;
		H_AREA_FORMAT = 18;
		
		ST_AREA = 28; %CET: Computational Efficiency Trick
		ST_AREA_TAG = 'ST_AREA';
		ST_AREA_CATEGORY = 8;
		ST_AREA_FORMAT = 8;
		
		LISTENER_ST_AREA = 29; %CET: Computational Efficiency Trick
		LISTENER_ST_AREA_TAG = 'LISTENER_ST_AREA';
		LISTENER_ST_AREA_CATEGORY = 7;
		LISTENER_ST_AREA_FORMAT = 18;
		
		H_LINE_DIFF = 30; %CET: Computational Efficiency Trick
		H_LINE_DIFF_TAG = 'H_LINE_DIFF';
		H_LINE_DIFF_CATEGORY = 7;
		H_LINE_DIFF_FORMAT = 18;
		
		ST_LINE_DIFF = 31; %CET: Computational Efficiency Trick
		ST_LINE_DIFF_TAG = 'ST_LINE_DIFF';
		ST_LINE_DIFF_CATEGORY = 8;
		ST_LINE_DIFF_FORMAT = 8;
		
		LISTENER_ST_LINE_DIFF = 32; %CET: Computational Efficiency Trick
		LISTENER_ST_LINE_DIFF_TAG = 'LISTENER_ST_LINE_DIFF';
		LISTENER_ST_LINE_DIFF_CATEGORY = 7;
		LISTENER_ST_LINE_DIFF_FORMAT = 18;
		
		H_LINE_CIL = 33; %CET: Computational Efficiency Trick
		H_LINE_CIL_TAG = 'H_LINE_CIL';
		H_LINE_CIL_CATEGORY = 7;
		H_LINE_CIL_FORMAT = 18;
		
		ST_LINE_CIL = 34; %CET: Computational Efficiency Trick
		ST_LINE_CIL_TAG = 'ST_LINE_CIL';
		ST_LINE_CIL_CATEGORY = 8;
		ST_LINE_CIL_FORMAT = 8;
		
		LISTENER_ST_LINE_CIL = 35; %CET: Computational Efficiency Trick
		LISTENER_ST_LINE_CIL_TAG = 'LISTENER_ST_LINE_CIL';
		LISTENER_ST_LINE_CIL_CATEGORY = 7;
		LISTENER_ST_LINE_CIL_FORMAT = 18;
		
		H_LINE_CIU = 36; %CET: Computational Efficiency Trick
		H_LINE_CIU_TAG = 'H_LINE_CIU';
		H_LINE_CIU_CATEGORY = 7;
		H_LINE_CIU_FORMAT = 18;
		
		ST_LINE_CIU = 37; %CET: Computational Efficiency Trick
		ST_LINE_CIU_TAG = 'ST_LINE_CIU';
		ST_LINE_CIU_CATEGORY = 8;
		ST_LINE_CIU_FORMAT = 8;
		
		LISTENER_ST_LINE_CIU = 38; %CET: Computational Efficiency Trick
		LISTENER_ST_LINE_CIU_TAG = 'LISTENER_ST_LINE_CIU';
		LISTENER_ST_LINE_CIU_CATEGORY = 7;
		LISTENER_ST_LINE_CIU_FORMAT = 18;
		
		H_TITLE = 39; %CET: Computational Efficiency Trick
		H_TITLE_TAG = 'H_TITLE';
		H_TITLE_CATEGORY = 7;
		H_TITLE_FORMAT = 18;
		
		ST_TITLE = 40; %CET: Computational Efficiency Trick
		ST_TITLE_TAG = 'ST_TITLE';
		ST_TITLE_CATEGORY = 8;
		ST_TITLE_FORMAT = 8;
		
		H_XLABEL = 41; %CET: Computational Efficiency Trick
		H_XLABEL_TAG = 'H_XLABEL';
		H_XLABEL_CATEGORY = 7;
		H_XLABEL_FORMAT = 18;
		
		ST_XLABEL = 42; %CET: Computational Efficiency Trick
		ST_XLABEL_TAG = 'ST_XLABEL';
		ST_XLABEL_CATEGORY = 8;
		ST_XLABEL_FORMAT = 8;
		
		H_YLABEL = 43; %CET: Computational Efficiency Trick
		H_YLABEL_TAG = 'H_YLABEL';
		H_YLABEL_CATEGORY = 7;
		H_YLABEL_FORMAT = 18;
		
		ST_YLABEL = 44; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			switch category
				...
				case 8 % Category.FIGURE
					prop_list = [13 19 23 28 31 34 37 40 42 44];
				case 9 % Category.GUI
					prop_list = [8 12];
				otherwise
					prop_list = [];
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisonensemblepf_category_list = { 1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  7  2  6  7  8  7  7  8  7  7  8  7  7  8  7  7  8  7  8  7  8 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisonensemblepf_format_list = { 2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  8  18  8  1  18  8  18  18  8  18  18  8  18  18  8  18  18  8  18  8  18  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 22 % ComparisonEnsemblePF.H_AXES
					prop_settings = Format.getFormatSettings(18);
				case 23 % ComparisonEnsemblePF.ST_AXIS
					prop_settings = 'SettingsAxis';
				case 24 % ComparisonEnsemblePF.LISTENER_ST_AXIS
					prop_settings = Format.getFormatSettings(18);
				case 25 % ComparisonEnsemblePF.CP
					prop_settings = 'ComparisonEnsemble';
				case 26 % ComparisonEnsemblePF.SETUP
					prop_settings = Format.getFormatSettings(1);
				case 27 % ComparisonEnsemblePF.H_AREA
					prop_settings = Format.getFormatSettings(18);
				case 28 % ComparisonEnsemblePF.ST_AREA
					prop_settings = 'SettingsArea';
				case 29 % ComparisonEnsemblePF.LISTENER_ST_AREA
					prop_settings = Format.getFormatSettings(18);
				case 30 % ComparisonEnsemblePF.H_LINE_DIFF
					prop_settings = Format.getFormatSettings(18);
				case 31 % ComparisonEnsemblePF.ST_LINE_DIFF
					prop_settings = 'SettingsLine';
				case 32 % ComparisonEnsemblePF.LISTENER_ST_LINE_DIFF
					prop_settings = Format.getFormatSettings(18);
				case 33 % ComparisonEnsemblePF.H_LINE_CIL
					prop_settings = Format.getFormatSettings(18);
				case 34 % ComparisonEnsemblePF.ST_LINE_CIL
					prop_settings = 'SettingsLine';
				case 35 % ComparisonEnsemblePF.LISTENER_ST_LINE_CIL
					prop_settings = Format.getFormatSettings(18);
				case 36 % ComparisonEnsemblePF.H_LINE_CIU
					prop_settings = Format.getFormatSettings(18);
				case 37 % ComparisonEnsemblePF.ST_LINE_CIU
					prop_settings = 'SettingsLine';
				case 38 % ComparisonEnsemblePF.LISTENER_ST_LINE_CIU
					prop_settings = Format.getFormatSettings(18);
				case 39 % ComparisonEnsemblePF.H_TITLE
					prop_settings = Format.getFormatSettings(18);
				case 40 % ComparisonEnsemblePF.ST_TITLE
					prop_settings = 'SettingsText';
				case 41 % ComparisonEnsemblePF.H_XLABEL
					prop_settings = Format.getFormatSettings(18);
				case 42 % ComparisonEnsemblePF.ST_XLABEL
					prop_settings = 'SettingsText';
				case 43 % ComparisonEnsemblePF.H_YLABEL
					prop_settings = Format.getFormatSettings(18);
				case 44 % ComparisonEnsemblePF.ST_YLABEL
					prop_settings = 'SettingsText';
				case 3 % ComparisonEnsemblePF.TEMPLATE
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pf, prop, varargin)
			...
			switch prop
				...
				case 10 % ComparisonEnsemblePF.DRAW
					...
					if value
					    ...
					    pf.memorize('H_AREA')
					    pf.memorize('ST_AREA').set('PANEL', pf, 'PROP', 27).get('SETUP')
					    pf.memorize('LISTENER_ST_AREA');
					
					    pf.memorize('H_LINE_DIFF')
					    pf.memorize('ST_LINE_DIFF').set('PANEL', pf, 'PROP', 30).get('SETUP')
						pf.memorize('LISTENER_ST_LINE_DIFF');
					    
					    pf.memorize('H_LINE_CIL')
					    pf.memorize('ST_LINE_CIL').set('PANEL', pf, 'PROP', 33).get('SETUP')
						pf.memorize('LISTENER_ST_LINE_CIL');
					
					    pf.memorize('H_LINE_CIU')
					    pf.memorize('ST_LINE_CIU').set('PANEL', pf, 'PROP', 36).get('SETUP')
						pf.memorize('LISTENER_ST_LINE_CIU');
					
					    pf.memorize('H_TITLE')
					    pf.memorize('ST_TITLE').set('PANEL', pf, 'PROP', 39).get('SETUP')
					
					    pf.memorize('H_XLABEL')
					    pf.memorize('ST_XLABEL').set('PANEL', pf, 'PROP', 41).get('SETUP')
					    
					    pf.memorize('H_YLABEL')
					    pf.memorize('ST_YLABEL').set('PANEL', pf, 'PROP', 43).get('SETUP')
					
					    pf.get('SETUP')
					end
					
				case 17 % ComparisonEnsemblePF.DELETE
				...
				case 21 % ComparisonEnsemblePF.H_TOOLS
	...
	methods % GUI
		function pr = getPanelProp(pf, prop, varargin)
			...
			switch prop
				...
				case 28 % ComparisonEnsemblePF.ST_AREA
					pr = SettingsAreaPP('EL', pf, 'PROP', 28, varargin{:});
					
				case 31 % ComparisonEnsemblePF.ST_LINE_DIFF
					pr = SettingsLinePP('EL', pf, 'PROP', 31, varargin{:});
					
				case 34 % ComparisonEnsemblePF.ST_LINE_CIL
					pr = SettingsLinePP('EL', pf, 'PROP', 34, varargin{:});
					
				case 37 % ComparisonEnsemblePF.ST_LINE_CIU
					pr = SettingsLinePP('EL', pf, 'PROP', 37, varargin{:});
					
				case 40 % ComparisonEnsemblePF.ST_TITLE
					pr = SettingsTextPP('EL', pf, 'PROP', 40, varargin{:});
					
				case 42 % ComparisonEnsemblePF.ST_XLABEL
					pr = SettingsTextPP('EL', pf, 'PROP', 42, varargin{:});
					
				case 44 % ComparisonEnsemblePF.ST_YLABEL
					pr = SettingsTextPP('EL', pf, 'PROP', 44, varargin{:});
