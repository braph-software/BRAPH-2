classdef ComparisonEnsemblePF_NU < ComparisonEnsemblePF
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the panel figure nodal unilayer group comparison figure.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the panel figure nodal unilayer group comparison figure.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the panel figure nodal unilayer group comparison figure.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				comparisonensemblepf_nu_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'ST_POSITION'  'H_TOOLBAR'  'H_TOOLS'  'H_AXES'  'ST_AXIS'  'LISTENER_ST_AXIS'  'CP'  'SETUP'  'H_AREA'  'ST_AREA'  'LISTENER_ST_AREA'  'H_LINE_DIFF'  'ST_LINE_DIFF'  'LISTENER_ST_LINE_DIFF'  'H_LINE_CIL'  'ST_LINE_CIL'  'LISTENER_ST_LINE_CIL'  'H_LINE_CIU'  'ST_LINE_CIU'  'LISTENER_ST_LINE_CIU'  'H_TITLE'  'ST_TITLE'  'H_XLABEL'  'ST_XLABEL'  'H_YLABEL'  'ST_YLABEL'  'NODE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisonensemblepf_nu_category_list = { 1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  7  2  6  7  8  7  7  8  7  7  8  7  7  8  7  7  8  7  8  7  8  8 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			comparisonensemblepf_nu_format_list = { 2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  8  18  8  1  18  8  18  18  8  18  18  8  18  18  8  18  18  8  18  8  18  8  11 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 45 % ComparisonEnsemblePF_NU.NODE
					prop_settings = Format.getFormatSettings(11);
				case 3 % ComparisonEnsemblePF_NU.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 45 % ComparisonEnsemblePF_NU.NODE
					prop_default = 1;
				case 1 % ComparisonEnsemblePF_NU.NAME
					prop_default = 'ComparisonEnsemblePF_NU';
				case 2 % ComparisonEnsemblePF_NU.DESCRIPTION
				...
				case 4 % ComparisonEnsemblePF_NU.ID
					prop_default = 'ComparisonEnsemblePF_NU ID';
				case 5 % ComparisonEnsemblePF_NU.LABEL
					prop_default = 'ComparisonEnsemblePF_NU label';
				case 6 % ComparisonEnsemblePF_NU.NOTES
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pf, prop, varargin)
			...
			switch prop
				case 26 % ComparisonEnsemblePF_NU.SETUP
					cp = pf.get('CP');
