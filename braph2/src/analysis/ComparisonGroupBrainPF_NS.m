classdef ComparisonGroupBrainPF_NS < ComparisonGroupBrainPF
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case ComparisonGroupBrainPF_NS.NODE
						tag = ComparisonGroupBrainPF_NS.NODE_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case ComparisonGroupBrainPF_NS.NODE
					prop_category = ComparisonGroupBrainPF_NS.NODE_CATEGORY;
				case ComparisonGroupBrainPF_NS.LAYER
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case ComparisonGroupBrainPF_NS.NODE
					prop_format = ComparisonGroupBrainPF_NS.NODE_FORMAT;
				case ComparisonGroupBrainPF_NS.LAYER
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case ComparisonGroupBrainPF_NS.NODE
					prop_description = 'NODE (figure, scalar) is the node number of the nodal group comparison on brain surface figure.';
				case ComparisonGroupBrainPF_NS.LAYER
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				case ComparisonGroupBrainPF_NS.NODE
					prop_default = Format.getFormatDefault(Format.SCALAR, ComparisonGroupBrainPF_NS.getPropSettings(prop));
				case ComparisonGroupBrainPF_NS.LAYER
					prop_default = 1;
				case ComparisonGroupBrainPF_NS.SIZE_DIFF
					prop_default = 'on';
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case ComparisonGroupBrainPF_NS.NODE % __ComparisonGroupBrainPF_NS.NODE__
