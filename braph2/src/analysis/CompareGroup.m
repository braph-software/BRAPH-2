classdef CompareGroup < ConcreteElement
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				comparegroup_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'VERBOSE'  'INTERRUPTIBLE'  'MEMORIZE'  'P'  'LONGITUDINAL'  'A1'  'A2'  'PERM_SEEDS'  'A1_PERM_DICT'  'A2_PERM_DICT'  'CP_DICT'  'COMPARISON'  'PERM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			comparegroup_category_list = { 1  1  3  4  2  2  9  9  9  2  3  3  4  4  5  5  5  5  6  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			comparegroup_format_list = { 2  2  8  2  2  2  4  4  11  4  11  4  8  8  12  10  10  10  8  9 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 7 % CompareGroup.WAITBAR
					prop_settings = Format.getFormatSettings(4);
				case 8 % CompareGroup.VERBOSE
					prop_settings = Format.getFormatSettings(4);
				case 9 % CompareGroup.INTERRUPTIBLE
					prop_settings = Format.getFormatSettings(11);
				case 10 % CompareGroup.MEMORIZE
					prop_settings = Format.getFormatSettings(4);
				case 11 % CompareGroup.P
					prop_settings = Format.getFormatSettings(11);
				case 12 % CompareGroup.LONGITUDINAL
					prop_settings = Format.getFormatSettings(4);
				case 13 % CompareGroup.A1
					prop_settings = 'AnalyzeGroup';
				case 14 % CompareGroup.A2
					prop_settings = 'AnalyzeGroup';
				case 15 % CompareGroup.PERM_SEEDS
					prop_settings = Format.getFormatSettings(12);
				case 16 % CompareGroup.A1_PERM_DICT
					prop_settings = 'AnalyzeGroup';
				case 17 % CompareGroup.A2_PERM_DICT
					prop_settings = 'AnalyzeGroup';
				case 18 % CompareGroup.CP_DICT
					prop_settings = 'ComparisonGroup';
				case 19 % CompareGroup.COMPARISON
					prop_settings = 'ComparisonGroup';
				case 20 % CompareGroup.PERM
		...
		function value = calculateValue(c, prop, varargin)
			...
			switch prop
				...
				case 18 % CompareGroup.CP_DICT
					...
					value = IndexedDictionary('IT_CLASS', 'ComparisonGroup', 'IT_KEY', 7);
	...
	methods % GUI
		function pr = getPanelProp(c, prop, varargin)
			...
			switch prop
				case 18 % CompareGroup.CP_DICT
					pr = CompareGroupPP_CpDict('EL', c, 'PROP', 18, ...
