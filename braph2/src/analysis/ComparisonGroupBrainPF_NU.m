classdef ComparisonGroupBrainPF_NU < ComparisonGroupBrainPF
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case ComparisonGroupBrainPF_NU.NODE
						tag = ComparisonGroupBrainPF_NU.NODE_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case ComparisonGroupBrainPF_NU.NODE
					prop_category = ComparisonGroupBrainPF_NU.NODE_CATEGORY;
				case ComparisonGroupBrainPF_NU.LAYER
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case ComparisonGroupBrainPF_NU.NODE
					prop_format = ComparisonGroupBrainPF_NU.NODE_FORMAT;
				case ComparisonGroupBrainPF_NU.LAYER
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case ComparisonGroupBrainPF_NU.NODE % __ComparisonGroupBrainPF_NU.NODE__
