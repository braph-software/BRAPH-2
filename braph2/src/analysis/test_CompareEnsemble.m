...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	c_1 = CompareEnsemble( ...
		...
		CompareEnsemble.LABEL, CompareEnsemble.getPropDefault(CompareEnsemble.LABEL), ...
		CompareEnsemble.NOTES, CompareEnsemble.getPropDefault(CompareEnsemble.NOTES), ...
		CompareEnsemble.WAITBAR, c_0.getCallback(7), ..., ...
		CompareEnsemble.VERBOSE, c_0.getCallback(8), ..., ...
		CompareEnsemble.INTERRUPTIBLE, c_0.getCallback(9), ..., ...
		CompareEnsemble.MEMORIZE, CompareEnsemble.getPropDefault(CompareEnsemble.MEMORIZE), ...
		CompareEnsemble.P, c_0.getCallback(11), ..., ...
		CompareEnsemble.LONGITUDINAL, c_0.getCallback(12), ..., ...
		CompareEnsemble.A1, c_0.getCallback(13), ..., ...
		CompareEnsemble.A2, c_0.getCallback(14), ..., ...
		CompareEnsemble.PERM_SEEDS, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A1_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A2_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.CP_DICT, CompareEnsemble.getNoValue(), ...
	...
	c_2 = CompareEnsemble( ...
		...
		CompareEnsemble.LABEL, CompareEnsemble.getPropDefault(CompareEnsemble.LABEL), ...
		CompareEnsemble.NOTES, CompareEnsemble.getPropDefault(CompareEnsemble.NOTES), ...
		CompareEnsemble.WAITBAR, c_1.getCallback(7), ..., ...
		CompareEnsemble.VERBOSE, c_1.getCallback(8), ..., ...
		CompareEnsemble.INTERRUPTIBLE, c_1.getCallback(9), ..., ...
		CompareEnsemble.MEMORIZE, CompareEnsemble.getPropDefault(CompareEnsemble.MEMORIZE), ...
		CompareEnsemble.P, c_1.getCallback(11), ..., ...
		CompareEnsemble.LONGITUDINAL, c_1.getCallback(12), ..., ...
		CompareEnsemble.A1, c_1.getCallback(13), ..., ...
		CompareEnsemble.A2, c_1.getCallback(14), ..., ...
		CompareEnsemble.PERM_SEEDS, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A1_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A2_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.CP_DICT, CompareEnsemble.getNoValue(), ...
	...
	c_3 = CompareEnsemble( ...
		...
		CompareEnsemble.LABEL, CompareEnsemble.getPropDefault(CompareEnsemble.LABEL), ...
		CompareEnsemble.NOTES, CompareEnsemble.getPropDefault(CompareEnsemble.NOTES), ...
		CompareEnsemble.WAITBAR, c_2.getCallback(7), ..., ...
		CompareEnsemble.VERBOSE, c_2.getCallback(8), ..., ...
		CompareEnsemble.INTERRUPTIBLE, c_2.getCallback(9), ..., ...
		CompareEnsemble.MEMORIZE, CompareEnsemble.getPropDefault(CompareEnsemble.MEMORIZE), ...
		CompareEnsemble.P, c_2.getCallback(11), ..., ...
		CompareEnsemble.LONGITUDINAL, c_2.getCallback(12), ..., ...
		CompareEnsemble.A1, c_2.getCallback(13), ..., ...
		CompareEnsemble.A2, c_2.getCallback(14), ..., ...
		CompareEnsemble.PERM_SEEDS, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A1_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A2_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.CP_DICT, CompareEnsemble.getNoValue(), ...
