...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	c_1 = CompareEnsemble( ...
		CompareEnsemble.NAME, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.DESCRIPTION, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.TEMPLATE, c_0.getCallback(3), ..., ...
		CompareEnsemble.ID, c_0.getCallback(4), ..., ...
		CompareEnsemble.LABEL, CompareEnsemble.getPropDefault(CompareEnsemble.LABEL), ...
		CompareEnsemble.NOTES, CompareEnsemble.getPropDefault(CompareEnsemble.NOTES), ...
		CompareEnsemble.TOSTRING, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.WAITBAR, c_0.getCallback(8), ..., ...
		CompareEnsemble.VERBOSE, c_0.getCallback(9), ..., ...
		CompareEnsemble.INTERRUPTIBLE, c_0.getCallback(10), ..., ...
		CompareEnsemble.MEMORIZE, CompareEnsemble.getPropDefault(CompareEnsemble.MEMORIZE), ...
		CompareEnsemble.P, c_0.getCallback(12), ..., ...
		CompareEnsemble.LONGITUDINAL, c_0.getCallback(13), ..., ...
		CompareEnsemble.A1, c_0.getCallback(14), ..., ...
		CompareEnsemble.A2, c_0.getCallback(15), ..., ...
		CompareEnsemble.PERM_SEEDS, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A1_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A2_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.CP_DICT, CompareEnsemble.getNoValue(), ...
	...
	c_2 = CompareEnsemble( ...
		CompareEnsemble.NAME, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.DESCRIPTION, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.TEMPLATE, c_1.getCallback(3), ..., ...
		CompareEnsemble.ID, c_1.getCallback(4), ..., ...
		CompareEnsemble.LABEL, CompareEnsemble.getPropDefault(CompareEnsemble.LABEL), ...
		CompareEnsemble.NOTES, CompareEnsemble.getPropDefault(CompareEnsemble.NOTES), ...
		CompareEnsemble.TOSTRING, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.WAITBAR, c_1.getCallback(8), ..., ...
		CompareEnsemble.VERBOSE, c_1.getCallback(9), ..., ...
		CompareEnsemble.INTERRUPTIBLE, c_1.getCallback(10), ..., ...
		CompareEnsemble.MEMORIZE, CompareEnsemble.getPropDefault(CompareEnsemble.MEMORIZE), ...
		CompareEnsemble.P, c_1.getCallback(12), ..., ...
		CompareEnsemble.LONGITUDINAL, c_1.getCallback(13), ..., ...
		CompareEnsemble.A1, c_1.getCallback(14), ..., ...
		CompareEnsemble.A2, c_1.getCallback(15), ..., ...
		CompareEnsemble.PERM_SEEDS, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A1_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A2_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.CP_DICT, CompareEnsemble.getNoValue(), ...
	...
	c_3 = CompareEnsemble( ...
		CompareEnsemble.NAME, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.DESCRIPTION, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.TEMPLATE, c_2.getCallback(3), ..., ...
		CompareEnsemble.ID, c_2.getCallback(4), ..., ...
		CompareEnsemble.LABEL, CompareEnsemble.getPropDefault(CompareEnsemble.LABEL), ...
		CompareEnsemble.NOTES, CompareEnsemble.getPropDefault(CompareEnsemble.NOTES), ...
		CompareEnsemble.TOSTRING, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.WAITBAR, c_2.getCallback(8), ..., ...
		CompareEnsemble.VERBOSE, c_2.getCallback(9), ..., ...
		CompareEnsemble.INTERRUPTIBLE, c_2.getCallback(10), ..., ...
		CompareEnsemble.MEMORIZE, CompareEnsemble.getPropDefault(CompareEnsemble.MEMORIZE), ...
		CompareEnsemble.P, c_2.getCallback(12), ..., ...
		CompareEnsemble.LONGITUDINAL, c_2.getCallback(13), ..., ...
		CompareEnsemble.A1, c_2.getCallback(14), ..., ...
		CompareEnsemble.A2, c_2.getCallback(15), ..., ...
		CompareEnsemble.PERM_SEEDS, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A1_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.A2_PERM_DICT, CompareEnsemble.getNoValue(), ...
		CompareEnsemble.CP_DICT, CompareEnsemble.getNoValue(), ...
