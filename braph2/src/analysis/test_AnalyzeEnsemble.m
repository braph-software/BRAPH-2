...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	a_1 = AnalyzeEnsemble( ...
		...
		AnalyzeEnsemble.LABEL, AnalyzeEnsemble.getPropDefault(AnalyzeEnsemble.LABEL), ...
		AnalyzeEnsemble.NOTES, AnalyzeEnsemble.getPropDefault(AnalyzeEnsemble.NOTES), ...
		AnalyzeEnsemble.WAITBAR, a_0.getCallback(7), ..., ...
		AnalyzeEnsemble.GR, a_0.getCallback(8), ..., ...
		AnalyzeEnsemble.GRAPH_TEMPLATE, a_0.getCallback(9), ..., ...
		AnalyzeEnsemble.G_DICT, AnalyzeEnsemble.getNoValue(), ...
		AnalyzeEnsemble.ME_DICT, AnalyzeEnsemble.getNoValue(), ...
		AnalyzeEnsemble.MEASUREENSEMBLE, AnalyzeEnsemble.getNoValue() ...
		);
	...
	a_2 = AnalyzeEnsemble( ...
		...
		AnalyzeEnsemble.LABEL, AnalyzeEnsemble.getPropDefault(AnalyzeEnsemble.LABEL), ...
		AnalyzeEnsemble.NOTES, AnalyzeEnsemble.getPropDefault(AnalyzeEnsemble.NOTES), ...
		AnalyzeEnsemble.WAITBAR, a_1.getCallback(7), ..., ...
		AnalyzeEnsemble.GR, a_1.getCallback(8), ..., ...
		AnalyzeEnsemble.GRAPH_TEMPLATE, a_1.getCallback(9), ..., ...
		AnalyzeEnsemble.G_DICT, AnalyzeEnsemble.getNoValue(), ...
		AnalyzeEnsemble.ME_DICT, AnalyzeEnsemble.getNoValue(), ...
		AnalyzeEnsemble.MEASUREENSEMBLE, AnalyzeEnsemble.getNoValue() ...
		);
	...
	a_3 = AnalyzeEnsemble( ...
		...
		AnalyzeEnsemble.LABEL, AnalyzeEnsemble.getPropDefault(AnalyzeEnsemble.LABEL), ...
		AnalyzeEnsemble.NOTES, AnalyzeEnsemble.getPropDefault(AnalyzeEnsemble.NOTES), ...
		AnalyzeEnsemble.WAITBAR, a_2.getCallback(7), ..., ...
		AnalyzeEnsemble.GR, a_2.getCallback(8), ..., ...
		AnalyzeEnsemble.GRAPH_TEMPLATE, a_2.getCallback(9), ..., ...
		AnalyzeEnsemble.G_DICT, AnalyzeEnsemble.getNoValue(), ...
		AnalyzeEnsemble.ME_DICT, AnalyzeEnsemble.getNoValue(), ...
		AnalyzeEnsemble.MEASUREENSEMBLE, AnalyzeEnsemble.getNoValue() ...
		);
