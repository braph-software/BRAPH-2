...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nncv_1 = NNCrossValidation( ...
		...
		NNCrossValidation.LABEL, NNCrossValidation.getPropDefault(NNCrossValidation.LABEL), ...
		NNCrossValidation.NOTES, NNCrossValidation.getPropDefault(NNCrossValidation.NOTES), ...
		NNCrossValidation.KFOLDS, nncv_0.getCallback(7), ..., ...
		NNCrossValidation.SPLIT, nncv_0.getCallback(8), ..., ...
		NNCrossValidation.D, nncv_0.getCallback(9), ..., ...
		NNCrossValidation.NN_TEMPLATE, nncv_0.getCallback(10), ..., ...
		NNCrossValidation.NNEVALUATOR_TEMPLATE, nncv_0.getCallback(11), ..., ...
		NNCrossValidation.DSP, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.D_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.NN_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_0.getCallback(16), ..., ...
		NNCrossValidation.BATCH, nncv_0.getCallback(17), ..., ...
		NNCrossValidation.SHUFFLE, nncv_0.getCallback(18), ..., ...
		NNCrossValidation.SOLVER, nncv_0.getCallback(19), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
	...
	nncv_2 = NNCrossValidation( ...
		...
		NNCrossValidation.LABEL, NNCrossValidation.getPropDefault(NNCrossValidation.LABEL), ...
		NNCrossValidation.NOTES, NNCrossValidation.getPropDefault(NNCrossValidation.NOTES), ...
		NNCrossValidation.KFOLDS, nncv_1.getCallback(7), ..., ...
		NNCrossValidation.SPLIT, nncv_1.getCallback(8), ..., ...
		NNCrossValidation.D, nncv_1.getCallback(9), ..., ...
		NNCrossValidation.NN_TEMPLATE, nncv_1.getCallback(10), ..., ...
		NNCrossValidation.NNEVALUATOR_TEMPLATE, nncv_1.getCallback(11), ..., ...
		NNCrossValidation.DSP, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.D_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.NN_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_1.getCallback(16), ..., ...
		NNCrossValidation.BATCH, nncv_1.getCallback(17), ..., ...
		NNCrossValidation.SHUFFLE, nncv_1.getCallback(18), ..., ...
		NNCrossValidation.SOLVER, nncv_1.getCallback(19), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
	...
	nncv_3 = NNCrossValidation( ...
		...
		NNCrossValidation.LABEL, NNCrossValidation.getPropDefault(NNCrossValidation.LABEL), ...
		NNCrossValidation.NOTES, NNCrossValidation.getPropDefault(NNCrossValidation.NOTES), ...
		NNCrossValidation.KFOLDS, nncv_2.getCallback(7), ..., ...
		NNCrossValidation.SPLIT, nncv_2.getCallback(8), ..., ...
		NNCrossValidation.D, nncv_2.getCallback(9), ..., ...
		NNCrossValidation.NN_TEMPLATE, nncv_2.getCallback(10), ..., ...
		NNCrossValidation.NNEVALUATOR_TEMPLATE, nncv_2.getCallback(11), ..., ...
		NNCrossValidation.DSP, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.D_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.NN_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_2.getCallback(16), ..., ...
		NNCrossValidation.BATCH, nncv_2.getCallback(17), ..., ...
		NNCrossValidation.SHUFFLE, nncv_2.getCallback(18), ..., ...
		NNCrossValidation.SOLVER, nncv_2.getCallback(19), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
