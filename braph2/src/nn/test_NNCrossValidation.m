...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nncv_1 = NNCrossValidation( ...
		...
		NNCrossValidation.NN_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_0.getCallback(17), ..., ...
		NNCrossValidation.BATCH, nncv_0.getCallback(18), ..., ...
		NNCrossValidation.SHUFFLE, nncv_0.getCallback(19), ..., ...
		NNCrossValidation.SOLVER, nncv_0.getCallback(20), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
	...
	nncv_2 = NNCrossValidation( ...
		...
		NNCrossValidation.NN_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_1.getCallback(17), ..., ...
		NNCrossValidation.BATCH, nncv_1.getCallback(18), ..., ...
		NNCrossValidation.SHUFFLE, nncv_1.getCallback(19), ..., ...
		NNCrossValidation.SOLVER, nncv_1.getCallback(20), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
	...
	nncv_3 = NNCrossValidation( ...
		...
		NNCrossValidation.NN_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_2.getCallback(17), ..., ...
		NNCrossValidation.BATCH, nncv_2.getCallback(18), ..., ...
		NNCrossValidation.SHUFFLE, nncv_2.getCallback(19), ..., ...
		NNCrossValidation.SOLVER, nncv_2.getCallback(20), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
