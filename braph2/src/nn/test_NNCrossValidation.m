...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nncv_1 = NNCrossValidation( ...
		...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST_IT, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_0.getCallback(22), ..., ...
		NNCrossValidation.BATCH, nncv_0.getCallback(23), ..., ...
		NNCrossValidation.SHUFFLE, nncv_0.getCallback(24), ..., ...
		NNCrossValidation.SOLVER, nncv_0.getCallback(25), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
	...
	nncv_2 = NNCrossValidation( ...
		...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST_IT, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_1.getCallback(22), ..., ...
		NNCrossValidation.BATCH, nncv_1.getCallback(23), ..., ...
		NNCrossValidation.SHUFFLE, nncv_1.getCallback(24), ..., ...
		NNCrossValidation.SOLVER, nncv_1.getCallback(25), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
	...
	nncv_3 = NNCrossValidation( ...
		...
		NNCrossValidation.EVALUATOR_LIST, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EVALUATOR_LIST_IT, NNCrossValidation.getNoValue(), ...
		NNCrossValidation.EPOCHS, nncv_2.getCallback(22), ..., ...
		NNCrossValidation.BATCH, nncv_2.getCallback(23), ..., ...
		NNCrossValidation.SHUFFLE, nncv_2.getCallback(24), ..., ...
		NNCrossValidation.SOLVER, nncv_2.getCallback(25), ..., ...
		NNCrossValidation.VERBOSE, NNCrossValidation.getPropDefault(NNCrossValidation.VERBOSE), ...
		NNCrossValidation.PLOT_TRAINING, NNCrossValidation.getPropDefault(NNCrossValidation.PLOT_TRAINING), ...
		NNCrossValidation.TRAIN, NNCrossValidation.getNoValue() ...
		);
