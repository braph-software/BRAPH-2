...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	dsp_1 = NNDatasetSplit( ...
		NNDatasetSplit.NAME, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.DESCRIPTION, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.TEMPLATE, dsp_0.getCallback(3), ..., ...
		NNDatasetSplit.ID, dsp_0.getCallback(4), ..., ...
		NNDatasetSplit.LABEL, NNDatasetSplit.getPropDefault(NNDatasetSplit.LABEL), ...
		NNDatasetSplit.NOTES, NNDatasetSplit.getPropDefault(NNDatasetSplit.NOTES), ...
		NNDatasetSplit.TOSTRING, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.D, dsp_0.getCallback(8), ..., ...
		NNDatasetSplit.SPLIT, dsp_0.getCallback(9), ..., ...
		NNDatasetSplit.D_LIST, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.D_LIST_IT, NNDatasetSplit.getNoValue() ...
		);
	...
	dsp_2 = NNDatasetSplit( ...
		NNDatasetSplit.NAME, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.DESCRIPTION, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.TEMPLATE, dsp_1.getCallback(3), ..., ...
		NNDatasetSplit.ID, dsp_1.getCallback(4), ..., ...
		NNDatasetSplit.LABEL, NNDatasetSplit.getPropDefault(NNDatasetSplit.LABEL), ...
		NNDatasetSplit.NOTES, NNDatasetSplit.getPropDefault(NNDatasetSplit.NOTES), ...
		NNDatasetSplit.TOSTRING, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.D, dsp_1.getCallback(8), ..., ...
		NNDatasetSplit.SPLIT, dsp_1.getCallback(9), ..., ...
		NNDatasetSplit.D_LIST, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.D_LIST_IT, NNDatasetSplit.getNoValue() ...
		);
	...
	dsp_3 = NNDatasetSplit( ...
		NNDatasetSplit.NAME, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.DESCRIPTION, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.TEMPLATE, dsp_2.getCallback(3), ..., ...
		NNDatasetSplit.ID, dsp_2.getCallback(4), ..., ...
		NNDatasetSplit.LABEL, NNDatasetSplit.getPropDefault(NNDatasetSplit.LABEL), ...
		NNDatasetSplit.NOTES, NNDatasetSplit.getPropDefault(NNDatasetSplit.NOTES), ...
		NNDatasetSplit.TOSTRING, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.D, dsp_2.getCallback(8), ..., ...
		NNDatasetSplit.SPLIT, dsp_2.getCallback(9), ..., ...
		NNDatasetSplit.D_LIST, NNDatasetSplit.getNoValue(), ...
		NNDatasetSplit.D_LIST_IT, NNDatasetSplit.getNoValue() ...
		);
