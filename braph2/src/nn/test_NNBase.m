...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	nn_1 = NNBase( ...
		NNBase.NAME, NNBase.getNoValue(), ...
		NNBase.DESCRIPTION, NNBase.getNoValue(), ...
		NNBase.TEMPLATE, nn_0.getCallback(3), ..., ...
		NNBase.ID, nn_0.getCallback(4), ..., ...
		NNBase.LABEL, NNBase.getPropDefault(NNBase.LABEL), ...
		NNBase.NOTES, NNBase.getPropDefault(NNBase.NOTES), ...
		NNBase.TOSTRING, NNBase.getNoValue(), ...
		NNBase.D, nn_0.getCallback(8), ..., ...
		NNBase.DP_CLASSES, nn_0.getCallback(9), ..., ...
		NNBase.EPOCHS, nn_0.getCallback(10), ..., ...
		NNBase.BATCH, nn_0.getCallback(11), ..., ...
		NNBase.SHUFFLE, nn_0.getCallback(12), ..., ...
		NNBase.SOLVER, nn_0.getCallback(13), ..., ...
		NNBase.MODEL, NNBase.getNoValue(), ...
		NNBase.INPUTS, NNBase.getNoValue(), ...
		NNBase.TARGETS, NNBase.getNoValue(), ...
		NNBase.TRAIN, NNBase.getNoValue(), ...
	...
	nn_2 = NNBase( ...
		NNBase.NAME, NNBase.getNoValue(), ...
		NNBase.DESCRIPTION, NNBase.getNoValue(), ...
		NNBase.TEMPLATE, nn_1.getCallback(3), ..., ...
		NNBase.ID, nn_1.getCallback(4), ..., ...
		NNBase.LABEL, NNBase.getPropDefault(NNBase.LABEL), ...
		NNBase.NOTES, NNBase.getPropDefault(NNBase.NOTES), ...
		NNBase.TOSTRING, NNBase.getNoValue(), ...
		NNBase.D, nn_1.getCallback(8), ..., ...
		NNBase.DP_CLASSES, nn_1.getCallback(9), ..., ...
		NNBase.EPOCHS, nn_1.getCallback(10), ..., ...
		NNBase.BATCH, nn_1.getCallback(11), ..., ...
		NNBase.SHUFFLE, nn_1.getCallback(12), ..., ...
		NNBase.SOLVER, nn_1.getCallback(13), ..., ...
		NNBase.MODEL, NNBase.getNoValue(), ...
		NNBase.INPUTS, NNBase.getNoValue(), ...
		NNBase.TARGETS, NNBase.getNoValue(), ...
		NNBase.TRAIN, NNBase.getNoValue(), ...
	...
	nn_3 = NNBase( ...
		NNBase.NAME, NNBase.getNoValue(), ...
		NNBase.DESCRIPTION, NNBase.getNoValue(), ...
		NNBase.TEMPLATE, nn_2.getCallback(3), ..., ...
		NNBase.ID, nn_2.getCallback(4), ..., ...
		NNBase.LABEL, NNBase.getPropDefault(NNBase.LABEL), ...
		NNBase.NOTES, NNBase.getPropDefault(NNBase.NOTES), ...
		NNBase.TOSTRING, NNBase.getNoValue(), ...
		NNBase.D, nn_2.getCallback(8), ..., ...
		NNBase.DP_CLASSES, nn_2.getCallback(9), ..., ...
		NNBase.EPOCHS, nn_2.getCallback(10), ..., ...
		NNBase.BATCH, nn_2.getCallback(11), ..., ...
		NNBase.SHUFFLE, nn_2.getCallback(12), ..., ...
		NNBase.SOLVER, nn_2.getCallback(13), ..., ...
		NNBase.MODEL, NNBase.getNoValue(), ...
		NNBase.INPUTS, NNBase.getNoValue(), ...
		NNBase.TARGETS, NNBase.getNoValue(), ...
		NNBase.TRAIN, NNBase.getNoValue(), ...
