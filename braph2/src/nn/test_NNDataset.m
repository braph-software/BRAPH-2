...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	d_1 = NNDataset( ...
		...
		NNDataset.NOTES, NNDataset.getPropDefault(NNDataset.NOTES), ...
		NNDataset.TOSTRING, NNDataset.getNoValue(), ...
		NNDataset.DP_CLASS, d_0.getCallback(8), ..., ...
		NNDataset.DP_DICT, d_0.getCallback(9), ..., ...
		NNDataset.INPUTS, NNDataset.getNoValue(), ...
		NNDataset.TARGETS, NNDataset.getNoValue() ...
		);
	...
	d_2 = NNDataset( ...
		...
		NNDataset.NOTES, NNDataset.getPropDefault(NNDataset.NOTES), ...
		NNDataset.TOSTRING, NNDataset.getNoValue(), ...
		NNDataset.DP_CLASS, d_1.getCallback(8), ..., ...
		NNDataset.DP_DICT, d_1.getCallback(9), ..., ...
		NNDataset.INPUTS, NNDataset.getNoValue(), ...
		NNDataset.TARGETS, NNDataset.getNoValue() ...
		);
	...
	d_3 = NNDataset( ...
		...
		NNDataset.NOTES, NNDataset.getPropDefault(NNDataset.NOTES), ...
		NNDataset.TOSTRING, NNDataset.getNoValue(), ...
		NNDataset.DP_CLASS, d_2.getCallback(8), ..., ...
		NNDataset.DP_DICT, d_2.getCallback(9), ..., ...
		NNDataset.INPUTS, NNDataset.getNoValue(), ...
		NNDataset.TARGETS, NNDataset.getNoValue() ...
		);
