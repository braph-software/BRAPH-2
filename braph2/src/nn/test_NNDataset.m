...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	d_1 = NNDataset( ...
		NNDataset.NAME, NNDataset.getNoValue(), ...
		NNDataset.DESCRIPTION, NNDataset.getNoValue(), ...
		NNDataset.TEMPLATE, d_0.getCallback(3), ..., ...
		NNDataset.ID, d_0.getCallback(4), ..., ...
		NNDataset.LABEL, NNDataset.getPropDefault(NNDataset.LABEL), ...
		NNDataset.NOTES, NNDataset.getPropDefault(NNDataset.NOTES), ...
		NNDataset.DP_CLASS, d_0.getCallback(7), ..., ...
		NNDataset.DP_DICT, d_0.getCallback(8), ..., ...
		NNDataset.INPUTS, NNDataset.getNoValue(), ...
		NNDataset.TARGETS, NNDataset.getNoValue() ...
		);
	...
	d_2 = NNDataset( ...
		NNDataset.NAME, NNDataset.getNoValue(), ...
		NNDataset.DESCRIPTION, NNDataset.getNoValue(), ...
		NNDataset.TEMPLATE, d_1.getCallback(3), ..., ...
		NNDataset.ID, d_1.getCallback(4), ..., ...
		NNDataset.LABEL, NNDataset.getPropDefault(NNDataset.LABEL), ...
		NNDataset.NOTES, NNDataset.getPropDefault(NNDataset.NOTES), ...
		NNDataset.DP_CLASS, d_1.getCallback(7), ..., ...
		NNDataset.DP_DICT, d_1.getCallback(8), ..., ...
		NNDataset.INPUTS, NNDataset.getNoValue(), ...
		NNDataset.TARGETS, NNDataset.getNoValue() ...
		);
	...
	d_3 = NNDataset( ...
		NNDataset.NAME, NNDataset.getNoValue(), ...
		NNDataset.DESCRIPTION, NNDataset.getNoValue(), ...
		NNDataset.TEMPLATE, d_2.getCallback(3), ..., ...
		NNDataset.ID, d_2.getCallback(4), ..., ...
		NNDataset.LABEL, NNDataset.getPropDefault(NNDataset.LABEL), ...
		NNDataset.NOTES, NNDataset.getPropDefault(NNDataset.NOTES), ...
		NNDataset.DP_CLASS, d_2.getCallback(7), ..., ...
		NNDataset.DP_DICT, d_2.getCallback(8), ..., ...
		NNDataset.INPUTS, NNDataset.getNoValue(), ...
		NNDataset.TARGETS, NNDataset.getNoValue() ...
		);
