		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNDatasetSplit.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the splitter of a neural network dataset.';
				case NNDatasetSplit.NAME
					prop_description = 'NAME (constant, string) is the name of the splitter of a neural network dataset.';
				case NNDatasetSplit.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the splitter of a neural network dataset.';
				case NNDatasetSplit.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the splitter of a neural network dataset.';
				case NNDatasetSplit.ID
					prop_description = 'ID (data, string) is a few-letter code for the splitter of a neural network dataset.';
				case NNDatasetSplit.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the splitter of a neural network dataset.';
				case NNDatasetSplit.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the splitter of a neural network dataset.';
				otherwise
