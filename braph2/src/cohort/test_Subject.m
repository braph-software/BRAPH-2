...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	sub_1 = Subject( ...
		Subject.NAME, Subject.getNoValue(), ...
		Subject.DESCRIPTION, Subject.getNoValue(), ...
		Subject.TEMPLATE, sub_0.getCallback(3), ..., ...
		Subject.ID, sub_0.getCallback(4), ..., ...
		Subject.LABEL, Subject.getPropDefault(Subject.LABEL), ...
		Subject.NOTES, Subject.getPropDefault(Subject.NOTES), ...
		Subject.VOI_DICT, sub_0.getCallback(7) ... ...
		);
	...
	sub_2 = Subject( ...
		Subject.NAME, Subject.getNoValue(), ...
		Subject.DESCRIPTION, Subject.getNoValue(), ...
		Subject.TEMPLATE, sub_1.getCallback(3), ..., ...
		Subject.ID, sub_1.getCallback(4), ..., ...
		Subject.LABEL, Subject.getPropDefault(Subject.LABEL), ...
		Subject.NOTES, Subject.getPropDefault(Subject.NOTES), ...
		Subject.VOI_DICT, sub_1.getCallback(7) ... ...
		);
	...
	sub_3 = Subject( ...
		Subject.NAME, Subject.getNoValue(), ...
		Subject.DESCRIPTION, Subject.getNoValue(), ...
		Subject.TEMPLATE, sub_2.getCallback(3), ..., ...
		Subject.ID, sub_2.getCallback(4), ..., ...
		Subject.LABEL, Subject.getPropDefault(Subject.LABEL), ...
		Subject.NOTES, Subject.getPropDefault(Subject.NOTES), ...
		Subject.VOI_DICT, sub_2.getCallback(7) ... ...
		);
