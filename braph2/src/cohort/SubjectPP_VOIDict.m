classdef SubjectPP_VOIDict < PanelProp
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the VOI plot.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the VOI plot.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the VOI plot.
	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 2 % SubjectPP_VOIDict.DESCRIPTION
				...
				case 4 % SubjectPP_VOIDict.ID
					prop_default = 'SubjectPP_VOIDict ID';
				case 5 % SubjectPP_VOIDict.LABEL
