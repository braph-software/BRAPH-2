...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	voi_1 = VOI( ...
		VOI.NAME, VOI.getNoValue(), ...
		VOI.DESCRIPTION, VOI.getNoValue(), ...
		VOI.TEMPLATE, voi_0.getCallback(3), ..., ...
		VOI.ID, voi_0.getCallback(4), ..., ...
		VOI.LABEL, VOI.getPropDefault(VOI.LABEL), ...
		VOI.NOTES, VOI.getPropDefault(VOI.NOTES), ...
		VOI.V, voi_0.getCallback(7) ... ...
		);
	...
	voi_2 = VOI( ...
		VOI.NAME, VOI.getNoValue(), ...
		VOI.DESCRIPTION, VOI.getNoValue(), ...
		VOI.TEMPLATE, voi_1.getCallback(3), ..., ...
		VOI.ID, voi_1.getCallback(4), ..., ...
		VOI.LABEL, VOI.getPropDefault(VOI.LABEL), ...
		VOI.NOTES, VOI.getPropDefault(VOI.NOTES), ...
		VOI.V, voi_1.getCallback(7) ... ...
		);
	...
	voi_3 = VOI( ...
		VOI.NAME, VOI.getNoValue(), ...
		VOI.DESCRIPTION, VOI.getNoValue(), ...
		VOI.TEMPLATE, voi_2.getCallback(3), ..., ...
		VOI.ID, voi_2.getCallback(4), ..., ...
		VOI.LABEL, VOI.getPropDefault(VOI.LABEL), ...
		VOI.NOTES, VOI.getPropDefault(VOI.NOTES), ...
		VOI.V, voi_2.getCallback(7) ... ...
		);
