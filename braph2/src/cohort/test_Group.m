...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	gr_1 = Group( ...
		Group.NAME, Group.getNoValue(), ...
		Group.DESCRIPTION, Group.getNoValue(), ...
		Group.TEMPLATE, gr_0.getCallback(3), ..., ...
		Group.ID, gr_0.getCallback(4), ..., ...
		Group.LABEL, Group.getPropDefault(Group.LABEL), ...
		Group.NOTES, Group.getPropDefault(Group.NOTES), ...
		Group.TOSTRING, Group.getNoValue(), ...
		Group.SUB_CLASS, gr_0.getCallback(8), ..., ...
		Group.SUB_DICT, gr_0.getCallback(9), ..., ...
		Group.VOIS, Group.getNoValue(), ...
		Group.COVARIATES, Group.getNoValue() ...
		);
	...
	gr_2 = Group( ...
		Group.NAME, Group.getNoValue(), ...
		Group.DESCRIPTION, Group.getNoValue(), ...
		Group.TEMPLATE, gr_1.getCallback(3), ..., ...
		Group.ID, gr_1.getCallback(4), ..., ...
		Group.LABEL, Group.getPropDefault(Group.LABEL), ...
		Group.NOTES, Group.getPropDefault(Group.NOTES), ...
		Group.TOSTRING, Group.getNoValue(), ...
		Group.SUB_CLASS, gr_1.getCallback(8), ..., ...
		Group.SUB_DICT, gr_1.getCallback(9), ..., ...
		Group.VOIS, Group.getNoValue(), ...
		Group.COVARIATES, Group.getNoValue() ...
		);
	...
	gr_3 = Group( ...
		Group.NAME, Group.getNoValue(), ...
		Group.DESCRIPTION, Group.getNoValue(), ...
		Group.TEMPLATE, gr_2.getCallback(3), ..., ...
		Group.ID, gr_2.getCallback(4), ..., ...
		Group.LABEL, Group.getPropDefault(Group.LABEL), ...
		Group.NOTES, Group.getPropDefault(Group.NOTES), ...
		Group.TOSTRING, Group.getNoValue(), ...
		Group.SUB_CLASS, gr_2.getCallback(8), ..., ...
		Group.SUB_DICT, gr_2.getCallback(9), ..., ...
		Group.VOIS, Group.getNoValue(), ...
		Group.COVARIATES, Group.getNoValue() ...
		);
