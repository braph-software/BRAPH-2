...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	gr_1 = Group( ...
		...
		Group.LABEL, Group.getPropDefault(Group.LABEL), ...
		Group.NOTES, Group.getPropDefault(Group.NOTES), ...
		Group.SUB_CLASS, gr_0.getCallback(7), ..., ...
		Group.SUB_DICT, gr_0.getCallback(8), ..., ...
		Group.VOIS, Group.getNoValue(), ...
		Group.COVARIATES, Group.getNoValue() ...
		);
	...
	gr_2 = Group( ...
		...
		Group.LABEL, Group.getPropDefault(Group.LABEL), ...
		Group.NOTES, Group.getPropDefault(Group.NOTES), ...
		Group.SUB_CLASS, gr_1.getCallback(7), ..., ...
		Group.SUB_DICT, gr_1.getCallback(8), ..., ...
		Group.VOIS, Group.getNoValue(), ...
		Group.COVARIATES, Group.getNoValue() ...
		);
	...
	gr_3 = Group( ...
		...
		Group.LABEL, Group.getPropDefault(Group.LABEL), ...
		Group.NOTES, Group.getPropDefault(Group.NOTES), ...
		Group.SUB_CLASS, gr_2.getCallback(7), ..., ...
		Group.SUB_DICT, gr_2.getCallback(8), ..., ...
		Group.VOIS, Group.getNoValue(), ...
		Group.COVARIATES, Group.getNoValue() ...
		);
