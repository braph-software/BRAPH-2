classdef MeasurePF_NxPP_Node < PanelProp
	...
	%  <strong>35</strong> <strong>DROPDOWN</strong> 	DROPDOWN (evanescent, handle) is the dropdown of the node.
	%
	...
	methods % constructor
		function pr = MeasurePF_NxPP_Node(varargin)
			%MeasurePF_NxPP_Node() creates a panel property node.
			%
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			%
			% PROPS = MeasurePF_NxPP_Node.GETPROPS() returns the property list of panel property node
			%  as a row vector.
			%
		...
		function prop_number = getPropNumber(varargin)
			...
			%
			% N = MeasurePF_NxPP_Node.GETPROPNUMBER() returns the property number of panel property node.
			%
			% N = MeasurePF_NxPP_Node.GETPROPNUMBER(CATEGORY) returns the property number of panel property node
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				measurepf_nxpp_node_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'DROPDOWN' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_nxpp_node_category_list = { 1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  7 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_nxpp_node_format_list = { 2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  18 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 35 % MeasurePF_NxPP_Node.DROPDOWN
					prop_settings = Format.getFormatSettings(18);
				case 3 % MeasurePF_NxPP_Node.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % MeasurePF_NxPP_Node.NAME
					prop_default = 'MeasurePF_NxPP_Node';
				case 2 % MeasurePF_NxPP_Node.DESCRIPTION
					prop_default = 'MeasurePF_NxPP_Node plots the panel to select a node from a drop-down list. It is supposed to be used with the property NODE of MeasurePF_NU, MeasurePF_NS, or MeasurePF_NB.';
				case 3 % MeasurePF_NxPP_Node.TEMPLATE
					prop_default = Format.getFormatDefault(8, MeasurePF_NxPP_Node.getPropSettings(prop));
				case 4 % MeasurePF_NxPP_Node.ID
					prop_default = 'MeasurePF_NxPP_Node ID';
				case 5 % MeasurePF_NxPP_Node.LABEL
					prop_default = 'MeasurePF_NxPP_Node label';
				case 6 % MeasurePF_NxPP_Node.NOTES
					prop_default = 'MeasurePF_NxPP_Node notes';
				case 22 % MeasurePF_NxPP_Node.EL
					prop_default = MeasurePF_NU();
				case 23 % MeasurePF_NxPP_Node.PROP
					prop_default = 39;
				case 24 % MeasurePF_NxPP_Node.HEIGHT
					prop_default = 48;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 21 % MeasurePF_NxPP_Node.REDRAW
				...
				case 17 % MeasurePF_NxPP_Node.DELETE
