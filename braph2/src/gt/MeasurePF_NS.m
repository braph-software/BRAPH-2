classdef MeasurePF_NS < MeasurePF
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the panel figure nodal superglobal measure.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the panel figure nodal superglobal measure.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the panel figure nodal superglobal measure.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the panel figure nodal superglobal measure.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the panel figure nodal superglobal measure.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the panel figure nodal superglobal measure.
	...
	%  <strong>38</strong> <strong>NODE</strong> 	NODE (figure, scalar) is the node number of the nodal measure.
	%
	...
	properties (Constant) % properties
		NODE = 38; %CET: Computational Efficiency Trick
		NODE_TAG = 'NODE';
		NODE_CATEGORY = 8;
		NODE_FORMAT = 11;
	end
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_ns_category_list = { 1  1  3  4  2  2  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  7  2  6  7  8  7  7  8  7  7  8  7  8  7  8  8 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_ns_format_list = { 2  2  8  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  8  18  8  1  18  8  18  18  8  18  18  8  18  8  18  8  11 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 38 % MeasurePF_NS.NODE
					prop_settings = Format.getFormatSettings(11);
				case 3 % MeasurePF_NS.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % MeasurePF_NS.NAME
					prop_default = 'MeasurePF_NS';
				case 2 % MeasurePF_NS.DESCRIPTION
				...
				case 4 % MeasurePF_NS.ID
					prop_default = 'MeasurePF_NS ID';
				case 5 % MeasurePF_NS.LABEL
					prop_default = 'MeasurePF_NS label';
				case 6 % MeasurePF_NS.NOTES
