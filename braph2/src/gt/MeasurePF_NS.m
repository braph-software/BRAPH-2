classdef MeasurePF_NS < MeasurePF
	...
	%  <strong>39</strong> <strong>NODE</strong> 	NODE (figure, scalar) is the node number of the nodal measure.
	%
	...
	properties (Constant) % properties
		NODE = 39; %CET: Computational Efficiency Trick
		NODE_TAG = 'NODE';
		NODE_CATEGORY = 8;
		NODE_FORMAT = 11;
	end
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_ns_category_list = { 1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  7  2  6  7  8  7  7  8  7  7  8  7  8  7  8  8 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_ns_format_list = { 2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  8  18  8  1  18  8  18  18  8  18  18  8  18  8  18  8  11 };
	...
	methods % GUI
		function pr = getPanelProp(pf, prop, varargin)
			...
			switch prop
				case 39 % MeasurePF_NS.NODE
					pr = MeasurePF_NxPP_Node('EL', pf, 'PROP', 39);
