classdef MeasurePF_GS < MeasurePF
	...
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the panel figure for global superglobal measure.
