classdef MeasurePF_BxPP_Nodes < PanelProp
	...
	%  <strong>35</strong> <strong>DROPDOWN_NODE1</strong> 	DROPDOWN_NODE1 (evanescent, handle) is the dropdown for the first node.
	%  <strong>36</strong> <strong>DROPDOWN_NODE2</strong> 	DROPDOWN_NODE2 (evanescent, handle) is the dropdown for the second node.
	%
	...
	properties (Constant) % properties
		DROPDOWN_NODE1 = 35; %CET: Computational Efficiency Trick
		DROPDOWN_NODE1_TAG = 'DROPDOWN_NODE1';
		DROPDOWN_NODE1_CATEGORY = 7;
		DROPDOWN_NODE1_FORMAT = 18;
		
		DROPDOWN_NODE2 = 36; %CET: Computational Efficiency Trick
	...
	methods % constructor
		function pr = MeasurePF_BxPP_Nodes(varargin)
			%MeasurePF_BxPP_Nodes() creates a panel property node.
			%
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			%
			% PROPS = MeasurePF_BxPP_Nodes.GETPROPS() returns the property list of panel property node
			%  as a row vector.
			%
			...
			switch category
				...
				case 7 % Category.EVANESCENT
					prop_list = [9 14 26 27 29 30 31 32 33 34 35 36];
		...
		function prop_number = getPropNumber(varargin)
			...
			%
			% N = MeasurePF_BxPP_Nodes.GETPROPNUMBER() returns the property number of panel property node.
			%
			% N = MeasurePF_BxPP_Nodes.GETPROPNUMBER(CATEGORY) returns the property number of panel property node
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_bxpp_nodes_category_list = { 1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  7  7 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_bxpp_nodes_format_list = { 2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  18  18 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 35 % MeasurePF_BxPP_Nodes.DROPDOWN_NODE1
					prop_settings = Format.getFormatSettings(18);
				case 36 % MeasurePF_BxPP_Nodes.DROPDOWN_NODE2
					prop_settings = Format.getFormatSettings(18);
				case 3 % MeasurePF_BxPP_Nodes.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 36 % MeasurePF_BxPP_Nodes.DROPDOWN_NODE2
					prop_default = Format.getFormatDefault(18, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				case 1 % MeasurePF_BxPP_Nodes.NAME
					prop_default = 'MeasurePF_BxPP_Nodes';
				case 2 % MeasurePF_BxPP_Nodes.DESCRIPTION
					prop_default = 'MeasurePF_BxPP_Nodes plots the panel to select the nodes from two drop-down lists. It is supposed to be used with the property NODES of MeasurePF_BU, MeasurePF_BS, or MeasurePF_BB.';
				case 3 % MeasurePF_BxPP_Nodes.TEMPLATE
					prop_default = Format.getFormatDefault(8, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				case 4 % MeasurePF_BxPP_Nodes.ID
					prop_default = 'MeasurePF_BxPP_Nodes ID';
				case 5 % MeasurePF_BxPP_Nodes.LABEL
					prop_default = 'MeasurePF_BxPP_Nodes label';
				case 6 % MeasurePF_BxPP_Nodes.NOTES
					prop_default = 'MeasurePF_BxPP_Nodes notes';
				case 22 % MeasurePF_BxPP_Nodes.EL
					prop_default = MeasurePF_BU();
				case 23 % MeasurePF_BxPP_Nodes.PROP
					prop_default = 39;
				case 24 % MeasurePF_BxPP_Nodes.HEIGHT
					prop_default = 48;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 19 % MeasurePF_BxPP_Nodes.X_DRAW
				...
				case 20 % MeasurePF_BxPP_Nodes.UPDATE
				...
				case 21 % MeasurePF_BxPP_Nodes.REDRAW
				...
				case 17 % MeasurePF_BxPP_Nodes.DELETE
