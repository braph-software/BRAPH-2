classdef GraphPP_MDict < PanelProp
	...
	%  <strong>39</strong> <strong>GUI_F_DICT</strong> 	GUI_F_DICT (gui, idict) contains the GUIs for the measure figures.
	%  <strong>40</strong> <strong>GUI_M_DICT</strong> 	GUI_M_DICT (gui, idict) contains the GUIs for the measures.
	%
	...
	properties (Constant) % properties
		...
		GUI_M_DICT = 40; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			switch category
				...
				case 8 % Category.FIGURE
					prop_list = 13;
				case 9 % Category.GUI
					prop_list = [8 12 24 25 35 36 39 40];
				otherwise
					prop_list = [];
			end
		end
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			graphpp_mdict_category_list = { 1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  9  9  7  7  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			graphpp_mdict_format_list = { 2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  22  13  18  18  10  10 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 35 % GraphPP_MDict.TABLE_HEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 36 % GraphPP_MDict.SELECTED
					prop_settings = Format.getFormatSettings(13);
				case 37 % GraphPP_MDict.TABLE
					prop_settings = Format.getFormatSettings(18);
				case 38 % GraphPP_MDict.CONTEXTMENU
					prop_settings = Format.getFormatSettings(18);
				case 39 % GraphPP_MDict.GUI_F_DICT
					prop_settings = 'GUIFig';
				case 40 % GraphPP_MDict.GUI_M_DICT
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 6 % GraphPP_MDict.NOTES
					prop_default = 'GraphPP_MDict';
				case 22 % GraphPP_MDict.EL
					prop_default = Graph();
				case 23 % GraphPP_MDict.PROP
					prop_default = 26;
				otherwise
