classdef GraphPP_MDict < PanelProp
	...
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the measure dictionary plot.
