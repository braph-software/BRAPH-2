classdef GraphPP_MDict < PanelProp
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the measure dictionary plot.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the measure dictionary plot.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the measure dictionary plot.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the measure dictionary plot.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the measure dictionary plot.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the measure dictionary plot.
	...
	%  <strong>38</strong> <strong>GUI_F_DICT</strong> 	GUI_F_DICT (gui, idict) contains the GUIs for the measure figures.
	%  <strong>39</strong> <strong>GUI_M_DICT</strong> 	GUI_M_DICT (gui, idict) contains the GUIs for the measures.
	%
	...
	properties (Constant) % properties
		...
		GUI_F_DICT = 38; %CET: Computational Efficiency Trick
		GUI_F_DICT_TAG = 'GUI_F_DICT';
		GUI_F_DICT_CATEGORY = 9;
		GUI_F_DICT_FORMAT = 10;
		
		GUI_M_DICT = 39; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			switch category
				...
				case 8 % Category.FIGURE
					prop_list = 12;
				case 9 % Category.GUI
					prop_list = [7 11 23 24 34 35 38 39];
				otherwise
					prop_list = [];
			end
		end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				graphpp_mdict_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'TABLE_HEIGHT'  'SELECTED'  'TABLE'  'CONTEXTMENU'  'GUI_F_DICT'  'GUI_M_DICT' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			graphpp_mdict_category_list = { 1  1  3  4  2  2  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  9  9  7  7  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			graphpp_mdict_format_list = { 2  2  8  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  22  13  18  18  10  10 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 34 % GraphPP_MDict.TABLE_HEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 35 % GraphPP_MDict.SELECTED
					prop_settings = Format.getFormatSettings(13);
				case 36 % GraphPP_MDict.TABLE
					prop_settings = Format.getFormatSettings(18);
				case 37 % GraphPP_MDict.CONTEXTMENU
					prop_settings = Format.getFormatSettings(18);
				case 38 % GraphPP_MDict.GUI_F_DICT
					prop_settings = 'GUIFig';
				case 39 % GraphPP_MDict.GUI_M_DICT
					prop_settings = 'GUIElement';
				case 3 % GraphPP_MDict.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 39 % GraphPP_MDict.GUI_M_DICT
					prop_default = Format.getFormatDefault(10, GraphPP_MDict.getPropSettings(prop));
				case 1 % GraphPP_MDict.NAME
					prop_default = 'GraphPP_MDict';
				case 2 % GraphPP_MDict.DESCRIPTION
				...
				case 4 % GraphPP_MDict.ID
					prop_default = 'GraphPP_MDict';
				case 5 % GraphPP_MDict.LABEL
					prop_default = 'GraphPP_MDict label';
				case 6 % GraphPP_MDict.NOTES
					prop_default = 'GraphPP_MDict';
				case 21 % GraphPP_MDict.EL
					prop_default = Graph();
				case 22 % GraphPP_MDict.PROP
					prop_default = 25;
				otherwise
