	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case MeasurePF_BU.LAYER
						tag = MeasurePF_BU.LAYER_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case MeasurePF_BU.LAYER
					prop_category = MeasurePF_BU.LAYER_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case MeasurePF_BU.LAYER
					prop_format = MeasurePF_BU.LAYER_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case MeasurePF_BU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the panel figure for binodal unilayer measure (MeasurPF_BU).';
		...
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case MeasurePF_BU.LAYER % __MeasurePF_BU.LAYER__
					check = Format.checkFormat(Format.SCALAR, value, MeasurePF_BU.getPropSettings(prop));
