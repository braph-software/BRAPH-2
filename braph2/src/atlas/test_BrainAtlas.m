...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	ba_1 = BrainAtlas( ...
		BrainAtlas.NAME, BrainAtlas.getNoValue(), ...
		BrainAtlas.DESCRIPTION, BrainAtlas.getNoValue(), ...
		BrainAtlas.TEMPLATE, ba_0.getCallback(3), ..., ...
		BrainAtlas.ID, ba_0.getCallback(4), ..., ...
		BrainAtlas.LABEL, BrainAtlas.getPropDefault(BrainAtlas.LABEL), ...
		BrainAtlas.NOTES, BrainAtlas.getPropDefault(BrainAtlas.NOTES), ...
		BrainAtlas.BR_DICT, ba_0.getCallback(7), ..., ...
		BrainAtlas.PFBA, ba_0.getCallback(8) ... ...
		);
	...
	ba_2 = BrainAtlas( ...
		BrainAtlas.NAME, BrainAtlas.getNoValue(), ...
		BrainAtlas.DESCRIPTION, BrainAtlas.getNoValue(), ...
		BrainAtlas.TEMPLATE, ba_1.getCallback(3), ..., ...
		BrainAtlas.ID, ba_1.getCallback(4), ..., ...
		BrainAtlas.LABEL, BrainAtlas.getPropDefault(BrainAtlas.LABEL), ...
		BrainAtlas.NOTES, BrainAtlas.getPropDefault(BrainAtlas.NOTES), ...
		BrainAtlas.BR_DICT, ba_1.getCallback(7), ..., ...
		BrainAtlas.PFBA, ba_1.getCallback(8) ... ...
		);
	...
	ba_3 = BrainAtlas( ...
		BrainAtlas.NAME, BrainAtlas.getNoValue(), ...
		BrainAtlas.DESCRIPTION, BrainAtlas.getNoValue(), ...
		BrainAtlas.TEMPLATE, ba_2.getCallback(3), ..., ...
		BrainAtlas.ID, ba_2.getCallback(4), ..., ...
		BrainAtlas.LABEL, BrainAtlas.getPropDefault(BrainAtlas.LABEL), ...
		BrainAtlas.NOTES, BrainAtlas.getPropDefault(BrainAtlas.NOTES), ...
		BrainAtlas.BR_DICT, ba_2.getCallback(7), ..., ...
		BrainAtlas.PFBA, ba_2.getCallback(8) ... ...
		);
