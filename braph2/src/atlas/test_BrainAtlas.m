...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	ba_1 = BrainAtlas( ...
		...
		BrainAtlas.NOTES, BrainAtlas.getPropDefault(BrainAtlas.NOTES), ...
		BrainAtlas.TOSTRING, BrainAtlas.getNoValue(), ...
		BrainAtlas.BR_DICT, ba_0.getCallback(8), ..., ...
		BrainAtlas.PFBA, ba_0.getCallback(9) ... ...
		);
	...
	ba_2 = BrainAtlas( ...
		...
		BrainAtlas.NOTES, BrainAtlas.getPropDefault(BrainAtlas.NOTES), ...
		BrainAtlas.TOSTRING, BrainAtlas.getNoValue(), ...
		BrainAtlas.BR_DICT, ba_1.getCallback(8), ..., ...
		BrainAtlas.PFBA, ba_1.getCallback(9) ... ...
		);
	...
	ba_3 = BrainAtlas( ...
		...
		BrainAtlas.NOTES, BrainAtlas.getPropDefault(BrainAtlas.NOTES), ...
		BrainAtlas.TOSTRING, BrainAtlas.getNoValue(), ...
		BrainAtlas.BR_DICT, ba_2.getCallback(8), ..., ...
		BrainAtlas.PFBA, ba_2.getCallback(9) ... ...
		);
