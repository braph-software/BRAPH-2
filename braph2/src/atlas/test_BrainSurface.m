...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	bs_1 = BrainSurface( ...
		BrainSurface.NAME, BrainSurface.getNoValue(), ...
		BrainSurface.DESCRIPTION, BrainSurface.getNoValue(), ...
		BrainSurface.TEMPLATE, bs_0.getCallback(3), ..., ...
		BrainSurface.ID, bs_0.getCallback(4), ..., ...
		BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
		BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
		BrainSurface.TOSTRING, BrainSurface.getNoValue(), ...
		BrainSurface.VERTEX_NUMBER, bs_0.getCallback(8), ..., ...
		BrainSurface.COORDINATES, bs_0.getCallback(9), ..., ...
		BrainSurface.TRIANGLES_NUMBER, bs_0.getCallback(10), ..., ...
		BrainSurface.TRIANGLES, bs_0.getCallback(11) ... ...
		);
	...
	bs_2 = BrainSurface( ...
		BrainSurface.NAME, BrainSurface.getNoValue(), ...
		BrainSurface.DESCRIPTION, BrainSurface.getNoValue(), ...
		BrainSurface.TEMPLATE, bs_1.getCallback(3), ..., ...
		BrainSurface.ID, bs_1.getCallback(4), ..., ...
		BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
		BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
		BrainSurface.TOSTRING, BrainSurface.getNoValue(), ...
		BrainSurface.VERTEX_NUMBER, bs_1.getCallback(8), ..., ...
		BrainSurface.COORDINATES, bs_1.getCallback(9), ..., ...
		BrainSurface.TRIANGLES_NUMBER, bs_1.getCallback(10), ..., ...
		BrainSurface.TRIANGLES, bs_1.getCallback(11) ... ...
		);
	...
	bs_3 = BrainSurface( ...
		BrainSurface.NAME, BrainSurface.getNoValue(), ...
		BrainSurface.DESCRIPTION, BrainSurface.getNoValue(), ...
		BrainSurface.TEMPLATE, bs_2.getCallback(3), ..., ...
		BrainSurface.ID, bs_2.getCallback(4), ..., ...
		BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
		BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
		BrainSurface.TOSTRING, BrainSurface.getNoValue(), ...
		BrainSurface.VERTEX_NUMBER, bs_2.getCallback(8), ..., ...
		BrainSurface.COORDINATES, bs_2.getCallback(9), ..., ...
		BrainSurface.TRIANGLES_NUMBER, bs_2.getCallback(10), ..., ...
		BrainSurface.TRIANGLES, bs_2.getCallback(11) ... ...
		);
