...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	bs_1 = BrainSurface( ...
		...
		BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
		BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
		BrainSurface.VERTEX_NUMBER, bs_0.getCallback(7), ..., ...
		BrainSurface.COORDINATES, bs_0.getCallback(8), ..., ...
		BrainSurface.TRIANGLES_NUMBER, bs_0.getCallback(9), ..., ...
		BrainSurface.TRIANGLES, bs_0.getCallback(10) ... ...
		);
	...
	bs_2 = BrainSurface( ...
		...
		BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
		BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
		BrainSurface.VERTEX_NUMBER, bs_1.getCallback(7), ..., ...
		BrainSurface.COORDINATES, bs_1.getCallback(8), ..., ...
		BrainSurface.TRIANGLES_NUMBER, bs_1.getCallback(9), ..., ...
		BrainSurface.TRIANGLES, bs_1.getCallback(10) ... ...
		);
	...
	bs_3 = BrainSurface( ...
		...
		BrainSurface.LABEL, BrainSurface.getPropDefault(BrainSurface.LABEL), ...
		BrainSurface.NOTES, BrainSurface.getPropDefault(BrainSurface.NOTES), ...
		BrainSurface.VERTEX_NUMBER, bs_2.getCallback(7), ..., ...
		BrainSurface.COORDINATES, bs_2.getCallback(8), ..., ...
		BrainSurface.TRIANGLES_NUMBER, bs_2.getCallback(9), ..., ...
		BrainSurface.TRIANGLES, bs_2.getCallback(10) ... ...
		);
