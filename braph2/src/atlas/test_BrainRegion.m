...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	br_1 = BrainRegion( ...
		...
		BrainRegion.LABEL, BrainRegion.getPropDefault(BrainRegion.LABEL), ...
		BrainRegion.NOTES, BrainRegion.getPropDefault(BrainRegion.NOTES), ...
		BrainRegion.X, br_0.getCallback(7), ..., ...
		BrainRegion.Y, br_0.getCallback(8), ..., ...
		BrainRegion.Z, br_0.getCallback(9) ... ...
		);
	...
	br_2 = BrainRegion( ...
		...
		BrainRegion.LABEL, BrainRegion.getPropDefault(BrainRegion.LABEL), ...
		BrainRegion.NOTES, BrainRegion.getPropDefault(BrainRegion.NOTES), ...
		BrainRegion.X, br_1.getCallback(7), ..., ...
		BrainRegion.Y, br_1.getCallback(8), ..., ...
		BrainRegion.Z, br_1.getCallback(9) ... ...
		);
	...
	br_3 = BrainRegion( ...
		...
		BrainRegion.LABEL, BrainRegion.getPropDefault(BrainRegion.LABEL), ...
		BrainRegion.NOTES, BrainRegion.getPropDefault(BrainRegion.NOTES), ...
		BrainRegion.X, br_2.getCallback(7), ..., ...
		BrainRegion.Y, br_2.getCallback(8), ..., ...
		BrainRegion.Z, br_2.getCallback(9) ... ...
		);
