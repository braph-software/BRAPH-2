...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	br_1 = BrainRegion( ...
		BrainRegion.NAME, BrainRegion.getNoValue(), ...
		BrainRegion.DESCRIPTION, BrainRegion.getNoValue(), ...
		BrainRegion.TEMPLATE, br_0.getCallback(3), ..., ...
		BrainRegion.ID, br_0.getCallback(4), ..., ...
		BrainRegion.LABEL, BrainRegion.getPropDefault(BrainRegion.LABEL), ...
		BrainRegion.NOTES, BrainRegion.getPropDefault(BrainRegion.NOTES), ...
		BrainRegion.TOSTRING, BrainRegion.getNoValue(), ...
		BrainRegion.X, br_0.getCallback(8), ..., ...
		BrainRegion.Y, br_0.getCallback(9), ..., ...
		BrainRegion.Z, br_0.getCallback(10) ... ...
		);
	...
	br_2 = BrainRegion( ...
		BrainRegion.NAME, BrainRegion.getNoValue(), ...
		BrainRegion.DESCRIPTION, BrainRegion.getNoValue(), ...
		BrainRegion.TEMPLATE, br_1.getCallback(3), ..., ...
		BrainRegion.ID, br_1.getCallback(4), ..., ...
		BrainRegion.LABEL, BrainRegion.getPropDefault(BrainRegion.LABEL), ...
		BrainRegion.NOTES, BrainRegion.getPropDefault(BrainRegion.NOTES), ...
		BrainRegion.TOSTRING, BrainRegion.getNoValue(), ...
		BrainRegion.X, br_1.getCallback(8), ..., ...
		BrainRegion.Y, br_1.getCallback(9), ..., ...
		BrainRegion.Z, br_1.getCallback(10) ... ...
		);
	...
	br_3 = BrainRegion( ...
		BrainRegion.NAME, BrainRegion.getNoValue(), ...
		BrainRegion.DESCRIPTION, BrainRegion.getNoValue(), ...
		BrainRegion.TEMPLATE, br_2.getCallback(3), ..., ...
		BrainRegion.ID, br_2.getCallback(4), ..., ...
		BrainRegion.LABEL, BrainRegion.getPropDefault(BrainRegion.LABEL), ...
		BrainRegion.NOTES, BrainRegion.getPropDefault(BrainRegion.NOTES), ...
		BrainRegion.TOSTRING, BrainRegion.getNoValue(), ...
		BrainRegion.X, br_2.getCallback(8), ..., ...
		BrainRegion.Y, br_2.getCallback(9), ..., ...
		BrainRegion.Z, br_2.getCallback(10) ... ...
		);
