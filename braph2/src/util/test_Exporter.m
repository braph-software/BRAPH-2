...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	ex_1 = Exporter( ...
		Exporter.NAME, Exporter.getNoValue(), ...
		Exporter.DESCRIPTION, Exporter.getNoValue(), ...
		Exporter.TEMPLATE, ex_0.getCallback(3), ..., ...
		Exporter.ID, ex_0.getCallback(4), ..., ...
		Exporter.LABEL, Exporter.getPropDefault(Exporter.LABEL), ...
		Exporter.NOTES, Exporter.getPropDefault(Exporter.NOTES), ...
		Exporter.WAITBAR, ex_0.getCallback(7) ... ...
		);
	...
	ex_2 = Exporter( ...
		Exporter.NAME, Exporter.getNoValue(), ...
		Exporter.DESCRIPTION, Exporter.getNoValue(), ...
		Exporter.TEMPLATE, ex_1.getCallback(3), ..., ...
		Exporter.ID, ex_1.getCallback(4), ..., ...
		Exporter.LABEL, Exporter.getPropDefault(Exporter.LABEL), ...
		Exporter.NOTES, Exporter.getPropDefault(Exporter.NOTES), ...
		Exporter.WAITBAR, ex_1.getCallback(7) ... ...
		);
	...
	ex_3 = Exporter( ...
		Exporter.NAME, Exporter.getNoValue(), ...
		Exporter.DESCRIPTION, Exporter.getNoValue(), ...
		Exporter.TEMPLATE, ex_2.getCallback(3), ..., ...
		Exporter.ID, ex_2.getCallback(4), ..., ...
		Exporter.LABEL, Exporter.getPropDefault(Exporter.LABEL), ...
		Exporter.NOTES, Exporter.getPropDefault(Exporter.NOTES), ...
		Exporter.WAITBAR, ex_2.getCallback(7) ... ...
		);
