...
for i = 1:1:length(analysis_class_list)
    ...
    comparison = Comparison.getComparison(comparison_class, 'c1', 'clabel1', 'cnotes1', atlas, 'Degree', group, group, 'setting name', 'setting value');
...
for i = 1:1:length(analysis_class_list)
    ...
    comparison = Comparison.getComparison(comparison_class, 'c1', 'clabel1', 'cnotes1', atlas, 'Degree', group, group, 'setting name', 'setting value');
    comparison2 = Comparison.getComparison(comparison_class, 'c2', 'clabel2', 'cnotes2', atlas, 'Degree', group, group, 'setting name', 'setting value');
    comparisons = {comparison, comparison2};
    % act
    analysis = Analysis.getAnalysis(analysis_class, 'analysis id', 'analysis label', 'analysis notes', cohort, measurements, {}, comparisons);
    analysis.getMeasurements().remove(2);
    analysis.getComparisons().remove(1);
    ...
    assert(analysis.getComparisons().length() == 1, ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.removeComparison() does not work')
end
...
for i = 1:1:length(analysis_class_list)
    ...
    analysis.getMeasurements().replace(measurement3.getID(), measurement3, 2);
    analysis.getComparisons().replace(comparison2.getID(), comparison2, 1);
    ...
    assert( isequal(analysis.getComparisons().getValue(1).getID(), comparison2.getID()), ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.replaceComparisons() does not work')
end
...
for i = 1:1:length(analysis_class_list)
    ...
    analysis.getComparisons().invert(2, 1);
    
    % assert
    assert( isequal(analysis.getMeasurements().getValue(2).getID(), measurement1.getID()), ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.invertMeasurements() does not work')
    
    assert( isequal(analysis.getComparisons().getValue(2).getID(), comparison.getID()), ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.invertComparisons() does not work')
end
...
for i = 1:1:length(analysis_class_list)
    ...
    analysis.getComparisons().move_to(2, 1);
    ...
    assert( isequal(analysis.getComparisons().getValue(1).getID(), comparison2.getID()), ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.movetoCompaisons() does not work')
end
...
for i = 1:1:length(analysis_class_list)
    ...
    selected_comparisons = analysis.getComparisons().remove_all([1, 2]);
    ...
    assert(analysis.getComparisons().length()==0, ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.removeComparisons() does not work')
end
...
for i = 1:1:length(analysis_class_list)
    ...
    comparison = Comparison.getComparison(comparison_class, 'c1', 'clabel1', 'cnotes1', atlas, 'Degree', group, group, 'setting name', 'setting value');
    comparison2 = Comparison.getComparison(comparison_class, 'c2', 'clabel2', 'cnotes2', atlas, 'Degree', group, group, 'setting name', 'setting value');
    comparison3 = Comparison.getComparison(comparison_class, 'c3', 'clabel3', 'cnotes3', atlas, 'Degree', group, group, 'setting name', 'setting value');
    comparisons = {comparison, comparison2, comparison3};
    
    % act
    analysis = Analysis.getAnalysis(analysis_class, 'analysis id', 'analysis label', 'analysis notes', cohort, measurements, {}, comparisons);
    selected = analysis.getMeasurements().move_up([2 3]);
    selected_comparisons = analysis.getComparisons().move_up([2 3]);
    ...
    assert( isequal(analysis.getComparisons().getValue(3).getID(), comparison.getID()), ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.moveupComparisons() does not work')
end
...
for i = 1:1:length(analysis_class_list)
    ...
    selected_comparisons = analysis.getComparisons().move_down([1 2]);
    ...
    assert( isequal(analysis.getComparisons().getValue(3).getID(), comparison2.getID()), ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.movedownMeasurements() does not work')
end
...
for i = 1:1:length(analysis_class_list)
    ...
    selected_comparisons = analysis.getComparisons().move_to_top([3]);
    ...
    assert( isequal(analysis.getComparisons().getValue(1).getID(), comparison3.getID()), ...
        [BRAPH2.STR ':' analysis_class ':' BRAPH2.BUG_FUNC], ...
        'Analysis.move2topMeasurements() does not work')
end
