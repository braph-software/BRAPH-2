...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	g_1 = OrdMxBU( ...
		OrdMxBU.NAME, OrdMxBU.getNoValue(), ...
		OrdMxBU.DESCRIPTION, OrdMxBU.getNoValue(), ...
		OrdMxBU.TEMPLATE, g_0.getCallback(3), ..., ...
		OrdMxBU.ID, g_0.getCallback(4), ..., ...
		OrdMxBU.LABEL, OrdMxBU.getPropDefault(OrdMxBU.LABEL), ...
		OrdMxBU.NOTES, OrdMxBU.getPropDefault(OrdMxBU.NOTES), ...
		OrdMxBU.TOSTRING, OrdMxBU.getNoValue(), ...
		OrdMxBU.GRAPH_TYPE, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.NODELABELS, OrdMxBU.getPropDefault(OrdMxBU.NODELABELS), ...
		OrdMxBU.ANODELABELS, OrdMxBU.getNoValue(), ...
		OrdMxBU.RANDOMIZE, g_0.getCallback(19), ..., ...
		OrdMxBU.RANDOM_SEED, g_0.getCallback(20), ..., ...
		OrdMxBU.A, OrdMxBU.getNoValue(), ...
		OrdMxBU.A_CHECK, OrdMxBU.getNoValue(), ...
		OrdMxBU.NODENUMBER, OrdMxBU.getNoValue(), ...
		OrdMxBU.LAYERNUMBER, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.COMPATIBLE_MEASURES, OrdMxBU.getNoValue(), ...
		OrdMxBU.MEASURE, OrdMxBU.getNoValue(), ...
		OrdMxBU.PFGA, g_0.getCallback(29), ..., ...
		OrdMxBU.PFGH, g_0.getCallback(30), ..., ...
		OrdMxBU.B, g_0.getCallback(31), ..., ...
		OrdMxBU.SYMMETRIZE_RULE, g_0.getCallback(32), ..., ...
		OrdMxBU.SEMIPOSITIVIZE_RULE, g_0.getCallback(33), ..., ...
		OrdMxBU.ATTEMPTSPEREDGE, g_0.getCallback(34), ..., ...
		OrdMxBU.RANDOMIZATION, OrdMxBU.getNoValue() ...
		);
	...
	g_2 = OrdMxBU( ...
		OrdMxBU.NAME, OrdMxBU.getNoValue(), ...
		OrdMxBU.DESCRIPTION, OrdMxBU.getNoValue(), ...
		OrdMxBU.TEMPLATE, g_1.getCallback(3), ..., ...
		OrdMxBU.ID, g_1.getCallback(4), ..., ...
		OrdMxBU.LABEL, OrdMxBU.getPropDefault(OrdMxBU.LABEL), ...
		OrdMxBU.NOTES, OrdMxBU.getPropDefault(OrdMxBU.NOTES), ...
		OrdMxBU.TOSTRING, OrdMxBU.getNoValue(), ...
		OrdMxBU.GRAPH_TYPE, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.NODELABELS, OrdMxBU.getPropDefault(OrdMxBU.NODELABELS), ...
		OrdMxBU.ANODELABELS, OrdMxBU.getNoValue(), ...
		OrdMxBU.RANDOMIZE, g_1.getCallback(19), ..., ...
		OrdMxBU.RANDOM_SEED, g_1.getCallback(20), ..., ...
		OrdMxBU.A, OrdMxBU.getNoValue(), ...
		OrdMxBU.A_CHECK, OrdMxBU.getNoValue(), ...
		OrdMxBU.NODENUMBER, OrdMxBU.getNoValue(), ...
		OrdMxBU.LAYERNUMBER, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.COMPATIBLE_MEASURES, OrdMxBU.getNoValue(), ...
		OrdMxBU.MEASURE, OrdMxBU.getNoValue(), ...
		OrdMxBU.PFGA, g_1.getCallback(29), ..., ...
		OrdMxBU.PFGH, g_1.getCallback(30), ..., ...
		OrdMxBU.B, g_1.getCallback(31), ..., ...
		OrdMxBU.SYMMETRIZE_RULE, g_1.getCallback(32), ..., ...
		OrdMxBU.SEMIPOSITIVIZE_RULE, g_1.getCallback(33), ..., ...
		OrdMxBU.ATTEMPTSPEREDGE, g_1.getCallback(34), ..., ...
		OrdMxBU.RANDOMIZATION, OrdMxBU.getNoValue() ...
		);
	...
	g_3 = OrdMxBU( ...
		OrdMxBU.NAME, OrdMxBU.getNoValue(), ...
		OrdMxBU.DESCRIPTION, OrdMxBU.getNoValue(), ...
		OrdMxBU.TEMPLATE, g_2.getCallback(3), ..., ...
		OrdMxBU.ID, g_2.getCallback(4), ..., ...
		OrdMxBU.LABEL, OrdMxBU.getPropDefault(OrdMxBU.LABEL), ...
		OrdMxBU.NOTES, OrdMxBU.getPropDefault(OrdMxBU.NOTES), ...
		OrdMxBU.TOSTRING, OrdMxBU.getNoValue(), ...
		OrdMxBU.GRAPH_TYPE, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.NODELABELS, OrdMxBU.getPropDefault(OrdMxBU.NODELABELS), ...
		OrdMxBU.ANODELABELS, OrdMxBU.getNoValue(), ...
		OrdMxBU.RANDOMIZE, g_2.getCallback(19), ..., ...
		OrdMxBU.RANDOM_SEED, g_2.getCallback(20), ..., ...
		OrdMxBU.A, OrdMxBU.getNoValue(), ...
		OrdMxBU.A_CHECK, OrdMxBU.getNoValue(), ...
		OrdMxBU.NODENUMBER, OrdMxBU.getNoValue(), ...
		OrdMxBU.LAYERNUMBER, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.COMPATIBLE_MEASURES, OrdMxBU.getNoValue(), ...
		OrdMxBU.MEASURE, OrdMxBU.getNoValue(), ...
		OrdMxBU.PFGA, g_2.getCallback(29), ..., ...
		OrdMxBU.PFGH, g_2.getCallback(30), ..., ...
		OrdMxBU.B, g_2.getCallback(31), ..., ...
		OrdMxBU.SYMMETRIZE_RULE, g_2.getCallback(32), ..., ...
		OrdMxBU.SEMIPOSITIVIZE_RULE, g_2.getCallback(33), ..., ...
		OrdMxBU.ATTEMPTSPEREDGE, g_2.getCallback(34), ..., ...
		OrdMxBU.RANDOMIZATION, OrdMxBU.getNoValue() ...
		);
