...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	g_1 = OrdMxBU( ...
		...
		OrdMxBU.NODELABELS, OrdMxBU.getPropDefault(OrdMxBU.NODELABELS), ...
		OrdMxBU.ANODELABELS, OrdMxBU.getNoValue(), ...
		OrdMxBU.RANDOMIZE, g_0.getCallback(20), ..., ...
		OrdMxBU.RANDOM_SEED, g_0.getCallback(21), ..., ...
		OrdMxBU.A, OrdMxBU.getNoValue(), ...
		OrdMxBU.A_CHECK, OrdMxBU.getNoValue(), ...
		OrdMxBU.NODENUMBER, OrdMxBU.getNoValue(), ...
		OrdMxBU.LAYERNUMBER, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.COMPATIBLE_MEASURES, OrdMxBU.getNoValue(), ...
		OrdMxBU.MEASURE, OrdMxBU.getNoValue(), ...
		OrdMxBU.PFGA, g_0.getCallback(30), ..., ...
		OrdMxBU.PFGH, g_0.getCallback(31), ..., ...
		OrdMxBU.B, g_0.getCallback(32), ..., ...
		OrdMxBU.SYMMETRIZE_RULE, g_0.getCallback(33), ..., ...
		OrdMxBU.SEMIPOSITIVIZE_RULE, g_0.getCallback(34), ..., ...
		OrdMxBU.ATTEMPTSPEREDGE, g_0.getCallback(35), ..., ...
		OrdMxBU.RANDOMIZATION, OrdMxBU.getNoValue() ...
		);
	...
	g_2 = OrdMxBU( ...
		...
		OrdMxBU.NODELABELS, OrdMxBU.getPropDefault(OrdMxBU.NODELABELS), ...
		OrdMxBU.ANODELABELS, OrdMxBU.getNoValue(), ...
		OrdMxBU.RANDOMIZE, g_1.getCallback(20), ..., ...
		OrdMxBU.RANDOM_SEED, g_1.getCallback(21), ..., ...
		OrdMxBU.A, OrdMxBU.getNoValue(), ...
		OrdMxBU.A_CHECK, OrdMxBU.getNoValue(), ...
		OrdMxBU.NODENUMBER, OrdMxBU.getNoValue(), ...
		OrdMxBU.LAYERNUMBER, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.COMPATIBLE_MEASURES, OrdMxBU.getNoValue(), ...
		OrdMxBU.MEASURE, OrdMxBU.getNoValue(), ...
		OrdMxBU.PFGA, g_1.getCallback(30), ..., ...
		OrdMxBU.PFGH, g_1.getCallback(31), ..., ...
		OrdMxBU.B, g_1.getCallback(32), ..., ...
		OrdMxBU.SYMMETRIZE_RULE, g_1.getCallback(33), ..., ...
		OrdMxBU.SEMIPOSITIVIZE_RULE, g_1.getCallback(34), ..., ...
		OrdMxBU.ATTEMPTSPEREDGE, g_1.getCallback(35), ..., ...
		OrdMxBU.RANDOMIZATION, OrdMxBU.getNoValue() ...
		);
	...
	g_3 = OrdMxBU( ...
		...
		OrdMxBU.NODELABELS, OrdMxBU.getPropDefault(OrdMxBU.NODELABELS), ...
		OrdMxBU.ANODELABELS, OrdMxBU.getNoValue(), ...
		OrdMxBU.RANDOMIZE, g_2.getCallback(20), ..., ...
		OrdMxBU.RANDOM_SEED, g_2.getCallback(21), ..., ...
		OrdMxBU.A, OrdMxBU.getNoValue(), ...
		OrdMxBU.A_CHECK, OrdMxBU.getNoValue(), ...
		OrdMxBU.NODENUMBER, OrdMxBU.getNoValue(), ...
		OrdMxBU.LAYERNUMBER, OrdMxBU.getNoValue(), ...
		...
		OrdMxBU.COMPATIBLE_MEASURES, OrdMxBU.getNoValue(), ...
		OrdMxBU.MEASURE, OrdMxBU.getNoValue(), ...
		OrdMxBU.PFGA, g_2.getCallback(30), ..., ...
		OrdMxBU.PFGH, g_2.getCallback(31), ..., ...
		OrdMxBU.B, g_2.getCallback(32), ..., ...
		OrdMxBU.SYMMETRIZE_RULE, g_2.getCallback(33), ..., ...
		OrdMxBU.SEMIPOSITIVIZE_RULE, g_2.getCallback(34), ..., ...
		OrdMxBU.ATTEMPTSPEREDGE, g_2.getCallback(35), ..., ...
		OrdMxBU.RANDOMIZATION, OrdMxBU.getNoValue() ...
		);
