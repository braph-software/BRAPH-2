	...
	methods (Access=protected) % calculate value
		function value = calculateValue(g, prop, varargin)
			...
			switch prop
				...
				case MultilayerBUT.ALAYERTICKS % __MultilayerBUT.ALAYERTICKS__
				...
				case MultilayerBUT.APARTITIONTICKS % __MultilayerBUT.APARTITIONTICKS__
