...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	g_1 = GraphBU( ...
		GraphBU.NAME, GraphBU.getNoValue(), ...
		GraphBU.DESCRIPTION, GraphBU.getNoValue(), ...
		GraphBU.TEMPLATE, g_0.getCallback(3), ..., ...
		GraphBU.ID, g_0.getCallback(4), ..., ...
		GraphBU.LABEL, GraphBU.getPropDefault(GraphBU.LABEL), ...
		GraphBU.NOTES, GraphBU.getPropDefault(GraphBU.NOTES), ...
		GraphBU.GRAPH_TYPE, GraphBU.getNoValue(), ...
		GraphBU.CONNECTIVITY_TYPE, GraphBU.getNoValue(), ...
		...
		GraphBU.NODELABELS, GraphBU.getPropDefault(GraphBU.NODELABELS), ...
		GraphBU.ANODELABELS, GraphBU.getNoValue(), ...
		GraphBU.RANDOMIZE, g_0.getCallback(18), ..., ...
		GraphBU.RANDOM_SEED, g_0.getCallback(19), ..., ...
		GraphBU.A, GraphBU.getNoValue(), ...
		GraphBU.A_CHECK, GraphBU.getNoValue(), ...
		GraphBU.NODENUMBER, GraphBU.getNoValue(), ...
		GraphBU.LAYERNUMBER, GraphBU.getNoValue(), ...
		...
		GraphBU.COMPATIBLE_MEASURES, GraphBU.getNoValue(), ...
		GraphBU.MEASURE, GraphBU.getNoValue(), ...
		GraphBU.PFGA, g_0.getCallback(28), ..., ...
		GraphBU.PFGH, g_0.getCallback(29), ..., ...
		GraphBU.B, g_0.getCallback(30), ..., ...
		GraphBU.SYMMETRIZE_RULE, g_0.getCallback(31), ..., ...
		GraphBU.SEMIPOSITIVIZE_RULE, g_0.getCallback(32), ..., ...
		GraphBU.ATTEMPTSPEREDGE, g_0.getCallback(33), ..., ...
		GraphBU.RANDOMIZATION, GraphBU.getNoValue() ...
		);
	...
	g_2 = GraphBU( ...
		GraphBU.NAME, GraphBU.getNoValue(), ...
		GraphBU.DESCRIPTION, GraphBU.getNoValue(), ...
		GraphBU.TEMPLATE, g_1.getCallback(3), ..., ...
		GraphBU.ID, g_1.getCallback(4), ..., ...
		GraphBU.LABEL, GraphBU.getPropDefault(GraphBU.LABEL), ...
		GraphBU.NOTES, GraphBU.getPropDefault(GraphBU.NOTES), ...
		GraphBU.GRAPH_TYPE, GraphBU.getNoValue(), ...
		GraphBU.CONNECTIVITY_TYPE, GraphBU.getNoValue(), ...
		...
		GraphBU.NODELABELS, GraphBU.getPropDefault(GraphBU.NODELABELS), ...
		GraphBU.ANODELABELS, GraphBU.getNoValue(), ...
		GraphBU.RANDOMIZE, g_1.getCallback(18), ..., ...
		GraphBU.RANDOM_SEED, g_1.getCallback(19), ..., ...
		GraphBU.A, GraphBU.getNoValue(), ...
		GraphBU.A_CHECK, GraphBU.getNoValue(), ...
		GraphBU.NODENUMBER, GraphBU.getNoValue(), ...
		GraphBU.LAYERNUMBER, GraphBU.getNoValue(), ...
		...
		GraphBU.COMPATIBLE_MEASURES, GraphBU.getNoValue(), ...
		GraphBU.MEASURE, GraphBU.getNoValue(), ...
		GraphBU.PFGA, g_1.getCallback(28), ..., ...
		GraphBU.PFGH, g_1.getCallback(29), ..., ...
		GraphBU.B, g_1.getCallback(30), ..., ...
		GraphBU.SYMMETRIZE_RULE, g_1.getCallback(31), ..., ...
		GraphBU.SEMIPOSITIVIZE_RULE, g_1.getCallback(32), ..., ...
		GraphBU.ATTEMPTSPEREDGE, g_1.getCallback(33), ..., ...
		GraphBU.RANDOMIZATION, GraphBU.getNoValue() ...
		);
	...
	g_3 = GraphBU( ...
		GraphBU.NAME, GraphBU.getNoValue(), ...
		GraphBU.DESCRIPTION, GraphBU.getNoValue(), ...
		GraphBU.TEMPLATE, g_2.getCallback(3), ..., ...
		GraphBU.ID, g_2.getCallback(4), ..., ...
		GraphBU.LABEL, GraphBU.getPropDefault(GraphBU.LABEL), ...
		GraphBU.NOTES, GraphBU.getPropDefault(GraphBU.NOTES), ...
		GraphBU.GRAPH_TYPE, GraphBU.getNoValue(), ...
		GraphBU.CONNECTIVITY_TYPE, GraphBU.getNoValue(), ...
		...
		GraphBU.NODELABELS, GraphBU.getPropDefault(GraphBU.NODELABELS), ...
		GraphBU.ANODELABELS, GraphBU.getNoValue(), ...
		GraphBU.RANDOMIZE, g_2.getCallback(18), ..., ...
		GraphBU.RANDOM_SEED, g_2.getCallback(19), ..., ...
		GraphBU.A, GraphBU.getNoValue(), ...
		GraphBU.A_CHECK, GraphBU.getNoValue(), ...
		GraphBU.NODENUMBER, GraphBU.getNoValue(), ...
		GraphBU.LAYERNUMBER, GraphBU.getNoValue(), ...
		...
		GraphBU.COMPATIBLE_MEASURES, GraphBU.getNoValue(), ...
		GraphBU.MEASURE, GraphBU.getNoValue(), ...
		GraphBU.PFGA, g_2.getCallback(28), ..., ...
		GraphBU.PFGH, g_2.getCallback(29), ..., ...
		GraphBU.B, g_2.getCallback(30), ..., ...
		GraphBU.SYMMETRIZE_RULE, g_2.getCallback(31), ..., ...
		GraphBU.SEMIPOSITIVIZE_RULE, g_2.getCallback(32), ..., ...
		GraphBU.ATTEMPTSPEREDGE, g_2.getCallback(33), ..., ...
		GraphBU.RANDOMIZATION, GraphBU.getNoValue() ...
		);
