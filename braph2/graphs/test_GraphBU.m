...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	g_1 = GraphBU( ...
		...
		GraphBU.NODELABELS, GraphBU.getPropDefault(GraphBU.NODELABELS), ...
		GraphBU.ANODELABELS, GraphBU.getNoValue(), ...
		GraphBU.RANDOMIZE, g_0.getCallback(20), ..., ...
		GraphBU.RANDOM_SEED, g_0.getCallback(21), ..., ...
		GraphBU.A, GraphBU.getNoValue(), ...
		GraphBU.A_CHECK, GraphBU.getNoValue(), ...
		GraphBU.NODENUMBER, GraphBU.getNoValue(), ...
		GraphBU.LAYERNUMBER, GraphBU.getNoValue(), ...
		...
		GraphBU.COMPATIBLE_MEASURES, GraphBU.getNoValue(), ...
		GraphBU.MEASURE, GraphBU.getNoValue(), ...
		GraphBU.PFGA, g_0.getCallback(30), ..., ...
		GraphBU.PFGH, g_0.getCallback(31), ..., ...
		GraphBU.B, g_0.getCallback(32), ..., ...
		GraphBU.SYMMETRIZE_RULE, g_0.getCallback(33), ..., ...
		GraphBU.SEMIPOSITIVIZE_RULE, g_0.getCallback(34), ..., ...
		GraphBU.ATTEMPTSPEREDGE, g_0.getCallback(35), ..., ...
		GraphBU.RANDOMIZATION, GraphBU.getNoValue() ...
		);
	...
	g_2 = GraphBU( ...
		...
		GraphBU.NODELABELS, GraphBU.getPropDefault(GraphBU.NODELABELS), ...
		GraphBU.ANODELABELS, GraphBU.getNoValue(), ...
		GraphBU.RANDOMIZE, g_1.getCallback(20), ..., ...
		GraphBU.RANDOM_SEED, g_1.getCallback(21), ..., ...
		GraphBU.A, GraphBU.getNoValue(), ...
		GraphBU.A_CHECK, GraphBU.getNoValue(), ...
		GraphBU.NODENUMBER, GraphBU.getNoValue(), ...
		GraphBU.LAYERNUMBER, GraphBU.getNoValue(), ...
		...
		GraphBU.COMPATIBLE_MEASURES, GraphBU.getNoValue(), ...
		GraphBU.MEASURE, GraphBU.getNoValue(), ...
		GraphBU.PFGA, g_1.getCallback(30), ..., ...
		GraphBU.PFGH, g_1.getCallback(31), ..., ...
		GraphBU.B, g_1.getCallback(32), ..., ...
		GraphBU.SYMMETRIZE_RULE, g_1.getCallback(33), ..., ...
		GraphBU.SEMIPOSITIVIZE_RULE, g_1.getCallback(34), ..., ...
		GraphBU.ATTEMPTSPEREDGE, g_1.getCallback(35), ..., ...
		GraphBU.RANDOMIZATION, GraphBU.getNoValue() ...
		);
	...
	g_3 = GraphBU( ...
		...
		GraphBU.NODELABELS, GraphBU.getPropDefault(GraphBU.NODELABELS), ...
		GraphBU.ANODELABELS, GraphBU.getNoValue(), ...
		GraphBU.RANDOMIZE, g_2.getCallback(20), ..., ...
		GraphBU.RANDOM_SEED, g_2.getCallback(21), ..., ...
		GraphBU.A, GraphBU.getNoValue(), ...
		GraphBU.A_CHECK, GraphBU.getNoValue(), ...
		GraphBU.NODENUMBER, GraphBU.getNoValue(), ...
		GraphBU.LAYERNUMBER, GraphBU.getNoValue(), ...
		...
		GraphBU.COMPATIBLE_MEASURES, GraphBU.getNoValue(), ...
		GraphBU.MEASURE, GraphBU.getNoValue(), ...
		GraphBU.PFGA, g_2.getCallback(30), ..., ...
		GraphBU.PFGH, g_2.getCallback(31), ..., ...
		GraphBU.B, g_2.getCallback(32), ..., ...
		GraphBU.SYMMETRIZE_RULE, g_2.getCallback(33), ..., ...
		GraphBU.SEMIPOSITIVIZE_RULE, g_2.getCallback(34), ..., ...
		GraphBU.ATTEMPTSPEREDGE, g_2.getCallback(35), ..., ...
		GraphBU.RANDOMIZATION, GraphBU.getNoValue() ...
		);
