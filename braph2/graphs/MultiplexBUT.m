classdef MultiplexBUT < MultiplexWU
	...
	%  <strong>28</strong> <strong>PARTITIONS</strong> 	PARTITIONS (result, rvector) returns the number of multiplex layers for each partition (threshold) of the graph.
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexbut_category_list = { 1  1  1  3  4  2  2  6  1  6  6  6  6  2  6  2  6  2  6  2  6  3  3  5  6  5  5  5  5  1  6  9  9  4  3  3  3  3  3  6  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexbut_format_list = { 2  2  2  8  2  2  2  2  11  15  15  15  11  12  12  3  3  3  3  3  3  4  11  16  4  12  11  12  10  7  8  8  8  16  5  5  5  11  11  16  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 41 % MultiplexBUT.THRESHOLDS
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 9 % MultiplexBUT.GRAPH_TYPE
					prop_default = 4;
				case 30 % MultiplexBUT.COMPATIBLE_MEASURES
				...
				case 38 % MultiplexBUT.ATTEMPTSPEREDGE
					prop_default = 5;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(g, prop, varargin)
			...
			switch prop
				...
				case 28 % MultiplexBUT.PARTITIONS
				...
				case 19 % MultiplexBUT.APARTITIONLABELS
				...
				case 40 % MultiplexBUT.RANDOMIZATION
