classdef OrdMxBU < Graph
	...
	%  <strong>24</strong> <strong>A</strong> 	A (result, cell) is the cell containing the multiplex binary adjacency matrices of the multiplex binary undirected graph.
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			switch category
				...
				case 3 % Category.PARAMETER
					prop_list = [4 22 23 35 36 37];
				case 4 % Category.DATA
					prop_list = [5 34];
				case 5 % Category.RESULT
					prop_list = [24 26 27 28 29];
				case 6 % Category.QUERY
					prop_list = [8 10 11 12 13 15 17 19 21 25 31 38];
				case 9 % Category.GUI
					prop_list = [32 33];
				otherwise
					prop_list = [];
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			ordmxbu_category_list = { 1  1  1  3  4  2  2  6  1  6  6  6  6  2  6  2  6  2  6  2  6  3  3  5  6  5  5  5  5  1  6  9  9  4  3  3  3  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			ordmxbu_format_list = { 2  2  2  8  2  2  2  2  11  15  15  15  11  12  12  3  3  3  3  3  3  4  11  16  4  12  11  12  10  7  8  8  8  16  5  5  11  16 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 35 % OrdMxBU.SYMMETRIZE_RULE
					prop_settings = {'max', 'sum', 'average', 'min'};
				case 36 % OrdMxBU.SEMIPOSITIVIZE_RULE
					prop_settings = {'zero', 'absolute'};
				case 37 % OrdMxBU.ATTEMPTSPEREDGE
					prop_settings = Format.getFormatSettings(11);
				case 38 % OrdMxBU.RANDOMIZATION
					prop_settings = Format.getFormatSettings(16);
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 9 % OrdMxBU.GRAPH_TYPE
					prop_default = 3;
				case 30 % OrdMxBU.COMPATIBLE_MEASURES
