classdef MultigraphBUT < GraphWU
	...
	%  <strong>19</strong> <strong>APARTITIONTICKS</strong> 	APARTITIONTICKS (query, stringlist) returns the partition (threshold) ticks for A.
