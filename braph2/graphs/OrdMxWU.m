classdef OrdMxWU < Graph
	...
	%  <strong>22</strong> <strong>A</strong> 	A (result, cell) is the cell containing the multiplex weighted adjacency matrices of the multiplex weighted undirected graph.
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			ordmxwu_category_list = { 1  1  1  3  4  2  2  6  1  6  6  6  6  2  6  2  6  2  6  3  3  5  6  5  5  5  5  1  6  9  9  4  3  3  3  3  3  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			ordmxwu_format_list = { 2  2  2  8  2  2  2  2  11  15  15  15  11  12  12  3  3  3  3  4  11  16  4  12  11  12  10  7  8  8  8  16  5  5  5  11  11  16 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 33 % OrdMxWU.SYMMETRIZE_RULE
					prop_settings = {'max', 'sum', 'average', 'min'};
				case 34 % OrdMxWU.SEMIPOSITIVIZE_RULE
					prop_settings = {'zero', 'absolute'};
				case 35 % OrdMxWU.STANDARDIZE_RULE
					prop_settings = {'threshold' 'range'};
				case 36 % OrdMxWU.ATTEMPTSPEREDGE
					prop_settings = Format.getFormatSettings(11);
				case 37 % OrdMxWU.NUMBEROFWEIGHTS
					prop_settings = Format.getFormatSettings(11);
				case 38 % OrdMxWU.RANDOMIZATION
					prop_settings = Format.getFormatSettings(16);
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 9 % OrdMxWU.GRAPH_TYPE
					prop_default = 3;
				case 28 % OrdMxWU.COMPATIBLE_MEASURES
