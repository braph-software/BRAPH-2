...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	g_1 = OrdMlWD( ...
		OrdMlWD.NAME, OrdMlWD.getNoValue(), ...
		OrdMlWD.DESCRIPTION, OrdMlWD.getNoValue(), ...
		OrdMlWD.TEMPLATE, g_0.getCallback(3), ..., ...
		OrdMlWD.ID, g_0.getCallback(4), ..., ...
		OrdMlWD.LABEL, OrdMlWD.getPropDefault(OrdMlWD.LABEL), ...
		OrdMlWD.NOTES, OrdMlWD.getPropDefault(OrdMlWD.NOTES), ...
		OrdMlWD.GRAPH_TYPE, OrdMlWD.getNoValue(), ...
		OrdMlWD.CONNECTIVITY_TYPE, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.NODELABELS, OrdMlWD.getPropDefault(OrdMlWD.NODELABELS), ...
		OrdMlWD.ANODELABELS, OrdMlWD.getNoValue(), ...
		OrdMlWD.RANDOMIZE, g_0.getCallback(18), ..., ...
		OrdMlWD.RANDOM_SEED, g_0.getCallback(19), ..., ...
		OrdMlWD.A, OrdMlWD.getNoValue(), ...
		OrdMlWD.A_CHECK, OrdMlWD.getNoValue(), ...
		OrdMlWD.NODENUMBER, OrdMlWD.getNoValue(), ...
		OrdMlWD.LAYERNUMBER, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.COMPATIBLE_MEASURES, OrdMlWD.getNoValue(), ...
		OrdMlWD.MEASURE, OrdMlWD.getNoValue(), ...
		OrdMlWD.PFGA, g_0.getCallback(28), ..., ...
		OrdMlWD.PFGH, g_0.getCallback(29), ..., ...
		OrdMlWD.B, g_0.getCallback(30), ..., ...
		OrdMlWD.SEMIPOSITIVIZE_RULE, g_0.getCallback(31), ..., ...
		OrdMlWD.STANDARDIZE_RULE, g_0.getCallback(32), ..., ...
		OrdMlWD.ATTEMPTSPEREDGE, g_0.getCallback(33), ..., ...
		OrdMlWD.NUMBEROFWEIGHTS, g_0.getCallback(34), ..., ...
		OrdMlWD.RANDOMIZATION, OrdMlWD.getNoValue() ...
		);
	...
	g_2 = OrdMlWD( ...
		OrdMlWD.NAME, OrdMlWD.getNoValue(), ...
		OrdMlWD.DESCRIPTION, OrdMlWD.getNoValue(), ...
		OrdMlWD.TEMPLATE, g_1.getCallback(3), ..., ...
		OrdMlWD.ID, g_1.getCallback(4), ..., ...
		OrdMlWD.LABEL, OrdMlWD.getPropDefault(OrdMlWD.LABEL), ...
		OrdMlWD.NOTES, OrdMlWD.getPropDefault(OrdMlWD.NOTES), ...
		OrdMlWD.GRAPH_TYPE, OrdMlWD.getNoValue(), ...
		OrdMlWD.CONNECTIVITY_TYPE, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.NODELABELS, OrdMlWD.getPropDefault(OrdMlWD.NODELABELS), ...
		OrdMlWD.ANODELABELS, OrdMlWD.getNoValue(), ...
		OrdMlWD.RANDOMIZE, g_1.getCallback(18), ..., ...
		OrdMlWD.RANDOM_SEED, g_1.getCallback(19), ..., ...
		OrdMlWD.A, OrdMlWD.getNoValue(), ...
		OrdMlWD.A_CHECK, OrdMlWD.getNoValue(), ...
		OrdMlWD.NODENUMBER, OrdMlWD.getNoValue(), ...
		OrdMlWD.LAYERNUMBER, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.COMPATIBLE_MEASURES, OrdMlWD.getNoValue(), ...
		OrdMlWD.MEASURE, OrdMlWD.getNoValue(), ...
		OrdMlWD.PFGA, g_1.getCallback(28), ..., ...
		OrdMlWD.PFGH, g_1.getCallback(29), ..., ...
		OrdMlWD.B, g_1.getCallback(30), ..., ...
		OrdMlWD.SEMIPOSITIVIZE_RULE, g_1.getCallback(31), ..., ...
		OrdMlWD.STANDARDIZE_RULE, g_1.getCallback(32), ..., ...
		OrdMlWD.ATTEMPTSPEREDGE, g_1.getCallback(33), ..., ...
		OrdMlWD.NUMBEROFWEIGHTS, g_1.getCallback(34), ..., ...
		OrdMlWD.RANDOMIZATION, OrdMlWD.getNoValue() ...
		);
	...
	g_3 = OrdMlWD( ...
		OrdMlWD.NAME, OrdMlWD.getNoValue(), ...
		OrdMlWD.DESCRIPTION, OrdMlWD.getNoValue(), ...
		OrdMlWD.TEMPLATE, g_2.getCallback(3), ..., ...
		OrdMlWD.ID, g_2.getCallback(4), ..., ...
		OrdMlWD.LABEL, OrdMlWD.getPropDefault(OrdMlWD.LABEL), ...
		OrdMlWD.NOTES, OrdMlWD.getPropDefault(OrdMlWD.NOTES), ...
		OrdMlWD.GRAPH_TYPE, OrdMlWD.getNoValue(), ...
		OrdMlWD.CONNECTIVITY_TYPE, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.NODELABELS, OrdMlWD.getPropDefault(OrdMlWD.NODELABELS), ...
		OrdMlWD.ANODELABELS, OrdMlWD.getNoValue(), ...
		OrdMlWD.RANDOMIZE, g_2.getCallback(18), ..., ...
		OrdMlWD.RANDOM_SEED, g_2.getCallback(19), ..., ...
		OrdMlWD.A, OrdMlWD.getNoValue(), ...
		OrdMlWD.A_CHECK, OrdMlWD.getNoValue(), ...
		OrdMlWD.NODENUMBER, OrdMlWD.getNoValue(), ...
		OrdMlWD.LAYERNUMBER, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.COMPATIBLE_MEASURES, OrdMlWD.getNoValue(), ...
		OrdMlWD.MEASURE, OrdMlWD.getNoValue(), ...
		OrdMlWD.PFGA, g_2.getCallback(28), ..., ...
		OrdMlWD.PFGH, g_2.getCallback(29), ..., ...
		OrdMlWD.B, g_2.getCallback(30), ..., ...
		OrdMlWD.SEMIPOSITIVIZE_RULE, g_2.getCallback(31), ..., ...
		OrdMlWD.STANDARDIZE_RULE, g_2.getCallback(32), ..., ...
		OrdMlWD.ATTEMPTSPEREDGE, g_2.getCallback(33), ..., ...
		OrdMlWD.NUMBEROFWEIGHTS, g_2.getCallback(34), ..., ...
		OrdMlWD.RANDOMIZATION, OrdMlWD.getNoValue() ...
		);
