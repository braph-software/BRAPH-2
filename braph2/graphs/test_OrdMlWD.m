...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	g_1 = OrdMlWD( ...
		...
		OrdMlWD.NODELABELS, OrdMlWD.getPropDefault(OrdMlWD.NODELABELS), ...
		OrdMlWD.ANODELABELS, OrdMlWD.getNoValue(), ...
		OrdMlWD.RANDOMIZE, g_0.getCallback(19), ..., ...
		OrdMlWD.RANDOM_SEED, g_0.getCallback(20), ..., ...
		OrdMlWD.A, OrdMlWD.getNoValue(), ...
		OrdMlWD.A_CHECK, OrdMlWD.getNoValue(), ...
		OrdMlWD.NODENUMBER, OrdMlWD.getNoValue(), ...
		OrdMlWD.LAYERNUMBER, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.COMPATIBLE_MEASURES, OrdMlWD.getNoValue(), ...
		OrdMlWD.MEASURE, OrdMlWD.getNoValue(), ...
		OrdMlWD.PFGA, g_0.getCallback(29), ..., ...
		OrdMlWD.PFGH, g_0.getCallback(30), ..., ...
		OrdMlWD.B, g_0.getCallback(31), ..., ...
		OrdMlWD.SEMIPOSITIVIZE_RULE, g_0.getCallback(32), ..., ...
		OrdMlWD.STANDARDIZE_RULE, g_0.getCallback(33), ..., ...
		OrdMlWD.ATTEMPTSPEREDGE, g_0.getCallback(34), ..., ...
		OrdMlWD.NUMBEROFWEIGHTS, g_0.getCallback(35), ..., ...
		OrdMlWD.RANDOMIZATION, OrdMlWD.getNoValue() ...
		);
	...
	g_2 = OrdMlWD( ...
		...
		OrdMlWD.NODELABELS, OrdMlWD.getPropDefault(OrdMlWD.NODELABELS), ...
		OrdMlWD.ANODELABELS, OrdMlWD.getNoValue(), ...
		OrdMlWD.RANDOMIZE, g_1.getCallback(19), ..., ...
		OrdMlWD.RANDOM_SEED, g_1.getCallback(20), ..., ...
		OrdMlWD.A, OrdMlWD.getNoValue(), ...
		OrdMlWD.A_CHECK, OrdMlWD.getNoValue(), ...
		OrdMlWD.NODENUMBER, OrdMlWD.getNoValue(), ...
		OrdMlWD.LAYERNUMBER, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.COMPATIBLE_MEASURES, OrdMlWD.getNoValue(), ...
		OrdMlWD.MEASURE, OrdMlWD.getNoValue(), ...
		OrdMlWD.PFGA, g_1.getCallback(29), ..., ...
		OrdMlWD.PFGH, g_1.getCallback(30), ..., ...
		OrdMlWD.B, g_1.getCallback(31), ..., ...
		OrdMlWD.SEMIPOSITIVIZE_RULE, g_1.getCallback(32), ..., ...
		OrdMlWD.STANDARDIZE_RULE, g_1.getCallback(33), ..., ...
		OrdMlWD.ATTEMPTSPEREDGE, g_1.getCallback(34), ..., ...
		OrdMlWD.NUMBEROFWEIGHTS, g_1.getCallback(35), ..., ...
		OrdMlWD.RANDOMIZATION, OrdMlWD.getNoValue() ...
		);
	...
	g_3 = OrdMlWD( ...
		...
		OrdMlWD.NODELABELS, OrdMlWD.getPropDefault(OrdMlWD.NODELABELS), ...
		OrdMlWD.ANODELABELS, OrdMlWD.getNoValue(), ...
		OrdMlWD.RANDOMIZE, g_2.getCallback(19), ..., ...
		OrdMlWD.RANDOM_SEED, g_2.getCallback(20), ..., ...
		OrdMlWD.A, OrdMlWD.getNoValue(), ...
		OrdMlWD.A_CHECK, OrdMlWD.getNoValue(), ...
		OrdMlWD.NODENUMBER, OrdMlWD.getNoValue(), ...
		OrdMlWD.LAYERNUMBER, OrdMlWD.getNoValue(), ...
		...
		OrdMlWD.COMPATIBLE_MEASURES, OrdMlWD.getNoValue(), ...
		OrdMlWD.MEASURE, OrdMlWD.getNoValue(), ...
		OrdMlWD.PFGA, g_2.getCallback(29), ..., ...
		OrdMlWD.PFGH, g_2.getCallback(30), ..., ...
		OrdMlWD.B, g_2.getCallback(31), ..., ...
		OrdMlWD.SEMIPOSITIVIZE_RULE, g_2.getCallback(32), ..., ...
		OrdMlWD.STANDARDIZE_RULE, g_2.getCallback(33), ..., ...
		OrdMlWD.ATTEMPTSPEREDGE, g_2.getCallback(34), ..., ...
		OrdMlWD.NUMBEROFWEIGHTS, g_2.getCallback(35), ..., ...
		OrdMlWD.RANDOMIZATION, OrdMlWD.getNoValue() ...
		);
