classdef GraphWU < Graph
	...
	%  <strong>24</strong> <strong>A</strong> 	A (result, cell) is the symmetric non-negative adjacency matrix of the weighted undirected graph.
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			graphwu_category_list = { 1  1  1  3  4  2  2  6  1  6  6  6  6  2  6  2  6  2  6  2  6  3  3  5  6  5  5  5  5  1  6  9  9  4  3  3  3  3  3  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			graphwu_format_list = { 2  2  2  8  2  2  2  2  11  15  15  15  11  12  12  3  3  3  3  3  3  4  11  16  4  12  11  12  10  7  8  8  8  15  5  5  5  11  11  16 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 35 % GraphWU.SYMMETRIZE_RULE
					prop_settings = {'max', 'sum', 'average', 'min'};
				case 36 % GraphWU.SEMIPOSITIVIZE_RULE
					prop_settings = {'zero', 'absolute'};
				case 37 % GraphWU.STANDARDIZE_RULE
					prop_settings = {'threshold' 'range'};
				case 38 % GraphWU.ATTEMPTSPEREDGE
					prop_settings = Format.getFormatSettings(11);
				case 39 % GraphWU.NUMBEROFWEIGHTS
					prop_settings = Format.getFormatSettings(11);
				case 40 % GraphWU.RANDOMIZATION
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 9 % GraphWU.GRAPH_TYPE
					prop_default = 1;
				case 30 % GraphWU.COMPATIBLE_MEASURES
