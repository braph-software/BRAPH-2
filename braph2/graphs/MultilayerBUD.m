classdef MultilayerBUD < MultilayerWU
	...
	%  <strong>19</strong> <strong>APARTITIONTICKS</strong> 	APARTITIONTICKS (query, stringlist) returns the partition (density) ticks for A.
