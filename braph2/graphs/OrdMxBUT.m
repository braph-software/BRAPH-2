		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case OrdMxBUT.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the ordinal multiplex binary undirected with fixed thresholds.';
				case OrdMxBUT.NAME
					prop_description = 'NAME (constant, string) is the name of the ordinal multiplex binary undirected with fixed thresholds.';
				...
				case OrdMxBUT.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the ordinal multiplex binary undirected with fixed thresholds.';
				case OrdMxBUT.ID
					prop_description = 'ID (data, string) is a few-letter code for the ordinal multiplex binary undirected with fixed thresholds.';
				case OrdMxBUT.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the ordinal multiplex binary undirected with fixed thresholds.';
				case OrdMxBUT.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the ordinal multiplex binary undirected with fixed thresholds.';
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(g, prop, varargin)
			...
			switch prop
				...
				case OrdMxBUT.ALAYERTICKS % __OrdMxBUT.ALAYERTICKS__
				...
				case OrdMxBUT.APARTITIONTICKS % __OrdMxBUT.APARTITIONTICKS__
