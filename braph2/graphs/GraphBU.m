classdef GraphBU < Graph
	...
	%  <strong>22</strong> <strong>A</strong> 	A (result, cell) is the symmetric binary adjacency matrix of the binary undirected graph.
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			graphbu_category_list = { 1  1  1  3  4  2  2  6  1  6  6  6  6  2  6  2  6  2  6  3  3  5  6  5  5  5  5  1  6  9  9  4  3  3  3  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			graphbu_format_list = { 2  2  2  8  2  2  2  2  11  15  15  15  11  12  12  3  3  3  3  4  11  16  4  12  11  12  10  7  8  8  8  15  5  5  11  16 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 33 % GraphBU.SYMMETRIZE_RULE
					prop_settings = {'max', 'sum', 'average', 'min'};
				case 34 % GraphBU.SEMIPOSITIVIZE_RULE
					prop_settings = {'zero', 'absolute'};
				case 35 % GraphBU.ATTEMPTSPEREDGE
					prop_settings = Format.getFormatSettings(11);
				case 36 % GraphBU.RANDOMIZATION
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 9 % GraphBU.GRAPH_TYPE
					prop_default = 1;
				case 28 % GraphBU.COMPATIBLE_MEASURES
	...
	methods % GUI
		function pr = getPanelProp(g, prop, varargin)
			...
			switch prop
				case 32 % GraphBU.B
					pr = PanelPropMatrix('EL', g, 'PROP', 32, ...
					    'TABLE_HEIGHT', 480, ...
