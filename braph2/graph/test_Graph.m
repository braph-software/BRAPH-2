...
directionality_type{11} = Graph.UNDIRECTED;
B{11} = {
    ones(3) [1 2; 3 4; 5 6]
    [1 2; 3 4; 5 6]' ones(2)
    };
...
directionality_type{12} = Graph.UNDIRECTED;
B{12} = {
    ones(3) [1 2; 3 4; 5 6]
    [1 2; 3 4; 6 5]' ones(2)
    };
...
for i = 1:1:length(graph_class_list)
    ...
    assert(isnumeric(g.getDirectionalityType()), ...
        [BRAPH2.STR ':' graph_class ':' BRAPH2.WRONG_OUTPUT], ...
    ...
    assert(iscell(Graph.getCompatibleMeasureList(g)), ...
        [BRAPH2.STR ':' graph_class ':' BRAPH2.WRONG_OUTPUT], ...
        [graph_class '.getCompatibleMeasureList() should return a cell array'])
    
    assert(isnumeric(Graph.getCompatibleMeasureNumber(g)), ...
        [BRAPH2.STR ':' graph_class ':' BRAPH2.WRONG_OUTPUT], ...
