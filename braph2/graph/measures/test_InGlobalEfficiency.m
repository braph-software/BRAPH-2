...
g = GraphBD(A);
in_global_efficiency = InGlobalEfficiency(g);

assert(isequal(in_global_efficiency.getValue(), known_in_global_efficiency), ...
...
known_in_global_efficiency = {[1/20 1/40 1/40 1/20 0]'};
...
assert(isequal(in_global_efficiency.getValue(), known_in_global_efficiency), ...
    [BRAPH2.STR ':InGlobalEfficiency:' BRAPH2.BUG_ERR], ...
    'InGlobalEfficiency is not being calculated correctly for GraphWD.')
...
assert(isequal(in_global_efficiency.getValue(), known_in_global_efficiency), ...
    [BRAPH2.STR ':InGlobalEfficiency:' BRAPH2.BUG_ERR], ...
    'InGlobalEfficiency is not being calculated correctly for MultiplexGraphWD.')
