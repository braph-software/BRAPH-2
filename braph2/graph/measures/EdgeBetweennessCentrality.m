classdef EdgeBetweennessCentrality < Measure
    ...
    % 
    % EdgeBetweennessCentrality descriptive methods (Static)
    ...
    %
    % See also Measure, GraphBU, GraphBD, GraphWU, GraphWD, MultiplexGraphBU, MultiplexGraphBD, MultiplexGraphWU, MultiplexGraphWD, Degree, Strength, BetweennessCentrality.
