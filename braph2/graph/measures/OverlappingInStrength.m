classdef OverlappingInStrength < InStrength
    ...
    %   getMeasure                  - returns the overlapping in-strength class
    ...
    methods (Static)  % Descriptive methods
        ...
        function parametricity = getParametricity()
            % GETPARAMETRICITY returns the parametricity of OverlappingInStrength
            %
            % PARAMETRICITY = GETPARAMETRICITY() returns the
            % parametricity of overlapping in-strength measure (NONPARAMETRIC).
            %
