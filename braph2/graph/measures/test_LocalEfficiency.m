...
[~, ~, local_efficiency_bct]= rout_efficiency(g.getA());

assert(isequal(local_efficiency{1}, local_efficiency_bct), ...
    [BRAPH2.STR ':LocalEfficiency:' BRAPH2.BUG_ERR], ...
    'LocalEfficiency is not being calculated correctly for BCT.')
