classdef MultiplexClustering < MultiplexTriangles
    ...
    methods (Static)
        ...
        function description = getDescription()
            ...
            description = [ ...
                'The two-multiplex clustering coefficient of a node is the fraction' ...
                'of two-multiplex triangles  with a vertex in node i and the number ' ...
                'of one-triads centered in i. ' ...
                ];
        end
