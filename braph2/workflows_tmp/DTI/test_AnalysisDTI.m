...
analysis = AnalysisDTI('analysis id', 'analysis label', 'analysis notes', cohort, {}, {}, {}); %#ok<NASGU>
...
assert(ischar(measurement_id), ...
    [BRAPH2.STR ':AnalysisDTI:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisDTI.getMeasurementID() not creating an ID')
assert(isequal(measurement_id, expected_value), ...
    [BRAPH2.STR ':AnalysisDTI:' BRAPH2.WRONG_OUTPUT], ...
    'AnalysisDTI.getMeasurementID() not creating correct ID')
...
for i = 1:1:length(measures)
    ...
    assert(~isempty(calculated_measurement), ...
        [BRAPH2.STR ':AnalysisDTI:' BRAPH2.BUG_FUNC], ...
        ['AnalysisDTI.getMeasurement() not working']) %#ok<*NBRAK>
    ...
    for j = 1:1:numel(measurement_keys)
        ...
        if Measure.is_global(measure)
            ...
            assert(isequal(calculated_measurement.getMeasureCode(), measure), ...
                [BRAPH2.STR ':AnalysisDTI:calculateMeasurement'], ...
            ...
            assert(iscell(calculated_value) & ...
                ...
                [BRAPH2.STR ':AnalysisDTI:Instantiation'], ...
...
for i = 1:1:numel(measures)
    ...
    assert(~isempty(calculated_comparison), ...
        [BRAPH2.STR ':AnalysisDTI:' BRAPH2.BUG_FUNC], ...
        'AnalysisDTI.getComparison() not working')
    ...
    if Measure.is_global(measures{i})
        ...
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisDTI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisDTI.getComparison() not working with global measures') 
    ...
    elseif Measure.is_nodal(measures{i})
        ...
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisDTI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisDTI.getComparison() not working with nodal measures') 
    ...
    elseif Measure.is_binodal(measures{i})
        ...
        assert(iscell(comparison_values_1) && ...
            ...
            [BRAPH2.STR ':AnalysisDTI:' BRAPH2.WRONG_OUTPUT], ...
            'AnalysisDTI.getComparison() not working with binodal measures') 
        ...
        assert(iscell(comparison_difference) && ...
            ...
            'AnalysisMRI.getComparison() not working with binodal measures') 
