...
% passes as a cell array. All copiable objects will be deep-copied (i.e.,
% the method copy() is called for all objects that have it).
%
% COPY = COPY_VARARGIN('PropertyName', PROPERTY, ... ) deep copy of
% VARARGIN is passes as a list of couples including a 'PropertyName' and a
% PROPERTY.
%
