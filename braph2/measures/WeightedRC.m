classdef WeightedRC < Strength
	...
	%  <strong>14</strong> <strong>WRC_PARAMETER</strong> 	WRC_PARAMETER (parameter, RVECTOR) is the threshold
	%
	...
	properties (Constant) % properties
		WRC_PARAMETER = 14; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function check_out = existsTag(tag)
			...
			check = any(strcmp(tag, { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'WRC_PARAMETER' })); %CET: Computational Efficiency Trick
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				prop = find(strcmp(pointer, { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'WRC_PARAMETER' })); % tag = pointer %CET: Computational Efficiency Trick
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				weightedrc_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'WRC_PARAMETER' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			weightedrc_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			weightedrc_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 14 % WeightedRC.WRC_PARAMETER
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 7 % WeightedRC.SHAPE
					prop_default = 2;
				case 8 % WeightedRC.SCOPE
					prop_default = 1;
				case 9 % WeightedRC.PARAMETRICITY
					prop_default = 2;
				case 10 % WeightedRC.COMPATIBLE_GRAPHS
