classdef EccentricityInAv < EccentricityIn
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the average eccentricity.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				eccentricityinav_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'RULE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			eccentricityinav_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			eccentricityinav_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8  5 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			eccentricityinav_description_list = { 'NAME (constant, string) is the name of the average eccentricity.'  'DESCRIPTION (constant, string) is the description of the average eccentricity.'  'TEMPLATE (parameter, item) is the template of the average eccentricity.'  'ID (data, string) is a few-letter code of the average eccentricity.'  'LABEL (metadata, string) is an extended label of the average eccentricity.'  'NOTES (metadata, string) are some specific notes about the average eccentricity.'  'SHAPE (constant, scalar) is the measure shape Measure.GLOBAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the average eccentricity.'  'PFM (gui, item) contains the panel figure of the measure.'  'RULE (parameter, OPTION)  % calculation in a graph or its subgraph' };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 7 % EccentricityInAv.SHAPE
					prop_default = 1;
				case 8 % EccentricityInAv.SCOPE
					prop_default = 2;
				case 9 % EccentricityInAv.PARAMETRICITY
					prop_default = 2;
				case 10 % EccentricityInAv.COMPATIBLE_GRAPHS
