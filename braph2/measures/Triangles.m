classdef Triangles < Measure
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the triangles.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the triangles.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the triangles.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the triangles.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the triangles.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the triangles.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				triangles_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'RULE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			triangles_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			triangles_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8  5 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			triangles_description_list = { 'NAME (constant, string) is the name of the triangles.'  'DESCRIPTION (constant, string) is the description of the triangles.'  'TEMPLATE (parameter, item) is the template of the triangles.'  'ID (data, string) is a few-letter code of the triangles.'  'LABEL (metadata, string) is an extended label of the triangles.'  'NOTES (metadata, string) are some specific notes about the triangles.'  'SHAPE (constant, scalar) is the measure shape Measure.NODAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the triangles.'  'PFM (gui, item) contains the panel figure of the measure.'  'RULE (parameter, option) is the rule to determine what is a triangle in a directed graph.' };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 14 % Triangles.RULE
					prop_settings = {'all' 'middleman' 'in' 'out' 'cycle'};
				case 3 % Triangles.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 14 % Triangles.RULE
					prop_default = 'cycle';
				case 1 % Triangles.NAME
					prop_default = 'Triangles';
				case 2 % Triangles.DESCRIPTION
				...
				case 5 % Triangles.LABEL
					prop_default = 'Triangles label';
				case 6 % Triangles.NOTES
					prop_default = 'Triangles notes';
				case 7 % Triangles.SHAPE
					prop_default = 2;
				case 8 % Triangles.SCOPE
					prop_default = 2;
				case 9 % Triangles.PARAMETRICITY
					prop_default = 2;
				case 10 % Triangles.COMPATIBLE_GRAPHS
