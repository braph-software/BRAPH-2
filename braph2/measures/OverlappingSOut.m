classdef OverlappingSOut < StrengthOut
	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case OverlappingSOut.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the Overlapping Out-Strength.';
				case OverlappingSOut.NAME
					prop_description = 'NAME (constant, string) is the name of the Overlapping Out-Strength.';
				case OverlappingSOut.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the Overlapping Out-Strength.';
				case OverlappingSOut.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the Overlapping Out-Strength.';
				case OverlappingSOut.ID
					prop_description = 'ID (data, string) is a few-letter code of the Overlapping Out-Strength.';
				case OverlappingSOut.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the Overlapping Out-Strength.';
				case OverlappingSOut.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the Overlapping Out-Strength.';
