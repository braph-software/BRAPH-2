classdef MultiRC < Richness
	...
	properties (Constant) % properties
		MULTIRICHNESS_COEFFICIENTS = 14; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				multirc_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'MULTIRICHNESS_COEFFICIENTS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			multirc_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			multirc_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 14 % MultiRC.MULTIRICHNESS_COEFFICIENTS
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 7 % MultiRC.SHAPE
					prop_default = 2;
				case 8 % MultiRC.SCOPE
					prop_default = 1;
				case 9 % MultiRC.PARAMETRICITY
					prop_default = 2;
				case 10 % MultiRC.COMPATIBLE_GRAPHS
