	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				overlappingsoutav_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			overlappingsoutav_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			overlappingsoutav_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 3 % OverlappingSOutAv.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % OverlappingSOutAv.NAME
					prop_default = 'OverlappingSOutAv';
				case 2 % OverlappingSOutAv.DESCRIPTION
				...
				case 4 % OverlappingSOutAv.ID
					prop_default = 'OverlappingSOutAv ID';
				case 5 % OverlappingSOutAv.LABEL
					prop_default = 'OverlappingSOutAv label';
				case 6 % OverlappingSOutAv.NOTES
					prop_default = 'OverlappingSOutAv notes';
				case 7 % OverlappingSOutAv.SHAPE
					prop_default = 1;
				case 8 % OverlappingSOutAv.SCOPE
					prop_default = 1;
				case 9 % OverlappingSOutAv.PARAMETRICITY
					prop_default = 2;
				case 10 % OverlappingSOutAv.COMPATIBLE_GRAPHS
