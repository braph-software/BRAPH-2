...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	m_1 = OverlappingSOut( ...
		...
		OverlappingSOut.PARAMETRICITY, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.COMPATIBLE_GRAPHS, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.G, m_0.getCallback(12), ..., ...
		OverlappingSOut.M, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.PFM, m_0.getCallback(14) ... ...
		);
	...
	m_2 = OverlappingSOut( ...
		...
		OverlappingSOut.PARAMETRICITY, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.COMPATIBLE_GRAPHS, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.G, m_1.getCallback(12), ..., ...
		OverlappingSOut.M, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.PFM, m_1.getCallback(14) ... ...
		);
	...
	m_3 = OverlappingSOut( ...
		...
		OverlappingSOut.PARAMETRICITY, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.COMPATIBLE_GRAPHS, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.G, m_2.getCallback(12), ..., ...
		OverlappingSOut.M, OverlappingSOut.getNoValue(), ...
		OverlappingSOut.PFM, m_2.getCallback(14) ... ...
		);
