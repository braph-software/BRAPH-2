classdef BetweennessCentrality < Measure
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the betweenness centrality.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the betweenness centrality.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the betweenness centrality.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the betweenness centrality.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the betweenness centrality.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the betweenness centrality.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the cell containing betweenness centrality.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				betweennesscentrality_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			betweennesscentrality_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			betweennesscentrality_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % BetweennessCentrality.NAME
				...
				case 6 % BetweennessCentrality.NOTES
					prop_default = 'BetweennessCentrality notes';
				case 7 % BetweennessCentrality.SHAPE
					prop_default = 2;
				case 8 % BetweennessCentrality.SCOPE
					prop_default = 2;
				case 9 % BetweennessCentrality.PARAMETRICITY
					prop_default = 2;
				case 10 % BetweennessCentrality.COMPATIBLE_GRAPHS
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(m, prop, varargin)
			...
			switch prop
				case 12 % BetweennessCentrality.M
