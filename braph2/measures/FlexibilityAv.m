classdef FlexibilityAv < Flexibility
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the average flexibility.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the average flexibility.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the average flexibility.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the average flexibility.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the average flexibility.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the average flexibility.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the average flexibility.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				flexibilityav_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'LIMIT'  'RANDORD'  'RANDMOVE'  'GAMMA'  'OMEGA'  'S0'  'OM'  'QUALITY_FUNCTION' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			flexibilityav_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9  3  3  3  3  3  4  4  4 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			flexibilityav_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8  11  4  4  11  11  13  14  14 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 6 % FlexibilityAv.NOTES
					prop_default = 'FlexibilityAv notes';
				case 7 % FlexibilityAv.SHAPE
					prop_default = 1;
				case 8 % FlexibilityAv.SCOPE
					prop_default = 1;
				case 9 % FlexibilityAv.PARAMETRICITY
					prop_default = 2;
				case 10 % FlexibilityAv.COMPATIBLE_GRAPHS
