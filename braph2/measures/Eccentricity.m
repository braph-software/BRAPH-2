classdef Eccentricity < Measure
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the eccentricity.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the eccentricity.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the eccentricity.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the eccentricity.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the eccentricity.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the eccentricity.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the eccentricity.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				eccentricity_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'RULE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			eccentricity_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			eccentricity_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8  5 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			eccentricity_description_list = { 'NAME (constant, string) is the name of the eccentricity.'  'DESCRIPTION (constant, string) is the description of the eccentricity.'  'TEMPLATE (parameter, item) is the template of the eccentricity.'  'ID (data, string) is a few-letter code of the eccentricity.'  'LABEL (metadata, string) is an extended label of the eccentricity.'  'NOTES (metadata, string) are some specific notes about the eccentricity.'  'SHAPE (constant, scalar) is the measure shape Measure.NODAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the eccentricity.'  'PFM (gui, item) contains the panel figure of the measure.'  'RULE (parameter, OPTION)  % calculation in a graph or its subgraph' };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 6 % Eccentricity.NOTES
					prop_default = 'Eccentricity notes';
				case 7 % Eccentricity.SHAPE
					prop_default = 2;
				case 8 % Eccentricity.SCOPE
					prop_default = 2;
				case 9 % Eccentricity.PARAMETRICITY
					prop_default = 2;
				case 10 % Eccentricity.COMPATIBLE_GRAPHS
