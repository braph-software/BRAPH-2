classdef Richness < Degree
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the richness.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the richness.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the richness.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the richness.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the richness.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the richness.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the richness.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				richness_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			richness_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			richness_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			richness_description_list = { 'NAME (constant, string) is the name of the richness.'  'DESCRIPTION (constant, string) is the description of the richness.'  'TEMPLATE (parameter, item) is the template of the richness.'  'ID (data, string) is a few-letter code of the richness.'  'LABEL (metadata, string) is an extended label of the richness.'  'NOTES (metadata, string) are some specific notes about the richness.'  'SHAPE (constant, scalar) is the measure shape Measure.NODAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the richness.'  'PFM (gui, item) contains the panel figure of the measure.' };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 6 % Richness.NOTES
					prop_default = 'Richness notes';
				case 7 % Richness.SHAPE
					prop_default = 2;
				case 8 % Richness.SCOPE
					prop_default = 2;
				case 9 % Richness.PARAMETRICITY
					prop_default = 2;
				case 10 % Richness.COMPATIBLE_GRAPHS
