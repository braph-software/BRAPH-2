	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				overlappings_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			overlappings_category_list = { 1  1  3  4  2  2  6  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			overlappings_format_list = { 2  2  8  2  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % OverlappingS.NAME
					prop_default = 'OverlappingS';
				case 2 % OverlappingS.DESCRIPTION
				...
				case 4 % OverlappingS.ID
					prop_default = 'OverlappingS ID';
				case 5 % OverlappingS.LABEL
					prop_default = 'OverlappingS label';
				case 6 % OverlappingS.NOTES
					prop_default = 'OverlappingS notes';
				case 8 % OverlappingS.SHAPE
					prop_default = 2;
				case 9 % OverlappingS.SCOPE
					prop_default = 1;
				case 10 % OverlappingS.PARAMETRICITY
					prop_default = 2;
				case 11 % OverlappingS.COMPATIBLE_GRAPHS
