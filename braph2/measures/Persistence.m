classdef Persistence < MultilayerCommunity
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the persistence.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the persistence.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the persistence.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the persistence.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the persistence.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the persistence.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the categorical persistence.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				persistence_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'LIMIT'  'RANDORD'  'RANDMOVE'  'GAMMA'  'OMEGA'  'S0'  'OM'  'QUALITY_FUNCTION' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			persistence_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9  3  3  3  3  3  4  4  4 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			persistence_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8  11  4  4  11  11  13  14  14 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % Persistence.NAME
					prop_default = 'Persistence';
				case 2 % Persistence.DESCRIPTION
				...
				case 4 % Persistence.ID
					prop_default = 'Persistence ID';
				case 5 % Persistence.LABEL
					prop_default = 'Persistence label';
				case 6 % Persistence.NOTES
					prop_default = 'Persistence notes';
				case 7 % Persistence.SHAPE
					prop_default = 1;
				case 8 % Persistence.SCOPE
					prop_default = 1;
				case 9 % Persistence.PARAMETRICITY
					prop_default = 2;
				case 10 % Persistence.COMPATIBLE_GRAPHS
