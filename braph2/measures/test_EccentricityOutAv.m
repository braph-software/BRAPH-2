...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	m_1 = EccentricityOutAv( ...
		...
		EccentricityOutAv.PARAMETRICITY, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.COMPATIBLE_GRAPHS, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.G, m_0.getCallback(11), ..., ...
		EccentricityOutAv.M, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.PFM, m_0.getCallback(13), ..., ...
		EccentricityOutAv.RULE, m_0.getCallback(14) ... ...
		);
	...
	m_2 = EccentricityOutAv( ...
		...
		EccentricityOutAv.PARAMETRICITY, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.COMPATIBLE_GRAPHS, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.G, m_1.getCallback(11), ..., ...
		EccentricityOutAv.M, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.PFM, m_1.getCallback(13), ..., ...
		EccentricityOutAv.RULE, m_1.getCallback(14) ... ...
		);
	...
	m_3 = EccentricityOutAv( ...
		...
		EccentricityOutAv.PARAMETRICITY, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.COMPATIBLE_GRAPHS, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.G, m_2.getCallback(11), ..., ...
		EccentricityOutAv.M, EccentricityOutAv.getNoValue(), ...
		EccentricityOutAv.PFM, m_2.getCallback(13), ..., ...
		EccentricityOutAv.RULE, m_2.getCallback(14) ... ...
		);
