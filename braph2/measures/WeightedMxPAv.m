classdef WeightedMxPAv < WeightedMxP
	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case WeightedMxPAv.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the Average Weighted Multiplex Participation.';
				case WeightedMxPAv.NAME
					prop_description = 'NAME (constant, string) is the name of the Average Weighted Multiplex Participation.';
				case WeightedMxPAv.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the Average Weighted Multiplex Participation.';
				case WeightedMxPAv.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the Average Weighted Multiplex Participation.';
				case WeightedMxPAv.ID
					prop_description = 'ID (data, string) is a few-letter code of the Average Weighted Multiplex Participation.';
				case WeightedMxPAv.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the Average Weighted Multiplex Participation.';
				case WeightedMxPAv.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the Average Weighted Multiplex Participation.';
