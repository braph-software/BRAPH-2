classdef AssortInOut < Measure
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the in-out-assortativity.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the in-out-assortativity.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the in-out-assortativity.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the in-out-assortativity.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the in-out-assortativity.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the in-out-assortativity.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the in-out-assortativity.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				assortinout_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			assortinout_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			assortinout_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			assortinout_description_list = { 'NAME (constant, string) is the name of the in-out-assortativity.'  'DESCRIPTION (constant, string) is the description of the in-out-assortativity.'  'TEMPLATE (parameter, item) is the template of the in-out-assortativity.'  'ID (data, string) is a few-letter code of the in-out-assortativity.'  'LABEL (metadata, string) is an extended label of the in-out-assortativity.'  'NOTES (metadata, string) are some specific notes about the in-out-assortativity.'  'SHAPE (constant, scalar) is the measure shape Measure.GLOBAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the in-out-assortativity.'  'PFM (gui, item) contains the panel figure of the measure.' };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % AssortInOut.NAME
					prop_default = 'AssortInOut';
				case 2 % AssortInOut.DESCRIPTION
				...
				case 4 % AssortInOut.ID
					prop_default = 'AssortInOut ID';
				case 5 % AssortInOut.LABEL
					prop_default = 'AssortInOut label';
				case 6 % AssortInOut.NOTES
					prop_default = 'AssortInOut notes';
				case 7 % AssortInOut.SHAPE
					prop_default = 1;
				case 8 % AssortInOut.SCOPE
					prop_default = 2;
				case 9 % AssortInOut.PARAMETRICITY
					prop_default = 2;
				case 10 % AssortInOut.COMPATIBLE_GRAPHS
