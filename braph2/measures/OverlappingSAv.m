	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				overlappingsav_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			overlappingsav_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			overlappingsav_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 3 % OverlappingSAv.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % OverlappingSAv.NAME
					prop_default = 'OverlappingSAv';
				case 2 % OverlappingSAv.DESCRIPTION
				...
				case 4 % OverlappingSAv.ID
					prop_default = 'OverlappingSAv ID';
				case 5 % OverlappingSAv.LABEL
					prop_default = 'OverlappingSAv label';
				case 6 % OverlappingSAv.NOTES
					prop_default = 'OverlappingSAv notes';
				case 7 % OverlappingSAv.SHAPE
					prop_default = 1;
				case 8 % OverlappingSAv.SCOPE
					prop_default = 1;
				case 9 % OverlappingSAv.PARAMETRICITY
					prop_default = 2;
				case 10 % OverlappingSAv.COMPATIBLE_GRAPHS
