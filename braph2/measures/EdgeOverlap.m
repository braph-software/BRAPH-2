classdef EdgeOverlap < Measure
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the edge overlap.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the edge overlap.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the edge overlap.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the edge overlap.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the edge overlap.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the edge overlap.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the edge overlap.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				edgeoverlap_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			edgeoverlap_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			edgeoverlap_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			edgeoverlap_description_list = { 'NAME (constant, string) is the name of the edge overlap.'  'DESCRIPTION (constant, string) is the description of the edge overlap.'  'TEMPLATE (parameter, item) is the template of the edge overlap.'  'ID (data, string) is a few-letter code of the edge overlap.'  'LABEL (metadata, string) is an extended label of the edge overlap.'  'NOTES (metadata, string) are some specific notes about the edge overlap.'  'SHAPE (constant, scalar) is the measure shape Measure.NODAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the edge overlap.'  'PFM (gui, item) contains the panel figure of the measure.' };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % EdgeOverlap.NAME
					prop_default = 'EdgeOverlap';
				case 2 % EdgeOverlap.DESCRIPTION
				...
				case 4 % EdgeOverlap.ID
					prop_default = 'EdgeOverlap ID';
				case 5 % EdgeOverlap.LABEL
					prop_default = 'EdgeOverlap label';
				case 6 % EdgeOverlap.NOTES
					prop_default = 'EdgeOverlap notes';
				case 7 % EdgeOverlap.SHAPE
					prop_default = 3;
				case 8 % EdgeOverlap.SCOPE
					prop_default = 1;
				case 9 % EdgeOverlap.PARAMETRICITY
					prop_default = 2;
				case 10 % EdgeOverlap.COMPATIBLE_GRAPHS
