	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				overlappingsinav_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			overlappingsinav_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			overlappingsinav_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 3 % OverlappingSInAv.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % OverlappingSInAv.NAME
					prop_default = 'OverlappingSInAv';
				case 2 % OverlappingSInAv.DESCRIPTION
				...
				case 4 % OverlappingSInAv.ID
					prop_default = 'OverlappingSInAv ID';
				case 5 % OverlappingSInAv.LABEL
					prop_default = 'OverlappingSInAv label';
				case 6 % OverlappingSInAv.NOTES
					prop_default = 'OverlappingSInAv notes';
				case 7 % OverlappingSInAv.SHAPE
					prop_default = 1;
				case 8 % OverlappingSInAv.SCOPE
					prop_default = 1;
				case 9 % OverlappingSInAv.PARAMETRICITY
					prop_default = 2;
				case 10 % OverlappingSInAv.COMPATIBLE_GRAPHS
