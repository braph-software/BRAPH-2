classdef GlobalEfficiencyOut < Distance
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the GlobalEfficiencyOut.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the GlobalEfficiencyOut.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the GlobalEfficiencyOut.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the GlobalEfficiencyOut.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the GlobalEfficiencyOut.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the GlobalEfficiencyOut.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the out-global efficiency.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				globalefficiencyout_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			globalefficiencyout_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			globalefficiencyout_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			globalefficiencyout_description_list = { 'NAME (constant, string) is the name of the GlobalEfficiencyOut.'  'DESCRIPTION (constant, string) is the description of the GlobalEfficiencyOut.'  'TEMPLATE (parameter, item) is the template of the GlobalEfficiencyOut.'  'ID (data, string) is a few-letter code of the GlobalEfficiencyOut.'  'LABEL (metadata, string) is an extended label of the GlobalEfficiencyOut.'  'NOTES (metadata, string) are some specific notes about the GlobalEfficiencyOut.'  'SHAPE (constant, scalar) is the measure shape Measure.NODAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the out-global efficiency.'  'PFM (gui, item) contains the panel figure of the measure.' };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 3 % GlobalEfficiencyOut.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % GlobalEfficiencyOut.NAME
					prop_default = 'GlobalEfficiencyOut';
				case 2 % GlobalEfficiencyOut.DESCRIPTION
				...
				case 4 % GlobalEfficiencyOut.ID
					prop_default = 'GlobalEfficiencyOut ID';
				case 5 % GlobalEfficiencyOut.LABEL
					prop_default = 'GlobalEfficiencyOut label';
				case 6 % GlobalEfficiencyOut.NOTES
					prop_default = 'GlobalEfficiencyOut notes';
				case 7 % GlobalEfficiencyOut.SHAPE
					prop_default = 2;
				case 8 % GlobalEfficiencyOut.SCOPE
					prop_default = 2;
				case 9 % GlobalEfficiencyOut.PARAMETRICITY
					prop_default = 2;
				case 10 % GlobalEfficiencyOut.COMPATIBLE_GRAPHS
