classdef LocalEfficiencyAv < LocalEfficiency
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is theaverage local efficiency.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				localefficiencyav_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			localefficiencyav_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			localefficiencyav_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 3 % LocalEfficiencyAv.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % LocalEfficiencyAv.NAME
					prop_default = 'LocalEfficiencyAv';
				case 2 % LocalEfficiencyAv.DESCRIPTION
				...
				case 4 % LocalEfficiencyAv.ID
					prop_default = 'LocalEfficiencyAv ID';
				case 5 % LocalEfficiencyAv.LABEL
					prop_default = 'LocalEfficiencyAv label';
				case 6 % LocalEfficiencyAv.NOTES
					prop_default = 'LocalEfficiencyAv notes';
				case 7 % LocalEfficiencyAv.SHAPE
					prop_default = 1;
				case 8 % LocalEfficiencyAv.SCOPE
					prop_default = 2;
				case 9 % LocalEfficiencyAv.PARAMETRICITY
					prop_default = 2;
				otherwise
