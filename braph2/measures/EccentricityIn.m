classdef EccentricityIn < Measure
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the eccentricityIn.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				eccentricityin_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'RULE' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			eccentricityin_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			eccentricityin_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8  5 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 6 % EccentricityIn.NOTES
					prop_default = 'EccentricityIn notes';
				case 7 % EccentricityIn.SHAPE
					prop_default = 2;
				case 8 % EccentricityIn.SCOPE
					prop_default = 2;
				case 9 % EccentricityIn.PARAMETRICITY
					prop_default = 2;
				case 10 % EccentricityIn.COMPATIBLE_GRAPHS
