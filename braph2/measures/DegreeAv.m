classdef DegreeAv < Degree
	...
	%  <strong>13</strong> <strong>M</strong> 	M (result, cell) is the average degree.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				degreeav_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			degreeav_category_list = { 1  1  3  4  2  2  6  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			degreeav_format_list = { 2  2  8  2  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 8 % DegreeAv.SHAPE
					prop_default = 1;
				case 9 % DegreeAv.SCOPE
					prop_default = 2;
				case 10 % DegreeAv.PARAMETRICITY
					prop_default = 2;
				otherwise
