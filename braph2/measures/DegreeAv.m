classdef DegreeAv < Degree
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the average degree.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the average degree.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the average degree.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the average degree.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the average degree.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the average degree.
	...
	%  <strong>12</strong> <strong>M</strong> 	M (result, cell) is the average degree.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				degreeav_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			degreeav_category_list = { 1  1  3  4  2  2  1  1  1  1  4  5  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			degreeav_format_list = { 2  2  8  2  2  2  11  11  11  7  8  16  8 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			degreeav_description_list = { 'NAME (constant, string) is the name of the average degree.'  'DESCRIPTION (constant, string) is the description of the average degree.'  'TEMPLATE (parameter, item) is the template of the average degree.'  'ID (data, string) is a few-letter code of the average degree.'  'LABEL (metadata, string) is an extended label of the average degree.'  'NOTES (metadata, string) are some specific notes about the average degree.'  'SHAPE (constant, scalar) is the measure shape Measure.GLOBAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the average degree.'  'PFM (gui, item) contains the panel figure of the measure.' };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % DegreeAv.NAME
					prop_default = 'DegreeAv';
				case 2 % DegreeAv.DESCRIPTION
				...
				case 5 % DegreeAv.LABEL
					prop_default = 'DegreeAv label';
				case 6 % DegreeAv.NOTES
					prop_default = 'DegreeAv notes';
				case 7 % DegreeAv.SHAPE
					prop_default = 1;
				case 8 % DegreeAv.SCOPE
					prop_default = 2;
				case 9 % DegreeAv.PARAMETRICITY
					prop_default = 2;
				otherwise
