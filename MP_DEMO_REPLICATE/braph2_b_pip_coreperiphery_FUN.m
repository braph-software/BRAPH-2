...
pc4 = PipelineCode( ...
    ...
    'CODE', char("AnalyzeEnsemble_FUN_BUD('GR', gr1_women_FUN)"), ...
    'EL', analysis_women ...
    );
...
pc5 = PipelineCode( ...
    ...
    'CODE', char("AnalyzeEnsemble_FUN_BUD('GR', gr2_men_FUN)"), ...
    'EL', analysis_men ...
    );
...
tic
Element.save(pipeline, 'pipeline_CorePeriphery_FUN.b2')
toc
fprintf('pipeline saved\n')

%% Load the pipeline
pipeline = Element.load('pipeline_CorePeriphery_FUN.b2')
gui = GUIElement('PE', pipeline);
gui.get('DRAW');
gui.get('SHOW')