...
A_BD = [
    ...
    0 1 0 1 1;
    1 0 0 1 1];
assortativity_BD = (15/7-(21/14)^2)/(35/14-(21/14)^2);
...
A_WD = [
    ...
    0 2 0 1 2;
    1 0 0 2 1];
assortativity_WD_threshold = (15/7-(21/14)^2)/(35/14-(21/14)^2);
assortativity_WD_compress = (5.666666/7-(6.333333/7)^2)/(6.444444/7-(6.333333/7)^2);

A_test = rand(randi(20));

%% Test 1: Comparison with known BD graph
g = GraphBD(A_BD);
assortativity_1 = InInAssortativity(g).getValue();
assortativity_2 = assortativity_BD;
assert(isequal(assortativity_1, assortativity_2), ...
    'BRAPH:InInAssortativity:Bug', ...
...
assert(isequal(assortativity_1, assortativity_2), ...
    'BRAPH:InInAssortativity:Bug', ...
    'InInAssortativity is not being calculated correctly for GraphWU')
