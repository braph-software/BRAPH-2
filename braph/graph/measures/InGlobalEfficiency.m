classdef InGlobalEfficiency < Measure
    ...
    % InGlobalEfficiency provides the in-globalefficiency of a node for binary directed (BD) and 
    ...
    methods
        function m = InGlobalEfficiency(g, varargin)
            % INGLOBALEFFICIENCY(G) creates in-globalefficiency with default measure properties.
            ...
            % Currently INGLOBALEFFICIENCY does not utilizes SETTINGS.
            %   
