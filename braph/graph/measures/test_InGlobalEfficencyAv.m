...
for i = 1:1:length(graph_class_list)
    ...
    assert(~isempty(ge), ...
        ['BRAPH:InGlobalEfficencyAv: ' graph_class], ...
        ['InGlobalEfficencyAv  is not calculating for ' graph_class])
end
...
for i = 1:1:length(graph_class_list)
    ...
    assert( isequal(ge, known_solution), ...
        ['BRAPH:InGlobalEfficencyAv: ' graph_class], ...
        ['InGlobalEfficencyAv is not working for: ' graph_class ])
end
