...
for i = 1:1:length(graph_class_list)
    ...
    ge = InGlobalEfficiencyAv(g).getValue();
    
    assert(~isempty(ge), ...
        ['BRAPH:InGlobalEfficiencyAv: ' graph_class], ...
        ['InGlobalEfficiencyAv  is not calculating for ' graph_class])
end
...
for i = 1:1:length(graph_class_list)
    ...
    assert( isequal(ge, known_solution), ...
        ['BRAPH:InGlobalEfficiencyAv: ' graph_class], ...
        ['InGlobalEfficiencyAv is not working for: ' graph_class ])
end
