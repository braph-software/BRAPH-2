...
for i = 1:1:length(graph_class_list)
    ...
    ecc = OutEccentricity(g).getValue();
    
    assert(~isempty(ecc), ...
        ['BRAPH:' graph_class ':OutEccentricity'], ...
        ['OutEccentricity is not calculated for ' graph_class])
end
...
for i = 1:1:length(graph_class_list)
    ...
    g = Graph.getGraph(graph_class, A);
    ecc = OutEccentricity(g, 'OutEccentricityRule', 'subgraphs').getValue();
    ...
    assert(isequal(ecc, known_solution), ...
        ['BRAPH:' graph_class ':OutEccentricity'], ...
        ['OutEccentricity is not calculated for subgraphs rule ' graph_class])
end
...
for i = 1:1:length(graph_class_list)
    ...
    assert(isequal(ecc, known_solution), ...
        ['BRAPH:' graph_class ':OutEccentricity'], ...
        ['OutEccentricity is not calculated for standard rule' graph_class])
end
...
assert(isequal(ecc(1,1), bct_value), ...
    ['BRAPH:OutEccentricity'], ...
    ['OutEccentricity is not calculated for BCT.'])
