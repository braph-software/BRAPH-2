...
A_BD = [
    ...
    0 1 0 1 1;
    1 0 0 1 1];
assortativity_BD = (16/7-(21/14)^2)/(35/14-(21/14)^2); 
...
A_WD = [
    ...
    0 2 0 1 2;
    1 0 0 2 1];
assortativity_WD_threshold = (16/7-(21/14)^2)/(35/14-(21/14)^2); 
assortativity_WD_compress = (6.111111/7-(6.666666/7)^2)/(7.111111/7-(6.666666/7)^2);

A_test = rand(randi(20));

%% Test 1: Comparison with known BD graph
g = GraphBD(A_BD);
assortativity_1 = OutOutAssortativity(g).getValue();
assortativity_2 = assortativity_BD;
assert(isequal(assortativity_1, assortativity_2), ...
    'BRAPH:OutOutAssortativity:Bug', ...
...
assert(isequal(assortativity_1, assortativity_2), ...
    'BRAPH:OutOutAssortativity:Bug', ...
    'OutOutAssortativity is not being calculated correctly for GraphWU')
