...
for i = 1:1:numel(measures)
    ...
    value_1 = randomcomparison.getGroupValue(1);    
    value_2 = randomcomparison.getGroupValue(2);
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonMRI('c1', atlas, {group group}, ...
        ...
        'RandomComparisonMRI.value_1', value_1, ...
        'RandomComparisonMRI.value_2', value_2, ...
    ...
    comparison_value_1 = randomcomparison.getGroupValue(1);
    comparison_value_2 = randomcomparison.getGroupValue(2);
