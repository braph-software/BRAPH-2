...
load_cohort = SubjectDTI.load_from_xls(sub_class, atlas, 'Directory', [save_dir_path '\' group.getName()]);
% assert
...
load_cohort = SubjectDTI.load_from_txt(sub_class, atlas, 'Directory', [save_dir_path '\' group.getName()]);
% assert
...
load_cohort = SubjectDTI.load_from_json(sub_class, atlas, 'Directory', [save_dir_path '\' group.getName()]);
% assert
