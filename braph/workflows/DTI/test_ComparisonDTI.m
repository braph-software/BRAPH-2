...
%     comparison = ComparisonDTI('c1', atlas, {group group}, 'ComparisonDTI.measure_code', measures{i});
%     
...
for i = 1:1:numel(measures)
    ...
    % act
    comparison = ComparisonDTI('c1', atlas, {group group}, ...
        'ComparisonDTI.measure_code', measures{i}, ...
        'ComparisonDTI.number_of_permutations', number_of_permutations, ...
