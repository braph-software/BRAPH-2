...
for i = 1:1:numel(measures)
    ...
    values_random = randomcomparison.getRandomValue();
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values_group) & ...
            ...
            iscell(values_random) & ...
            isequal(numel(values_random), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [1, 1]), values_random)), ...
            ['BRAPH:RandomComparisonDTI:Instantiation'], ...
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(values_group) & ...
            ...
            iscell(values_random) & ...
            isequal(numel(values_random), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), values_random)) , ...
            ['BRAPH:RandomComparisonDTI:Instantiation'], ...
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(values_group) & ...
            ...
            iscell(values_random) & ...
            isequal(numel(values_random), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), values_random)), ...
            ['BRAPH:RandomComparisonDTI:Instantiation'], ...
...
for i = 1:1:numel(measures)
    ...
    average_values_random = mean(reshape(cell2mat(values_random), [size(values_random{1}, 1), size(values_random{1}, 2), group.subjectnumber()]), 3);
    
    difference  = average_values_random - average_values_group;
    for j = 1:1:number_of_permutations
        all_differences{j} =  values_group{1} - values_random{1};  % similar
    end
    ...
    comparison_values_group = randomcomparison.getGroupValue();
    comparison_values_random = randomcomparison.getRandomValue();
    comparison_average_group = randomcomparison.getAverageValue();
    comparison_average_random = randomcomparison.getAverageRandomValue();
    ...
    % assert
    if Measure.is_global(measures{i})
        assert(iscell(comparison_values_group) & ...
            isequal(numel(comparison_values_group), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [1, 1]), comparison_values_group)) & ...
            iscell(comparison_values_random) & ...
            isequal(numel(comparison_values_random), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [1, 1]), comparison_values_random)), ...
            ['BRAPH:RandomComparisonDTI:Instantiation'], ...
            ['RandomComparisonDTI does not initialize correctly with global measures.']) %#ok<*NBRAK>
        assert(isequal(numel(comparison_average_group), 1) & ...
            isequal(numel(comparison_average_random), 1) & ...
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(comparison_values_group) & ...
            isequal(numel(comparison_values_group), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), comparison_values_group)) & ...
            iscell(comparison_values_random) & ...
            isequal(numel(comparison_values_random), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), 1]), comparison_values_random)) , ...
            ['BRAPH:RandomComparisonDTI:Instantiation'], ...
            ['RandomComparisonDTI does not initialize correctly with nodal measures.']) %#ok<*NBRAK>
        assert(isequal(size(comparison_average_group), [atlas.getBrainRegions().length(), 1]) & ...
            isequal(size(comparison_average_random), [atlas.getBrainRegions().length(), 1]) & ...
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(comparison_values_group) & ...
            isequal(numel(comparison_values_group), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), comparison_values_group)) & ...
            iscell(comparison_values_random) & ...
            isequal(numel(comparison_values_random), group.subjectnumber) & ...
            all(cellfun(@(x) isequal(size(x), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]), comparison_values_random)), ...
            ['BRAPH:RandomComparisonDTI:Instantiation'], ...
            ['RandomComparisonDTI does not initialize correctly with binodal measures.']) %#ok<*NBRAK>
        assert(isequal(size(comparison_average_group), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]) & ...
            isequal(size(comparison_average_random), [atlas.getBrainRegions().length(), atlas.getBrainRegions().length()]) & ...
