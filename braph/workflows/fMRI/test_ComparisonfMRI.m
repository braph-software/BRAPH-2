...
for i = 1:1:numel(measures)
    comparison = ComparisonfMRI('c1', atlas,  {group group}, 'ComparisonfMRI.measure_code', measures{i});
    assert(~isempty(comparison), ...
        ['BRAPH:ComparisionfMRI:Instantiation'], ...
        ['ComparisionfMRI does not initialize correctly.']) %#ok<*NBRAK>
end
...
for i = 1:1:numel(measures)
    ...
    comparison = ComparisonfMRI('c1', atlas, {group group}, 'ComparisonfMRI.measure_code', measures{i}, 'ComparisonfMRI.number_of_permutations', number_of_permutations);
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values_1) & ...
            ...
            ['BRAPH:ComparisonfMRI:Instantiation'], ...
...
for i = 1:1:numel(measures)
    ...
    % act
    comparison = ComparisonfMRI('c1', atlas, {group group}, ...
        'ComparisonfMRI.measure_code', measures{i}, ...
        'ComparisonfMRI.number_of_permutations', number_of_permutations, ...
        'ComparisonfMRI.values_1', values_1, ...
        'ComparisonfMRI.values_2', values_2, ...
        'ComparisonfMRI.average_values_1', average_values_1, ...
        'ComparisonfMRI.average_values_2', average_values_2, ...
