classdef RandomComparisonfMRI < RandomComparison
    ...
    methods
        function c =  RandomComparisonfMRI(id, atlas, group, varargin)
        ...
        function initialize_data(c, varargin)
            ...
            if Measure.is_global(c.getMeasureCode())  % global measure
                ...
                c.values_group = get_from_varargin( ...
                    repmat({0}, 1, group{1}.subjectnumber()), ...
                ...
                assert(iscell(c.getGroupValue()) & ...
                    isequal(size(c.getGroupValue()), [1, group{1}.subjectnumber]) & ...
                ...
                assert(iscell(c.getRandomValue()) & ...
                    isequal(size(c.getRandomValue()), [1, group{1}.subjectnumber]) & ...
            ...
            elseif Measure.is_nodal(c.getMeasureCode())  % nodal measure
                c.values_group = get_from_varargin( ...
                    repmat({zeros(atlas.getBrainRegions().length(), 1)}, 1, group{1}.subjectnumber()), ...
                    'RandomComparisonfMRI.values_group', ...
                    varargin{:});
                c.values_random = get_from_varargin( ...
                    repmat({zeros(atlas.getBrainRegions().length(), 1)}, 1, group{1}.subjectnumber()), ...
            ...
            elseif Measure.is_binodal(c.getMeasureCode())  % binodal measure
                c.values_group = get_from_varargin( ...
                    repmat({zeros(atlas.getBrainRegions().length())}, 1, group{1}.subjectnumber()), ...
                    'RandomComparisonfMRI.values_group', ...
                    varargin{:});
                c.values_random = get_from_varargin( ...
                    repmat({zeros(atlas.getBrainRegions().length())}, 1, group{1}.subjectnumber()), ...
