...
for i = 1:1:numel(measures)
    randomcomparison = RandomComparisonfMRI('c1', atlas,  {group group}, 'RandomComparisonfMRI.measure_code', measures{i});
...
for i = 1:1:numel(measures)
    ...
    randomcomparison = RandomComparisonfMRI('c1', atlas, {group group}, 'RandomComparisonfMRI.measure_code', measures{i}, 'RandomComparisonfMRI.number_of_permutations', number_of_permutations);
...
for i = 1:1:numel(measures)
    ...
    % act
    randomcomparison = RandomComparisonfMRI('c1', atlas, {group group}, ...
        'RandomComparisonfMRI.measure_code', measures{i}, ...
        'RandomComparisonfMRI.number_of_permutations', number_of_permutations, ...
        'RandomComparisonfMRI.values_1', values_1, ...
        'RandomComparisonfMRI.values_2', values_2, ...
        'RandomComparisonfMRI.average_values_1', average_values_1, ...
        'RandomComparisonfMRI.average_values_2', average_values_2, ...
