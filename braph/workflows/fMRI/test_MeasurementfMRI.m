...
subject_class = Measurement.getSubjectClass('MeasurementfMRI');
...
for i = 1:1:numel(measures)
    ...
    assert(~isempty(measurement), ...
        ['BRAPH:MeasurementfMRI:Instantiation'], ...
        ['MeasurementfMRI does not initialize correctly.']) %#ok<*NBRAK>
end
...
for i=1:1:numel(measures)
    ...
    if Measure.is_global(measures{i})
        assert(iscell(values) & ...
            ...
            ['BRAPH:MeasurementfMRI:Instantiation'], ...
            ['MeasurementfMRI does not initialize correctly with global measures.']) %#ok<*NBRAK>
    ...
    elseif Measure.is_nodal(measures{i})
        assert(iscell(values) & ...
            ...
            ['BRAPH:MeasurementfMRI:Instantiation'], ...
            ['MeasurementfMRI does not initialize correctly with nodal measures.']) %#ok<*NBRAK>
    ...
    elseif Measure.is_binodal(measures{i})
        assert(iscell(values) & ...
            ...
            ['BRAPH:MeasurementfMRI:Instantiation'], ...
            ['MeasurementfMRI does not initialize correctly with binodal measures.']) %#ok<*NBRAK>
