   ...
   function measure_code = getMeasureCode(m)
    ...
    methods (Access=protected)
        function initialize_data(m, varargin)            
            ...
            m.values = get_data_from_varargin('MeasurementDTI.measure_code', m.getMeasureCode(), m.getGroup().subjectnumber());
...
%             m.values = values;
            ...
            m.average_value = get_data_from_varargin('MeasurementDTI.average_value', m.getMeasureCode(), 1);
