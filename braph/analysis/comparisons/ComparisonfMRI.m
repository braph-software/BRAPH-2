classdef ComparisonfMRI < Comparison
    ...
    methods (Access=protected)
        function initialize_data(c, varargin)
            ...
            c.difference_all =  get_from_varargin(0,'ComparisonfMRI.difference_all', varargin{:});
            c.p_single = get_from_varargin(0, 'ComparisonfMRI.p_single', varargin{:});
            c.p_double = get_from_varargin(0, 'ComparisonfMRI.p_double', varargin{:});
            c.percentiles = get_from_varargin(0, 'ComparisonfMRI.percentiles', varargin{:});
