...
assert(ao.get('SUM_OR_DIFF', 'SUM') == ao.get('SUM')) ¥\circled{3}\circlednote{3}{and \circled{4} returns the sum or the difference depening on the argument.}¥
assert(ao.get('SUM_OR_DIFF', 'DIFF') == ao.get('DIFF')) ¥\circled{4}¥
assert(isnan(ao.get('SUM_OR_DIFF'))) ¥\circled{5}\circlednote{5}{and \circled{6} retunrs \code{NaN} when the input is absent or unexpected.}¥
