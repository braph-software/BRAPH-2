...
¤%% ¡props!
%%% ¡prop! 
RULE (parameter, option) is the rule to determine what is a triangle in directed networks. ¥\circled{2}\circlednote{2}{these are the available triangle rule options.}¥
%%%% ¡settings!
