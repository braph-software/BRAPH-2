...
%%% ¡prop! 
RULE (parameter, option) is the rule to determine what is a triangle in directed networks. ¥\circled{2}\circlednote{2}{defines a parameter to determine how the measure is calculated. This property must be of category \code{parameter}.}¥
%%%% ¡settings!
