...
If you don't have the \fn{Example data FUN\_MP XLS} folder inside \fn{functional multiplex}, then you can generate it by running the commands in \Coderef{cd:exampledata}.
