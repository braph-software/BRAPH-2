...
In this window that was opened in the previous step (1) you have a menu that you can use to import a brain atlas (2) that you created or has already been prepared for you to use from the atlases folder of BRAPH 2.0 (3). In this example, we are uploading the Desikan atlas (4) \Figref{fig3} . 
...
\item {\bf Desikan} Anatomical atlas with 68 cortical derived from the FreeSurfer software.
\item {\bf Destrieux} Anatomical atlas with 148 cortical derived from the FreeSurfer software.
