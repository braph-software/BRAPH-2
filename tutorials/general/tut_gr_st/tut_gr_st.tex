...
If you don't have the \fn{Example data ST XLS} folder inside \fn{structural}, then you can generate it by running the commands in \Coderef{cd:exampledata}.
%
\begin{lstlisting}[
...
create_data_SubjectST_XLS ¥\circled{1}\circlednote{1}{generates the example structural XLS data folder.}¥
create_data_SubjectST_TXT ¥\circled{2}\circlednote{2}{generates the example structural TXT data folder.}¥
\end{lstlisting}
