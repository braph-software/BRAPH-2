...
After configuring the parameters, you can proceed to calculate specific graph measures (\Figref{TTfig:06}). To do this, return to the \fn{Analyze Ensemble} interface (\Figref{TTfig:06}a) and scroll down to locate the \fn{Group-averaged MEASURES} panel. By clicking the 'C' button, you will see a table displaying all measures.
