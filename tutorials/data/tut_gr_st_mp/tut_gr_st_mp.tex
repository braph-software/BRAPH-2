...
If you do not have the \fn{Example data ST\_MP XLS} folder inside \fn{structural multiplex}, then you can generate it by running the commands in \Coderef{cd:exampledata}.
...
\fig{figure}
	...
	{\bf c}-{\bf f} navigate to the BRAPH~2 folder \fn{pipelines}, {\bf d} \fn{structural multiplex},  {\bf e} \fn{Example data ST\_MP XLS}, and {\bf f} select the folder with structural multiplex values of one group \fn{ST\_MP\_Group\_1\_XLS}.
	}
