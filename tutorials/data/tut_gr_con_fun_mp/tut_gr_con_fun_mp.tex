...
If you do not have the \fn{Example data CON\_FUN\_MP XLS} folder inside \fn{connectivity-functional multiplex}, then you can generate it by running the commands in \Coderef{cd:exampledata}.
