function [target_dir, source_dir] = genesis(target_dir, source_dir, run_number) %TODO: revise
...
for run = 1:1:run_number
    ...
    parfor i = 1:1:numel(util_gen_list)
    ...
    parfor i = 1:1:numel(ds_gen_list)
...
% % %     parfor i = 1:1:numel(gt_gen_list)
...
% % %     parfor i = 1:1:numel(atlas_gen_list)
...
% % %     parfor i = 1:1:numel(cohort_gen_list)
...
% % %     parfor i = 1:1:numel(analysis_gen_list)
...
% % %     parfor i = 1:1:numel(nn_gen_list)
...
% % %     parfor i = 1:1:numel(graphs_gen_list)
...
% % %     parfor i = 1:1:numel(measures_gen_list)
...
% % %     parfor i = 1:1:numel(neuralnetworks_gen_list)
...
% % %     parfor i = 1:1:numel(gui_gen_list)
