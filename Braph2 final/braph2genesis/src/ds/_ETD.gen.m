%% ¡header!
ETD < Element (et, test Element D) tests multiple values with checks.

%%% ¡description!
ETD tests multiple values with checks.

%%% ¡seealso!
Element, Category, Format, ETE
...
assert_with_error("varargin{1}.set('UNO', 1)", ...
    [BRAPH2.STR ':ETD:' BRAPH2.WRONG_INPUT], ...
    et)
