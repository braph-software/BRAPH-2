%% ¡header!
PPCompareEnsembleMP_CON_FUN_CPDict_BUT < PlotProp (pr, plot property graph) is a plot of a binary undirect using thresholds multilayer comparison ensemble dictionary.
