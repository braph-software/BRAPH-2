...
%%%% ¡calculate!
subs1 = nnds.get('GR1').get('SUB_DICT').getItems();
selected_subs1 = nnds.get('SPLIT_GR1');

subs2 = nnds.get('GR2').get('SUB_DICT').getItems();
selected_subs2 = nnds.get('SPLIT_GR2');
...
val_nn_gr = NNGroup( ...
    ...
    'NOTES', 'This validation set is used to perform mutual information analysis and train the neural networks.', ...
    'SUB_CLASS', nnds.get('GR1').get('SUB_CLASS'), ...
    'SUB_DICT', IndexedDictionary('IT_CLASS', 'NNSubject', 'IT_LIST', subs) ...
    );
