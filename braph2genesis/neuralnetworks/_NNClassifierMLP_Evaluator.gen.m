...
if any(strcmp(dp_class, graph_dp_classes)) % GRAPH input
    pr = NNxMLP_xPP_FI_Graph('EL', nne, 'PROP', NNClassifierMLP_Evaluator.FEATURE_IMPORTANCE, varargin{:});
elseif any(strcmp(dp_class, measure_dp_classes))% MEASURE input
    pr = NNxMLP_xPP_FI_Measure('EL', nne, 'PROP', NNClassifierMLP_Evaluator.FEATURE_IMPORTANCE, varargin{:});
else % DATA input
    pr = NNxMLP_xPP_FI_Data('EL', nne, 'PROP', NNClassifierMLP_Evaluator.FEATURE_IMPORTANCE, varargin{:});
end
