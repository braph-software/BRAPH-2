%% ¡header!
NNxMLP_FeatureImportanceBrainSurfacePF_NU < NNxMLP_FeatureImportanceBrainSurfacePF (pf, panel figure for feature importance brain) is a plot of a feature importance brain.
...
%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.SPHS
%%%% ¡title!
Brain Region SPHERES ON/OFF

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.SPH_DICT
%%%% ¡title!
...
%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.ID
%%%% ¡title!
Brain Atlas Figure ID

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.LABEL
%%%% ¡title!
Brain Atlas Figure NAME

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.WAITBAR
%%%% ¡title!
WAITBAR ON/OFF

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.NOTES
%%%% ¡title!
Brain Atlas NOTES

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.BKGCOLOR
%%%% ¡title!
BACKGROUND COLOR

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.ST_POSITION
%%%% ¡title!
PANEL POSITION

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.VIEW
%%%% ¡title!
3D VIEW

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.ST_AXIS
%%%% ¡title!
AXIS

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.BRAIN
%%%% ¡title!
BRAIN ON/OFF

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.SURFFILE
%%%% ¡title!
BRAIN SURFACE

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.ST_SURFACE
%%%% ¡title!
BRAIN COLOR

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.ST_AMBIENT
%%%% ¡title!
MATERIAL & LIGHTNING

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.SYMS
%%%% ¡title!
Brain Region SYMBOLS ON/OFF

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.SYM_DICT
%%%% ¡title!
Brain Region SYMBOLS PROPERTIES

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.IDS
%%%% ¡title!
Brain Region IDs ON/OFF

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.ID_DICT
%%%% ¡title!
Brain Region IDs PROPERTIES

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.LABS
%%%% ¡title!
Brain Region LABELS ON/OFF

%%% ¡prop!
%%%% ¡id!
NNxMLP_FeatureImportanceBrainSurfacePF_NU.LAB_DICT
%%%% ¡title!
...
pf.get('SETUP');
%%%% ¡gui!
pr = NNFeatureImportanceBSPF_xUPP_Layer('EL', pf, 'PROP', NNxMLP_FeatureImportanceBrainSurfacePF_NU.LAYER);
...
%%% ¡excluded_props!
[NNxMLP_FeatureImportanceBrainSurfacePF_NU.PARENT NNxMLP_FeatureImportanceBrainSurfacePF_NU.H NNxMLP_FeatureImportanceBrainSurfacePF_NU.ST_POSITION NNxMLP_FeatureImportanceBrainSurfacePF_NU.ST_AXIS NNxMLP_FeatureImportanceBrainSurfacePF_NU.ST_SURFACE NNxMLP_FeatureImportanceBrainSurfacePF_NU.ST_AMBIENT NNxMLP_FeatureImportanceBrainSurfacePF_NU.CP]
...
Remove Figures
%%%% ¡code!
warning('off', [BRAPH2.STR ':NNxMLP_FeatureImportanceBrainSurfacePF_NU'])
assert(length(findall(0, 'type', 'figure')) == 5)
delete(findall(0, 'type', 'figure'))
warning('on', [BRAPH2.STR ':NNxMLP_FeatureImportanceBrainSurfacePF_NU'])
