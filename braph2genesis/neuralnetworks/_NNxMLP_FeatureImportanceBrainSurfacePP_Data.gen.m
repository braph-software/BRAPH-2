%% ¡header!
NNxMLP_FeatureImportanceBrainSurfacePP_Data < PanelProp (pr, panel property feature importance) plots the panel to manage the feature importance of a neural network analysis with the data of subjects.
...
%%% ¡seealso!
NNxMLP_FeatureImportanceBrainSurfacePP, NNxMLP_FeatureImportanceBrainSurfacePP_Measure, NNxMLP_FeatureImportanceBrainSurfacePP_Graph
...
%%%% ¡default!
'A panel for neural networks feature importance analysis with the data of subjects (NNxMLP_FeatureImportanceBrainSurfacePP_Data) plots the panel to show the feature importance values, matching the layer number and node number of the subject data.'
...
%%% ¡excluded_props!
[NNxMLP_FeatureImportanceBrainSurfacePP_Data.PARENT NNxMLP_FeatureImportanceBrainSurfacePP_Data.H NNxMLP_FeatureImportanceBrainSurfacePP_Data.LISTENER_CB NNxMLP_FeatureImportanceBrainSurfacePP_Data.HEIGHT NNxMLP_FeatureImportanceBrainSurfacePP_Data.XSLIDER NNxMLP_FeatureImportanceBrainSurfacePP_Data.YSLIDER NNxMLP_FeatureImportanceBrainSurfacePP_Data.TABLE NNxMLP_FeatureImportanceBrainSurfacePP_Data.CONTEXTMENU]
...
Remove Figures
%%%% ¡code!
warning('off', [BRAPH2.STR ':NNxMLP_FeatureImportanceBrainSurfacePP_Data'])
assert(length(findall(0, 'type', 'figure')) == 1)
delete(findall(0, 'type', 'figure'))
warning('on', [BRAPH2.STR ':NNxMLP_FeatureImportanceBrainSurfacePP_Data'])