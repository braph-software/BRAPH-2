%% ¡header!
NNClassifierData_GraphMeasures < NNData (nnd, data of a neural network classifier) produces a dataset to train or test a neural netowrk classifier.  
...
%%%% ¡settings!
{'adjacency_matrices' 'graph_measures' 'both'}
