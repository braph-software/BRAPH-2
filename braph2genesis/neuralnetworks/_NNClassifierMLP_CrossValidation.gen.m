...
if any(strcmp(dp_class, graph_dp_classes)) % GRAPH input
    pr = NNxMLP_xPP_FI_Graph('EL', nncv, 'PROP', NNClassifierMLP_CrossValidation.AV_FEATURE_IMPORTANCE, varargin{:});
elseif any(strcmp(dp_class, measure_dp_classes))% MEASURE input
    pr = NNxMLP_xPP_FI_Measure('EL', nncv, 'PROP', NNClassifierMLP_CrossValidation.AV_FEATURE_IMPORTANCE, varargin{:});
else % DATA input
    pr = NNxMLP_xPP_FI_Data('EL', nncv, 'PROP', NNClassifierMLP_CrossValidation.AV_FEATURE_IMPORTANCE, varargin{:});
end
