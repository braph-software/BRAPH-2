%% ¡header!
PP_THRESHOLD < PanelPropString (pr, panel property string) plots the panel of a property string.

%%% ¡description!
PP_THRESHOLD plots the panel for a STRING property with an edit field.
