%% ¡header!
NNFeatureImportanceBrainSurfacePF_Measure_NS < NNFeatureImportanceBrainSurfacePF_Measure (pf, panel nodal superglobal ensemble-based comparison figure on brain surface figure) is the base element to plot a nodal superglobal ensemble-based comparison figure on brain surface figure.
...
%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.TOP_SHOWN
%%%% ¡title!
TOP ONLY

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.TOP_PERCENTAGE
%%%% ¡title!
TOP RATIOs 
...
%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.SPHS
%%%% ¡title!
Brain Region SPHERES ON/OFF

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.SPH_DICT
%%%% ¡title!
Brain Region SPHERES PROPERTIES

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.SIZE_DIFF
%%%% ¡title!
Show Difference with SPHERES SIZE

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.SIZE_SCALE
%%%% ¡title!
Size SCALE

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.COLOR_DIFF
%%%% ¡title!
Show Difference with SPHERES COLOR

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.ID
%%%% ¡title!
Brain Atlas Figure ID

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.LABEL
%%%% ¡title!
Brain Atlas Figure NAME

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.WAITBAR
%%%% ¡title!
WAITBAR ON/OFF

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.NOTES
%%%% ¡title!
Brain Atlas NOTES

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.BKGCOLOR
%%%% ¡title!
BACKGROUND COLOR

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.ST_POSITION
%%%% ¡title!
PANEL POSITION

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.VIEW
%%%% ¡title!
3D VIEW

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.ST_AXIS
%%%% ¡title!
AXIS

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.BRAIN
%%%% ¡title!
BRAIN ON/OFF

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.SURFFILE
%%%% ¡title!
BRAIN SURFACE

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.ST_SURFACE
%%%% ¡title!
BRAIN COLOR

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.ST_AMBIENT
%%%% ¡title!
MATERIAL & LIGHTNING

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.SYMS
%%%% ¡title!
Brain Region SYMBOLS ON/OFF

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.SYM_DICT
%%%% ¡title!
Brain Region SYMBOLS PROPERTIES

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.IDS
%%%% ¡title!
Brain Region IDs ON/OFF

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.ID_DICT
%%%% ¡title!
Brain Region IDs PROPERTIES

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.LABS
%%%% ¡title!
Brain Region LABELS ON/OFF

%%% ¡prop!
%%%% ¡id!
NNFeatureImportanceBrainSurfacePF_Measure_NS.LAB_DICT
%%%% ¡title!
...
%%%% ¡default!
'NNFeatureImportanceBrainSurfacePF_Measure_NS manages the basic functionalities to plot of a nodal superglobal ensemble-based comparison figure on brain surface.'
...
pf.get('SETUP');
%%%% ¡gui!
pr = NNFeatureImportanceBrainSurfacePF_x_xSPP_Layer('EL', pf, 'PROP', NNFeatureImportanceBrainSurfacePF_Measure_NS.LAYER);
