%% ¡header!
DatasetProcessor_Classification < DatasetProcessor (dp, data processor of a neural network classifier) produces a dataset to train or test a neural netowrk classifier.  

%% ¡description!
This dataset processor produces a dataset that can be used to train
...
%%% ¡prop!
GR2 (data, item) is subject group 2.
%%%% ¡settings!
'Group'
