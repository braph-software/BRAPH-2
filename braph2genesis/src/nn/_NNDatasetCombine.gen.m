...
%%% ¡prop!
ELCLASS (constant, string) is the class of the combination of neural networks datasets.
%%%% ¡default!
'NNDatasetCombine'

%%% ¡prop!
NAME (constant, string) is the name of the combination of neural networks datasets.
%%%% ¡default!
'NNDatasetCombine'

%%% ¡prop!
DESCRIPTION (constant, string) is the description of the combination of neural networks datasets.
%%%% ¡default!
...
%%% ¡prop!
TEMPLATE (parameter, item) is the template of the combination of neural networks datasets.
%%%% ¡settings!
'NNDatasetCombine'

%%% ¡prop!
ID (data, string) is a few-letter code of the combination of neural networks datasets.
%%%% ¡default!
'NNDatasetCombine ID'

%%% ¡prop!
LABEL (metadata, string) is an extended label of the combination of neural networks datasets.
%%%% ¡default!
'NNDatasetCombine label'

%%% ¡prop!
NOTES (metadata, string) are some specific notes of the combination of neural networks datasets.
%%%% ¡default!
