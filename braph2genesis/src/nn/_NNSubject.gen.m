...
if ~braph2_testing
    if string(sub.get('INPUT_TYPE')) == 'graph_measures'
        pr = PPNNSubjectInputMeasure('EL', sub, 'PROP', NNSubject.INPUT, varargin{:});
        pr.set('XSLIDERLABELS', 'el.measure_types()');
    elseif string(sub.get('INPUT_TYPE')) == 'structural_data'
        pr = PPNNSubjectInputStructuralData('EL', sub, 'PROP', NNSubject.INPUT, varargin{:});
    elseif string(sub.get('INPUT_TYPE')) == 'adjacency_matrices'
        pr = PPNNSubjectInputAdjacency('EL', sub, 'PROP', NNSubject.INPUT, varargin{:});
    else
