...
if ~(any(format == [Format.STRING Format.CLASS]) && any(category == [Category.PARAMETER Category.DATA]))
    error( ...
        [BRAPH2.STR ':IndexedDictionary:' BRAPH2.WRONG_INPUT], ...
        [BRAPH2.STR ':IndexedDictionary:' BRAPH2.WRONG_INPUT '\\n' ...
        'The format of property ''IT_KEY'' must be ''' int2str(Format.STRING) ''' or ''' int2str(Format.CLASS) ''' (it is ''' format ''').\\n' ...
