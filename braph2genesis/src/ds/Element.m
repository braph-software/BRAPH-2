                            ...
                            if isa(value, 'Callback')
                                if el.getPropFormat(prop) ~= value.get('EL').getPropFormat(value.get('PROP'))
                                    warning( ...
                                        ['BRAPH2' ':' class(el)], ...
                                        ['BRAPH2' ':' class(el) '\n' ...
                                        'Different formats for a prop (' int2str(el.getPropFormat(prop)) ') ' ...
                                        'and a callback (' int2str(value.get('EL').getPropFormat(value.get('PROP'))) '). ' ...
                                ...
                                elseif ~isequal(el.getPropSettings(prop), value.get('EL').getPropSettings(value.get('PROP')))
                                    warning( ...
                                        ['BRAPH2' ':' class(el)], ...
                                        ['BRAPH2' ':' class(el) '\n' ...
                                        'Different format settings for a prop (' int2str(el.getPropFormat(prop)) ', ' tostring(el.getPropSettings(prop)) ') ' ...
                                        'and a callback (' int2str(value.get('EL').getPropFormat(value.get('PROP'))) ', ' tostring(value.get('EL').getPropSettings(value.get('PROP'))) '). ' ...
                                        'This is not necessarily a problem.'] ...
                                        )                                
                                end
