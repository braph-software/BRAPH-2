                            ...
                            if isa(value, 'Callback')
                                if el.getPropFormat(prop) ~= value.get('EL').getPropFormat(value.get('PROP'))
                                    warning( ...
                                        [BRAPH2.STR ':' class(el)], ...
                                        [BRAPH2.STR ':' class(el) '\n' ...
                                        'Different formats for a prop (' el.getPropFormat(prop) ') ' ...
                                ...
                                elseif ~isequal(el.getPropSettings(prop), value.get('EL').getPropSettings(value.get('PROP')))
                                    warning( ...
                                        [BRAPH2.STR ':' class(el)], ...
                                        [BRAPH2.STR ':' class(el) '\n' ...
                                        'Different format settings for a prop (' el.getPropFormat(prop) ', ' tostring(el.getPropSettings(prop)) ') ' ...
                    ...
                    for i = 1:1:length(el1_list)
                        if ~strcmp(el1_list{i}.getClass(), el2_list{i}.getClass())
                            ...
                            for prop = 1:1:el1_list{i}.getPropNumber()
                                if  el1_list{i}.getPropCategory(prop) ~= Category.EVANESCENT ...
                                        && all(el1_list{i}.getPropFormat(prop) ~= [Format.ITEM Format.ITEMLIST Format.IDICT]) ...
