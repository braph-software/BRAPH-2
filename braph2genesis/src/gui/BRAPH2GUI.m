...
linkbar()
    function linkbar()
        set(load_btn, ...
            'Cdata', imresize(imread('icon_load.png'), [25 25]), ...
        ...
        set(load_pipeline_btn, ...
            ...
            'Cdata', imresize(imread('icon_load2.png'), [25 25]), ...
            'BackgroundColor', [1 1 1], ...
            'Callback', {@cb_load_pipeline});
        set(website_btn, ...
            'Position', [.29 0 .14 .08], ...
            'Tooltip', 'Click to visit BRAPH 2.0 website', ...
            'Cdata', imresize(imread('icon_web.png'), [25 25]), ...
            'BackgroundColor', [1 1 1], ...
            'Callback', {@cb_website_btn});
        set(forums_btn, ...
            'Position', [.43 0 .14 .08], ...
            'Tooltip', 'Click to visit BRAPH 2.0 forums', ...
            'Cdata', imresize(imread('icon_forum.png'), [25 25]), ...
            'BackgroundColor', [1 1 1], ...
            'Callback', {@cb_forum_btn});
        set(twitter_btn, ...
            'Position', [.57 0 .14 .08], ...
            'Tooltip', 'Click to visit BRAPH 2.0 twitter', ...
            'Cdata', imresize(imread('icon_twitter.png'), [25 25]), ...
            'BackgroundColor', [1 1 1], ...
            'Callback', {@cb_twitter_btn});
        set(license_btn, ...
            'Position', [.71 0 .14 .08], ...
            'Cdata', imresize(imread('icon_license.png'), [25 25]), ...
            'BackgroundColor', [1 1 1], ...
            'Tooltip', 'Click to open BRAPH 2.0 License', ...
            'Callback', {@cb_license});
        set(about_btn, ...
            'Position', [.85 0 .14 .08], ...
            'Cdata', imresize(imread('icon_about.png'), [25 25]), ...
            'BackgroundColor', [1 1 1], ...
