...
h_button_el = uibutton( ...
    ...
    'FontSize', BRAPH2.FONTSIZE, ...
    'Position', [(bw)+(3*dw) dh bw bh], ...%[dw+(2*dw+bw) dh bw bh], ...
    'BackgroundColor', [1 1 1], ...    
...
h_button_web = uibutton( ...
    ...
    'FontSize', BRAPH2.FONTSIZE, ...
    'Position', [(2*bw)+(4*dw) dh bw bh], ...%[dw+2*(2*dw+bw) dh bw bh], ...
...
h_button_forum = uibutton( ...
    ...
    'FontSize', BRAPH2.FONTSIZE, ...
    'Position', [(3*bw)+(5*dw) dh bw bh], ...% [dw+3*(2*dw+bw) dh bw bh], ...
...
h_button_twitter = uibutton( ...
    ...
    'FontSize', BRAPH2.FONTSIZE, ...
    'Position',  [(4*bw)+(6*dw) dh bw bh], ... %[dw+4*(2*dw+bw) dh bw bh], ...
...
h_button_license = uibutton( ...
    ...
    'FontSize', BRAPH2.FONTSIZE, ...
    'Position',  [(5*bw)+(7*dw) dh bw bh], ...%  [dw+5*(2*dw+bw) dh bw bh], ...
...
h_button_about = uibutton( ...
    ...
    'FontSize', BRAPH2.FONTSIZE, ...
    'Position',  [(6*bw)+(8*dw) dh bw bh], ... %[dw+6*(2*dw+bw) dh bw bh], ...
...
h_panel = uipanel( ...
    'Parent', f, ...
    'Position', [w(h_axes)-x_start*w(h_axes) .2*h(f) .95*w(f)-w(h_axes)-x_end*w(h_axes) .2*h(f)], ...
    'Scrollable', 'on' ...
    );
