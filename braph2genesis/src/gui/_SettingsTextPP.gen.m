...
if value
    ...
    set(pr.get('SLIDER_FONTSIZE'),    'Position', [s(.6)+.35*w_p+s(1.7)   s(4.75) .50*w_p   3]) % the height of a slider cannot be changed
end
...
%%% ¡excluded_props!
[SettingsTextPP.PARENT SettingsTextPP.H SettingsTextPP.LISTENER_CB SettingsTextPP.EDITFIELD_X SettingsTextPP.EDITFIELD_Y SettingsTextPP.EDITFIELD_Z SettingsTextPP.EDITFIELD_TXT SettingsTextPP.BUTTON_FONTCOLOR SettingsTextPP.EDITFIELD_FONTSIZE SettingsTextPP.SLIDER_FONTSIZE]
