%% ¡header!
PanelPropSize < PanelProp (pl, panel property size) plots the panel of a property size.
...
function update(pr)
    ...
    switch el.getPropCategory(prop)
        case Category.METADATA
            ...
            set(pr.line, 'LineWidth', el.get(prop))
        ...
        case Category.RESULT
            ...
            if isa(value, 'NoValue')
                ...
                set(pr.line, 'LineWidth', el.getPropDefault(prop))
            else
                set(pr.editfield, ...
                    'Value', el.get(prop), ...
                    'Editable', 'off', ...
