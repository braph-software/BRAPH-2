...
f_NW = figure( ...
    'Name', 'NW', ...
    'OuterPosition', [x0(0)+w(0)/4 h(0)/2 w(0)/4 h(0)/4] ...
    );
f_NE = figure( ...
    'Name', 'NE', ...
    'OuterPosition', [w(0)/2 h(0)/2 w(0)/4 h(0)/4] ...
    );
f_SW = figure( ...
    'Name', 'SW', ...
    'OuterPosition', [x0(0)+w(0)/4 y0(0)+h(0)/4 w(0)/4 h(0)/4] ...
    );
f_SE = figure( ...
    'Name', 'SE', ...
    'OuterPosition', [w(0)/2 y0(0)+h(0)/4 w(0)/4 h(0)/4] ...
    );
