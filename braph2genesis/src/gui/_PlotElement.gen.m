    ...
    switch el.getPropFormat(prop)
        ...
        case Format.STRING
            pp_list{prop} = PlotPropString( ...
                ...
                'BKGCOLOR', color);
        case Format.LOGICAL
            pp_list{prop} = PlotPropLogical( ...
                'ID', el.getPropTag(prop), ...
                'EL', el, ...
                'PROP', prop, ...
                'BKGCOLOR', color);
        case Format.OPTION
            pp_list{prop} = PlotPropOption( ...
                'ID', el.getPropTag(prop), ...
                'EL', el, ...
                'PROP', prop, ...
                'BKGCOLOR', color);
        case Format.CLASS
            pp_list{prop} = PlotPropClass( ...
                'ID', el.getPropTag(prop), ...
                'EL', el, ...
                'PROP', prop, ...
                'BKGCOLOR', color);
        case Format.CLASSLIST
            pp_list{prop} = PlotPropClassList( ...
                'ID', el.getPropTag(prop), ...
                'EL', el, ...
                'PROP', prop, ...
                'BKGCOLOR', color);
        case Format.ITEM
            pp_list{prop} = PlotPropItem( ...
                'ID', el.getPropTag(prop), ...
                'EL', el, ...
                'PROP', prop, ...
                'BKGCOLOR', color);
