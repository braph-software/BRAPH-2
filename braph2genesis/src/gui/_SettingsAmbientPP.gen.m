...
function cb_ambient(pr)
    ...
    el.get(prop).set('LIGHTING', get(pr.dropdown_lighting, 'Value'))
    el.get(prop).set('MATERIAL', get(pr.dropdown_material, 'Value'))
    el.get(prop).set('CAMLIGHT', get(pr.dropdown_camlight, 'Value'))
    el.get(prop).set('SHADING', get(pr.dropdown_shading, 'Value'))
    el.get(prop).set('COLORMAP', get(pr.dropdown_colormap, 'Value'))
