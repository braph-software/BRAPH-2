classdef GUI
    ...
    methods % constructor
        function gui = GUI(el, varargin)
            ...
            gui.x0 = get_from_varargin(.02 * GUI.SCREEN_WIDTH, 'x0', varargin);
            gui.y0 = get_from_varargin(.10 * GUI.SCREEN_HEIGHT, 'y0', varargin);
            gui.width = get_from_varargin(.60 * GUI.SCREEN_WIDTH, 'width', varargin);
            gui.height = get_from_varargin(.80 * GUI.SCREEN_HEIGHT, 'height', varargin);
            ...
            panel_props = uipanel( ...
                'Parent', f, ...
                'Units', 'pixels', ...
                'Position', [0 0 200 10000]);
            slide_props = uicontrol('Style', 'slider', ...
                'Parent', f, ...
                'Enable', 'off', ...
                'Units', 'pixels', ...`
                'Position',[200 0 20 10000], ...
                'Min', 0-eps, ...
                'Max', 0, ...
                'Value', 0, ...
                'Callback', {@onSlide, panel_props});
