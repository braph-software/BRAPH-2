...
%%% ¡description!
PlotPropString plots a property string of an element in a panel.
For multiline text use PlotPropText instead.
...
function h_panel = draw(pl, varargin)
    ...
    position = get_from_varargin([.01 .10 .98 .45], 'position', varargin);
    
    if isempty(pl.edit_value) || ~isgraphics(pl.edit_value, 'uicontrol') || ~strcmpi(get(pl.edit_value, 'Style'), 'edit')
