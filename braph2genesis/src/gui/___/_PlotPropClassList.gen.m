...
%%% ¡description!
PlotPropClassList plots a property class list of an element in a panel.
...
function h_panel = draw(pl, varargin)
    ...
    if isempty(pl.listbox_value) || ~isgraphics(pl.listbox_value, 'uicontrol') || ~strcmpi(get(pl.listbox_value, 'Style'), 'listbox') 
