...
%%% ¡description!
PlotPropItemList plots a property item list of an element in a panel.
...
function update(pl)
    ...
    if el.getPropCategory(prop) == Category.RESULT && isa(value, 'NoValue')
        ...
        for i = 1:1:length(item_list)
            if isempty(pl.pushbutton_value_list{i}) || ~isgraphics(pl.pushbutton_value_list{i}, 'uicontrol') || ~strcmpi(get(pl.pushbutton_value_list{i}, 'Style'), 'pushbutton')
