...
init_filename()
    function init_filename()
        ...
        set(ui_text_pipeline_filename, ...
            ...
            'Position', [3 figure_size(4)*.08+15 300 20], ...
...
if ~isempty(previous_workspace)
    ...
    function cb_slide(~, ~)
        ...
        if w_p > figure_size(3)
            ...
            set(horizontal_slider, ...
                'Position', [0 figure_size(4)*.08+1 figure_size(3) 10], ...
                'Visible', 'on', ...
...
menu()
    ...
    function cb_export_pipeline_braph2(~, ~)
        exp_h_f = screen_size(4) * .5;
        exp_w_f = exp_h_f * 1.61;
        exp_x_f = screen_size(3) * .3;
