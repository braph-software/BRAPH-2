...
function h_panel = draw(pl, varargin)
    ...
    if isempty(pl.checkbox_value) || ~isgraphics(pl.checkbox_value, 'uicontrol') || ~strcmpi(get(pl.checkbox_value, 'Style'), 'checkbox') 
...
function update(pl)
    ...
    if el.isLocked(prop)
        set(pl.checkbox_value, 'Enable', pl.get('ENABLE'))
    end
...
function redraw(pl, varargin)
    ...
    pl.redraw@PlotProp('Height', 2.5, varargin{:})
end