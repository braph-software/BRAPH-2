...
%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.WAITBAR
%%%% ¡title!
WAITBAR ON/OFF
...
%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.BKGCOLOR
%%%% ¡title!
BACKGROUND COLOR

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_POSITION
%%%% ¡title!
PANEL POSITION

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_AXIS
%%%% ¡title!
AXIS
...
%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_LINE_DIFF
%%%% ¡title!
DIFFERENCE

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_AREA
%%%% ¡title!
CONFIDENCE AREA (95%)

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_LINE_CIL
%%%% ¡title!
LOWER CONFIDENCE LINE

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_LINE_CIU
%%%% ¡title!
UPPER CONFIDENCE LINE

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_TITLE
%%%% ¡title!
TITLE

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_XLABEL
%%%% ¡title!
X-LABEL

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_BS.ST_YLABEL
%%%% ¡title!
Y-LABEL
...
%%% ¡excluded_props!
[ComparisonEnsembleBrainPF_BS.PARENT ComparisonEnsembleBrainPF_BS.H ComparisonEnsembleBrainPF_BS.ST_POSITION ComparisonEnsembleBrainPF_BS.ST_AXIS ComparisonEnsembleBrainPF_BS.ST_AREA ComparisonEnsembleBrainPF_BS.ST_LINE_DIFF ComparisonEnsembleBrainPF_BS.ST_LINE_CIL ComparisonEnsembleBrainPF_BS.ST_LINE_CIU ComparisonEnsembleBrainPF_BS.ST_TITLE ComparisonEnsembleBrainPF_BS.ST_XLABEL ComparisonEnsembleBrainPF_BS.ST_YLABEL] 
