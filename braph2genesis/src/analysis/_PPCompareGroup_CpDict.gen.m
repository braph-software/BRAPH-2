...
% % %     end
    ...
    if ~check_graphics(pr.table, 'uitable')
        pr.table = uitable( ...
            ...
            'ColumnSortable', true, ...
            'ContextMenu', pr.contextmenu, ... % % %             'ColumnName', {'', 'Measure', 'Shape', 'Scope', 'Notes'}, ... % % %             'ColumnFormat', {'logical',  'char', 'char', 'char', 'char'}, ... % % %             'ColumnWidth', {30, 'auto', 'auto', 'auto', 'auto'}, ... % % %             'ColumnEditable', [true false false false false], ...
