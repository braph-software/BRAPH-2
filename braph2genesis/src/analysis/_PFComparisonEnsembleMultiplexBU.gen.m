%% ¡header!
PFComparisonEnsembleMultiplexBU < PFComparisonEnsembleNU (pf, panel figure group comparison multiplex GU) is a plot of a binodal unilayer group comparison for multiplex graphs.
...
%%%% ¡gui!
pr = SettingsFillPP('EL', pf, 'PROP', PFComparisonEnsembleMultiplexBU.ST_FILL, ...    
    varargin{:});
...
pr = PP_BrainRegion('EL', pf, 'PROP', PFComparisonEnsembleMultiplexBU.BR1_ID, ...
    'BA', ba, ...
    varargin{:});
...
pr = PP_BrainRegion('EL', pf, 'PROP', PFComparisonEnsembleMultiplexBU.BR2_ID, ...
    'BA', ba, ...
    varargin{:});
...
pr = PP_LayerID('EL', pf, 'PROP', PFComparisonEnsembleMultiplexBU.LAYER, ...
    'G', g, ...
    varargin{:});
...
function p_out = draw(pf, varargin)
    ...
    pf.p = draw@PFComparisonEnsembleNU(pf, varargin{:});
