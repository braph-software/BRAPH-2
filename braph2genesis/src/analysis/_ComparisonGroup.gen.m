...
if Element.getPropDefault(m, 'SHAPE') == Measure.GLOBAL % __Measure.GLOBAL__
    pr.set( ...
        'TABLE_HEIGHT', s(3), ...
        'ROWNAME', {}, ...
        'COLUMNNAME', {} ...
        )
elseif Element.getPropDefault(m, 'SHAPE') == Measure.NODAL % __Measure.NODAL__
    pr.set( ...
        'TABLE_HEIGHT', s(40), ...
        'ROWNAME', g.getCallback('ANODELABELS'), ...
        'COLUMNNAME', '[]' ...
        )
elseif Element.getPropDefault(m, 'SHAPE') == Measure.BINODAL % __Measure.BINODAL__
    pr.set( ...
        'TABLE_HEIGHT', s(40), ...
        'ROWNAME', g.getCallback('ANODELABELS'), ...
...
if g.get('LAYERNUMBER') == 1
    ...
    if  Element.getPropDefault(m, 'SCOPE') == Measure.SUPERGLOBAL % __Measure.SUPERGLOBAL__
        pr.set( ...
    ...
    elseif Element.getPropDefault(m, 'SCOPE') == Measure.UNILAYER % __Measure.UNILAYER__
        pr.set( ...
            'TABLE_HEIGHT', max(pr.get('TABLE_HEIGHT'), s(1) * g.get('LAYERNUMBER')), ...
            'XSLIDERSHOW', false, ...
            'YSLIDERSHOW', true, ...
    ...
    elseif Element.getPropDefault(m, 'SCOPE') == Measure.BILAYER % __Measure.BILAYER__
        pr.set( ...
