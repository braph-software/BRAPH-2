%% ¡header!
PFMeasureEnsemble < PanelFig (pf, panel figure measure) is a plot of a measure.
...
%%%% ¡gui!
pr = SettingsAxisPP('EL', pf, 'PROP', PFMeasureEnsemble.ST_AXIS, varargin{:});
