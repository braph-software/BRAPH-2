%% ¡header!
PFMeasureEnsembleMultiplexBU < PFMeasureEnsembleNU (pf, panel figure measure multiplex GU) is a plot of a binodal unilayer measure for multiplex graphs.
...
pr = PP_BrainRegion('EL', pf, 'PROP', PFMeasureEnsembleMultiplexBU.BR1_ID, ...
    'BA', ba, varargin{:});
...
pr = PP_BrainRegion('EL', pf, 'PROP', PFMeasureEnsembleMultiplexBU.BR2_ID, ...
    'BA', ba, ...
    varargin{:});
...
g = g_dict.getItem(1); 
pr = PP_LayerID('EL', pf, 'PROP', PFMeasureEnsembleMultiplexBU.LAYER, ...
    'G', g, ...
    varargin{:});
...
function p_out = draw(pf, varargin)
    ...
    pf.p = draw@PFMeasureEnsembleNU(pf, varargin{:});
