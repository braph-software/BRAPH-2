...
%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.WAITBAR
%%%% ¡title!
WAITBAR ON/OFF
...
%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.BKGCOLOR
%%%% ¡title!
BACKGROUND COLOR

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_POSITION
%%%% ¡title!
PANEL POSITION

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_AXIS
%%%% ¡title!
AXIS
...
%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_LINE_DIFF
%%%% ¡title!
DIFFERENCE

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_AREA
%%%% ¡title!
CONFIDENCE AREA (95%)

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_LINE_CIL
%%%% ¡title!
LOWER CONFIDENCE LINE

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_LINE_CIU
%%%% ¡title!
UPPER CONFIDENCE LINE

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_TITLE
%%%% ¡title!
TITLE

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_XLABEL
%%%% ¡title!
X-LABEL

%%% ¡prop!
%%%% ¡id!
ComparisonEnsembleBrainPF_NB.ST_YLABEL
%%%% ¡title!
Y-LABEL
...
%%% ¡excluded_props!
[ComparisonEnsembleBrainPF_NB.PARENT ComparisonEnsembleBrainPF_NB.H ComparisonEnsembleBrainPF_NB.ST_POSITION ComparisonEnsembleBrainPF_NB.ST_AXIS ComparisonEnsembleBrainPF_NB.ST_AREA ComparisonEnsembleBrainPF_NB.ST_LINE_DIFF ComparisonEnsembleBrainPF_NB.ST_LINE_CIL ComparisonEnsembleBrainPF_NB.ST_LINE_CIU ComparisonEnsembleBrainPF_NB.ST_TITLE ComparisonEnsembleBrainPF_NB.ST_XLABEL ComparisonEnsembleBrainPF_NB.ST_YLABEL] 
