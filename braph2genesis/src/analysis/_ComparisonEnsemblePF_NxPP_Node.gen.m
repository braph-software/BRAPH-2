%% ¡header!
ComparisonEnsemblePF_NxPP_Node < PanelProp (pr, panel property node) plots the panel to select a node.
...
%%% ¡seealso!
uidropdown, GUI, ComparisonEnsemblePF_NU, ComparisonEnsemblePF_NS, ComparisonEnsemblePF_NB
...
%%%% ¡default!
'ComparisonEnsemblePF_NxPP_Node'
...
%%%% ¡default!
'ComparisonEnsemblePF_NxPP_Node plots the panel to select a node from a drop-down list. It is supposed to be used with the property NODE of ComparisonGroupPF_NU, ComparisonGroupPF_NS, or ComparisonGroupPF_NB.'
...
%%% ¡excluded_props!
[ComparisonEnsemblePF_NxPP_Node.DRAW ComparisonEnsemblePF_NxPP_Node.PARENT ComparisonEnsemblePF_NxPP_Node.H ComparisonEnsemblePF_NxPP_Node.UPDATE ComparisonEnsemblePF_NxPP_Node.LISTENER_CB ComparisonEnsemblePF_NxPP_Node.DROPDOWN]
...
Remove Figures
%%%% ¡code!
warning('off', [BRAPH2.STR ':ComparisonEnsemblePF_NxPP_Node'])
assert(length(findall(0, 'type', 'figure')) == 1)
delete(findall(0, 'type', 'figure'))
warning('on', [BRAPH2.STR ':ComparisonEnsemblePF_NxPP_Node'])