...
function h_panel = draw(pr, varargin)
    ...
    if Measure.is_global(el.get('Measure')) && graph.getGraphType()==2
    ...
    elseif Measure.is_nodal(el.get('Measure')) && graph.getGraphType()==2
         pr.p = PlotPropMeasureEnsembleNodal( ...
            ...
            'TITLE', 'M', ...
            'BKGCOLOR', [0.8 0.5 0.2]).draw(varargin{:});
    elseif Measure.is_binodal(el.get('Measure')) && graph.getGraphType()==2 % binodal
        pr.p = PlotPropMeasureEnsembleBinodal( ...
            ...
            'TITLE', 'M', ...
            'BKGCOLOR', [0.8 0.5 0.2]).draw(varargin{:});
    elseif Measure.is_global(el.get('Measure')) && graph.getGraphType()==4
        pr.p = PlotPropMeasureEnsembleGlobalMultilayer( ...
            ...
            'TITLE', 'M', ...
            'BKGCOLOR', [0.8 0.5 0.2]).draw(varargin{:});
    elseif Measure.is_nodal(el.get('Measure')) && graph.getGraphType()==4
