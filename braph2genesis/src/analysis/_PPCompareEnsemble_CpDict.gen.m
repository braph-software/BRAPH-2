%% ¡header!
PPCompareEnsemble_CpDict < PanelProp (pr, panel property graph) is a plot of a group-based comparison dictionary property.

%%% ¡description!
PPCompareEnsemble_CpDict plots a table of the group-based comparison associated with a group comparison.
...
%%% ¡seealso!
GUI, PlotElement, CompareEnsemble, uitable
