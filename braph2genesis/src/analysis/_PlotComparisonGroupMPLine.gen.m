...
function f_settings = settings(pr, varargin)
    ...
    init_cil_panel()
        function init_cil_panel()
            set(ui_confidence_interval_min_checkbox, 'Position', [.77 .81 .1 .13]);
            ...
            set(ui_confidence_interval_max_checkbox, 'Position', [.88 .81 .1 .13]);
    ...
    init_layer_section()
        function init_layer_section()
            set(layer_popup, 'Position', [.55 .67 .1 .13], ...
                'Value', pr.get('LAYER'), ...
