...
function [a1_perm, a2_perm] = getPerm(c, i, memorize)
    ...
    if a1_perm_dict.containsIndex(i) && a2_perm_dict.containsIndex(i)
        ...
        a1_perm.set( ...
            ...
            'G_DICT', c.get('A1').get('G_DICT').clone() ...
            )
        ...
        a1_perm.get('G_DICT').set('IT_LIST', cellfun(@(x) x(2), subs1_gdict1_perm))

        a2_perm = c.get('A2').clone();
        a2_perm.set( ...
            'ID', [c.get('A2').get('ID') ' permutation ' int2str(i)], ...
            'GR', c.get('A2').get('GR').clone(), ...
            'G_DICT', c.get('A2').get('G_DICT').clone() ...
            )
        ...
        a2_perm.get('G_DICT').set('IT_LIST', cellfun(@(x) x(2), subs2_gdict2_perm))
