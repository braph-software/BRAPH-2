%% ¡header!
PFComparisonEnsembleBU < PFComparisonEnsembleNU (pf, panel figure group comparison GU) is a plot of a binodal unilayer group comparison.
...
pr = PP_BrainRegion('EL', pf, 'PROP', PFComparisonEnsembleBU.BR1_ID, ...
    'BA', ba, ...
    varargin{:});
...
pr = PP_BrainRegion('EL', pf, 'PROP', PFComparisonEnsembleBU.BR2_ID, ...
    'BA', ba, ...
    varargin{:});
