%% ¡header!
PFComparisonEnsembleNU < PFComparisonEnsembleGU (pf, panel figure group comparison GU) is a plot of a nodal unilayer group comparison.
...
%%%% ¡gui!
pr = SettingsFillPP('EL', pf, 'PROP', PFComparisonEnsembleNU.ST_FILL, ...    
    varargin{:});
...
pr = PP_BrainRegion('EL', pf, 'PROP', PFComparisonEnsembleNU.BR1_ID, ...
    'BA', ba, ...
    varargin{:});
