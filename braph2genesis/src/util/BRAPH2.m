classdef BRAPH2
    ...
    %  add_menu_about - adds the menu about to a figure
    ...
    methods (Static)
        ...
        function add_tool_about(toolbar)
            ...
            %  tool = findall(gui.toolbar, 'Tag', 'BRAPH2.Web');
            %  tool = findall(gui.toolbar, 'BRAPH2.Forum');
            %  tool = findall(gui.toolbar, 'BRAPH2.Twitter');
            %  tool = findall(gui.toolbar, 'BRAPH2.License');
            %  tool = findall(gui.toolbar, 'BRAPH2.Credits');
