    ...
    for i = 1:1:pl.get('ATLAS').get('BR_DICT').length
        ...
        if IDS_SHOW(i)
            ...
            if ~ishandle(pl.h_ids.h(i))
                ...
                if X{i} ~= get(pl.h_ids.h(i), 'Xdata') || ...
                        Y{i} ~= get(pl.h_ids.h(i), 'Ydata') || ...
                        Z{i} ~= get(pl.h_ids.h(i), 'Zdata') || ...
                        ID{i} ~= get(pl.h_ids.h(i), 'String')
            ...
            if IDS_SIZE(i) ~= get(pl.h_ids.h(i), 'FontSize') || ...
                    ...
                    pl.get('IDS_FONT_NAME') ~= get(pl.h_ids.h(i), 'FontName') || ...
                    int_ids{1} ~= get(pl.h_ids.h(i), 'Interpreter')
        ...
        if LABS_SHOW(i)
            ...
            if ~ishandle(pl.h_labs.h(i))
                ...
                if X{i} ~= get(pl.h_labs.h(i), 'Xdata') || ...
                        Y{i} ~= get(pl.h_labs.h(i), 'Ydata') || ...
                        Z{i} ~= get(pl.h_labs.h(i), 'Zdata') || ...
                        LABS{i} ~= get(pl.h_labs.h(i), 'String')
                    pl.h_labs.h(i) = text(X{i}, Y{i}, Z{i}, LABS{i}, 'Parent', pl.h_axes);
                end
            end
            % set
            if LABS_SIZE(i) ~= get(pl.h_labs.h(i), 'FontSize') || ...
                    ...
                    pl.get('LABS_FONT_NAME') ~= get(pl.h_labs.h(i), 'FontName') || ...
                    int_labs{1} ~= get(pl.h_labs.h(i), 'Interpreter')
