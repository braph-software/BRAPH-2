...
if (isempty(varargin) || pf.prop_set('VIEW', varargin)) && check_graphics(pf.h_axes, 'axes')
    ...
    set(findall(pf.toolbar, 'Tag', 'tool.view3D'), 'State', isequal(pf.get('VIEW'), PFBrainSurface.VIEW_3D_AZEL))
    set(findall(pf.toolbar, 'Tag', 'tool.viewSL'), 'State', isequal(pf.get('VIEW'), PFBrainSurface.VIEW_SL_AZEL))
    set(findall(pf.toolbar, 'Tag', 'tool.viewSR'), 'State', isequal(pf.get('VIEW'), PFBrainSurface.VIEW_SR_AZEL))
    set(findall(pf.toolbar, 'Tag', 'tool.viewAD'), 'State', isequal(pf.get('VIEW'), PFBrainSurface.VIEW_AD_AZEL))
    set(findall(pf.toolbar, 'Tag', 'tool.viewAV'), 'State', isequal(pf.get('VIEW'), PFBrainSurface.VIEW_AV_AZEL))
    set(findall(pf.toolbar, 'Tag', 'tool.viewCA'), 'State', isequal(pf.get('VIEW'), PFBrainSurface.VIEW_CA_AZEL))
    set(findall(pf.toolbar, 'Tag', 'tool.viewCP'), 'State', isequal(pf.get('VIEW'), PFBrainSurface.VIEW_CP_AZEL))
end
