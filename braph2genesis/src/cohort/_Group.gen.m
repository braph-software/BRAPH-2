...
sub1 = Subject('ID','id1', 'LABEL', 'label1', 'NOTES', 'notes1', 'ATLAS_DICT', atlas_dict)
sub2 = Subject('ID','id2', 'LABEL', 'label2', 'NOTES', 'notes2', 'ATLAS_DICT', atlas_dict)
sub3 = Subject('ID','id3', 'LABEL', 'label3', 'NOTES', 'notes3', 'ATLAS_DICT', atlas_dict)
