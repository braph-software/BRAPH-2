...
im_gr1 = ImporterGroupSubjectFUNXLS( ...
    ...
    'FILE_COVARIATES', [fileparts(which('example_FUN_WU')) filesep 'example data FUN (fMRI)' filesep 'xls' filesep 'covariates_age_sex' filesep 'GroupName1_age_sex.xlsx'], ...
    'BA', ba ...
    );
...
im_gr2 = ImporterGroupSubjectFUNXLS( ...
    ...
    'FILE_COVARIATES', [fileparts(which('example_FUN_WU')) filesep 'example data FUN (fMRI)' filesep 'xls' filesep 'covariates_age_sex' filesep 'GroupName2_age_sex.xlsx'], ...
    'BA', ba ...
    );
