...
im_gr1 = ImporterGroupSubjectCONXLS( ...
    ...
    'FILE_COVARIATES', [fileparts(which('example_CON_FUN_MP_WU')) filesep 'example data CON-FUN_MP' filesep 'xls' filesep 'covariates_age_sex' filesep 'GroupName1_age_sex.xlsx'], ...
    'BA', ba ...
    );
...
im_gr2 = ImporterGroupSubjectCONXLS( ...
    ...
    'FILE_COVARIATES', [fileparts(which('example_CON_FUN_MP_WU')) filesep 'example data CON-FUN_MP' filesep 'xls' filesep 'covariates_age_sex' filesep 'GroupName2_age_sex.xlsx'], ...
    'BA', ba ...
    );
...
im_gr2 = ImporterGroupSubjectFUNXLS( ...
    'DIRECTORY', [fileparts(which('example_FUN_WU')) filesep 'example data CON-FUN_MP' filesep 'xls' filesep 'functional' filesep 'GroupName2'], ...
    'FILE_COVARIATES', [fileparts(which('example_FUN_WU')) filesep 'example data CON-FUN_MP' filesep 'xls' filesep 'covariates_age_sex' filesep 'GroupName2_age_sex.xlsx'], ...
    'BA', ba ...
    );
