...
%%% ¡description!
ExporterGroupSubjectSTMPXLS exports a group of subjects with structural multiplex data to an XLSX file and their covariates age and sex (if existing) to another XLSX file.
...
%%%% ¡default!
[fileparts(which('test_braph2')) filesep 'default_xls_file_to_save_group_ST_MP_covs_most_likely_to_be_erased.xlsx']
...
function uiputfile(ex)
    % UIPUTFILE opens a dialog box to set the XLS/XLSX file where to save the group of subjects with structural multiplex data.
