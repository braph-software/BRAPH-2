%EXAMPLE_ST_MP_BUT
% Script example workflow ST MP BUT

clear variables %#ok<*NASGU>

%% Load BrainAtlas
im_ba = ImporterBrainAtlasXLS('FILE', [fileparts(which('example_ST_MP_BUT')) filesep 'example data ST_MP (MRI)' filesep 'desikan_atlas.xlsx']);
...
%% Analysis ST MP BUT
a_BUT1 = AnalyzeGroup_ST_MP_BUT('GR', gr1);

a_BUT2 = AnalyzeGroup_ST_MP_BUT('GR', gr2);
