...
im_gr1 = ImporterGroupSubjectSTMPXLS( ...
    ...
    'FILE_COVARIATES', [fileparts(which('example_ST_WU')) filesep 'example data ST_MP (MRI)' filesep 'xls' filesep 'covariates_age_sex' filesep 'ST_MP_group1_age_sex.xlsx'], ...
    'BA', ba ...
    );
...
im_gr2 = ImporterGroupSubjectSTMPXLS( ...
    ...
    'FILE_COVARIATES', [fileparts(which('example_ST_WU')) filesep 'example data ST_MP (MRI)' filesep 'xls' filesep 'covariates_age_sex' filesep 'ST_MP_group2_age_sex.xlsx'], ...
    'BA', ba ...
    );
