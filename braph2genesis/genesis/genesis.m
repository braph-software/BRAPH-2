...
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'group_handler.cpp'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'group_handler.cpp'])
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'group_handler.h'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'group_handler.h'])
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'group_index.cpp'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'group_index.cpp'])
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'group_index.h'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'group_index.h'])
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'metanetwork_reduce.cpp'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'metanetwork_reduce.cpp'])
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'mex.xcconfig'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'mex.xcconfig'])
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'matlab_matrix' fp 'full.cpp'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'matlab_matrix' fp 'full.cpp'])
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'matlab_matrix' fp 'matlab_matrix.h'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'matlab_matrix' fp 'matlab_matrix.h'])
copyfile([source_dir fp 'src' fp 'util' fp 'MEX_SRC' fp 'matlab_matrix' fp 'sparse.cpp'], [target_dir fp 'measures' fp 'MEX_SRC' fp 'matlab_matrix' fp 'sparse.cpp'])
copyfile([source_dir fp 'src' fp 'util' fp 'private' fp 'group_handler.mexa64'], [target_dir fp 'measures' fp 'private' fp 'group_handler.mexa64'])
copyfile([source_dir fp 'src' fp 'util' fp 'private' fp 'group_handler.mexmaci64'], [target_dir fp 'measures' fp 'private' fp 'group_handler.mexmaci64'])
copyfile([source_dir fp 'src' fp 'util' fp 'private' fp 'group_handler.mexw64'], [target_dir fp 'measures' fp 'private' fp 'group_handler.mexw64'])
copyfile([source_dir fp 'src' fp 'util' fp 'private' fp 'metanetwork_reduce.mexa64'], [target_dir fp 'measures' fp 'private' fp 'metanetwork_reduce.mexa64'])
copyfile([source_dir fp 'src' fp 'util' fp 'private' fp 'metanetwork_reduce.mexmaci64'], [target_dir fp 'measures' fp 'private' fp 'metanetwork_reduce.mexmaci64'])
copyfile([source_dir fp 'src' fp 'util' fp 'private' fp 'metanetwork_reduce.mexw64'], [target_dir fp 'measures' fp 'private' fp 'metanetwork_reduce.mexw64'])
