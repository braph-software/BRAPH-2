...
mkdir([target_dir fp 'src' fp 'atlas' fp 'brainsurfs'])
...
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_Ch2withCerebellum.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_Ch2withCerebellum.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152_smoothed.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152_smoothed.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152_smoothed_tal.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152_smoothed_tal.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152_tal.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152_tal.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152Left.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152Left.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152Left_smoothed.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152Left_smoothed.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152Right.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'BrainMesh_ICBM152Right.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'ferret.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'ferret.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'human.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'human.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'macaque.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'macaque.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'mouse.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'mouse.nv'])
copyfile([source_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'rat.nv'], [target_dir fp 'src' fp 'atlas' fp 'brainsurfs' fp 'rat.nv'])
