            ...
            ['for prop = 1:1:' class_name '.getPropNumber()']
                ...
                ['\t' 'switch ' class_name '.getPropCategory(prop)']
                    ['\t\t' 'case {Category.METADATA, Category.PARAMETER, Category.DATA, Category.FIGURE, Category.GUI}']
                        ['\t\t\t' 'assert( ...']
                            ['\t\t\t\t' 'isa(' moniker '.getr(prop), ''Callback'') || isequal(' moniker '.getr(prop), ' class_name '.getPropDefaultConditioned(prop)), ...']
                            ['\t\t\t\t' '[BRAPH2.STR '':' class_name ':'' BRAPH2.BUG_FUNC], ...']
                            ...
                            ['\t\t\t\t' ')']
                        ['\t\t\t' 'assert( ...']
                            ['\t\t\t\t' 'isa(' moniker '.getr(TAG), ''Callback'') || isequal(' moniker '.getr(TAG), ' class_name '.getPropDefaultConditioned(prop)), ...']
                            ['\t\t\t\t' '[BRAPH2.STR '':' class_name ':'' BRAPH2.BUG_FUNC], ...']
