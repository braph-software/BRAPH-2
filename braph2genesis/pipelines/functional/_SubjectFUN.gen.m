...
function cb_exporter_TXT(~, ~)
    ...
    if ~is(ex.get('DIRECTORY'), 'NoValue') % % % ~strcmp(ex.get('DIRECTORY'), ExporterGroupSubjectFUN_TXT.getPropDefault('DIRECTORY')) %TBE
        ex.get('SAVE');
    end
end
...
function cb_exporter_XLS(~, ~)
    ...
    if ~is(ex.get('DIRECTORY'), 'NoValue') % % % ~strcmp(ex.get('DIRECTORY'), ExporterGroupSubjectFUN_XLS.getPropDefault('DIRECTORY')) %TBE
        ex.get('SAVE');
    end
end
