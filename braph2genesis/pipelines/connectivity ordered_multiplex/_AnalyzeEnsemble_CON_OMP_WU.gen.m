...
%%% ¡prop!
ELCLASS (constant, string) is the class of the ensemble-based graph analysis with connectivity ordinal multiplex data.
%%%% ¡default!
...
%%%% ¡default!
'Multiplex Ordered Connectivity Weighted Undirected'
