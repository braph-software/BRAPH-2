...
im_ba = ImporterBrainAtlasTXT( ...
    'FILE', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST MM TXT' filesep 'atlas.txt'], ...
    'WAITBAR', true ...
    );
...
im_gr1 = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST MM TXT' filesep 'ST_MM_Group_1_TXT'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectST_MP_TXT( ...
    'DIRECTORY', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST MM TXT' filesep 'ST_MM_Group_2_TXT'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
