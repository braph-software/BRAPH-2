...
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST MM XLS' filesep 'atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
im_gr1 = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST MM XLS' filesep 'ST_MM_Group_1_XLS'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST MM XLS' filesep 'ST_MM_Group_2_XLS'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr3 = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST MM XLS' filesep 'ST_MM_Group_3_XLS'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
