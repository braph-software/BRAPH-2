...
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('NNDataPoint_ST_MM_REG')) filesep 'Example data NN REG ST MM XLS' filesep 'atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
im_gr = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('NNDataPoint_ST_MM_REG')) filesep 'Example data NN REG ST MM XLS' filesep 'ST_MM_Group_XLS'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
