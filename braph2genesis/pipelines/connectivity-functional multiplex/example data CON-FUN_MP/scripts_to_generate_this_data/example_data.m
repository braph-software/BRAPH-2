...
mkdir('functional/FUN_Group_1');
mkdir('functional/FUN_Group_2');
...
for i_tab = 1:1:N_subjects
    ...
    file_name = strcat("Functional/FUN_Group_1/", sub_Tags(i_tab), ".xlsx");
    ...
    file_name = strcat("functional/FUN_Group_2/", sub_Tags(i_tab), ".xlsx");
...
mkdir('connectivity/CON_Group_1');
mkdir('connectivity/CON_Group_2');
...
for i_tab = 1:1:N_subjects
    ...
    file_name = strcat("connectivity/CON_Group_1/", sub_Tags(i_tab), ".xlsx");
    ...
    file_name = strcat("connectivity/CON_Group_2/", sub_Tags(i_tab), ".xlsx");
