%% ¡header!
ImporterGroupSubjectCON_FUN_MP_TXT < Importer (im, importer of CON_FUN_MP subject group from TXT) imports a group of subjects with connectivity data from a series of TXT file.
