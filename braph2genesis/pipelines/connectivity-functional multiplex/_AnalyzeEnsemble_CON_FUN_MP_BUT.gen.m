...
%%% ¡prop!
ELCLASS (constant, string) is the class of the ensemble-based graph analysis with connectivity and functional multiplex data of fixed threshold..
%%%% ¡default!
...
%%%% ¡default!
'Multiplex Connectivity-Functional Binary at fixed Thresholds Analyze Ensemble'
