%% ¡header!
ExporterGroupSubjectCON_FUN_MP_XLS < Exporter (ex, exporter of CON and FUN subject groups in XLS) exports a group of subjects with connectivity data and functional data to a series of XLS files.
...
%%% ¡prop!
SAVE (result, empty) saves the group of subjects with connectivity data and functional data in XLS files in the selected directories.
%%%% ¡calculate!

directory_con = ex.get('DIRECTORY_CON');
gr = ex.get('GR');
grs_obj = SepareteGroups_CON_FUN( ...
    'GR_CON_FUN_MP', gr);
