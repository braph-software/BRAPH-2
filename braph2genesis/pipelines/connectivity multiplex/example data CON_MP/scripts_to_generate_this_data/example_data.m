...
for i_tab = 1:1:N_groups
    ...
    mkdir(strcat('CON_MP_Group_1/', sub_Tags(i_tab)));
    % create the tables - layer 1
    T_gr11 = array2table(gr1_matrices1{i_tab});
    tables_gr11{i_tab} = T_gr11;
    file_name = strcat("CON_MP_Group_1/", sub_Tags(i_tab), "/", sub_Tags(i_tab), "_1.xlsx");
    ...
    file_name = strcat("CON_MP_Group_1/", sub_Tags(i_tab), "/", sub_Tags(i_tab), "_2.xlsx");
...
mkdir('CON_MP_Group_2');

for i_tab = 1:1:N_groups
    % Create directory per subject
    mkdir(strcat('CON_MP_Group_2/', sub_Tags(i_tab)));
    % create the tables - layer 1
    T_gr21 = array2table(gr2_matrices1{i_tab});
    tables_gr21{i_tab} = T_gr21;
    file_name = strcat("CON_MP_Group_2/", sub_Tags(i_tab), "/", sub_Tags(i_tab), "_1.xlsx");
    ...
    file_name = strcat("CON_MP_Group_2/", sub_Tags(i_tab), "/", sub_Tags(i_tab), "_2.xlsx");
