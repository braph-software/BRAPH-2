...
for i = 51:1:100
    ...
    writetable(array2table(A_full1), [gr2_dir filesep() sub_id num2str(i) '.1.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
    writetable(array2table(A_full2), [gr2_dir filesep() sub_id num2str(i) '.2.txt'], 'Delimiter', '\t', 'WriteVariableNames', false)
