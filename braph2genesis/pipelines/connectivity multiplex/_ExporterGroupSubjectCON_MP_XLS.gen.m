%% ¡header!
ExporterGroupSubjectCON_MP_XLS < Exporter (ex, exporter of CON MP subject group in XLSX) exports a group of subjects with connectivity multiplex data to a series of XLSX file.
...
%%% ¡prop!
ELCLASS (constant, string) is the class of the CON MP subject group exporter in XLSX.
%%%% ¡default!
'ExporterGroupSubjectCON_MP_XLS'

%%% ¡prop!
NAME (constant, string) is the name of the CON MP subject group exporter in XLSX.
%%%% ¡default!
'Multiplex Connectivity Subject Group XLS Exporter'

%%% ¡prop!
DESCRIPTION (constant, string) is the description of the CON MP subject group exporter in XLSX.
%%%% ¡default!
...
%%% ¡prop!
LABEL (metadata, string) is an extended label of the CON MP subject group exporter in XLSX.
%%%% ¡default!
'ExporterGroupSubjectCON_MP_XLS label'

%%% ¡prop!
NOTES (metadata, string) are some specific notes about the CON MP subject group exporter in XLSX.
%%%% ¡default!
...
%%% ¡prop!
SAVE (result, empty) saves the group of subjects with connectivity multiplex data in XLSX files in the selected directory.
%%%% ¡calculate!
