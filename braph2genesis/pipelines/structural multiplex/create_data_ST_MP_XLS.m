function create_data_ST_MP_XLS(data_dir, random_seed)
%CREATE_DATA_ST_MP_XLS creates structural data
%
% CREATE_DATA_ST_MP_XLS() creates structural data in default folder 'Example
%  data ST MP XLS'.
%
% CREATE_DATA_ST_MP_XLS(DATA_DIR) creates structural data in DATA_DIR folder.
%
% CREATE_DATA_ST_MP_XLS(DATA_DIR, RANDOM_SEED) cretes structural data in DATA_DIR
