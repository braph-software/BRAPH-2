...
function cb_exporter_TXT(~, ~)
    ...
    if ~is(ex.get('DIRECTORY'), 'NoValue') % % % ~strcmp(ex.get('DIRECTORY'), ExporterGroupSubjectST_MP_TXT.getPropDefault('DIRECTORY'))
        ex.get('SAVE');
    end
end
...
function cb_exporter_XLS(~, ~)
    ...
    if ~is(ex.get('DIRECTORY'), 'NoValue') % % % ~strcmp(ex.get('DIRECTORY'), ExporterGroupSubjectST_MP_XLS.getPropDefault('DIRECTORY'))
        ex.get('SAVE');
    end
end
