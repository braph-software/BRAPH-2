function create_data_NN_REG_CON_XLS(data_dir, random_seed)
%CREATE_DATA_CON_NN_XLS creates connectivity data for neural network regression analysis
%
% CREATE_DATA_CON_NN_XLS() creates connectivity data in default folder 'Example
%  data NN CLA CON XLS'.
%
