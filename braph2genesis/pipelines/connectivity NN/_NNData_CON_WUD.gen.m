%% ¡header!
NNData_CON_WUD < NNData (nnd, data for neural network) produces a dataset to train or test a neural netowrk model for connectivity data. 
...
Example 1
%%%% ¡code!
example_NNCV_CON_WUD_Classification_AdjacencyMatrix