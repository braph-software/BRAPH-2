...
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('AnalyzeEnsemble_CON_WD')) filesep 'Example data CON XLS' filesep 'atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
im_gr1 = ImporterGroupSubjectCON_XLS( ...
    'DIRECTORY', [fileparts(which('AnalyzeEnsemble_CON_WD')) filesep 'Example data CON XLS' filesep 'CON_Group_1_XLS'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectCON_XLS( ...
    'DIRECTORY', [fileparts(which('AnalyzeEnsemble_CON_WD')) filesep 'Example data CON XLS' filesep 'CON_Group_2_XLS'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
