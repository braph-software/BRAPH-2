%% ¡header!
PPCompareEnsemble_CPDict_WD < PlotProp (pr, plot property graph) is a plot of a comparison ensemble dictionary.

%%% ¡description!
PPCompareEnsemble_CPDict_WD plots the comparison ensemble dictionary property associated with a graph.
