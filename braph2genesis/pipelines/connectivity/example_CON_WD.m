...
% measure calculation
degree_WU1 = a_WD1.getMeasureEnsemble('Degree').get('M');
degree_av_WU1 = a_WD1.getMeasureEnsemble('DegreeAv').get('M');
distance_WU1 = a_WD1.getMeasureEnsemble('Distance').get('M');

degree_WU2 = a_WD2.getMeasureEnsemble('Degree').get('M');
degree_av_WU2 = a_WD2.getMeasureEnsemble('DegreeAv').get('M');
distance_WU2 = a_WD2.getMeasureEnsemble('Distance').get('M');
