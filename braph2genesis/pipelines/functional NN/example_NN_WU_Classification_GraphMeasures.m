%EXAMPLE_FUN_NN_WU_CLASSIFICATION
% Script example pipeline NN WU Classification Graph Measures

clear variables %#ok<*NASGU>

%% Load BrainAtlas
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('example_NN_WU_Classification_GraphMeasures')) filesep 'example data FUN (fMRI)' filesep 'desikan_atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
im_gr1 = ImporterGroupSubjectFUN_XLS( ...
    'DIRECTORY', [fileparts(which('example_NN_WU_Classification_GraphMeasures')) filesep 'example data FUN (fMRI)' filesep 'xls' filesep 'GroupName1'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectFUN_XLS( ...
    'DIRECTORY', [fileparts(which('example_NN_WU_Classification_GraphMeasures')) filesep 'example data FUN (fMRI)' filesep 'xls' filesep 'GroupName2'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
