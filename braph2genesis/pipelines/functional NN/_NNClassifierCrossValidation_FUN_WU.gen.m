%% ¡header!
NNClassifierCrossValidation_FUN_WU < NNClassifierCrossValidation (nncv, cross-validation of a neural network classifier) cross-validates the performance of a neural network classifier with a dataset.

%% ¡description!
This cross validation performan k-fold cross validation of a neural network
classifier with desired repetitions for functional data. The dataset is 
