%% ¡header!
NNData_FUN_WU < NNData (nnd, data of a neural network regressor with functional data) produces a dataset to train or test a neural netowrk regressor using functional data. 
