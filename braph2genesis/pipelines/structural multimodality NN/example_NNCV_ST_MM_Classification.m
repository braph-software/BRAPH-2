...
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('example_NNCV_ST_MM_Classification')) filesep 'example data ST_MP (MRI)' filesep 'desikan_atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
im_gr1 = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('example_NNCV_ST_MM_Classification')) filesep 'example data ST_MP (MRI)' filesep 'xls' filesep 'GroupName1'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('example_NNCV_ST_MM_Classification')) filesep 'example data ST_MP (MRI)' filesep 'xls' filesep 'GroupName2'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
