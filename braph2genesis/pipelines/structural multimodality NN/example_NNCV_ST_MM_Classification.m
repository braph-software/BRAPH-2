...
im_gr1 = ImporterGroupSubjectST_MP_XLS( ...
    'FILE', [fileparts(which('example_NNCV_ST_MM_Classification')) filesep 'example data ST_MP (MRI)' filesep 'xls' filesep 'ST_group1.xlsx'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectST_MP_XLS( ...
    'FILE', [fileparts(which('example_NNCV_ST_MM_Classification')) filesep 'example data ST_MP (MRI)' filesep 'xls' filesep 'ST_group2.xlsx'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
