...
%%% ¡prop!
ELCLASS (constant, string) is the class of the ensemble-based graph analysis with functional ordinal multiplex data.
%%%% ¡default!
...
%%%% ¡default!
'Multiplex Functional Ordered Weighted Undirected Analyze Ensemble'
