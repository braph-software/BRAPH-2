...
% Script example pipeline FUN_MP WU Group

clear variables %#ok<*NASGU>

%% Load BrainAtlas
im_ba = ImporterBrainAtlasXLS('FILE', [fileparts(which('example_FUN_OrderedMP_WU_Group')) filesep 'example data FUN_MP (fMRI)' filesep 'craddock_atlas.xlsx']);
...
im_gr1 = ImporterGroupSubjectFUNMPXLS( ...
    'DIRECTORY', [fileparts(which('example_FUN_OrderedMP_WU_Group')) filesep 'example data FUN_MP (fMRI)' filesep 'xls' filesep 'GroupName1'], ...
    'BA', ba ...
    );
...
im_gr2 = ImporterGroupSubjectFUNMPXLS( ...
    'DIRECTORY', [fileparts(which('example_FUN_OrderedMP_WU_Group')) filesep 'example data FUN_MP (fMRI)' filesep 'xls' filesep 'GroupName2'], ...
    'BA', ba ...
    );
...
%% Analysis FUN_MP WU
a_WU1 = AnalyzeGroup_FUN_OrderedMP_WU( ...
    'GR', gr1 ...
    );

a_WU2 = AnalyzeGroup_FUN_OrderedMP_WU( ...
    'GR', gr2 ...
    );
