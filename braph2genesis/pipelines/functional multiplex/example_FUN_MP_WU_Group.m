...
im_gr1 = ImporterGroupSubjectFUNMPXLS( ...
    'DIRECTORY', [fileparts(which('example_FUN_MP_WU_Group')) filesep 'example data FUN_MP (fMRI)' filesep 'xls' filesep 'GroupName1'], ...
    'BA', ba ...
    );
...
im_gr2 = ImporterGroupSubjectFUNMPXLS( ...
    'DIRECTORY', [fileparts(which('example_FUN_MP_WU_Group')) filesep 'example data FUN_MP (fMRI)' filesep 'xls' filesep 'GroupName2'], ...
    'BA', ba ...
    );
...
a_WU1 = AnalyzeGroup_FUN_MP_WU( ...
    'GR', gr1 ...
    );

a_WU2 = AnalyzeGroup_FUN_MP_WU( ...
    'GR', gr2 ...
    );
