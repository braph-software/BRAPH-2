...
%% Fix the number of subjects - 2 groups in total
N_groups = 50;
...
mkdir('GroupName1');
mkdir('GroupName2');
writetable(C_group1, 'GroupName1/GroupName1_covariates.xlsx', 'WriteRowNames', true)
writetable(C_group2, 'GroupName2/GroupName2_covariates.xlsx', 'WriteRowNames', true)
