...
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('example_NN_CON_FUN_MP_WU_Classification_GraphMeasures')) filesep 'example data CON-FUN_MP' filesep 'desikan_atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
im_gr1 = ImporterGroupSubjectCON_XLS( ...
    'DIRECTORY', [fileparts(which('example_NN_CON_FUN_MP_WU_Classification_GraphMeasures')) filesep 'example data CON-FUN_MP' filesep 'xls' filesep 'connectivity' filesep 'GroupName1'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectCON_XLS( ...
    'DIRECTORY', [fileparts(which('example_NN_CON_FUN_MP_WU_Classification_GraphMeasures')) filesep 'example data CON-FUN_MP' filesep 'xls' filesep 'connectivity' filesep 'GroupName2'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr1 = ImporterGroupSubjectFUN_XLS( ...
    'DIRECTORY', [fileparts(which('example_NN_CON_FUN_MP_WU_Classification_GraphMeasures')) filesep 'example data CON-FUN_MP' filesep 'xls' filesep 'functional' filesep 'GroupName1'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectFUN_XLS( ...
    'DIRECTORY', [fileparts(which('example_NN_CON_FUN_MP_WU_Classification_GraphMeasures')) filesep 'example data CON-FUN_MP' filesep 'xls' filesep 'functional' filesep 'GroupName2'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
nnd1 = NNData_CON_FUN_MP_WU( ...
    ...
    'MEASURES', {'MultilayerCommunityStructure' 'MultiplexTriangles' 'DegreeAv' 'Degree' 'Distance'}, ...
...
gr2_unseen = co_gr2.get('GR');

%% Construct the datatset
nnd1_unseen = NNData_CON_FUN_MP_WU( ...
    'GR', gr1_unseen, ...
    'INPUT_TYPE', 'graph_measures', ...
    'MEASURES', {'MultilayerCommunityStructure' 'MultiplexTriangles' 'DegreeAv' 'Degree' 'Distance'}, ...
...
nnd2_unseen = NNData_CON_FUN_MP_WU( ...
    'GR', gr2_unseen, ...
    'INPUT_TYPE', 'graph_measures', ...
    'MEASURES', {'MultilayerCommunityStructure' 'MultiplexTriangles' 'DegreeAv' 'Degree' 'Distance'}, ...
