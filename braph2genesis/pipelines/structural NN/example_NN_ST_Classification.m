...
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('example_NN_ST_Classification')) filesep 'example data ST NN' filesep 'classification' filesep 'desikan_atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
im_gr1 = ImporterGroupSubjectST_XLS( ...
    'FILE', [fileparts(which('example_NN_ST_Classification')) filesep 'example data ST NN' filesep 'classification' filesep 'xls' filesep 'ST_group1.xlsx'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectST_XLS( ...
    'FILE', [fileparts(which('example_NN_ST_Classification')) filesep 'example data ST NN' filesep 'classification' filesep 'xls' filesep 'ST_group3.xlsx'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
