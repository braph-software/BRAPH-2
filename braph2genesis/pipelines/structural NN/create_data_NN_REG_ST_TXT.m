...
%CREATE_DATA_NN_REG_ST_TXT creates functional data for neural network regression analysis
%
% CREATE_DATA_NN_REG_ST_TXT() creates functional data in default folder 'Example
%  data NN REG ST TXT'.
%
% CREATE_DATA_NN_REG_ST_TXT(DATA_DIR) creates functional data in DATA_DIR folder.
%
% CREATE_DATA_NN_REG_ST_TXT(DATA_DIR, RANDOM_SEED) cretes functional data in
