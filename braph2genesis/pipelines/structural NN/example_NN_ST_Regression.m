...
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('example_NN_ST_Regression')) filesep 'example data ST (MRI)' filesep 'regression' filesep 'desikan_atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
im_gr = ImporterGroupSubjectST_XLS( ...
    'FILE', [fileparts(which('example_NN_ST_Classification')) filesep 'example data ST (MRI)' filesep 'regression' filesep 'xls' filesep 'ST_group.xlsx'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
