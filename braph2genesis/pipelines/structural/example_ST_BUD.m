...
degree_BUD_p1 = c_BUD.getComparison('Degree').get('DIFF');
...
degree_av_BUD_p1 = c_BUD.getComparison('DegreeAv').get('DIFF');
...
distance_BUD_p1 = c_BUD.getComparison('Distance').get('DIFF');
