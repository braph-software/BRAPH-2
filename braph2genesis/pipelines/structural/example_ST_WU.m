...
degree_WU_p1 = c_WU.getComparison('Degree').get('DIFF');
...
degree_av_WU_p1 = c_WU.getComparison('DegreeAv').get('DIFF');
...
distance_WU_p1 = c_WU.getComparison('Distance').get('DIFF');
