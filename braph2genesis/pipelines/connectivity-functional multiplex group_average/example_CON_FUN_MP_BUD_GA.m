%EXAMPLE_CON_FUN_MP_BUD_GA
% Script example pipeline CON FUN MP BUD GA

clear variables %#ok<*NASGU>

%% Load BrainAtlas
im_ba = ImporterBrainAtlasXLS( ...
    'FILE', [fileparts(which('example_CON_FUN_MP_BUD')) filesep 'example data CON-FUN_MP' filesep 'desikan_atlas.xlsx'], ...
    'WAITBAR', true ...
    );
...
%% Analysis CON FUN MP BUD GA
densities = [0 100];

a_BUD1 = AnalyzeGroup_CON_FUN_MP_BUD_GA( ...
    'GR', gr1, ...
    'DENSITIES', densities ...
    );

a_BUD2 = AnalyzeGroup_CON_FUN_MP_BUD_GA( ...
    'GR', gr2, ...
    'DENSITIES', densities ...
    );
