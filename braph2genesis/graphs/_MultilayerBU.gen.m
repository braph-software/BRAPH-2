...
%%% ¡description!
In a multilayer binary undirected (BU) graph, layers have same or different number 
...
%%%% ¡default!
'In a multilayer binary undirected (BU) graph, layers have same or different nodes with within-layer undirected edges either 0 (absence of connection) or 1 (existence of connection). The connectivity matrices are symmetric. There are connections between layers connecting the corresponding nodes.'
