...
%%% ¡description!
In an ordinal multilayer binary undirected with fixed thresholds (BUT) graph, layers 
...
%%% ¡prop!
ELCLASS (constant, string) is the class of the ordinal multilayer binary undirected with fixed thresholds.
%%%% ¡default!
'OrdMlBUT'

%%% ¡prop!
NAME (constant, string) is the name of the ordinal multilayer binary undirected with fixed thresholds.
%%%% ¡default!
'OrdMlBUT'
...
%%% ¡prop!
ID (data, string) is a few-letter code for the ordinal multilayer binary undirected with fixed thresholds.
%%%% ¡default!
'OrdMlBUT ID'

%%% ¡prop!
LABEL (metadata, string) is an extended label of the ordinal multilayer binary undirected with fixed thresholds.
%%%% ¡default!
'OrdMlBUT label'

%%% ¡prop!
NOTES (metadata, string) are some specific notes about the ordinal multilayer binary undirected with fixed thresholds.
%%%% ¡default!
'OrdMlBUT notes'
